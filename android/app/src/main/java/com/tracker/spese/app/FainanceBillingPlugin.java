...
public class FainanceBillingPlugin extends Plugin implements PurchasesUpdatedListener {
    ...
    public void purchase(final PluginCall call) {
        ...
        runWhenReady(new Runnable() {
            @Override
            public void run() {
                queryAndLaunchPurchase(call, productId, basePlanId, plan);
            }
        }, call);
    }
    ...
    private void queryAndLaunchPurchase(final PluginCall call, final String productId, final String basePlanId, final String plan) {
        ...
        billingClient.queryProductDetailsAsync(params, (billingResult, queryProductDetailsResult) -> {
            ...
            if (productDetailsList == null || productDetailsList.isEmpty()) {
                call.reject("Prodotto non trovato su Google Play: " + productId);
                return;
            }

            ProductDetails selectedProduct = productDetailsList.get(0);
            String selectedOfferToken = findOfferToken(selectedProduct, basePlanId);
