...
export const EMOJI_LIST=["🏠", "💡", "🛋", "🔧", "🛒", "💆", "💊", "🎱", "🍽", "☕", "👗", "🎟", "🏋", "🎁", "❤", "✈", "🅿", "🚖", "⛽", "📦", "💳", "💵", "🏦", "💰", "🍱", "📈", "💼", "🎯", "⭐", "💠", "🏛", "🎮", "🎵", "📚", "🏖", "🚗", "🚌", "🛵", "🎬", "🍕", "🍷", "💻", "📱", "🎓", "👶", "🐶", "🌱", "🔑", "🏥", "⚽", "🎾", "🌍", "🎄", "📦", "🧾", "🧮", "📑", "📌", "📍", "🧷", "🗃️", "🗄️", "🧺", "🛍️", "🥩", "🐟", "🥬", "🍎", "🥕", "🧀", "🥛", "🥚", "🍞", "🥐", "🍝", "🍚", "🥫", "🧃", "🧴", "🧼", "🪥", "🧻", "🧽", "🧹", "🪣", "🧊", "🔥", "❄️", "☂️", "👓", "🧢", "👟", "💍", "⌚", "📷", "🎧", "🖨️", "🖥️", "🖱️", "⌨️", "🔌", "🔋", "🧯", "🛠️", "🪛", "🔩", "⚙️", "🧰", "🏗️", "🏡", "🏢", "🏬", "🏪", "🏫", "🏟️", "🛏️", "🚿", "🛁", "🚽", "🪑", "🚪", "🪟", "🪴", "🌵", "🌿", "🌸", "🍀", "🐱", "🐭", "🐠", "🦜", "🐢", "🚲", "🛴", "🚆", "🚇", "🚁", "🛫", "🛳️", "🏕️", "🧭", "🗺️", "🏔️", "🏝️", "🎭", "🎨", "🎤", "🎹", "🥁", "🎲", "♟️", "🧩", "🎯", "🏆", "🥇", "🧘", "🏊", "🚴", "🥾", "🩺", "🩹", "🦷", "👨‍⚕️", "⚖️", "📜", "🧾", "💹", "📉", "📊", "🪙", "💶", "💷", "💴", "💲", "🔐", "🔔", "🚨", "✅", "❌", "➕", "➖", "🔄", "📅", "⏳", "PayPal", "Revolut", "Wise", "N26", "Satispay", "Hype", "Postepay", "Bancomat", "Visa", "Mastercard", "Amex", "Apple Pay", "Google Pay", "Samsung Pay", "Stripe", "SumUp", "Nexi", "Pagopa", "SEPA", "IBAN", "SWIFT", "BIC", "ETF", "PAC", "BTP", "BOT", "Fondo", "Azioni", "Obbligazioni", "Crypto", "Bitcoin", "Ethereum", "NASDAQ", "S&P", "FTSE", "CAC", "DAX", "Mutuo", "Affitto", "Bolletta", "Fattura", "Canone", "Tasse", "IVA", "730", "F24", "INPS", "Assicurazione", "Finanziamento", "Prestito", "Risparmio", "Budget", "Cashback", "Rimborso", "Stipendio", "Bonus", "Dividendi", "Interessi", "POS", "ATM", "Conto", "Carta", "Prepagata", "Wallet", "Broker", "Trading", "Pensione", "TFR", "Fondo pensione", "Split", "Share", "Scontrino", "Preventivo", "Salvadanaio", "Cassa", "Cassetta", "Cassaforte", "Banca", "Fintech", "OpenBank", "BBVA", "Intesa", "UniCredit", "Fineco", "Mediolanum", "ING", "Poste", "Mooney", "Telepass", "PagoBANCOMAT", "Klarna", "Scalapay", "Amazon Pay", "Vinted", "eBay", "Subito", "Airbnb", "Booking", "Uber", "Bolt", "FreeNow", "Deliveroo", "Glovo", "JustEat", "Esselunga", "Coop", "Conad", "Lidl", "Eurospin", "Carrefour", "IKEA", "Amazon", "Netflix", "Spotify", "Disney+", "DAZN", "Sky", "TIM", "Vodafone", "WindTre", "Iliad", "Enel", "A2A", "Hera", "Edison", "Eni", "Illumia", "🚀", "🧠", "🤖", "📲", "💸", "💱", "🏧", "📇", "🧿", "🪪", "🧳", "🔏", "🗂️", "📁", "📝", "🖋️", "⚠️"];
