...
function isNativeIOSRuntime(){
  try{
    ...
    // non � disponibile abbastanza presto, quindi il protocollo � il segnale pi� affidabile.
...
function App({currentUser,onLogout,fbUser,onProfileUpdate}){
  ...
  useEffect(function(){
    // 1.6.13 iOS: su WKWebView la riscrittura manuale dei text node può causare
