...
function App({ currentUser, onLogout, fbUser, onProfileUpdate }) {
  ...
  function sectionLabel(id) {
    ...
    if (id === "consulenteAI") return translateUiRuntimeText("Agente AI");
        var aiAgentNavLabels: any = {
      it: "Agente AI",
      en: "AI Agent",
      es: "Agente de IA",
      fr: "Agent IA",
    ...
    if (id === "consulenteAI") return aiAgentNavLabels[lang] || aiAgentNavLabels.it;    return (dict[lang] && dict[lang][id]) || dict.it[id] || id;
  }
  function allNavDefs() {
    return {
        ...
        >
          ...
          <div
            style={{
              ...
              padding: tab === "consulenteAI" && aiTab === "chat" ? 8 : 14,
            }}
          >
