...
// APP.TSX â Shell principale, login, stato globale, navigazione
...
// Evita il flash visibile in italiano quando Ã¨ attiva una lingua diversa:
...
function LoginScreen({onLogin}){
  ...
  function doRegister(){
    ...
    createUserWithEmailAndPassword(fbAuth,email,password)
      ...
      .catch(function(err){
        setError(err.code==="auth/email-already-in-use"?L("Email giÃ  registrata."):L("Errore: ")+err.message);
        setLoading(false);
      });
  }
  ...
  return <div style={{minHeight:"100vh",background:"linear-gradient(160deg,#f0edff 0%,#e8f4ff 100%)",display:"flex",alignItems:"center",justifyContent:"center",padding:20,overflowY:"auto"}}>
    <div style={{width:"100%",maxWidth:400}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          ...
          <div><label style={{fontSize:12,color:"#888",display:"block",marginBottom:4}}>{L("Password")} *</label>
            <div style={{position:"relative"}}>
              ...
              <button onClick={function(){setShowPwd(!showPwd);}} style={{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",background:"none",border:"none",cursor:"pointer",fontSize:16,color:"#aaa"}}>{showPwd?"ð":"ð"}</button>
            </div>
          </div>
          ...
          {mode==="login"&&resetOpen&&<div style={{background:"linear-gradient(135deg,#f0edff,#e8f4ff)",border:"1px solid rgba(127,119,221,0.25)",borderRadius:18,padding:16,boxShadow:"0 6px 20px rgba(127,119,221,0.12)",display:"flex",flexDirection:"column",gap:10}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}><div style={{width:34,height:34,borderRadius:12,background:"linear-gradient(135deg,#7F77DD,#378ADD)",display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",fontSize:17}}>ð</div><div><div style={{fontSize:14,fontWeight:800,color:"#534AB7"}}>{L("Recupera password")}</div><div style={{fontSize:11,color:"#777",marginTop:2}}>{L("Ti invieremo un link sicuro per reimpostarla.")}</div></div></div>
            <div><label style={{fontSize:12,color:"#777",display:"block",marginBottom:4}}>{L("Email dellâaccount")}</label><input type="email" value={resetEmail} onChange={function(e){setResetEmail(e.target.value);}} placeholder={L("nome@email.com")} style={{...inp,background:"#fff",border:"1px solid rgba(127,119,221,0.25)"}}/></div>
          ...
          {resetSent&&<div style={{background:"#e8f8f0",borderRadius:12,padding:"12px 14px",fontSize:13,color:"#1D9E75",border:"1px solid #a8e6c8",lineHeight:1.4}}>â {L("Email di recupero password inviata. Controlla la casella di posta.")}</div>}
          {error&&<div style={{background:"#fff0f0",borderRadius:10,padding:"10px 14px",fontSize:13,color:"#E24B4A",border:"1px solid #fcc"}}>â ï¸ {error}</div>}
      ...
      <div style={{textAlign:"center",marginTop:14,fontSize:11,color:"#aaa"}}>Â© 2026 fAInance</div>
    </div>
  </div>;
}


// ââ SECTION ERROR BOUNDARY ââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  render(){
    if(this.state.hasError){
      ...
      return <div style={{background:dark?"#2a2424":"#fff0f0",border:"1.5px solid "+borderC,borderRadius:18,padding:24,display:"flex",gap:18,alignItems:"flex-start"}}>
        <div style={{width:58,height:58,borderRadius:18,background:dark?"#3a2b2b":"#ffe0e0",display:"flex",alignItems:"center",justifyContent:"center",fontSize:30,flexShrink:0}}>â ï¸</div>
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:20,fontWeight:900,color:dark?"#ffd0d0":"#8a2d2d",marginBottom:8}}>{tr("Questa sezione non si Ã¨ caricata correttamente")}</div>
...
function ContactForm({currentUser}){
  ...
  return <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
    <div style={{fontSize:15,fontWeight:700,color:textC,marginBottom:14}}>ð¬ {PL("Contattaci")}</div>
    <div style={{display:"flex",flexDirection:"column",gap:10}}>
      ...
      {status&&<div style={{fontSize:13,borderRadius:10,padding:"10px 12px",background:status.type==="ok"?"#e8f8f0":"#fff0f0",color:status.type==="ok"?"#1D9E75":"#E24B4A",border:"1px solid "+(status.type==="ok"?"#a8e6c8":"#fcc")}}>{status.type==="ok"?"â ":"â ï¸ "}{status.text}</div>}
...
function ChangePwdSection({dark,textC,subC,borderC,btnRadius,setToast}){
  ...
  return <div style={{borderTop:"1px solid "+borderC,paddingTop:12,marginTop:12}}>
    <button onClick={function(){setOpen(!open);setError("");}} style={{background:"none",border:"none",cursor:"pointer",color:"#7F77DD",fontSize:13,fontWeight:500,padding:0}}>
      ð {open?PL("Annulla"):PL("Cambia password")}
    </button>
...
const PROFILE_COUNTRY_OPTIONS=[{"code":"AF","it":"Afghanistan","en":"Afghanistan","es":"AfganistÃ¡n","fr":"Afghanistan"},{"code":"AL","it":"Albania","en":"Albania","es":"Albania","fr":"Albanie"},{"code":"DZ","it":"Algeria","en":"Algeria","es":"Argelia","fr":"AlgÃ©rie"},{"code":"AD","it":"Andorra","en":"Andorra","es":"Andorra","fr":"Andorre"},{"code":"AO","it":"Angola","en":"Angola","es":"Angola","fr":"Angola"},{"code":"AI","it":"Anguilla","en":"Anguilla","es":"Anguila","fr":"Anguilla"},{"code":"AQ","it":"Antartide","en":"Antarctica","es":"AntÃ¡rtida","fr":"Antarctique"},{"code":"AG","it":"Antigua e Barbuda","en":"Antigua & Barbuda","es":"Antigua y Barbuda","fr":"Antigua-et-Barbuda"},{"code":"SA","it":"Arabia Saudita","en":"Saudi Arabia","es":"Arabia SaudÃ­","fr":"Arabie saoudite"},{"code":"AR","it":"Argentina","en":"Argentina","es":"Argentina","fr":"Argentine"},{"code":"AM","it":"Armenia","en":"Armenia","es":"Armenia","fr":"ArmÃ©nie"},{"code":"AW","it":"Aruba","en":"Aruba","es":"Aruba","fr":"Aruba"},{"code":"AU","it":"Australia","en":"Australia","es":"Australia","fr":"Australie"},{"code":"AT","it":"Austria","en":"Austria","es":"Austria","fr":"Autriche"},{"code":"AZ","it":"Azerbaigian","en":"Azerbaijan","es":"AzerbaiyÃ¡n","fr":"AzerbaÃ¯djan"},{"code":"BS","it":"Bahamas","en":"Bahamas","es":"Bahamas","fr":"Bahamas"},{"code":"BH","it":"Bahrein","en":"Bahrain","es":"BarÃ©in","fr":"BahreÃ¯n"},{"code":"BD","it":"Bangladesh","en":"Bangladesh","es":"BangladÃ©s","fr":"Bangladesh"},{"code":"BB","it":"Barbados","en":"Barbados","es":"Barbados","fr":"Barbade"},{"code":"BE","it":"Belgio","en":"Belgium","es":"BÃ©lgica","fr":"Belgique"},{"code":"BZ","it":"Belize","en":"Belize","es":"Belice","fr":"Belize"},{"code":"BJ","it":"Benin","en":"Benin","es":"BenÃ­n","fr":"BÃ©nin"},{"code":"BM","it":"Bermuda","en":"Bermuda","es":"Bermudas","fr":"Bermudes"},{"code":"BT","it":"Bhutan","en":"Bhutan","es":"ButÃ¡n","fr":"Bhoutan"},{"code":"BY","it":"Bielorussia","en":"Belarus","es":"Bielorrusia","fr":"BiÃ©lorussie"},{"code":"BO","it":"Bolivia","en":"Bolivia","es":"Bolivia","fr":"Bolivie"},{"code":"BA","it":"Bosnia ed Erzegovina","en":"Bosnia & Herzegovina","es":"Bosnia y Herzegovina","fr":"Bosnie-HerzÃ©govine"},{"code":"BW","it":"Botswana","en":"Botswana","es":"Botsuana","fr":"Botswana"},{"code":"BR","it":"Brasile","en":"Brazil","es":"Brasil","fr":"BrÃ©sil"},{"code":"BN","it":"Brunei","en":"Brunei","es":"BrunÃ©i","fr":"Brunei"},{"code":"BG","it":"Bulgaria","en":"Bulgaria","es":"Bulgaria","fr":"Bulgarie"},{"code":"BF","it":"Burkina Faso","en":"Burkina Faso","es":"Burkina Faso","fr":"Burkina Faso"},{"code":"BI","it":"Burundi","en":"Burundi","es":"Burundi","fr":"Burundi"},{"code":"KH","it":"Cambogia","en":"Cambodia","es":"Camboya","fr":"Cambodge"},{"code":"CM","it":"Camerun","en":"Cameroon","es":"CamerÃºn","fr":"Cameroun"},{"code":"CA","it":"Canada","en":"Canada","es":"CanadÃ¡","fr":"Canada"},{"code":"CV","it":"Capo Verde","en":"Cape Verde","es":"Cabo Verde","fr":"Cap-Vert"},{"code":"BQ","it":"Caraibi Olandesi","en":"Caribbean Netherlands","es":"Caribe neerlandÃ©s","fr":"Pays-Bas caribÃ©ens"},{"code":"CZ","it":"Cechia","en":"Czechia","es":"Chequia","fr":"TchÃ©quie"},{"code":"TD","it":"Ciad","en":"Chad","es":"Chad","fr":"Tchad"},{"code":"CL","it":"Cile","en":"Chile","es":"Chile","fr":"Chili"},{"code":"CN","it":"Cina","en":"China","es":"China","fr":"Chine"},{"code":"CY","it":"Cipro","en":"Cyprus","es":"Chipre","fr":"Chypre"},{"code":"VA","it":"CittÃ  del Vaticano","en":"Vatican City","es":"Ciudad del Vaticano","fr":"Ãtat de la CitÃ© du Vatican"},{"code":"CO","it":"Colombia","en":"Colombia","es":"Colombia","fr":"Colombie"},{"code":"KM","it":"Comore","en":"Comoros","es":"Comoras","fr":"Comores"},{"code":"CD","it":"Congo - Kinshasa","en":"Congo - Kinshasa","es":"RepÃºblica DemocrÃ¡tica del Congo","fr":"Congo-Kinshasa"},{"code":"CG","it":"Congo-Brazzaville","en":"Congo - Brazzaville","es":"Congo","fr":"Congo-Brazzaville"},{"code":"KP","it":"Corea del Nord","en":"North Korea","es":"Corea del Norte","fr":"CorÃ©e du Nord"},{"code":"KR","it":"Corea del Sud","en":"South Korea","es":"Corea del Sur","fr":"CorÃ©e du Sud"},{"code":"CR","it":"Costa Rica","en":"Costa Rica","es":"Costa Rica","fr":"Costa Rica"},{"code":"CI","it":"Costa dâAvorio","en":"CÃ´te dâIvoire","es":"CÃ´te dâIvoire","fr":"CÃ´te dâIvoire"},{"code":"HR","it":"Croazia","en":"Croatia","es":"Croacia","fr":"Croatie"},{"code":"CU","it":"Cuba","en":"Cuba","es":"Cuba","fr":"Cuba"},{"code":"CW","it":"CuraÃ§ao","en":"CuraÃ§ao","es":"Curazao","fr":"CuraÃ§ao"},{"code":"DK","it":"Danimarca","en":"Denmark","es":"Dinamarca","fr":"Danemark"},{"code":"DM","it":"Dominica","en":"Dominica","es":"Dominica","fr":"Dominique"},{"code":"EC","it":"Ecuador","en":"Ecuador","es":"Ecuador","fr":"Ãquateur"},{"code":"EG","it":"Egitto","en":"Egypt","es":"Egipto","fr":"Ãgypte"},{"code":"SV","it":"El Salvador","en":"El Salvador","es":"El Salvador","fr":"Salvador"},{"code":"AE","it":"Emirati Arabi Uniti","en":"United Arab Emirates","es":"Emiratos Ãrabes Unidos","fr":"Ãmirats arabes unis"},{"code":"ER","it":"Eritrea","en":"Eritrea","es":"Eritrea","fr":"ÃrythrÃ©e"},{"code":"EE","it":"Estonia","en":"Estonia","es":"Estonia","fr":"Estonie"},{"code":"SZ","it":"Eswatini","en":"Eswatini","es":"Esuatini","fr":"Eswatini"},{"code":"ET","it":"Etiopia","en":"Ethiopia","es":"EtiopÃ­a","fr":"Ãthiopie"},{"code":"FJ","it":"Figi","en":"Fiji","es":"Fiyi","fr":"Fidji"},{"code":"PH","it":"Filippine","en":"Philippines","es":"Filipinas","fr":"Philippines"},{"code":"FI","it":"Finlandia","en":"Finland","es":"Finlandia","fr":"Finlande"},{"code":"FR","it":"Francia","en":"France","es":"Francia","fr":"France"},{"code":"GA","it":"Gabon","en":"Gabon","es":"GabÃ³n","fr":"Gabon"},{"code":"GM","it":"Gambia","en":"Gambia","es":"Gambia","fr":"Gambie"},{"code":"GE","it":"Georgia","en":"Georgia","es":"Georgia","fr":"GÃ©orgie"},{"code":"GS","it":"Georgia del Sud e Sandwich Australi","en":"South Georgia & South Sandwich Islands","es":"Islas Georgia del Sur y Sandwich del Sur","fr":"GÃ©orgie du Sud-et-les Ãles Sandwich du Sud"},{"code":"DE","it":"Germania","en":"Germany","es":"Alemania","fr":"Allemagne"},{"code":"GH","it":"Ghana","en":"Ghana","es":"Ghana","fr":"Ghana"},{"code":"JM","it":"Giamaica","en":"Jamaica","es":"Jamaica","fr":"JamaÃ¯que"},{"code":"JP","it":"Giappone","en":"Japan","es":"JapÃ³n","fr":"Japon"},{"code":"GI","it":"Gibilterra","en":"Gibraltar","es":"Gibraltar","fr":"Gibraltar"},{"code":"DJ","it":"Gibuti","en":"Djibouti","es":"Yibuti","fr":"Djibouti"},{"code":"JO","it":"Giordania","en":"Jordan","es":"Jordania","fr":"Jordanie"},{"code":"GR","it":"Grecia","en":"Greece","es":"Grecia","fr":"GrÃ¨ce"},{"code":"GD","it":"Grenada","en":"Grenada","es":"Granada","fr":"Grenade"},{"code":"GL","it":"Groenlandia","en":"Greenland","es":"Groenlandia","fr":"Groenland"},{"code":"GP","it":"Guadalupa","en":"Guadeloupe","es":"Guadalupe","fr":"Guadeloupe"},{"code":"GU","it":"Guam","en":"Guam","es":"Guam","fr":"Guam"},{"code":"GT","it":"Guatemala","en":"Guatemala","es":"Guatemala","fr":"Guatemala"},{"code":"GG","it":"Guernsey","en":"Guernsey","es":"Guernesey","fr":"Guernesey"},{"code":"GN","it":"Guinea","en":"Guinea","es":"Guinea","fr":"GuinÃ©e"},{"code":"GQ","it":"Guinea Equatoriale","en":"Equatorial Guinea","es":"Guinea Ecuatorial","fr":"GuinÃ©e Ã©quatoriale"},{"code":"GW","it":"Guinea-Bissau","en":"Guinea-Bissau","es":"Guinea-BisÃ¡u","fr":"GuinÃ©e-Bissau"},{"code":"GY","it":"Guyana","en":"Guyana","es":"Guyana","fr":"Guyana"},{"code":"GF","it":"Guyana Francese","en":"French Guiana","es":"Guayana Francesa","fr":"Guyane franÃ§aise"},{"code":"HT","it":"Haiti","en":"Haiti","es":"HaitÃ­","fr":"HaÃ¯ti"},{"code":"HN","it":"Honduras","en":"Honduras","es":"Honduras","fr":"Honduras"},{"code":"IN","it":"India","en":"India","es":"India","fr":"Inde"},{"code":"ID","it":"Indonesia","en":"Indonesia","es":"Indonesia","fr":"IndonÃ©sie"},{"code":"IR","it":"Iran","en":"Iran","es":"IrÃ¡n","fr":"Iran"},{"code":"IQ","it":"Iraq","en":"Iraq","es":"Irak","fr":"Irak"},{"code":"IE","it":"Irlanda","en":"Ireland","es":"Irlanda","fr":"Irlande"},{"code":"IS","it":"Islanda","en":"Iceland","es":"Islandia","fr":"Islande"},{"code":"BV","it":"Isola Bouvet","en":"Bouvet Island","es":"Isla Bouvet","fr":"Ãle Bouvet"},{"code":"CX","it":"Isola Christmas","en":"Christmas Island","es":"Isla de Navidad","fr":"Ãle Christmas"},{"code":"NF","it":"Isola Norfolk","en":"Norfolk Island","es":"Isla Norfolk","fr":"Ãle Norfolk"},{"code":"IM","it":"Isola di Man","en":"Isle of Man","es":"Isla de Man","fr":"Ãle de Man"},{"code":"KY","it":"Isole Cayman","en":"Cayman Islands","es":"Islas CaimÃ¡n","fr":"Ãles CaÃ¯mans"},{"code":"CC","it":"Isole Cocos (Keeling)","en":"Cocos (Keeling) Islands","es":"Islas Cocos","fr":"Ãles Cocos"},{"code":"CK","it":"Isole Cook","en":"Cook Islands","es":"Islas Cook","fr":"Ãles Cook"},{"code":"FK","it":"Isole Falkland","en":"Falkland Islands","es":"Islas Malvinas","fr":"Ãles Malouines"},{"code":"FO","it":"Isole FÃ¦r Ãer","en":"Faroe Islands","es":"Islas Feroe","fr":"Ãles FÃ©roÃ©"},{"code":"HM","it":"Isole Heard e McDonald","en":"Heard & McDonald Islands","es":"Islas Heard y McDonald","fr":"Ãles Heard-et-MacDonald"},{"code":"MP","it":"Isole Marianne Settentrionali","en":"Northern Mariana Islands","es":"Islas Marianas del Norte","fr":"Ãles Mariannes du Nord"},{"code":"MH","it":"Isole Marshall","en":"Marshall Islands","es":"Islas Marshall","fr":"Ãles Marshall"},{"code":"UM","it":"Isole Minori Esterne degli Stati Uniti","en":"U.S. Outlying Islands","es":"Islas menores alejadas de EE. UU.","fr":"Ãles mineures Ã©loignÃ©es des Ãtats-Unis"},{"code":"PN","it":"Isole Pitcairn","en":"Pitcairn Islands","es":"Islas Pitcairn","fr":"Ãles Pitcairn"},{"code":"SB","it":"Isole Salomone","en":"Solomon Islands","es":"Islas SalomÃ³n","fr":"Ãles Salomon"},{"code":"TC","it":"Isole Turks e Caicos","en":"Turks & Caicos Islands","es":"Islas Turcas y Caicos","fr":"Ãles Turques-et-CaÃ¯ques"},{"code":"VI","it":"Isole Vergini Americane","en":"U.S. Virgin Islands","es":"Islas VÃ­rgenes de EE. UU.","fr":"Ãles Vierges des Ãtats-Unis"},{"code":"VG","it":"Isole Vergini Britanniche","en":"British Virgin Islands","es":"Islas VÃ­rgenes BritÃ¡nicas","fr":"Ãles Vierges britanniques"},{"code":"AX","it":"Isole Ãland","en":"Ãland Islands","es":"Islas Aland","fr":"Ãles Ãland"},{"code":"IL","it":"Israele","en":"Israel","es":"Israel","fr":"IsraÃ«l"},{"code":"IT","it":"Italia","en":"Italy","es":"Italia","fr":"Italie"},{"code":"JE","it":"Jersey","en":"Jersey","es":"Jersey","fr":"Jersey"},{"code":"KZ","it":"Kazakistan","en":"Kazakhstan","es":"KazajistÃ¡n","fr":"Kazakhstan"},{"code":"KE","it":"Kenya","en":"Kenya","es":"Kenia","fr":"Kenya"},{"code":"KG","it":"Kirghizistan","en":"Kyrgyzstan","es":"KirguistÃ¡n","fr":"Kirghizstan"},{"code":"KI","it":"Kiribati","en":"Kiribati","es":"Kiribati","fr":"Kiribati"},{"code":"KW","it":"Kuwait","en":"Kuwait","es":"Kuwait","fr":"KoweÃ¯t"},{"code":"LA","it":"Laos","en":"Laos","es":"Laos","fr":"Laos"},{"code":"LS","it":"Lesotho","en":"Lesotho","es":"Lesoto","fr":"Lesotho"},{"code":"LV","it":"Lettonia","en":"Latvia","es":"Letonia","fr":"Lettonie"},{"code":"LB","it":"Libano","en":"Lebanon","es":"LÃ­bano","fr":"Liban"},{"code":"LR","it":"Liberia","en":"Liberia","es":"Liberia","fr":"Liberia"},{"code":"LY","it":"Libia","en":"Libya","es":"Libia","fr":"Libye"},{"code":"LI","it":"Liechtenstein","en":"Liechtenstein","es":"Liechtenstein","fr":"Liechtenstein"},{"code":"LT","it":"Lituania","en":"Lithuania","es":"Lituania","fr":"Lituanie"},{"code":"LU","it":"Lussemburgo","en":"Luxembourg","es":"Luxemburgo","fr":"Luxembourg"},{"code":"MK","it":"Macedonia del Nord","en":"North Macedonia","es":"Macedonia del Norte","fr":"MacÃ©doine du Nord"},{"code":"MG","it":"Madagascar","en":"Madagascar","es":"Madagascar","fr":"Madagascar"},{"code":"MW","it":"Malawi","en":"Malawi","es":"Malaui","fr":"Malawi"},{"code":"MY","it":"Malaysia","en":"Malaysia","es":"Malasia","fr":"Malaisie"},{"code":"MV","it":"Maldive","en":"Maldives","es":"Maldivas","fr":"Maldives"},{"code":"ML","it":"Mali","en":"Mali","es":"Mali","fr":"Mali"},{"code":"MT","it":"Malta","en":"Malta","es":"Malta","fr":"Malte"},{"code":"MA","it":"Marocco","en":"Morocco","es":"Marruecos","fr":"Maroc"},{"code":"MQ","it":"Martinica","en":"Martinique","es":"Martinica","fr":"Martinique"},{"code":"MR","it":"Mauritania","en":"Mauritania","es":"Mauritania","fr":"Mauritanie"},{"code":"MU","it":"Mauritius","en":"Mauritius","es":"Mauricio","fr":"Maurice"},{"code":"YT","it":"Mayotte","en":"Mayotte","es":"Mayotte","fr":"Mayotte"},{"code":"MX","it":"Messico","en":"Mexico","es":"MÃ©xico","fr":"Mexique"},{"code":"FM","it":"Micronesia","en":"Micronesia","es":"Micronesia","fr":"MicronÃ©sie"},{"code":"MD","it":"Moldavia","en":"Moldova","es":"Moldavia","fr":"Moldavie"},{"code":"MC","it":"Monaco","en":"Monaco","es":"MÃ³naco","fr":"Monaco"},{"code":"MN","it":"Mongolia","en":"Mongolia","es":"Mongolia","fr":"Mongolie"},{"code":"ME","it":"Montenegro","en":"Montenegro","es":"Montenegro","fr":"MontÃ©nÃ©gro"},{"code":"MS","it":"Montserrat","en":"Montserrat","es":"Montserrat","fr":"Montserrat"},{"code":"MZ","it":"Mozambico","en":"Mozambique","es":"Mozambique","fr":"Mozambique"},{"code":"MM","it":"Myanmar (Birmania)","en":"Myanmar (Burma)","es":"Myanmar (Birmania)","fr":"Myanmar (Birmanie)"},{"code":"NA","it":"Namibia","en":"Namibia","es":"Namibia","fr":"Namibie"},{"code":"NR","it":"Nauru","en":"Nauru","es":"Nauru","fr":"Nauru"},{"code":"NP","it":"Nepal","en":"Nepal","es":"Nepal","fr":"NÃ©pal"},{"code":"NI","it":"Nicaragua","en":"Nicaragua","es":"Nicaragua","fr":"Nicaragua"},{"code":"NE","it":"Niger","en":"Niger","es":"NÃ­ger","fr":"Niger"},{"code":"NG","it":"Nigeria","en":"Nigeria","es":"Nigeria","fr":"Nigeria"},{"code":"NU","it":"Niue","en":"Niue","es":"Niue","fr":"Niue"},{"code":"NO","it":"Norvegia","en":"Norway","es":"Noruega","fr":"NorvÃ¨ge"},{"code":"NC","it":"Nuova Caledonia","en":"New Caledonia","es":"Nueva Caledonia","fr":"Nouvelle-CalÃ©donie"},{"code":"NZ","it":"Nuova Zelanda","en":"New Zealand","es":"Nueva Zelanda","fr":"Nouvelle-ZÃ©lande"},{"code":"OM","it":"Oman","en":"Oman","es":"OmÃ¡n","fr":"Oman"},{"code":"NL","it":"Paesi Bassi","en":"Netherlands","es":"PaÃ­ses Bajos","fr":"Pays-Bas"},{"code":"PK","it":"Pakistan","en":"Pakistan","es":"PakistÃ¡n","fr":"Pakistan"},{"code":"PW","it":"Palau","en":"Palau","es":"Palaos","fr":"Palaos"},{"code":"PA","it":"Panama","en":"Panama","es":"PanamÃ¡","fr":"Panama"},{"code":"PG","it":"Papua Nuova Guinea","en":"Papua New Guinea","es":"PapÃºa Nueva Guinea","fr":"Papouasie-Nouvelle-GuinÃ©e"},{"code":"PY","it":"Paraguay","en":"Paraguay","es":"Paraguay","fr":"Paraguay"},{"code":"PE","it":"PerÃ¹","en":"Peru","es":"PerÃº","fr":"PÃ©rou"},{"code":"PF","it":"Polinesia Francese","en":"French Polynesia","es":"Polinesia Francesa","fr":"PolynÃ©sie franÃ§aise"},{"code":"PL","it":"Polonia","en":"Poland","es":"Polonia","fr":"Pologne"},{"code":"PT","it":"Portogallo","en":"Portugal","es":"Portugal","fr":"Portugal"},{"code":"PR","it":"Portorico","en":"Puerto Rico","es":"Puerto Rico","fr":"Porto Rico"},{"code":"QA","it":"Qatar","en":"Qatar","es":"Catar","fr":"Qatar"},{"code":"HK","it":"RAS di Hong Kong","en":"Hong Kong SAR China","es":"RAE de Hong Kong (China)","fr":"R.A.S. chinoise de Hong Kong"},{"code":"MO","it":"RAS di Macao","en":"Macao SAR China","es":"RAE de Macao (China)","fr":"R.A.S. chinoise de Macao"},{"code":"GB","it":"Regno Unito","en":"United Kingdom","es":"Reino Unido","fr":"Royaume-Uni"},{"code":"CF","it":"Repubblica Centrafricana","en":"Central African Republic","es":"RepÃºblica Centroafricana","fr":"RÃ©publique centrafricaine"},{"code":"DO","it":"Repubblica Dominicana","en":"Dominican Republic","es":"RepÃºblica Dominicana","fr":"RÃ©publique dominicaine"},{"code":"RE","it":"Riunione","en":"RÃ©union","es":"ReuniÃ³n","fr":"La RÃ©union"},{"code":"RO","it":"Romania","en":"Romania","es":"RumanÃ­a","fr":"Roumanie"},{"code":"RW","it":"Ruanda","en":"Rwanda","es":"Ruanda","fr":"Rwanda"},{"code":"RU","it":"Russia","en":"Russia","es":"Rusia","fr":"Russie"},{"code":"EH","it":"Sahara Occidentale","en":"Western Sahara","es":"SÃ¡hara Occidental","fr":"Sahara occidental"},{"code":"KN","it":"Saint Kitts e Nevis","en":"St. Kitts & Nevis","es":"San CristÃ³bal y Nieves","fr":"Saint-Christophe-et-NiÃ©vÃ¨s"},{"code":"LC","it":"Saint Lucia","en":"St. Lucia","es":"Santa LucÃ­a","fr":"Sainte-Lucie"},{"code":"MF","it":"Saint Martin","en":"St. Martin","es":"San MartÃ­n","fr":"Saint-Martin"},{"code":"VC","it":"Saint Vincent e Grenadine","en":"St. Vincent & Grenadines","es":"San Vicente y las Granadinas","fr":"Saint-Vincent-et-les Grenadines"},{"code":"BL","it":"Saint-BarthÃ©lemy","en":"St. BarthÃ©lemy","es":"San BartolomÃ©","fr":"Saint-BarthÃ©lemy"},{"code":"PM","it":"Saint-Pierre e Miquelon","en":"St. Pierre & Miquelon","es":"San Pedro y MiquelÃ³n","fr":"Saint-Pierre-et-Miquelon"},{"code":"WS","it":"Samoa","en":"Samoa","es":"Samoa","fr":"Samoa"},{"code":"AS","it":"Samoa Americane","en":"American Samoa","es":"Samoa Americana","fr":"Samoa amÃ©ricaines"},{"code":"SM","it":"San Marino","en":"San Marino","es":"San Marino","fr":"Saint-Marin"},{"code":"SH","it":"SantâElena","en":"St. Helena","es":"Santa Elena","fr":"Sainte-HÃ©lÃ¨ne"},{"code":"SN","it":"Senegal","en":"Senegal","es":"Senegal","fr":"SÃ©nÃ©gal"},{"code":"RS","it":"Serbia","en":"Serbia","es":"Serbia","fr":"Serbie"},{"code":"SC","it":"Seychelles","en":"Seychelles","es":"Seychelles","fr":"Seychelles"},{"code":"SL","it":"Sierra Leone","en":"Sierra Leone","es":"Sierra Leona","fr":"Sierra Leone"},{"code":"SG","it":"Singapore","en":"Singapore","es":"Singapur","fr":"Singapour"},{"code":"SX","it":"Sint Maarten","en":"Sint Maarten","es":"Sint Maarten","fr":"Saint-Martin (partie nÃ©erlandaise)"},{"code":"SY","it":"Siria","en":"Syria","es":"Siria","fr":"Syrie"},{"code":"SK","it":"Slovacchia","en":"Slovakia","es":"Eslovaquia","fr":"Slovaquie"},{"code":"SI","it":"Slovenia","en":"Slovenia","es":"Eslovenia","fr":"SlovÃ©nie"},{"code":"SO","it":"Somalia","en":"Somalia","es":"Somalia","fr":"Somalie"},{"code":"ES","it":"Spagna","en":"Spain","es":"EspaÃ±a","fr":"Espagne"},{"code":"LK","it":"Sri Lanka","en":"Sri Lanka","es":"Sri Lanka","fr":"Sri Lanka"},{"code":"US","it":"Stati Uniti","en":"United States","es":"Estados Unidos","fr":"Ãtats-Unis"},{"code":"SS","it":"Sud Sudan","en":"South Sudan","es":"SudÃ¡n del Sur","fr":"Soudan du Sud"},{"code":"ZA","it":"Sudafrica","en":"South Africa","es":"SudÃ¡frica","fr":"Afrique du Sud"},{"code":"SD","it":"Sudan","en":"Sudan","es":"SudÃ¡n","fr":"Soudan"},{"code":"SR","it":"Suriname","en":"Suriname","es":"Surinam","fr":"Suriname"},{"code":"SJ","it":"Svalbard e Jan Mayen","en":"Svalbard & Jan Mayen","es":"Svalbard y Jan Mayen","fr":"Svalbard et Jan Mayen"},{"code":"SE","it":"Svezia","en":"Sweden","es":"Suecia","fr":"SuÃ¨de"},{"code":"CH","it":"Svizzera","en":"Switzerland","es":"Suiza","fr":"Suisse"},{"code":"ST","it":"SÃ£o TomÃ© e PrÃ­ncipe","en":"SÃ£o TomÃ© & PrÃ­ncipe","es":"Santo TomÃ© y PrÃ­ncipe","fr":"Sao TomÃ©-et-Principe"},{"code":"TJ","it":"Tagikistan","en":"Tajikistan","es":"TayikistÃ¡n","fr":"Tadjikistan"},{"code":"TW","it":"Taiwan","en":"Taiwan","es":"TaiwÃ¡n","fr":"TaÃ¯wan"},{"code":"TZ","it":"Tanzania","en":"Tanzania","es":"Tanzania","fr":"Tanzanie"},{"code":"TF","it":"Terre Australi Francesi","en":"French Southern Territories","es":"Territorios Australes Franceses","fr":"Terres australes franÃ§aises"},{"code":"PS","it":"Territori Palestinesi","en":"Palestinian Territories","es":"Territorios Palestinos","fr":"Territoires palestiniens"},{"code":"IO","it":"Territorio Britannico dellâOceano Indiano","en":"British Indian Ocean Territory","es":"Territorio BritÃ¡nico del OcÃ©ano Ãndico","fr":"Territoire britannique de lâocÃ©an Indien"},{"code":"TH","it":"Thailandia","en":"Thailand","es":"Tailandia","fr":"ThaÃ¯lande"},{"code":"TL","it":"Timor Est","en":"Timor-Leste","es":"Timor-Leste","fr":"Timor oriental"},{"code":"TG","it":"Togo","en":"Togo","es":"Togo","fr":"Togo"},{"code":"TK","it":"Tokelau","en":"Tokelau","es":"Tokelau","fr":"Tokelau"},{"code":"TO","it":"Tonga","en":"Tonga","es":"Tonga","fr":"Tonga"},{"code":"TT","it":"Trinidad e Tobago","en":"Trinidad & Tobago","es":"Trinidad y Tobago","fr":"TrinitÃ©-et-Tobago"},{"code":"TN","it":"Tunisia","en":"Tunisia","es":"TÃºnez","fr":"Tunisie"},{"code":"TR","it":"Turchia","en":"TÃ¼rkiye","es":"TurquÃ­a","fr":"Turquie"},{"code":"TM","it":"Turkmenistan","en":"Turkmenistan","es":"TurkmenistÃ¡n","fr":"TurkmÃ©nistan"},{"code":"TV","it":"Tuvalu","en":"Tuvalu","es":"Tuvalu","fr":"Tuvalu"},{"code":"UA","it":"Ucraina","en":"Ukraine","es":"Ucrania","fr":"Ukraine"},{"code":"UG","it":"Uganda","en":"Uganda","es":"Uganda","fr":"Ouganda"},{"code":"HU","it":"Ungheria","en":"Hungary","es":"HungrÃ­a","fr":"Hongrie"},{"code":"UY","it":"Uruguay","en":"Uruguay","es":"Uruguay","fr":"Uruguay"},{"code":"UZ","it":"Uzbekistan","en":"Uzbekistan","es":"UzbekistÃ¡n","fr":"OuzbÃ©kistan"},{"code":"VU","it":"Vanuatu","en":"Vanuatu","es":"Vanuatu","fr":"Vanuatu"},{"code":"VE","it":"Venezuela","en":"Venezuela","es":"Venezuela","fr":"Venezuela"},{"code":"VN","it":"Vietnam","en":"Vietnam","es":"Vietnam","fr":"ViÃªt Nam"},{"code":"WF","it":"Wallis e Futuna","en":"Wallis & Futuna","es":"Wallis y Futuna","fr":"Wallis-et-Futuna"},{"code":"YE","it":"Yemen","en":"Yemen","es":"Yemen","fr":"YÃ©men"},{"code":"ZM","it":"Zambia","en":"Zambia","es":"Zambia","fr":"Zambie"},{"code":"ZW","it":"Zimbabwe","en":"Zimbabwe","es":"Zimbabue","fr":"Zimbabwe"}];
...
function ProfileLocalPromptField({label,value,onChange,placeholder,options,subC,dark,borderC,textC,sinp}){
  ...
  return <div>
    ...
    <button type="button" onClick={function(){setOpen(true);setQuery("");}} style={{...sinp,width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,textAlign:"left",cursor:"pointer",background:dark?"#2a2a3e":"#fff"}}>
      ...
      <span style={{fontSize:14,color:subC,flexShrink:0}}>â</span>
    </button>
    ...
    {open&&<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.48)",zIndex:800,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={function(e){if(e.target===e.currentTarget)setOpen(false);}}>
      <div style={{background:dark?"#1e1e30":"#fff",borderRadius:18,width:"100%",maxWidth:460,maxHeight:"80vh",overflow:"hidden",boxShadow:"0 12px 44px rgba(0,0,0,.28)",border:"1px solid "+borderC}}>
        <div style={{padding:"16px 16px 12px",borderBottom:"1px solid "+borderC,display:"flex",alignItems:"center",gap:10}}>
          ...
          <button type="button" onClick={function(){setOpen(false);}} style={{background:dark?"#333":"#f0f0f0",border:"none",borderRadius:10,color:textC,fontSize:16,padding:"6px 10px",cursor:"pointer"}}>Ã</button>
        </div>
...
function ProfileCard({currentUser,onLogout,dark,textC,subC,borderC,cardBg,btnRadius,dateFmt,setToast,fbDb:fbDbProp,onProfileUpdate,onDeleteAccount}){
  ...
  var PHONE_PREFIXES=[{code:"+39",country:"Italia"},{code:"+34",country:"EspaÃ±a"},{code:"+33",country:"France"},{code:"+49",country:"Deutschland"},{code:"+44",country:"United Kingdom"},{code:"+1",country:"United States / Canada"},{code:"+351",country:"Portugal"},{code:"+48",country:"Polska"},{code:"+31",country:"Nederland"},{code:"+40",country:"RomÃ¢nia"},{code:"+30",country:"ÎÎ»Î»Î¬Î´Î±"}];
  var JOB_TYPES=["Dipendente","Manager","Consulente","Libero professionista","Imprenditore","Commerciante","Artigiano","Insegnante / Formazione","SanitÃ ","Tecnologia / IT","Finanza / Amministrazione","Marketing / Comunicazione","Vendite","Studente","Pensionato","Non occupato","Altro"];
  var APP_USE_REASONS=["Controllare le spese quotidiane","Risparmiare di piÃ¹ ogni mese","Gestire budget e limiti","Monitorare entrate e uscite","Gestire patrimonio e conti","Preparare obiettivi personali","Controllare spese condivise","Capire dove finiscono i soldi","Ricevere consigli dallâAI","Tenere tutto in unâunica app","Altro"];
  ...
  function save(){
    ...
    if(pPhone&&cleanPhone.length<6){if(setToast)setToast({text:PL("Numero di telefono non valido"),type:"warning",color:"#EF9F27",icon:"â ï¸"});return;}
  ...
  async function saveEmailChange(){
    ...
    if(cleanEmail===String(currentUser.email||"").toLowerCase()){setEmailError(PL("La nuova email Ã¨ uguale a quella attuale."));return;}
    ...
    try{
      ...
      else if(code==="auth/email-already-in-use")setEmailError(PL("Questa email Ã¨ giÃ  usata da un altro account."));
  ...
  function requestDeleteAccount(){
    ...
    Promise.resolve(onDeleteAccount()).catch(function(err){
      var msg=(err&&err.message)?err.message:"Errore durante lâeliminazione account.";
      setDeleteError(msg);
  ...
  return <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
      <div style={{fontSize:14,fontWeight:600,color:textC}}>{PL("ð¤ Profilo")}</div>
      {!edit&&<button onClick={function(){setEdit(true);}} style={{background:"linear-gradient(135deg,#7F77DD,#378ADD)",border:"none",borderRadius:btnRadius,padding:"8px 14px",cursor:"pointer",color:"#fff",fontSize:13,fontWeight:800,boxShadow:dark?"none":"0 6px 16px rgba(83,74,183,0.22)",display:"inline-flex",alignItems:"center",gap:6}}>{PL("â Modifica")}</button>}
    </div>
    {!edit?<>
      <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:14}}>
        ...
        <div>
          ...
          {<div style={{fontSize:11,color:"#7F77DD",marginTop:2}}>{PL("âï¸ Dati sincronizzati su cloud")}</div>}
        </div>
      </div>
      {<div style={{display:"flex",flexDirection:"column",gap:0,marginBottom:14}}>
        {[["ð",d.phone?(d.phonePrefix||"+39")+" "+d.phone:"â",PL("Telefono")],["ð",d.nationality||"â",PL("NazionalitÃ ")],["ð",d.birthDate?fmtDate(d.birthDate,dateFmt):"â",PL("Nascita")],["ð",[d.country,d.province,d.city].filter(Boolean).join(" Â· ")||"â",PL("LocalitÃ ")],["ð",d.address||"â",PL("Indirizzo")],["ð¼",d.jobType?PL(d.jobType):"â",PL("Lavoro")],["ð¯",d.appUseReason?PL(d.appUseReason):"â",PL("Uso principale")],["â§",d.gender==="M"?PL("Maschile"):d.gender==="F"?PL("Femminile"):d.gender==="X"?PL("Non spec."):"â",PL("Sesso")]].map(function(r){return <div key={r[2]} style={{display:"flex",alignItems:"center",gap:10,padding:"7px 0",borderBottom:"1px solid "+borderC}}>
      ...
      {<div style={{borderTop:"1px solid "+borderC,paddingTop:12,marginTop:12}}>
        <button onClick={function(){setEmailOpen(!emailOpen);setEmailError("");setEmailOk(false);setNewEmail(String(currentUser.email||""));}} style={{background:"none",border:"none",cursor:"pointer",color:"#7F77DD",fontSize:13,fontWeight:700,padding:0}}>{PL("âï¸ Cambia email di accesso")}</button>
        {emailOpen&&<div style={{display:"flex",flexDirection:"column",gap:10,marginTop:12}}>
          ...
          <div style={{fontSize:11,color:subC,lineHeight:1.35}}>{PL("La nuova email diventerÃ  lâindirizzo usato per accedere allâapp.")}</div>
      ...
      {<div style={{borderTop:"1px solid "+borderC,paddingTop:12,marginTop:12,marginBottom:12}}>
        <button onClick={function(){setDeleteOpen(!deleteOpen);setDeleteError("");setDeleteConfirm("");}} style={{background:"none",border:"none",cursor:"pointer",color:"#E24B4A",fontSize:13,fontWeight:700,padding:0}}>{PL("ð Elimina account e dati")}</button>
      ...
      <button onClick={function(){if(window.confirm(PL("Uscire dall'account?")))onLogout();}} style={{width:"100%",background:dark?"#252535":"#f5f5f5",color:"#E24B4A",border:"1px solid #E24B4A",borderRadius:btnRadius,padding:"11px",fontSize:14,fontWeight:500,cursor:"pointer"}}>{PL("ðª Esci")}</button>
    </>:<div style={{display:"flex",flexDirection:"column",gap:10}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
        ...
        <div><label style={{fontSize:11,color:subC,display:"block",marginBottom:3}}>{PL("Sesso")}</label>
          <select value={pGender} onChange={function(e){setPGender(e.target.value);}} style={sinp}><option value="">â</option><option value="M">{PL("Maschile")}</option><option value="F">{PL("Femminile")}</option><option value="X">{PL("Non spec.")}</option></select>
        </div>
      </div>
      <ProfileLocalPromptField label={PL("NazionalitÃ ")} value={pNationality} onChange={setPNationality} placeholder={PL("Cerca nazionalitÃ ")} options={countryNames} subC={subC} dark={dark} borderC={borderC} textC={textC} sinp={sinp}/>
      ...
      <div><label style={{fontSize:11,color:subC,display:"block",marginBottom:3}}>{PL("Lavoro")}</label><select value={pJobType} onChange={function(e){setPJobType(e.target.value);}} style={sinp}><option value="">â</option>{JOB_TYPES.map(function(j){return <option key={j} value={j}>{PL(j)}</option>;})}</select></div>
      <div><label style={{fontSize:11,color:subC,display:"block",marginBottom:3}}>{PL("Per cosa vuoi usare principalmente fAInance?")}</label><select value={pAppUseReason} onChange={function(e){setPAppUseReason(e.target.value);}} style={sinp}><option value="">â</option>{APP_USE_REASONS.map(function(r){return <option key={r} value={r}>{PL(r)}</option>;})}</select></div>
      <div style={{display:"flex",gap:8}}>
        <button onClick={save} style={{flex:1,background:"linear-gradient(135deg,#7F77DD,#378ADD)",color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px",fontSize:14,fontWeight:600,cursor:"pointer"}}>{"ð¾ "+PL("Salva")}</button>
...
function App({currentUser,onLogout,fbUser,onProfileUpdate}){
  ...
  var [shoppingLists,setShoppingLists]=useStorage(userKey("shopping_lists_v2"),[{id:"main",title:"Lista principale",icon:"ð§º",createdAt:new Date().toISOString()}]);
  ...
  var SHOPPING_ICON_OPTIONS=["ð","ð§º","ð","ð¥©","ð","ð¥","ð","ð","ð·","ð§","ð¥","ð¥ª","ð","ð­","ð¥","ð§","ð","ð¦","ð¦","ð¥","ð","ð¥","ð¥","ð","ð","ð¥«","ð«","ð¥¦","ð¥¬","ð¥","ð","ð½","ð¥","ð","ð","ð§","ð§","ð¥","ð«","ð¥","ð","ð","ð","ð","ð","ð","ð","ð¥","ð¥­","ð","ð","ð","ð«","ð¥¥","ð","ð§¼","ð§´","ð§»","ðª¥","ð§½","ð§¹","ð§º","ð§","â","ðµ","ð¥¤","ðº","ð·","ð«","ðª","ð¯","ð§","ð¶ï¸","ð¥","ð¿","ð§","ð¬","ð­","ð¼","ð¾","ð¶","ð","ð©¹","ð¦","â­","â¤ï¸","ð¥","âï¸","â"];
  ...
  // ââ FIRESTORE SYNC ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  useEffect(function(){
    ...
    getDoc(docRef).then(function(snap){
      if(snap.exists()){
        ...
        // Nuovo account o documento cloud mancante: non cancellare mai dati locali giÃ  presenti.
  ...
  async function deleteCurrentAccount(){
    ...
    try{
      ...
      if(err&&err.code==="auth/requires-recent-login"){
        clearFainanceLocalAccountData();
        await Promise.resolve(onLogout&&onLogout());
        throw new Error("Per sicurezza Firebase richiede un accesso recente. Rientra con lo stesso account e ripeti lâeliminazione: i dati locali sono giÃ  stati rimossi da questo dispositivo.");
      }
  ...
  async function createShareInvite(project,participant,email,name,foundUser){
    ...
    var mailHtml=""
      ...
      +"<p style=\"font-size:12px;color:#999;margin:0;\">Hai ricevuto questa email perchÃ© qualcuno ti ha invitato a un progetto Share su fAInance.</p>"
      +"</div>";
  ...
  function translateCriticalUiText(value, code){
    ...
    var k=raw.trim();
    if(!k)return raw;
    var D={"Riepilogo alto, numero icone e ordine delle sezioni": {"en": "Top summary, number of icons and section order", "es": "Resumen superior, nÃºmero de iconos y orden de secciones", "fr": "RÃ©sumÃ© supÃ©rieur, nombre dâicÃ´nes et ordre des sections", "de": "Obere Zusammenfassung, Anzahl der Symbole und Reihenfolge der Bereiche", "pt": "Resumo superior, nÃºmero de Ã­cones e ordem das secÃ§Ãµes", "pl": "GÃ³rne podsumowanie, liczba ikon i kolejnoÅÄ sekcji", "nl": "Bovenste samenvatting, aantal pictogrammen en volgorde van secties", "ro": "Rezumat superior, numÄr de pictograme Èi ordinea secÈiunilor", "el": "Î Î¬Î½Ï ÏÏÎ½Î¿ÏÎ·, Î±ÏÎ¹Î¸Î¼ÏÏ ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯ÏÎ½ ÎºÎ±Î¹ ÏÎµÎ¹ÏÎ¬ ÎµÎ½Î¿ÏÎ®ÏÏÎ½"}, "Top summary, number of icons and section order": {"en": "Top summary, number of icons and section order", "es": "Resumen superior, nÃºmero de iconos y orden de secciones", "fr": "RÃ©sumÃ© supÃ©rieur, nombre dâicÃ´nes et ordre des sections", "de": "Obere Zusammenfassung, Anzahl der Symbole und Reihenfolge der Bereiche", "pt": "Resumo superior, nÃºmero de Ã­cones e ordem das secÃ§Ãµes", "pl": "GÃ³rne podsumowanie, liczba ikon i kolejnoÅÄ sekcji", "nl": "Bovenste samenvatting, aantal pictogrammen en volgorde van secties", "ro": "Rezumat superior, numÄr de pictograme Èi ordinea secÈiunilor", "el": "Î Î¬Î½Ï ÏÏÎ½Î¿ÏÎ·, Î±ÏÎ¹Î¸Î¼ÏÏ ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯ÏÎ½ ÎºÎ±Î¹ ÏÎµÎ¹ÏÎ¬ ÎµÎ½Î¿ÏÎ®ÏÏÎ½"}, "Colore + Spesa": {"en": "Expense button color", "es": "Color del botÃ³n de gasto", "fr": "Couleur du bouton de dÃ©pense", "de": "Farbe der Ausgaben-SchaltflÃ¤che", "pt": "Cor do botÃ£o de despesa", "pl": "Kolor przycisku wydatku", "nl": "Kleur van de uitgavenknop", "ro": "Culoarea butonului de cheltuialÄ", "el": "Î§ÏÏÎ¼Î± ÎºÎ¿ÏÎ¼ÏÎ¹Î¿Ï ÎµÎ¾ÏÎ´Î¿Ï"}, "Color + Expense": {"en": "Expense button color", "es": "Color del botÃ³n de gasto", "fr": "Couleur du bouton de dÃ©pense", "de": "Farbe der Ausgaben-SchaltflÃ¤che", "pt": "Cor do botÃ£o de despesa", "pl": "Kolor przycisku wydatku", "nl": "Kleur van de uitgavenknop", "ro": "Culoarea butonului de cheltuialÄ", "el": "Î§ÏÏÎ¼Î± ÎºÎ¿ÏÎ¼ÏÎ¹Î¿Ï ÎµÎ¾ÏÎ´Î¿Ï"}, "Color + Uitgave": {"en": "Expense button color", "es": "Color del botÃ³n de gasto", "fr": "Couleur du bouton de dÃ©pense", "de": "Farbe der Ausgaben-SchaltflÃ¤che", "pt": "Cor do botÃ£o de despesa", "pl": "Kolor przycisku wydatku", "nl": "Kleur van de uitgavenknop", "ro": "Culoarea butonului de cheltuialÄ", "el": "Î§ÏÏÎ¼Î± ÎºÎ¿ÏÎ¼ÏÎ¹Î¿Ï ÎµÎ¾ÏÎ´Î¿Ï"}, "Colore AttivitÃ ": {"en": "Activity color", "es": "Color de actividad", "fr": "Couleur de lâactivitÃ©", "de": "AktivitÃ¤tsfarbe", "pt": "Cor da atividade", "pl": "Kolor aktywnoÅci", "nl": "Activiteitskleur", "ro": "Culoarea activitÄÈii", "el": "Î§ÏÏÎ¼Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±Ï"}, "Activity color": {"en": "Activity color", "es": "Color de actividad", "fr": "Couleur de lâactivitÃ©", "de": "AktivitÃ¤tsfarbe", "pt": "Cor da atividade", "pl": "Kolor aktywnoÅci", "nl": "Activiteitskleur", "ro": "Culoarea activitÄÈii", "el": "Î§ÏÏÎ¼Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±Ï"}, "Colore titolo": {"en": "Title color", "es": "Color del tÃ­tulo", "fr": "Couleur du titre", "de": "Titelfarbe", "pt": "Cor do tÃ­tulo", "pl": "Kolor tytuÅu", "nl": "Titelkleur", "ro": "Culoarea titlului", "el": "Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"}, "Title color": {"en": "Title color", "es": "Color del tÃ­tulo", "fr": "Couleur du titre", "de": "Titelfarbe", "pt": "Cor do tÃ­tulo", "pl": "Kolor tytuÅu", "nl": "Titelkleur", "ro": "Culoarea titlului", "el": "Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"}, "Colore testi secondari": {"en": "Secondary text color", "es": "Color del texto secundario", "fr": "Couleur du texte secondaire", "de": "Farbe des sekundÃ¤ren Textes", "pt": "Cor do texto secundÃ¡rio", "pl": "Kolor tekstu dodatkowego", "nl": "Kleur van secundaire tekst", "ro": "Culoarea textului secundar", "el": "Î§ÏÏÎ¼Î± Î´ÎµÏÏÎµÏÎµÏÎ¿Î½ÏÎ¿Ï ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"}, "Secondary text color": {"en": "Secondary text color", "es": "Color del texto secundario", "fr": "Couleur du texte secondaire", "de": "Farbe des sekundÃ¤ren Textes", "pt": "Cor do texto secundÃ¡rio", "pl": "Kolor tekstu dodatkowego", "nl": "Kleur van secundaire tekst", "ro": "Culoarea textului secundar", "el": "Î§ÏÏÎ¼Î± Î´ÎµÏÏÎµÏÎµÏÎ¿Î½ÏÎ¿Ï ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"}, "Progetto mostrato nel widget": {"en": "Project shown in the widget", "es": "Proyecto mostrado en el widget", "fr": "Projet affichÃ© dans le widget", "de": "Im Widget angezeigtes Projekt", "pt": "Projeto mostrado no widget", "pl": "Projekt pokazany w widÅ¼ecie", "nl": "Project dat in de widget wordt getoond", "ro": "Proiect afiÈat Ã®n widget", "el": "ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"}, "Project shown in the widget": {"en": "Project shown in the widget", "es": "Proyecto mostrado en el widget", "fr": "Projet affichÃ© dans le widget", "de": "Im Widget angezeigtes Projekt", "pt": "Projeto mostrado no widget", "pl": "Projekt pokazany w widÅ¼ecie", "nl": "Project dat in de widget wordt getoond", "ro": "Proiect afiÈat Ã®n widget", "el": "ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"}, "Scegli il progetto predefinito. Ogni singolo widget potrÃ  comunque essere configurato con un progetto diverso.": {"en": "Choose the default project. Each individual widget can still be configured with a different project.", "es": "Elige el proyecto predeterminado. Cada widget individual puede configurarse con un proyecto distinto.", "fr": "Choisis le projet par dÃ©faut. Chaque widget individuel peut quand mÃªme Ãªtre configurÃ© avec un projet diffÃ©rent.", "de": "WÃ¤hle das Standardprojekt. Jedes einzelne Widget kann weiterhin mit einem anderen Projekt konfiguriert werden.", "pt": "Escolhe o projeto predefinido. Cada widget individual ainda pode ser configurado com um projeto diferente.", "pl": "Wybierz projekt domyÅlny. KaÅ¼dy pojedynczy widÅ¼et nadal moÅ¼na skonfigurowaÄ z innym projektem.", "nl": "Kies het standaardproject. Elke afzonderlijke widget kan nog steeds met een ander project worden ingesteld.", "ro": "Alege proiectul implicit. Fiecare widget poate fi configurat totuÈi cu un proiect diferit.", "el": "ÎÏÎ¯Î»ÎµÎ¾Îµ ÏÎ¿ ÏÏÎ¿ÎµÏÎ¹Î»ÎµÎ³Î¼Î­Î½Î¿ Î­ÏÎ³Î¿. ÎÎ¬Î¸Îµ Î¼ÎµÎ¼Î¿Î½ÏÎ¼Î­Î½Î¿ widget Î¼ÏÎ¿ÏÎµÎ¯ Î±ÎºÏÎ¼Î· Î½Î± ÏÏÎ¸Î¼Î¹ÏÏÎµÎ¯ Î¼Îµ Î´Î¹Î±ÏÎ¿ÏÎµÏÎ¹ÎºÏ Î­ÏÎ³Î¿."}, "Choose the default project. Each individual widget can still be configured with a different project.": {"en": "Choose the default project. Each individual widget can still be configured with a different project.", "es": "Elige el proyecto predeterminado. Cada widget individual puede configurarse con un proyecto distinto.", "fr": "Choisis le projet par dÃ©faut. Chaque widget individuel peut quand mÃªme Ãªtre configurÃ© avec un projet diffÃ©rent.", "de": "WÃ¤hle das Standardprojekt. Jedes einzelne Widget kann weiterhin mit einem anderen Projekt konfiguriert werden.", "pt": "Escolhe o projeto predefinido. Cada widget individual ainda pode ser configurado com um projeto diferente.", "pl": "Wybierz projekt domyÅlny. KaÅ¼dy pojedynczy widÅ¼et nadal moÅ¼na skonfigurowaÄ z innym projektem.", "nl": "Kies het standaardproject. Elke afzonderlijke widget kan nog steeds met een ander project worden ingesteld.", "ro": "Alege proiectul implicit. Fiecare widget poate fi configurat totuÈi cu un proiect diferit.", "el": "ÎÏÎ¯Î»ÎµÎ¾Îµ ÏÎ¿ ÏÏÎ¿ÎµÏÎ¹Î»ÎµÎ³Î¼Î­Î½Î¿ Î­ÏÎ³Î¿. ÎÎ¬Î¸Îµ Î¼ÎµÎ¼Î¿Î½ÏÎ¼Î­Î½Î¿ widget Î¼ÏÎ¿ÏÎµÎ¯ Î±ÎºÏÎ¼Î· Î½Î± ÏÏÎ¸Î¼Î¹ÏÏÎµÎ¯ Î¼Îµ Î´Î¹Î±ÏÎ¿ÏÎµÏÎ¹ÎºÏ Î­ÏÎ³Î¿."}, "Primo progetto disponibile": {"en": "First available project", "es": "Primer proyecto disponible", "fr": "Premier projet disponible", "de": "Erstes verfÃ¼gbares Projekt", "pt": "Primeiro projeto disponÃ­vel", "pl": "Pierwszy dostÄpny projekt", "nl": "Eerste beschikbare project", "ro": "Primul proiect disponibil", "el": "Î ÏÏÏÎ¿ Î´Î¹Î±Î¸Î­ÏÎ¹Î¼Î¿ Î­ÏÎ³Î¿"}, "First available project": {"en": "First available project", "es": "Primer proyecto disponible", "fr": "Premier projet disponible", "de": "Erstes verfÃ¼gbares Projekt", "pt": "Primeiro projeto disponÃ­vel", "pl": "Pierwszy dostÄpny projekt", "nl": "Eerste beschikbare project", "ro": "Primul proiect disponibil", "el": "Î ÏÏÏÎ¿ Î´Î¹Î±Î¸Î­ÏÎ¹Î¼Î¿ Î­ÏÎ³Î¿"}, "Salva e aggiorna widget": {"en": "Save and update widget", "es": "Guardar y actualizar widget", "fr": "Enregistrer et mettre Ã  jour le widget", "de": "Widget speichern und aktualisieren", "pt": "Guardar e atualizar widget", "pl": "Zapisz i zaktualizuj widÅ¼et", "nl": "Widget opslaan en bijwerken", "ro": "SalveazÄ Èi actualizeazÄ widgetul", "el": "ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"}, "Save and update widget": {"en": "Save and update widget", "es": "Guardar y actualizar widget", "fr": "Enregistrer et mettre Ã  jour le widget", "de": "Widget speichern und aktualisieren", "pt": "Guardar e atualizar widget", "pl": "Zapisz i zaktualizuj widÅ¼et", "nl": "Widget opslaan en bijwerken", "ro": "SalveazÄ Èi actualizeazÄ widgetul", "el": "ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"}, "Aggiornamento automatico": {"en": "Automatic update", "es": "ActualizaciÃ³n automÃ¡tica", "fr": "Mise Ã  jour automatique", "de": "Automatische Aktualisierung", "pt": "AtualizaÃ§Ã£o automÃ¡tica", "pl": "Automatyczna aktualizacja", "nl": "Automatische update", "ro": "Actualizare automatÄ", "el": "ÎÏÏÏÎ¼Î±ÏÎ· ÎµÎ½Î·Î¼Î­ÏÏÏÎ·"}, "Automatic update": {"en": "Automatic update", "es": "ActualizaciÃ³n automÃ¡tica", "fr": "Mise Ã  jour automatique", "de": "Automatische Aktualisierung", "pt": "AtualizaÃ§Ã£o automÃ¡tica", "pl": "Automatyczna aktualizacja", "nl": "Automatische update", "ro": "Actualizare automatÄ", "el": "ÎÏÏÏÎ¼Î±ÏÎ· ÎµÎ½Î·Î¼Î­ÏÏÏÎ·"}, "Saldo": {"en": "Balance", "es": "Saldo", "fr": "Solde", "de": "Kontostand", "pt": "Saldo", "pl": "Saldo", "nl": "Balans", "ro": "Sold", "el": "Î¥ÏÏÎ»Î¿Î¹ÏÎ¿"}, "Balance": {"en": "Balance", "es": "Saldo", "fr": "Solde", "de": "Kontostand", "pt": "Saldo", "pl": "Saldo", "nl": "Balans", "ro": "Sold", "el": "Î¥ÏÏÎ»Î¿Î¹ÏÎ¿"}, "Spesa": {"en": "Expense", "es": "Gasto", "fr": "DÃ©pense", "de": "Ausgabe", "pt": "Despesa", "pl": "Wydatek", "nl": "Uitgave", "ro": "CheltuialÄ", "el": "ÎÎ¾Î¿Î´Î¿"}, "+ Spesa": {"en": "+ Expense", "es": "+ Gasto", "fr": "+ DÃ©pense", "de": "+ Ausgabe", "pt": "+ Despesa", "pl": "+ Wydatek", "nl": "+ Uitgave", "ro": "+ CheltuialÄ", "el": "+ ÎÎ¾Î¿Î´Î¿"}, "+ Expense": {"en": "+ Expense", "es": "+ Gasto", "fr": "+ DÃ©pense", "de": "+ Ausgabe", "pt": "+ Despesa", "pl": "+ Wydatek", "nl": "+ Uitgave", "ro": "+ CheltuialÄ", "el": "+ ÎÎ¾Î¿Î´Î¿"}, "AttivitÃ ": {"en": "Activity", "es": "Actividad", "fr": "ActivitÃ©", "de": "AktivitÃ¤t", "pt": "Atividade", "pl": "AktywnoÅÄ", "nl": "Activiteit", "ro": "Activitate", "el": "ÎÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±"}, "Activity": {"en": "Activity", "es": "Actividad", "fr": "ActivitÃ©", "de": "AktivitÃ¤t", "pt": "Atividade", "pl": "AktywnoÅÄ", "nl": "Activiteit", "ro": "Activitate", "el": "ÎÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±"}, "Sfondo": {"en": "Background", "es": "Fondo", "fr": "ArriÃ¨re-plan", "de": "Hintergrund", "pt": "Fundo", "pl": "TÅo", "nl": "Achtergrond", "ro": "Fundal", "el": "Î¦ÏÎ½ÏÎ¿"}, "Background": {"en": "Background", "es": "Fondo", "fr": "ArriÃ¨re-plan", "de": "Hintergrund", "pt": "Fundo", "pl": "TÅo", "nl": "Achtergrond", "ro": "Fundal", "el": "Î¦ÏÎ½ÏÎ¿"}, "Questo widget mostra sulla Home il riepilogo di un progetto Share: saldo personale, quanto devi, quanto ti devono e ultima attivitÃ . Il progetto puÃ² essere scelto qui come default e anche dal tasto di configurazione quando aggiungi il widget.": {"en": "This widget shows a Share project summary on the Home screen: personal balance, what you owe, what others owe you and the latest activity. The project can be selected here as default and also from the configuration button when you add the widget.", "es": "Este widget muestra en la pantalla de inicio el resumen de un proyecto Share: saldo personal, cuÃ¡nto debes, cuÃ¡nto te deben y la Ãºltima actividad. El proyecto puede elegirse aquÃ­ como predeterminado y tambiÃ©n desde el botÃ³n de configuraciÃ³n al aÃ±adir el widget.", "fr": "Ce widget affiche sur lâÃ©cran dâaccueil le rÃ©sumÃ© dâun projet Share : solde personnel, ce que tu dois, ce quâon te doit et la derniÃ¨re activitÃ©. Le projet peut Ãªtre choisi ici par dÃ©faut et aussi depuis le bouton de configuration lorsque tu ajoutes le widget.", "de": "Dieses Widget zeigt auf dem Startbildschirm die Zusammenfassung eines Share-Projekts: persÃ¶nlicher Kontostand, was du schuldest, was dir geschuldet wird und die letzte AktivitÃ¤t. Das Projekt kann hier als Standard und auch Ã¼ber die Konfigurationstaste beim HinzufÃ¼gen des Widgets gewÃ¤hlt werden.", "pt": "Este widget mostra no ecrÃ£ inicial o resumo de um projeto Share: saldo pessoal, quanto deves, quanto te devem e a Ãºltima atividade. O projeto pode ser escolhido aqui como padrÃ£o e tambÃ©m no botÃ£o de configuraÃ§Ã£o ao adicionares o widget.", "pl": "Ten widÅ¼et pokazuje na ekranie gÅÃ³wnym podsumowanie projektu Share: saldo osobiste, ile jesteÅ winien, ile inni sÄ winni tobie i ostatniÄ aktywnoÅÄ. Projekt moÅ¼na wybraÄ tutaj jako domyÅlny, a takÅ¼e przyciskiem konfiguracji podczas dodawania widÅ¼etu.", "nl": "Deze widget toont op het startscherm de samenvatting van een Share-project: persoonlijk saldo, wat jij verschuldigd bent, wat anderen jou verschuldigd zijn en de laatste activiteit. Het project kan hier als standaard worden gekozen en ook via de configuratieknop wanneer je de widget toevoegt.", "ro": "Acest widget afiÈeazÄ pe ecranul principal rezumatul unui proiect Share: sold personal, cÃ¢t datorezi, cÃ¢t Èi se datoreazÄ Èi ultima activitate. Proiectul poate fi ales aici ca implicit Èi Èi din butonul de configurare cÃ¢nd adaugi widgetul.", "el": "ÎÏÏÏ ÏÎ¿ widget ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î· ÏÎ· ÏÏÎ½Î¿ÏÎ· ÎµÎ½ÏÏ Î­ÏÎ³Î¿Ï Share: ÏÏÎ¿ÏÏÏÎ¹ÎºÏ ÏÏÏÎ»Î¿Î¹ÏÎ¿, ÏÏÏÎ± Î¿ÏÎµÎ¯Î»ÎµÎ¹Ï, ÏÏÏÎ± ÏÎ¿Ï Î¿ÏÎµÎ¯Î»Î¿ÏÎ½ ÎºÎ±Î¹ ÏÎ·Î½ ÏÎµÎ»ÎµÏÏÎ±Î¯Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±. Î¤Î¿ Î­ÏÎ³Î¿ Î¼ÏÎ¿ÏÎµÎ¯ Î½Î± ÎµÏÎ¹Î»ÎµÎ³ÎµÎ¯ ÎµÎ´Ï ÏÏ ÏÏÎ¿ÎµÏÎ¹Î»Î¿Î³Î® ÎºÎ±Î¹ ÎµÏÎ¯ÏÎ·Ï Î±ÏÏ ÏÎ¿ ÎºÎ¿ÏÎ¼ÏÎ¯ ÏÏÎ¸Î¼Î¹ÏÎ·Ï ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÎ¹Ï ÏÎ¿ widget."}, "This widget shows a Share project summary on the Home screen: personal balance, how much you owe, how much others owe you and the latest activity. The project can be selected here as the default and also from the configuration button when you add the widget.": {"en": "This widget shows a Share project summary on the Home screen: personal balance, what you owe, what others owe you and the latest activity. The project can be selected here as default and also from the configuration button when you add the widget.", "es": "Este widget muestra en la pantalla de inicio el resumen de un proyecto Share: saldo personal, cuÃ¡nto debes, cuÃ¡nto te deben y la Ãºltima actividad. El proyecto puede elegirse aquÃ­ como predeterminado y tambiÃ©n desde el botÃ³n de configuraciÃ³n al aÃ±adir el widget.", "fr": "Ce widget affiche sur lâÃ©cran dâaccueil le rÃ©sumÃ© dâun projet Share : solde personnel, ce que tu dois, ce quâon te doit et la derniÃ¨re activitÃ©. Le projet peut Ãªtre choisi ici par dÃ©faut et aussi depuis le bouton de configuration lorsque tu ajoutes le widget.", "de": "Dieses Widget zeigt auf dem Startbildschirm die Zusammenfassung eines Share-Projekts: persÃ¶nlicher Kontostand, was du schuldest, was dir geschuldet wird und die letzte AktivitÃ¤t. Das Projekt kann hier als Standard und auch Ã¼ber die Konfigurationstaste beim HinzufÃ¼gen des Widgets gewÃ¤hlt werden.", "pt": "Este widget mostra no ecrÃ£ inicial o resumo de um projeto Share: saldo pessoal, quanto deves, quanto te devem e a Ãºltima atividade. O projeto pode ser escolhido aqui como padrÃ£o e tambÃ©m no botÃ£o de configuraÃ§Ã£o ao adicionares o widget.", "pl": "Ten widÅ¼et pokazuje na ekranie gÅÃ³wnym podsumowanie projektu Share: saldo osobiste, ile jesteÅ winien, ile inni sÄ winni tobie i ostatniÄ aktywnoÅÄ. Projekt moÅ¼na wybraÄ tutaj jako domyÅlny, a takÅ¼e przyciskiem konfiguracji podczas dodawania widÅ¼etu.", "nl": "Deze widget toont op het startscherm de samenvatting van een Share-project: persoonlijk saldo, wat jij verschuldigd bent, wat anderen jou verschuldigd zijn en de laatste activiteit. Het project kan hier als standaard worden gekozen en ook via de configuratieknop wanneer je de widget toevoegt.", "ro": "Acest widget afiÈeazÄ pe ecranul principal rezumatul unui proiect Share: sold personal, cÃ¢t datorezi, cÃ¢t Ã®Èi datoreazÄ alÈii Èi ultima activitate. Proiectul selectat aici este folosit ca implicit Èi Èi de butonul de configurare cÃ¢nd adaugi widgetul.", "el": "ÎÏÏÏ ÏÎ¿ widget ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î· Î¼Î¹Î± ÏÏÎ½Î¿ÏÎ· ÏÎ¿Ï Î­ÏÎ³Î¿Ï Share: ÏÏÎ¿ÏÏÏÎ¹ÎºÏ ÏÏÏÎ»Î¿Î¹ÏÎ¿, ÏÏÏÎ± Î¿ÏÎµÎ¯Î»ÎµÎ¹Ï, ÏÏÏÎ± ÏÎ¿Ï Î¿ÏÎµÎ¯Î»Î¿ÏÎ½ ÎºÎ±Î¹ ÏÎ·Î½ ÏÎµÎ»ÎµÏÏÎ±Î¯Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±. Î¤Î¿ Î­ÏÎ³Î¿ ÏÎ¿Ï ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÎµÎ´Ï ÏÏÎ·ÏÎ¹Î¼Î¿ÏÎ¿Î¹ÎµÎ¯ÏÎ±Î¹ ÏÏ ÏÏÎ¿ÎµÏÎ¹Î»Î¿Î³Î® ÎºÎ±Î¹ ÎµÏÎ¯ÏÎ·Ï Î±ÏÏ ÏÎ¿ ÎºÎ¿ÏÎ¼ÏÎ¯ ÏÏÎ¸Î¼Î¹ÏÎ·Ï ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÎ¹Ï ÏÎ¿ widget."}};
    var EXTRA_TRANSLATIONS_1633={"Scegli la lista, aggiungi prodotti e spunta quelli giÃ  messi nel carrello.":{"it":"Scegli la lista, aggiungi prodotti e spunta quelli giÃ  messi nel carrello.","en":"Choose a list, add products and tick the items already in your cart.","es":"Elige la lista, aÃ±ade productos y marca los que ya estÃ¡n en el carrito.","fr":"Choisissez la liste, ajoutez des produits et cochez ceux dÃ©jÃ  dans le panier.","de":"WÃ¤hle die Liste, fÃ¼ge Produkte hinzu und markiere die Artikel im Einkaufswagen.","pt":"Escolhe a lista, adiciona produtos e marca os que jÃ¡ estÃ£o no carrinho.","pl":"Wybierz listÄ, dodaj produkty i zaznacz te, ktÃ³re sÄ juÅ¼ w koszyku.","nl":"Kies de lijst, voeg producten toe en vink de artikelen aan die al in je winkelwagen liggen.","ro":"Alege lista, adaugÄ produse Èi bifeazÄ articolele deja puse Ã®n coÈ.","el":"ÎÏÎ¹Î»Î­Î¾ÏÎµ Î»Î¯ÏÏÎ±, ÏÏÎ¿ÏÎ¸Î­ÏÏÎµ ÏÏÎ¿ÏÏÎ½ÏÎ± ÎºÎ±Î¹ ÏÎ·Î¼ÎµÎ¹ÏÏÏÎµ ÏÏÎ± ÎµÎ¯Î½Î±Î¹ Î®Î´Î· ÏÏÎ¿ ÎºÎ±Î»Î¬Î¸Î¹."},"Tocca il prodotto per aggiungerlo alla lista.":{"it":"Tocca il prodotto per aggiungerlo alla lista.","en":"Tap the product to add it to the list.","es":"Toca el producto para aÃ±adirlo a la lista.","fr":"Touchez le produit pour lâajouter Ã  la liste.","de":"Tippe auf das Produkt, um es zur Liste hinzuzufÃ¼gen.","pt":"Toca no produto para o adicionar Ã  lista.","pl":"Dotknij produktu, aby dodaÄ go do listy.","nl":"Tik op het product om het aan de lijst toe te voegen.","ro":"Atinge produsul pentru a-l adÄuga Ã®n listÄ.","el":"Î Î±ÏÎ®ÏÏÎµ ÏÎ¿ ÏÏÎ¿ÏÏÎ½ Î³Î¹Î± Î½Î± ÏÎ¿ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÏÎ· Î»Î¯ÏÏÎ±."},"VisibilitÃ , collegamento a patrimonio e movimenti":{"it":"VisibilitÃ , collegamento a patrimonio e movimenti","en":"Visibility, connection to assets and transactions","es":"Visibilidad, conexiÃ³n con patrimonio y movimientos","fr":"VisibilitÃ©, lien avec patrimoine et mouvements","de":"Sichtbarkeit, VerknÃ¼pfung mit VermÃ¶gen und Bewegungen","pt":"Visibilidade, ligaÃ§Ã£o a patrimÃ³nio e movimentos","pl":"WidocznoÅÄ, poÅÄczenie z majÄtkiem i ruchami","nl":"Zichtbaarheid, koppeling met vermogen en bewegingen","ro":"Vizibilitate, legÄturÄ cu patrimoniu Èi miÈcÄri","el":"ÎÏÎ±ÏÏÏÎ·ÏÎ±, ÏÏÎ½Î´ÎµÏÎ· Î¼Îµ ÏÎµÏÎ¹Î¿ÏÏÎ¯Î± ÎºÎ±Î¹ ÎºÎ¹Î½Î®ÏÎµÎ¹Ï"},"Aree lista spesa, fidelity card e prepagate":{"it":"Aree lista spesa, fidelity card e prepagate","en":"Shopping list areas, loyalty cards and prepaid cards","es":"Ãreas de la lista de la compra, tarjetas fidelidad y prepago","fr":"Rayons de la liste de courses, cartes fidÃ©litÃ© et prÃ©payÃ©es","de":"Einkaufslistenbereiche, Kundenkarten und Prepaid-Karten","pt":"Ãreas da lista de compras, cartÃµes fidelidade e prÃ©-pagos","pl":"Obszary listy zakupÃ³w, karty lojalnoÅciowe i przedpÅacone","nl":"Boodschappenlijstgebieden, klantenkaarten en prepaidkaarten","ro":"Zone listÄ cumpÄrÄturi, carduri fidelitate Èi preplÄtite","el":"Î ÎµÏÎ¹Î¿ÏÎ­Ï Î»Î¯ÏÏÎ±Ï Î±Î³Î¿ÏÏÎ½, ÎºÎ¬ÏÏÎµÏ ÏÎµÎ»Î¬ÏÎ· ÎºÎ±Î¹ ÏÏÎ¿ÏÎ»Î·ÏÏÎ¼Î­Î½ÎµÏ"},"Carte fidelity e prepagate":{"it":"Carte fidelity e prepagate","en":"Loyalty and prepaid cards","es":"Tarjetas fidelidad y prepago","fr":"Cartes fidÃ©litÃ© et prÃ©payÃ©es","de":"Kunden- und Prepaid-Karten","pt":"CartÃµes fidelidade e prÃ©-pagos","pl":"Karty lojalnoÅciowe i przedpÅacone","nl":"Klanten- en prepaidkaarten","ro":"Carduri fidelitate Èi preplÄtite","el":"ÎÎ¬ÏÏÎµÏ ÏÎµÎ»Î¬ÏÎ· ÎºÎ±Î¹ ÏÏÎ¿ÏÎ»Î·ÏÏÎ¼Î­Î½ÎµÏ"},"Riporta nel patrimonio":{"it":"Riporta nel patrimonio","en":"Include in assets","es":"Incluir en patrimonio","fr":"Inclure dans le patrimoine","de":"In VermÃ¶gen aufnehmen","pt":"Incluir no patrimÃ³nio","pl":"UwzglÄdnij w majÄtku","nl":"Opnemen in vermogen","ro":"Include Ã®n patrimoniu","el":"Î£ÏÎ¼ÏÎµÏÎ¯Î»Î·ÏÎ· ÏÏÎ·Î½ ÏÎµÏÎ¹Î¿ÏÏÎ¯Î±"},"Consente di creare una voce Patrimonio collegata al Saldo del debito o credito.":{"it":"Consente di creare una voce Patrimonio collegata al Saldo del debito o credito.","en":"Allows creating an asset item linked to the debt or credit balance.","es":"Permite crear una partida de patrimonio vinculada al saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er un Ã©lÃ©ment de patrimoine liÃ© au solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht einen VermÃ¶genseintrag, der mit dem Saldo der Schuld oder des Guthabens verknÃ¼pft ist.","pt":"Permite criar um item de patrimÃ³nio ligado ao saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala utworzyÄ pozycjÄ majÄtku poÅÄczonÄ z saldem dÅugu lub naleÅ¼noÅci.","nl":"Maakt een vermogensitem aan dat gekoppeld is aan het saldo van de schuld of het tegoed.","ro":"Permite crearea unui element de patrimoniu legat de soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÏÏÎ¿Î¹ÏÎµÎ¯Î¿Ï ÏÎµÏÎ¹Î¿ÏÏÎ¯Î±Ï ÏÏÎ½Î´ÎµÎ´ÎµÎ¼Î­Î½Î¿Ï Î¼Îµ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Consente di creare una voce patrimonio collegata al saldo del debito o credito.":{"it":"Consente di creare una voce patrimonio collegata al saldo del debito o credito.","en":"Allows creating an asset item linked to the debt or credit balance.","es":"Permite crear una partida de patrimonio vinculada al saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er un Ã©lÃ©ment de patrimoine liÃ© au solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht einen VermÃ¶genseintrag, der mit dem Saldo der Schuld oder des Guthabens verknÃ¼pft ist.","pt":"Permite criar um item de patrimÃ³nio ligado ao saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala utworzyÄ pozycjÄ majÄtku poÅÄczonÄ z saldem dÅugu lub naleÅ¼noÅci.","nl":"Maakt een vermogensitem aan dat gekoppeld is aan het saldo van de schuld of het tegoed.","ro":"Permite crearea unui element de patrimoniu legat de soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÏÏÎ¿Î¹ÏÎµÎ¯Î¿Ï ÏÎµÏÎ¹Î¿ÏÏÎ¯Î±Ï ÏÏÎ½Î´ÎµÎ´ÎµÎ¼Î­Î½Î¿Ï Î¼Îµ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Riporta nei movimenti":{"it":"Riporta nei movimenti","en":"Include in transactions","es":"Incluir en movimientos","fr":"Inclure dans les mouvements","de":"In Bewegungen aufnehmen","pt":"Incluir nos movimentos","pl":"UwzglÄdnij w ruchach","nl":"Opnemen in bewegingen","ro":"Include Ã®n miÈcÄri","el":"Î£ÏÎ¼ÏÎµÏÎ¯Î»Î·ÏÎ· ÏÏÎ¹Ï ÎºÎ¹Î½Î®ÏÎµÎ¹Ï"},"Consente di creare entrate o uscite partendo dal Saldo del debito o credito.":{"it":"Consente di creare entrate o uscite partendo dal Saldo del debito o credito.","en":"Allows creating income or expenses from the debt or credit balance.","es":"Permite crear ingresos o gastos a partir del saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er des entrÃ©es ou sorties Ã  partir du solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht Einnahmen oder Ausgaben aus dem Saldo der Schuld oder des Guthabens.","pt":"Permite criar entradas ou saÃ­das a partir do saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala tworzyÄ przychody lub wydatki z salda dÅugu lub naleÅ¼noÅci.","nl":"Maakt inkomsten of uitgaven aan op basis van het saldo van de schuld of het tegoed.","ro":"Permite crearea de venituri sau cheltuieli pornind de la soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÎµÏÏÎ´ÏÎ½ Î® ÎµÎ¾ÏÎ´ÏÎ½ Î±ÏÏ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Consente di creare entrate o uscite partendo dal saldo del debito o credito.":{"it":"Consente di creare entrate o uscite partendo dal saldo del debito o credito.","en":"Allows creating income or expenses from the debt or credit balance.","es":"Permite crear ingresos o gastos a partir del saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er des entrÃ©es ou sorties Ã  partir du solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht Einnahmen oder Ausgaben aus dem Saldo der Schuld oder des Guthabens.","pt":"Permite criar entradas ou saÃ­das a partir do saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala tworzyÄ przychody lub wydatki z salda dÅugu lub naleÅ¼noÅci.","nl":"Maakt inkomsten of uitgaven aan op basis van het saldo van de schuld of het tegoed.","ro":"Permite crearea de venituri sau cheltuieli pornind de la soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÎµÏÏÎ´ÏÎ½ Î® ÎµÎ¾ÏÎ´ÏÎ½ Î±ÏÏ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Gestisci le aree dei prodotti e scegli icona e area predefinita.":{"it":"Gestisci le aree dei prodotti e scegli icona e area predefinita.","en":"Manage product areas and choose the icon and default area.","es":"Gestiona las Ã¡reas de productos y elige icono y Ã¡rea predeterminada.","fr":"GÃ©rez les rayons des produits et choisissez lâicÃ´ne et le rayon par dÃ©faut.","de":"Verwalte Produktbereiche und wÃ¤hle Symbol und Standardbereich.","pt":"Gere as Ã¡reas dos produtos e escolhe Ã­cone e Ã¡rea predefinida.","pl":"ZarzÄdzaj obszarami produktÃ³w oraz wybierz ikonÄ i obszar domyÅlny.","nl":"Beheer productgebieden en kies het pictogram en standaardgebied.","ro":"GestioneazÄ zonele produselor Èi alege pictograma Èi zona implicitÄ.","el":"ÎÎ¹Î±ÏÎµÎ¹ÏÎ¹ÏÏÎµÎ¯ÏÎµ ÏÎ¹Ï ÏÎµÏÎ¹Î¿ÏÎ­Ï ÏÏÎ¿ÏÏÎ½ÏÏÎ½ ÎºÎ±Î¹ ÎµÏÎ¹Î»Î­Î¾ÏÎµ ÎµÎ¹ÎºÎ¿Î½Î¯Î´Î¹Î¿ ÎºÎ±Î¹ ÏÏÎ¿ÎµÏÎ¹Î»ÎµÎ³Î¼Î­Î½Î· ÏÎµÏÎ¹Î¿ÏÎ®."},"Colore usato nella lista quando un prodotto Ã¨ giÃ  nel carrello.":{"it":"Colore usato nella lista quando un prodotto Ã¨ giÃ  nel carrello.","en":"Color used in the list when a product is already in the cart.","es":"Color usado en la lista cuando un producto ya estÃ¡ en el carrito.","fr":"Couleur utilisÃ©e dans la liste lorsquâun produit est dÃ©jÃ  dans le panier.","de":"Farbe in der Liste, wenn ein Produkt bereits im Wagen ist.","pt":"Cor usada na lista quando um produto jÃ¡ estÃ¡ no carrinho.","pl":"Kolor uÅ¼ywany na liÅcie, gdy produkt jest juÅ¼ w koszyku.","nl":"Kleur in de lijst wanneer een product al in de winkelwagen staat.","ro":"Culoare folositÄ Ã®n listÄ cÃ¢nd un produs este deja Ã®n coÈ.","el":"Î§ÏÏÎ¼Î± ÏÏÎ· Î»Î¯ÏÏÎ± ÏÏÎ±Î½ Î­Î½Î± ÏÏÎ¿ÏÏÎ½ ÎµÎ¯Î½Î±Î¹ Î®Î´Î· ÏÏÎ¿ ÎºÎ±Î»Î¬Î¸Î¹."},"Top summary, number of icons and section order":{"it":"Riepilogo alto, numero icone e ordine delle sezioni","en":"Top summary, number of icons and section order","es":"Resumen superior, nÃºmero de iconos y orden de secciones","fr":"RÃ©sumÃ© supÃ©rieur, nombre dâicÃ´nes et ordre des sections","de":"Obere Zusammenfassung, Anzahl der Symbole und Abschnittsreihenfolge","pt":"Resumo superior, nÃºmero de Ã­cones e ordem das secÃ§Ãµes","pl":"GÃ³rne podsumowanie, liczba ikon i kolejnoÅÄ sekcji","nl":"Bovenste samenvatting, aantal pictogrammen en volgorde van secties","ro":"Rezumat superior, numÄr de pictograme Èi ordinea secÈiunilor","el":"ÎÏÎ¬Î½Ï ÏÏÎ½Î¿ÏÎ·, Î±ÏÎ¹Î¸Î¼ÏÏ ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯ÏÎ½ ÎºÎ±Î¹ ÏÎµÎ¹ÏÎ¬ ÎµÎ½Î¿ÏÎ®ÏÏÎ½"},"Riepilogo alto, numero icone e ordine delle sezioni":{"it":"Riepilogo alto, numero icone e ordine delle sezioni","en":"Top summary, number of icons and section order","es":"Resumen superior, nÃºmero de iconos y orden de secciones","fr":"RÃ©sumÃ© supÃ©rieur, nombre dâicÃ´nes et ordre des sections","de":"Obere Zusammenfassung, Anzahl der Symbole und Abschnittsreihenfolge","pt":"Resumo superior, nÃºmero de Ã­cones e ordem das secÃ§Ãµes","pl":"GÃ³rne podsumowanie, liczba ikon i kolejnoÅÄ sekcji","nl":"Bovenste samenvatting, aantal pictogrammen en volgorde van secties","ro":"Rezumat superior, numÄr de pictograme Èi ordinea secÈiunilor","el":"ÎÏÎ¬Î½Ï ÏÏÎ½Î¿ÏÎ·, Î±ÏÎ¹Î¸Î¼ÏÏ ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯ÏÎ½ ÎºÎ±Î¹ ÏÎµÎ¹ÏÎ¬ ÎµÎ½Î¿ÏÎ®ÏÏÎ½"},"Configurazione widget Android":{"it":"Configurazione widget Android","en":"Android widget configuration","es":"ConfiguraciÃ³n de widgets Android","fr":"Configuration des widgets Android","de":"Android-Widget-Konfiguration","pt":"ConfiguraÃ§Ã£o dos widgets Android","pl":"Konfiguracja widÅ¼etÃ³w Android","nl":"Android-widgetconfiguratie","ro":"Configurare widgeturi Android","el":"Î¡ÏÎ¸Î¼Î¹ÏÎ· widget Android"},"Widget ingresso rapido":{"it":"Widget ingresso rapido","en":"Quick entry widget","es":"Widget de entrada rÃ¡pida","fr":"Widget de saisie rapide","de":"Schnelleingabe-Widget","pt":"Widget de entrada rÃ¡pida","pl":"WidÅ¼et szybkiego wpisu","nl":"Widget snelle invoer","ro":"Widget introducere rapidÄ","el":"Widget Î³ÏÎ®Î³Î¿ÏÎ·Ï ÎµÎ¹ÏÎ±Î³ÏÎ³Î®Ï"},"Incluso nel piano gratuito. Logo fAInance, pulsanti Entrata/Uscita e layout 1x4 in una sola riga":{"it":"Incluso nel piano gratuito. Logo fAInance, pulsanti Entrata/Uscita e layout 1x4 in una sola riga","en":"Included in the free plan. fAInance logo, income/expense buttons and 1x4 layout in one row","es":"Incluido en el plan gratuito. Logo fAInance, botones Entrada/Salida y diseÃ±o 1x4 en una sola fila","fr":"Inclus dans le plan gratuit. Logo fAInance, boutons EntrÃ©e/Sortie et disposition 1x4 sur une seule ligne","de":"Im Gratis-Plan enthalten. fAInance-Logo, Einnahmen/Ausgaben-SchaltflÃ¤chen und 1x4-Layout in einer Zeile","pt":"IncluÃ­do no plano gratuito. Logo fAInance, botÃµes Entrada/SaÃ­da e layout 1x4 numa sÃ³ linha","pl":"DostÄpne w planie darmowym. Logo fAInance, przyciski PrzychÃ³d/Wydatek i ukÅad 1x4 w jednym wierszu","nl":"Inbegrepen in het gratis plan. fAInance-logo, knoppen Inkomsten/Uitgaven en 1x4-indeling op Ã©Ã©n rij","ro":"Inclus Ã®n planul gratuit. Logo fAInance, butoane Venit/CheltuialÄ Èi aspect 1x4 pe un singur rÃ¢nd","el":"Î ÎµÏÎ¹Î»Î±Î¼Î²Î¬Î½ÎµÏÎ±Î¹ ÏÏÎ¿ Î´ÏÏÎµÎ¬Î½ ÏÎ»Î¬Î½Î¿. ÎÎ¿Î³ÏÏÏÏÎ¿ fAInance, ÎºÎ¿ÏÎ¼ÏÎ¹Î¬ ÎÏÎ¿Î´Î±/ÎÎ¾Î¿Î´Î± ÎºÎ±Î¹ Î´Î¹Î¬ÏÎ±Î¾Î· 1x4 ÏÎµ Î¼Î¯Î± Î³ÏÎ±Î¼Î¼Î®"},"Lista spesa":{"it":"Lista spesa","en":"Shopping list","es":"Lista de la compra","fr":"Liste de courses","de":"Einkaufsliste","pt":"Lista de compras","pl":"Lista zakupÃ³w","nl":"Boodschappenlijst","ro":"ListÄ de cumpÄrÄturi","el":"ÎÎ¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½"},"Visualizza la lista della spesa e permette di segnare gli articoli acquistati.":{"it":"Visualizza la lista della spesa e permette di segnare gli articoli acquistati.","en":"Shows the shopping list and lets you mark purchased items.","es":"Muestra la lista de la compra y permite marcar los artÃ­culos comprados.","fr":"Affiche la liste de courses et permet de marquer les articles achetÃ©s.","de":"Zeigt die Einkaufsliste und lÃ¤sst gekaufte Artikel markieren.","pt":"Mostra a lista de compras e permite marcar os artigos comprados.","pl":"Pokazuje listÄ zakupÃ³w i pozwala oznaczaÄ kupione produkty.","nl":"Toont de boodschappenlijst en laat gekochte artikelen markeren.","ro":"AfiÈeazÄ lista de cumpÄrÄturi Èi permite marcarea articolelor cumpÄrate.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÎ· Î»Î¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½ ÎºÎ±Î¹ ÎµÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· ÏÎ®Î¼Î±Î½ÏÎ· ÏÏÎ½ Î±Î³Î¿ÏÎ±ÏÎ¼Î­Î½ÏÎ½ ÎµÎ¹Î´ÏÎ½."},"Mostra la lista della spesa e permette di segnare gli articoli acquistati.":{"it":"Mostra la lista della spesa e permette di segnare gli articoli acquistati.","en":"Shows the shopping list and lets you mark purchased items.","es":"Muestra la lista de la compra y permite marcar los artÃ­culos comprados.","fr":"Affiche la liste de courses et permet de marquer les articles achetÃ©s.","de":"Zeigt die Einkaufsliste und lÃ¤sst gekaufte Artikel markieren.","pt":"Mostra a lista de compras e permite marcar os artigos comprados.","pl":"Pokazuje listÄ zakupÃ³w i pozwala oznaczaÄ kupione produkty.","nl":"Toont de boodschappenlijst en laat gekochte artikelen markeren.","ro":"AfiÈeazÄ lista de cumpÄrÄturi Èi permite marcarea articolelor cumpÄrate.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÎ· Î»Î¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½ ÎºÎ±Î¹ ÎµÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· ÏÎ®Î¼Î±Î½ÏÎ· ÏÏÎ½ Î±Î³Î¿ÏÎ±ÏÎ¼Î­Î½ÏÎ½ ÎµÎ¹Î´ÏÎ½."},"Fidelity card":{"it":"Fidelity card","en":"Loyalty card","es":"Tarjeta fidelidad","fr":"Carte fidÃ©litÃ©","de":"Kundenkarte","pt":"CartÃ£o fidelidade","pl":"Karta lojalnoÅciowa","nl":"Klantenkaart","ro":"Card fidelitate","el":"ÎÎ¬ÏÏÎ± ÏÎµÎ»Î¬ÏÎ·"},"Visualizza rapidamente una fidelity card o una prepagata.":{"it":"Visualizza rapidamente una fidelity card o una prepagata.","en":"Quickly shows a loyalty or prepaid card.","es":"Muestra rÃ¡pidamente una tarjeta fidelidad o prepago.","fr":"Affiche rapidement une carte fidÃ©litÃ© ou prÃ©payÃ©e.","de":"Zeigt schnell eine Kunden- oder Prepaid-Karte.","pt":"Mostra rapidamente um cartÃ£o fidelidade ou prÃ©-pago.","pl":"Szybko pokazuje kartÄ lojalnoÅciowÄ lub przedpÅaconÄ.","nl":"Toont snel een klantenkaart of prepaidkaart.","ro":"AfiÈeazÄ rapid un card fidelitate sau preplÄtit.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ Î³ÏÎ®Î³Î¿ÏÎ± Î¼Î¹Î± ÎºÎ¬ÏÏÎ± ÏÎµÎ»Î¬ÏÎ· Î® ÏÏÎ¿ÏÎ»Î·ÏÏÎ¼Î­Î½Î·."},"Debiti / Crediti":{"it":"Debiti / Crediti","en":"Debts / Credits","es":"Deudas / CrÃ©ditos","fr":"Dettes / CrÃ©dits","de":"Schulden / Guthaben","pt":"DÃ­vidas / CrÃ©ditos","pl":"DÅugi / NaleÅ¼noÅci","nl":"Schulden / Tegoeden","ro":"Datorii / Credite","el":"Î§ÏÎ­Î· / Î Î¹ÏÏÏÏÎµÎ¹Ï"},"Mostra il saldo aperto di debiti e crediti.":{"it":"Mostra il saldo aperto di debiti e crediti.","en":"Shows the open balance of debts and credits.","es":"Muestra el saldo abierto de deudas y crÃ©ditos.","fr":"Affiche le solde ouvert des dettes et crÃ©dits.","de":"Zeigt den offenen Saldo von Schulden und Guthaben.","pt":"Mostra o saldo em aberto de dÃ­vidas e crÃ©ditos.","pl":"Pokazuje otwarte saldo dÅugÃ³w i naleÅ¼noÅci.","nl":"Toont het open saldo van schulden en tegoeden.","ro":"AfiÈeazÄ soldul deschis al datoriilor Èi creditelor.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÎ¿ Î±Î½Î¿Î¹ÎºÏÏ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎµÏÎ½ ÎºÎ±Î¹ ÏÎ¹ÏÏÏÏÎµÏÎ½."},"Icon color":{"it":"Colore icona","en":"Icon color","es":"Color del icono","fr":"Couleur de lâicÃ´ne","de":"Symbolfarbe","pt":"Cor do Ã­cone","pl":"Kolor ikony","nl":"Pictogramkleur","ro":"Culoare pictogramÄ","el":"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},"Title color":{"it":"Colore titolo","en":"Title color","es":"Color del tÃ­tulo","fr":"Couleur du titre","de":"Titelfarbe","pt":"Cor do tÃ­tulo","pl":"Kolor tytuÅu","nl":"Titelkleur","ro":"Culoare titlu","el":"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},"Text color":{"it":"Colore testo","en":"Text color","es":"Color del texto","fr":"Couleur du texte","de":"Textfarbe","pt":"Cor do texto","pl":"Kolor tekstu","nl":"Tekstkleur","ro":"Culoare text","el":"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Project shown in the widget":{"it":"Progetto mostrato nel widget","en":"Project shown in the widget","es":"Proyecto mostrado en el widget","fr":"Projet affichÃ© dans le widget","de":"Im Widget angezeigtes Projekt","pt":"Projeto mostrado no widget","pl":"Projekt pokazany w widÅ¼ecie","nl":"Project getoond in de widget","ro":"Proiect afiÈat Ã®n widget","el":"ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"},"Save and update widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},"Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.":{"it":"Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.","en":"You choose the exact content when adding the widget to the Home screen; here you only edit appearance, colors, transparency and updates.","es":"El contenido exacto se elige al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas aspecto, colores, transparencia y actualizaciÃ³n.","fr":"Le contenu exact se choisit lors de lâajout du widget Ã  lâÃ©cran dâaccueil ; ici vous modifiez seulement lâaspect, les couleurs, la transparence et lâactualisation.","de":"Den genauen Inhalt wÃ¤hlst du beim HinzufÃ¼gen des Widgets zum Startbildschirm; hier Ã¤nderst du nur Aussehen, Farben, Transparenz und Aktualisierung.","pt":"O conteÃºdo exato Ã© escolhido ao adicionar o widget ao ecrÃ£ inicial; aqui alteras apenas aspeto, cores, transparÃªncia e atualizaÃ§Ã£o.","pl":"DokÅadnÄ treÅÄ wybierasz podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory, przezroczystoÅÄ i odÅwieÅ¼anie.","nl":"De exacte inhoud kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren, transparantie en updates.","ro":"ConÈinutul exact se alege cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile, transparenÈa Èi actualizarea.","el":"Î¤Î¿ Î±ÎºÏÎ¹Î²Î­Ï ÏÎµÏÎ¹ÎµÏÏÎ¼ÎµÎ½Î¿ ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÏÎµ Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ±, Î´Î¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},"La carta precisa si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.":{"it":"La carta precisa si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.","en":"You choose the exact card when adding the widget to the Home screen; here you only edit appearance, colors, transparency and updates.","es":"La tarjeta exacta se elige al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas aspecto, colores, transparencia y actualizaciÃ³n.","fr":"La carte exacte se choisit lors de lâajout du widget Ã  lâÃ©cran dâaccueil ; ici vous modifiez seulement lâaspect, les couleurs, la transparence et lâactualisation.","de":"Die genaue Karte wÃ¤hlst du beim HinzufÃ¼gen des Widgets zum Startbildschirm; hier Ã¤nderst du nur Aussehen, Farben, Transparenz und Aktualisierung.","pt":"O cartÃ£o exato Ã© escolhido ao adicionar o widget ao ecrÃ£ inicial; aqui alteras apenas aspeto, cores, transparÃªncia e atualizaÃ§Ã£o.","pl":"DokÅadnÄ kartÄ wybierasz podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory, przezroczystoÅÄ i odÅwieÅ¼anie.","nl":"De exacte kaart kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren, transparantie en updates.","ro":"Cardul exact se alege cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile, transparenÈa Èi actualizarea.","el":"Î Î±ÎºÏÎ¹Î²Î®Ï ÎºÎ¬ÏÏÎ± ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÏÎµ Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ±, Î´Î¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},"I debiti e crediti precisi si scelgono quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.":{"it":"I debiti e crediti precisi si scelgono quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.","en":"You choose the exact debts and credits when adding the widget to the Home screen; here you only edit appearance, colors, transparency and updates.","es":"Las deudas y crÃ©ditos exactos se eligen al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas aspecto, colores, transparencia y actualizaciÃ³n.","fr":"Les dettes et crÃ©dits exacts se choisissent lors de lâajout du widget Ã  lâÃ©cran dâaccueil ; ici vous modifiez seulement lâaspect, les couleurs, la transparence et lâactualisation.","de":"Die genauen Schulden und Guthaben wÃ¤hlst du beim HinzufÃ¼gen des Widgets zum Startbildschirm; hier Ã¤nderst du nur Aussehen, Farben, Transparenz und Aktualisierung.","pt":"As dÃ­vidas e crÃ©ditos exatos sÃ£o escolhidos ao adicionar o widget ao ecrÃ£ inicial; aqui alteras apenas aspeto, cores, transparÃªncia e atualizaÃ§Ã£o.","pl":"DokÅadne dÅugi i naleÅ¼noÅci wybierasz podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory, przezroczystoÅÄ i odÅwieÅ¼anie.","nl":"De exacte schulden en tegoeden kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren, transparantie en updates.","ro":"Datoriile Èi creditele exacte se aleg cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile, transparenÈa Èi actualizarea.","el":"Î¤Î± Î±ÎºÏÎ¹Î²Î® ÏÏÎ­Î· ÎºÎ±Î¹ ÏÎ¹ÏÏÏÏÎµÎ¹Ï ÎµÏÎ¹Î»Î­Î³Î¿Î½ÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÏÎµ Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ±, Î´Î¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},"Grandezza testo":{"it":"Grandezza testo","en":"Text size","es":"TamaÃ±o del texto","fr":"Taille du texte","de":"TextgrÃ¶Ãe","pt":"Tamanho do texto","pl":"Rozmiar tekstu","nl":"Tekstgrootte","ro":"Dimensiune text","el":"ÎÎ­Î³ÎµÎ¸Î¿Ï ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Dimensione del contenuto mostrato nel widget.":{"it":"Dimensione del contenuto mostrato nel widget.","en":"Size of the content shown in the widget.","es":"TamaÃ±o del contenido mostrado en el widget.","fr":"Taille du contenu affichÃ© dans le widget.","de":"GrÃ¶Ãe des im Widget angezeigten Inhalts.","pt":"Tamanho do conteÃºdo mostrado no widget.","pl":"Rozmiar treÅci pokazywanej w widÅ¼ecie.","nl":"Grootte van de inhoud die in de widget wordt getoond.","ro":"Dimensiunea conÈinutului afiÈat Ã®n widget.","el":"ÎÎ­Î³ÎµÎ¸Î¿Ï ÏÎ¿Ï ÏÎµÏÎ¹ÎµÏÎ¿Î¼Î­Î½Î¿Ï ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget."},"Trasparenza sfondo widget":{"it":"Trasparenza sfondo widget","en":"Widget background transparency","es":"Transparencia del fondo del widget","fr":"Transparence du fond du widget","de":"Widget-Hintergrundtransparenz","pt":"TransparÃªncia do fundo do widget","pl":"PrzezroczystoÅÄ tÅa widÅ¼etu","nl":"Transparantie van widgetachtergrond","ro":"TransparenÈÄ fundal widget","el":"ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget"},"100% = completamente trasparente. 0% = sfondo pieno.":{"it":"100% = completamente trasparente. 0% = sfondo pieno.","en":"100% = fully transparent. 0% = solid background.","es":"100% = totalmente transparente. 0% = fondo sÃ³lido.","fr":"100 % = totalement transparent. 0 % = fond plein.","de":"100 % = vollstÃ¤ndig transparent. 0 % = voller Hintergrund.","pt":"100% = totalmente transparente. 0% = fundo sÃ³lido.","pl":"100% = caÅkowicie przezroczyste. 0% = peÅne tÅo.","nl":"100% = volledig transparant. 0% = volle achtergrond.","ro":"100% = complet transparent. 0% = fundal plin.","el":"100% = ÏÎ»Î®ÏÏÏ Î´Î¹Î±ÏÎ±Î½Î­Ï. 0% = ÏÎ»Î®ÏÎµÏ ÏÏÎ½ÏÎ¿."},"Aggiornamento automatico":{"it":"Aggiornamento automatico","en":"Automatic update","es":"ActualizaciÃ³n automÃ¡tica","fr":"Mise Ã  jour automatique","de":"Automatische Aktualisierung","pt":"AtualizaÃ§Ã£o automÃ¡tica","pl":"Automatyczna aktualizacja","nl":"Automatische update","ro":"Actualizare automatÄ","el":"ÎÏÏÏÎ¼Î±ÏÎ· ÎµÎ½Î·Î¼Î­ÏÏÏÎ·"},"Aggiorna i widget giÃ  installati quando cambi contenuti o impostazioni.":{"it":"Aggiorna i widget giÃ  installati quando cambi contenuti o impostazioni.","en":"Updates already installed widgets when you change content or settings.","es":"Actualiza los widgets ya instalados cuando cambias contenidos o ajustes.","fr":"Met Ã  jour les widgets dÃ©jÃ  installÃ©s lorsque vous changez du contenu ou des paramÃ¨tres.","de":"Aktualisiert bereits installierte Widgets, wenn du Inhalte oder Einstellungen Ã¤nderst.","pt":"Atualiza os widgets jÃ¡ instalados quando alteras conteÃºdos ou definiÃ§Ãµes.","pl":"Aktualizuje juÅ¼ zainstalowane widÅ¼ety po zmianie treÅci lub ustawieÅ.","nl":"Werkt al geÃ¯nstalleerde widgets bij wanneer je inhoud of instellingen wijzigt.","ro":"ActualizeazÄ widgeturile deja instalate cÃ¢nd schimbi conÈinutul sau setÄrile.","el":"ÎÎ½Î·Î¼ÎµÏÏÎ½ÎµÎ¹ ÏÎ± Î®Î´Î· ÎµÎ³ÎºÎ±ÏÎµÏÏÎ·Î¼Î­Î½Î± widget ÏÏÎ±Î½ Î±Î»Î»Î¬Î¶ÎµÏÎµ ÏÎµÏÎ¹ÎµÏÏÎ¼ÎµÎ½Î¿ Î® ÏÏÎ¸Î¼Î¯ÏÎµÎ¹Ï."},"Colore icona":{"it":"Colore icona","en":"Icon color","es":"Color del icono","fr":"Couleur de lâicÃ´ne","de":"Symbolfarbe","pt":"Cor do Ã­cone","pl":"Kolor ikony","nl":"Pictogramkleur","ro":"Culoare pictogramÄ","el":"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},"Colore titolo":{"it":"Colore titolo","en":"Title color","es":"Color del tÃ­tulo","fr":"Couleur du titre","de":"Titelfarbe","pt":"Cor do tÃ­tulo","pl":"Kolor tytuÅu","nl":"Titelkleur","ro":"Culoare titlu","el":"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},"Colore testo":{"it":"Colore testo","en":"Text color","es":"Color del texto","fr":"Couleur du texte","de":"Textfarbe","pt":"Cor do texto","pl":"Kolor tekstu","nl":"Tekstkleur","ro":"Culoare text","el":"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Progetto mostrato nel widget":{"it":"Progetto mostrato nel widget","en":"Project shown in the widget","es":"Proyecto mostrado en el widget","fr":"Projet affichÃ© dans le widget","de":"Im Widget angezeigtes Projekt","pt":"Projeto mostrado no widget","pl":"Projekt pokazany w widÅ¼ecie","nl":"Project getoond in de widget","ro":"Proiect afiÈat Ã®n widget","el":"ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"},"Salva e aggiorna widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"}};Object.keys(EXTRA_TRANSLATIONS_1633).forEach(function(x){D[x]=EXTRA_TRANSLATIONS_1633[x];});var WIDGET_ALIAS_TRANSLATIONS_1634={"Icon Color":{"it":"Colore icona","en":"Icon color","es":"Color del icono","fr":"Couleur de lâicÃ´ne","de":"Symbolfarbe","pt":"Cor do Ã­cone","pl":"Kolor ikony","nl":"Pictogramkleur","ro":"Culoare pictogramÄ","el":"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},"Title Color":{"it":"Colore titolo","en":"Title color","es":"Color del tÃ­tulo","fr":"Couleur du titre","de":"Titelfarbe","pt":"Cor do tÃ­tulo","pl":"Kolor tytuÅu","nl":"Titelkleur","ro":"Culoare titlu","el":"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},"Text Color":{"it":"Colore testo","en":"Text color","es":"Color del texto","fr":"Couleur du texte","de":"Textfarbe","pt":"Cor do texto","pl":"Kolor tekstu","nl":"Tekstkleur","ro":"Culoare text","el":"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Background Transparency":{"it":"Trasparenza sfondo widget","en":"Widget background transparency","es":"Transparencia del fondo del widget","fr":"Transparence du fond du widget","de":"Widget-Hintergrundtransparenz","pt":"TransparÃªncia do fundo do widget","pl":"PrzezroczystoÅÄ tÅa widÅ¼etu","nl":"Transparantie widgetachtergrond","ro":"TransparenÈÄ fundal widget","el":"ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget"},"Save and Update widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},"Save and update widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},"Show percentage":{"it":"Mostra percentuale","en":"Show percentage","es":"Mostrar porcentaje","fr":"Afficher le pourcentage","de":"Prozent anzeigen","pt":"Mostrar percentagem","pl":"PokaÅ¼ procent","nl":"Percentage tonen","ro":"AfiÈeazÄ procentul","el":"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},"Show amounts":{"it":"Mostra importi","en":"Show amounts","es":"Mostrar importes","fr":"Afficher les montants","de":"BetrÃ¤ge anzeigen","pt":"Mostrar valores","pl":"PokaÅ¼ kwoty","nl":"Bedragen tonen","ro":"AfiÈeazÄ sumele","el":"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÏÎ½"},"Bar color":{"it":"Colore barra","en":"Bar color","es":"Color de la barra","fr":"Couleur de la barre","de":"Balkenfarbe","pt":"Cor da barra","pl":"Kolor paska","nl":"Balkkleur","ro":"Culoarea barei","el":"Î§ÏÏÎ¼Î± Î³ÏÎ±Î¼Î¼Î®Ï"},"Percentage color":{"it":"Colore percentuale","en":"Percentage color","es":"Color del porcentaje","fr":"Couleur du pourcentage","de":"Prozentfarbe","pt":"Cor da percentagem","pl":"Kolor procentu","nl":"Percentagekleur","ro":"Culoarea procentului","el":"Î§ÏÏÎ¼Î± ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"}};Object.keys(WIDGET_ALIAS_TRANSLATIONS_1634).forEach(function(x){D[x]=WIDGET_ALIAS_TRANSLATIONS_1634[x];});var row=D[k];
  ...
  useEffect(function(){
    ...
    function repairMojibake(value){
      var raw=String(value==null?"":value);
      if(!/[ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½]/.test(raw))return raw;
      try{
        var decoded=decodeURIComponent(escape(raw));
        if(decoded&&decoded!==raw&&decoded.indexOf("ï¿½")<0)return decoded;
      }catch(e){}
      return raw;
    }
    function norm(v){return String(v||"").replace(/ï¿½/g,"").replace(/â|â|â|â|`/g,"'").replace(/â|ï¿½ï¿½|â|â/g,'"').normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").replace(/\s+/g," ").trim();}
    ...
    function tx(value){
      ...
      if(/^[\d\s.,:;â¬$%+\-()\/]+$/.test(trimmed))return raw;
      if(lang==="it"){
        ...
        if(nextIt&&nextIt!==trimmed&&String(nextIt).indexOf("ï¿½")<0)return raw.replace(trimmed,repairMojibake(String(nextIt)));
        return raw;
      }
  ...
  function monthShortName(index){
    var names={
      ...
      el:["ÎÎ±Î½","Î¦ÎµÎ²","ÎÎ±Ï","ÎÏÏ","ÎÎ±Î¹","ÎÎ¿ÏÎ½","ÎÎ¿ÏÎ»","ÎÏÎ³","Î£ÎµÏ","ÎÎºÏ","ÎÎ¿Îµ","ÎÎµÎº"]
    };
  ...
  function monthFullName(index){
    var names={
      ...
      el:["ÎÎ±Î½Î¿ÏÎ±ÏÎ¹Î¿Ï","Î¦ÎµÎ²ÏÎ¿ÏÎ±ÏÎ¹Î¿Ï","ÎÎ±ÏÏÎ¹Î¿Ï","ÎÏÏÎ¹Î»Î¹Î¿Ï","ÎÎ±Î¹Î¿Ï","ÎÎ¿ÏÎ½Î¹Î¿Ï","ÎÎ¿ÏÎ»Î¹Î¿Ï","ÎÏÎ³Î¿ÏÏÏÎ¿Ï","Î£ÎµÏÏÎµÎ¼Î²ÏÎ¹Î¿Ï","ÎÎºÏÏÎ²ÏÎ¹Î¿Ï","ÎÎ¿ÎµÎ¼Î²ÏÎ¹Î¿Ï","ÎÎµÎºÎµÎ¼Î²ÏÎ¹Î¿Ï"]
    };
    var list=names[lang]||names.en;
  ...
  function inferToastPresentation(text,base){
    ...
    if(isBlock){b.type="error";b.color="#E24B4A";b.icon=b.icon||"ð«";}
    else if(isWarn){b.type=b.type||"warning";b.color=b.color||"#EF9F27";b.icon=b.icon||"â ï¸";}
    else if(isSuccess){b.type=b.type||"success";b.color=b.color||"#1D9E75";b.icon=b.icon||"â";}
    return b;
  }
  ...
  function openVoiceModal(autoStart?:any){if(!canUsePlanFeature("voiceEntry",1)){setToast({text:upgradeMessage("voiceEntry"),type:"error",color:"#E24B4A",icon:"ð«"});return;}setVoiceModal(true);setVoiceText("");setVoiceParsed(null);setVoiceError("");setVoiceListening(false);}
  ...
  try{
    // 1.6.35: non nascondiamo piÃ¹ la UI a ogni cambio sezione.
  ...
  useEffect(function(){
    ...
    // Evita ritardi nelle aperture delle sezioni e regressioni su testi giÃ  corretti.
    try{
      if(typeof document!=="undefined")document.documentElement.removeAttribute("data-fainance-i18n");
    }catch(e){}
  },[lang]);
  ...
  var sym=(CURRENCIES.find(function(c){return c.code===currency;})||{symbol:"â¬"}).symbol;
  ...
  function bulkMovementCooldownText(){
    ...
    if(currentPlan==="base")return translateUiRuntimeText("Hai giÃ  usato un inserimento multiplo. Nel piano Base puoi usarne un altro tra 2 mesi, dal ")+dateText+".";
    return translateUiRuntimeText("Hai giÃ  usato un inserimento multiplo. Nel piano Gratis puoi usarne un altro tra 1 mese, dal ")+dateText+".";
  }
  ...
  function upgradeMessage(feature,currentCount){
    ...
    if(feature==="manualMovement")return tr("Limite giornaliero raggiunto. Hai giÃ  usato tutti i movimenti inclusi e quelli extra con annuncio.");
  ...
  function unlockRewardedFeature(feature,amount){
    ...
    if(g.state==="blocked"){setToast({text:g.text,type:"error",color:"#E24B4A",icon:"ð«"});return false;}
  ...
  function successToastForFeature(feature,label,usedAfterOverride){
    ...
    var lim=featureLimits(feature);
    if(lim.total===Infinity)return {text:label,type:"success",color:"#1D9E75",icon:"â"};
    ...
    if(usedAfter<included){
      if(feature==="manualMovement"){
        if(remainingIncluded===1&&rewarded>0)return {text:label+"\nTi resta 1 movimento gratuito oggi + "+extraAdText(rewarded)+".",type:"success",color:"#1D9E75",icon:"â"};
        return {text:label+"\nTi "+oneMany(remainingIncluded,"resta","restano")+" "+remainingIncluded+" "+oneMany(remainingIncluded,"movimento gratuito","movimenti gratuiti")+" oggi.",type:"success",color:"#1D9E75",icon:"â"};
      }
      if(remainingIncluded===1&&rewarded>0)return {text:label+"\nTi resta 1 "+unit+" inclusa "+period+" + "+extraAdText(rewarded)+".",type:"success",color:"#1D9E75",icon:"â"};
      return {text:label+"\nTi "+oneMany(remainingIncluded,"resta","restano")+" "+remainingIncluded+" "+unit+" "+oneMany(remainingIncluded,"inclusa","incluse")+" "+period+".",type:"success",color:"#1D9E75",icon:"â"};
    }
    if(usedAfter===included&&rewarded>0){
      if(feature==="manualMovement")return {text:label+"\nHai completato le transazioni gratuite. Ne hai ancora "+rewarded+" se guardi un annuncio.",type:"success",color:"#1D9E75",icon:"â"};
      if(feature==="voiceEntry")return {text:translateUiRuntimeText(label)+"\n"+translateUiRuntimeText("Hai terminato per oggi gli inserimenti vocali gratuiti. Te ne resta")+" "+rewarded+" "+translateUiRuntimeText("con annuncio."),translated:true,type:"success",color:"#1D9E75",icon:"â"};
      if(feature==="receiptScan")return {text:translateUiRuntimeText(label)+"\n"+translateUiRuntimeText("Hai terminato per oggi gli scontrini gratuiti. Te ne resta")+" "+rewarded+" "+translateUiRuntimeText("con annuncio."),translated:true,type:"success",color:"#1D9E75",icon:"â"};
      return {text:label+"\nHai completato le operazioni incluse per "+unit+". Ne hai ancora "+rewarded+" se guardi un annuncio.",type:"success",color:"#1D9E75",icon:"â"};
    }
    if(usedAfter<total){
      if(feature==="manualMovement")return {text:label+"\nTi resta "+remainingExtra+" movimento extra se guardi un annuncio.",type:"success",color:"#1D9E75",icon:"â"};
      return {text:label+"\nTi "+oneMany(remainingExtra,"resta","restano")+" "+remainingExtra+" "+unit+" extra se guardi un annuncio.",type:"success",color:"#1D9E75",icon:"â"};
    }
    if(feature==="manualMovement")return {text:label+"\nPer oggi non hai altre spese da inserire. Aspetta domani o passa a un altro piano.",type:"warning",color:"#EF9F27",icon:"â ï¸"};
    return {text:label+"\nHai usato tutte le operazioni disponibili per "+unit+" "+period+". Aspetta "+(featurePeriod(feature)==="monthly"?"il prossimo mese":"domani")+" o passa a un altro piano.",type:"warning",color:"#EF9F27",icon:"â ï¸"};
  }
  ...
  function purchasePlan(pid){
    ...
    if(!isNativeMobileApp()||!billing||!billing.purchase){
      setToast({text:L("Gli acquisti reali sono disponibili solo dallâapp installata dallo store."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
      return;
    }
    ...
    if(!productId){
      setToast({text:L("Configurazione acquisto non disponibile."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
      return;
    }
    ...
    billing.purchase({productId:productId,basePlanId:basePlanId,plan:pid,billingPeriod:period,platform:nativePlatform()})
      .then(function(res){
        if(res&&res.success){
          ...
          setToast({text:L("Piano aggiornato")+": "+planLabel(res.plan||pid,lang)+" Â· "+billingPeriodLabel(res.billingPeriod||period),type:"success",color:"#1D9E75",icon:"â"});
          setTimeout(function(){try{saveWidgetSettingsToNative(false,enforceWidgetPlanPayload(widgetSettingsPayload()));}catch(e){}},50);
        }else if(res&&res.cancelled){
          setToast({text:L("Acquisto annullato. Il piano resta invariato."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
        }else if(res&&res.pending){
          setToast({text:L("Acquisto in attesa di conferma dallo store."),type:"warning",color:"#EF9F27",icon:"â³"});
        }else{
          setToast({text:L("Acquisto non completato. Il piano resta invariato."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
        }
      })
      .catch(function(err){
        var msg=err&&err.message?err.message:String(err||"");
        setToast({text:L("Errore acquisto")+(msg?": "+msg:""),type:"error",color:"#E24B4A",icon:"â"});
      })
  ...
  function restorePurchases(){
    ...
    if(!isNativeMobileApp()||!billing||!billing.restorePurchases){
      setToast({text:L("Ripristino acquisti disponibile solo dallâapp installata dallo store."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
      return;
    }
    ...
    billing.restorePurchases({platform:nativePlatform()})
      .then(function(res){
        if(res&&res.success&&res.plan){
          ...
          setToast({text:L("Acquisti ripristinati")+": "+planLabel(res.plan,lang),type:"success",color:"#1D9E75",icon:"â"});
          setTimeout(function(){try{saveWidgetSettingsToNative(false,enforceWidgetPlanPayload(widgetSettingsPayload()));}catch(e){}},50);
        }else{
          setToast({text:L("Nessun abbonamento attivo trovato."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
        }
      })
      .catch(function(err){var msg=err&&err.message?err.message:String(err||"");setToast({text:L("Errore ripristino acquisti")+(msg?": "+msg:""),type:"error",color:"#E24B4A",icon:"â"});})
      .finally(function(){setPlanPurchaseLoading("");});
  }
  function showRewardedAdForExtraMovement(onReward){
    ...
    if(!isNativeMobileApp()||!ads||!ads.showRewarded){
      setToast({text:L("Annuncio non disponibile in questa versione. Installa lâapp dallo store e riprova."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
      return;
    }
    rewardedAdInProgressRef.current=true;
    requestAdConsentIfNeeded();
    setToast({text:L("Caricamento annuncio..."),type:"info",color:"#7F77DD",icon:"â³"});
    ads.showRewarded({adUnitId:currentRewardedAdUnitId()})
      .then(function(res){
        if(res&&res.rewarded){rewardedAdCompletedAtRef.current=Date.now();onReward();}
        else setToast({text:L("Annuncio non completato. Operazione extra non sbloccata."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
      })
      .catch(function(err){
        var msg=err&&err.message?err.message:String(err||"");
        setToast({text:L("Annuncio non disponibile")+(msg?": "+msg:""),type:"warning",color:"#EF9F27",icon:"â ï¸"});
      })
  ...
  function settingLockedMessage(requiredPlan){return "ð Impostazione non inclusa nel piano "+planLabel(currentPlan,lang)+". Disponibile dal piano "+settingPlanName(requiredPlan)+". Vai in Info per cambiare piano.";}
  function blockSetting(requiredPlan){if(settingAllowed(requiredPlan))return false;setToast({text:translateUiRuntimeText(settingLockedMessage(requiredPlan)),type:"error",color:"#E24B4A",icon:"ð«"});return true;}
  ...
  function handleRewardedFeature(feature,amount,onAllowed,label){
    ...
    if(g.state==="ad"){
      ...
      setToast({text:translateUiRuntimeText("Hai terminato le risposte gratuite incluse. Sta per partire un annuncio per sbloccare un messaggio extra.")+" "+translateUiRuntimeText("Messaggi extra disponibili con annuncio")+": "+left+".",type:"warning",color:"#EF9F27",icon:"ð¢",duration:1800});
  ...
  function useRewardedMovement(){
    ...
    setToast({text:g.text,type:"error",color:"#E24B4A",icon:"ð«"});
    return false;
  }
  function addExpenses(items,source){
    ...
    if(feature==="bulkMovement"){
      ...
      if(maxBulk!==Infinity&&list.length>maxBulk){setToast({text:translateUiRuntimeText("Puoi inserire al massimo ")+maxBulk+translateUiRuntimeText(" movimenti per volta."),type:"warning",color:"#EF9F27",icon:"â ï¸"});return false;}
    }
    if(!canUsePlanFeature(feature,amount)){setToast({text:upgradeMessage(feature),type:"error",color:"#E24B4A",icon:"ð«"});return false;}
    function save(){
  ...
  // ââ REAL-TIME ALERT: only fire popup for newly triggered and not-yet-seen alerts ââ
  ...
  function TopAdBox(){
    ...
    return <div ref={adBoxRef} style={{position:"relative",height:slotHeight,margin:showAppSummaryHeader?"8px 0 12px":"16px 0 12px",background:nativeBanner?(dark?"#171725":"#fff"):(dark?"#202033":"#F8FAFF"),border:nativeBanner?"1px solid transparent":"1px solid "+borderC,borderRadius:nativeBanner?0:10,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,overflow:"hidden",boxSizing:"border-box",pointerEvents:nativeBanner?"none":"auto"}}>
      {!nativeBanner&&<div style={{fontSize:12,color:subC,textAlign:"center",fontWeight:700}}>ð¢ {L("Spazio annuncio")}</div>}
  ...
  var ctxValue={
    // ââ GiÃ  presenti ââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ Tema / stile (usati dai pannelli) âââââââââââââââââââââââââââââââââ
    textC,subC,borderC,cardBg,inp,sb,bgColor,
    // ââ Navigazione e stato UI âââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ Statistiche ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    statsView,setStatsView,curYear,yearExp,yearInc,monthlyTotals,
    // ââ Filtri storico âââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ Firestore / auth ââââââââââââââââââââââââââââââââââââââââââââââââââââ
    firestoreReady,isOffline,userKey,userId,currentUser,
    // ââ Funzioni e ref condivisi usati dai pannelli estratti ââââââââââââââââ
    ...
    // ââ Valori calcolati ââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ Settings specifici âââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    // ââ AI floating ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    aiFloatingPos,setAiFloatingPos,aiFloatingDrag,setAiFloatingDrag,
    // ââ Widget Android âââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  function widgetSettingsPayload(){
    ...
    var lastText=last?(last.kind==="settlement"?"Ultimo saldo: "+fmt(Number(last.amount||0)):(last.desc||"Ultima spesa")+" Â· "+fmt(Number(last.amount||0))):"Nessuna attivitÃ  recente";
    return {
    ...
    var widgetShoppingLists=readWidgetLocalValue("shopping_lists_v2",[{id:"main",title:"Lista principale",icon:"ð§º"}]);
    if(!Array.isArray(widgetShoppingLists)||!widgetShoppingLists.length)widgetShoppingLists=[{id:"main",title:"Lista principale",icon:"ð§º"}];
    ...
    return {
      ...
      shoppingListWidget:{
        ...
        title:L("Lista spesa"),
        subtitle:L("Tocca un articolo quando Ã¨ nel carrello"),
        ...
        lists:widgetShoppingLists.map(function(l){return{id:String(l.id||"main"),title:String(l.title||l.name||"Lista"),icon:String(l.icon||"ð§º")};}),
      ...
      shareWidget:{
        ...
        lastActivity:selectedShareProject?(selectedShareProject.lastActivity||"Nessuna attivitÃ  recente"):"Nessuna attivitÃ  recente",
        currency:sym,
      ...
      goalWidget:{
        ...
        icon:selectedGoal?(selectedGoal.icon||"ð¯"):"ð¯",
        target:goalTarget,
        saved:goalSaved,
        percent:goalPct,
  ...
  function saveWidgetSettingsToNative(showMessage,overridePayload){
    ...
    try{
      ...
      var legacyQuickAddPayload={
        ...
        voiceIcon:(payload.quickAdd&&payload.quickAdd.voiceIcon)||"ðï¸",
        ...
        receiptIcon:(payload.quickAdd&&payload.quickAdd.receiptIcon)||"ð·",
      ...
      var fallbackSave=function(){
        ...
        if(prefs&&prefs.set){
          ...
          ]).then(afterSave).catch(function(){if(showMessage)setToast({text:"Errore salvataggio widget",type:"error",color:"#E24B4A",icon:"ð«"});});
        } else {
    ...
    }catch(e){if(showMessage)setToast({text:"Errore salvataggio widget",type:"error",color:"#E24B4A",icon:"ð«"});}
  }
  ...
  function AppuntiPanel(){
    ...
    function LimitReachedBox(){return <div style={{background:dark?"#4b3d1b":"#FFF3CD",border:"1px solid "+(dark?"#80672a":"#FFD54F"),borderRadius:12,padding:"10px 12px",fontSize:12,color:dark?"#FFE5A6":"#856404",fontWeight:800,lineHeight:1.4,marginBottom:12}}>â ï¸ {L("Hai raggiunto il limite massimo del tuo piano. Non puoi aggiungere altri elementi in questa sezione.")}</div>;}
    return <div style={{display:"flex",flexDirection:"column",gap:16}}>
      <div style={{background:documentsLimitReached?(dark?"#342b16":"#FFF8E1"):cardBg,borderRadius:14,border:"1px solid "+(documentsLimitReached?(dark?"#6a5520":"#FFD54F"):borderC),padding:20}}><div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:4}}>ð {L("Documenti")}</div><div style={{fontSize:12,color:documentsLimitReached?(dark?"#FFE5A6":"#856404"):subC,marginBottom:12}}>{documentsLimitReached?L("Hai raggiunto il limite massimo del tuo piano. Non puoi aggiungere altri elementi in questa sezione."):L("Carica PDF, immagini, Excel o CSV. I file vengono salvati nei dati dellâaccount.")}</div>{documentsLimitReached&&<LimitReachedBox/>}<input ref={fileInputRef} type="file" multiple accept=".pdf,.png,.jpg,.jpeg,.webp,.gif,.xls,.xlsx,.csv,image/*,application/pdf" style={{display:"none"}} onChange={handleFiles}/><Btn onClick={function(){if(documentsLimitReached)return;fileInputRef.current&&fileInputRef.current.click();}} bg={documentsLimitReached?"#999":"#7F77DD"} disabled={documentsLimitReached} style={{marginBottom:12}}>{L("+ Carica documento")}</Btn>{(!appuntiDocuments||appuntiDocuments.length===0)&&<div style={{fontSize:13,color:"#bbb",padding:"16px 0",textAlign:"center"}}>{L("Nessun documento caricato")}</div>}{(appuntiDocuments||[]).map(function(d){var isEditingDoc=editingDocumentId===d.id;return <div key={d.id} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 0",borderBottom:"1px solid "+borderC}}><span style={{fontSize:20}}>{/image/i.test(d.type)?"ð¼":/pdf/i.test(d.type)||/\.pdf$/i.test(d.name)?"ð":"ð"}</span><div style={{flex:1,minWidth:0}}>{isEditingDoc?<div style={{display:"flex",flexDirection:"column",gap:6}}><input value={documentNameDraft} onChange={function(e){setDocumentNameDraft(e.target.value);}} style={sinp}/><div style={{display:"flex",gap:6}}><Btn onClick={saveDocumentEdit} bg="#378ADD" style={{padding:"6px 10px",fontSize:12}}>{L("Salva")}</Btn><Btn onClick={cancelDocumentEdit} bg={dark?"#333":"#f0f0f0"} color={dark?"#eee":"#555"} style={{padding:"6px 10px",fontSize:12}}>{L("Annulla")}</Btn></div></div>:<><div style={{fontSize:13,fontWeight:600,color:textC,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{d.name}</div><div style={{fontSize:11,color:subC}}>{fmtSize(d.size)} Â· {d.createdAt?fmtDate(d.createdAt.slice(0,10),dateFmt):""}</div></>}</div>{!isEditingDoc&&d.dataUrl&&<button onClick={function(){var w=window.open();if(w)w.document.write('<iframe src="'+d.dataUrl+'" style="border:0;width:100%;height:100vh"></iframe>');}} style={{background:"none",border:"none",cursor:"pointer",color:"#7F77DD",fontSize:13}}>{L("Apri")}</button>}{!isEditingDoc&&<button onClick={function(){editDocument(d);}} style={{background:"#EEF4FF",border:"1px solid #BFD7FF",borderRadius:8,cursor:"pointer",color:"#378ADD",fontSize:14,padding:"5px 8px",fontWeight:700}}>âï¸</button>}<button onClick={function(){if(!window.confirm(L("Eliminare questo documento?")))return;if(editingDocumentId===d.id)cancelDocumentEdit();setAppuntiDocuments(function(p){return p.filter(function(x){return x.id!==d.id;});});setToast("Documento eliminato");}} style={{background:"#FFF0F0",border:"1px solid #FFD0D0",borderRadius:8,cursor:"pointer",color:"#E24B4A",fontSize:14,padding:"5px 8px",fontWeight:700}}>ðï¸</button></div>;})}</div>
      <div style={{background:notesLimitReached?(dark?"#342b16":"#FFF8E1"):cardBg,borderRadius:14,border:"1px solid "+(notesLimitReached?(dark?"#6a5520":"#FFD54F"):borderC),padding:20}}><div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:12}}>{L("ð Appunti di testo")}</div>{notesLimitReached&&<LimitReachedBox/>}<div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:12}}><input placeholder={L("Titolo")} value={noteTitle} onChange={function(e){setNoteTitle(e.target.value);}} style={sinp} disabled={notesLimitReached&&!editingNoteId}/><textarea placeholder={L("Scrivi un appunto...")} value={noteText} onChange={function(e){setNoteText(e.target.value);}} style={{...sinp,minHeight:90,resize:"vertical"}} disabled={notesLimitReached&&!editingNoteId}/><div style={{display:"flex",gap:8}}><Btn onClick={saveNote} bg={notesLimitReached?"#999":"#378ADD"} disabled={notesLimitReached&&!editingNoteId}>{L(editingNoteId?"Aggiorna appunto":"Salva appunto")}</Btn>{editingNoteId&&<Btn onClick={cancelNoteEdit} bg={dark?"#333":"#f0f0f0"} color={dark?"#eee":"#555"}>{L("Annulla")}</Btn>}</div></div>{(!appuntiNotes||appuntiNotes.length===0)&&<div style={{fontSize:13,color:"#bbb",padding:"12px 0",textAlign:"center"}}>{L("Nessun appunto")}</div>}{(appuntiNotes||[]).map(function(n){return <div key={n.id} style={{background:dark?"#1e1e30":"#f9f9f9",borderRadius:10,border:"1px solid "+borderC,padding:"10px 12px",marginBottom:8}}><div style={{display:"flex",gap:8,alignItems:"flex-start"}}><div style={{flex:1}}><div style={{fontSize:13,fontWeight:700,color:textC}}>{n.title}</div><div style={{fontSize:12,color:subC,whiteSpace:"pre-wrap",marginTop:4}}>{n.text}</div></div><button onClick={function(){editNote(n);}} style={{background:"#EEF4FF",border:"1px solid #BFD7FF",borderRadius:8,cursor:"pointer",color:"#378ADD",fontSize:14,padding:"5px 8px",fontWeight:700}}>âï¸</button><button onClick={function(){if(!window.confirm(L("Eliminare questa nota?")))return;if(widget2SelectedNoteId===n.id)setWidget2SelectedNoteId("");setAppuntiNotes(function(p){return p.filter(function(x){return x.id!==n.id;});});setToast(L("Nota eliminata"));}} style={{background:"#FFF0F0",border:"1px solid #FFD0D0",borderRadius:8,cursor:"pointer",color:"#E24B4A",fontSize:14,padding:"5px 8px",fontWeight:700}}>ðï¸</button></div></div>;})}</div>
      <div style={{background:bankLimitReached?(dark?"#342b16":"#FFF8E1"):cardBg,borderRadius:14,border:"1px solid "+(bankLimitReached?(dark?"#6a5520":"#FFD54F"):borderC),padding:20}}><div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:12}}>{L("ð¦ Coordinate bancarie")}</div>{bankLimitReached&&<LimitReachedBox/>}<div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:8,marginBottom:12}}><input placeholder={L("Banca")} value={bankForm.bank} onChange={function(e){setBankForm(function(p){return{...p,bank:e.target.value};});}} style={sinp} disabled={bankLimitReached&&!editingBankId}/><input placeholder={L("Intestatario")} value={bankForm.holder} onChange={function(e){setBankForm(function(p){return{...p,holder:e.target.value};});}} style={sinp} disabled={bankLimitReached&&!editingBankId}/><input placeholder="IBAN" value={bankForm.iban} onChange={function(e){setBankForm(function(p){return{...p,iban:e.target.value};});}} style={sinp} disabled={bankLimitReached&&!editingBankId}/><input placeholder="BIC/SWIFT" value={bankForm.bic} onChange={function(e){setBankForm(function(p){return{...p,bic:e.target.value};});}} style={sinp} disabled={bankLimitReached&&!editingBankId}/><input placeholder={L("Note")} value={bankForm.note} onChange={function(e){setBankForm(function(p){return{...p,note:e.target.value};});}} style={{...sinp,gridColumn:isMobile?"auto":"1 / -1"}} disabled={bankLimitReached&&!editingBankId}/></div><div style={{display:"flex",gap:8,marginBottom:12}}><Btn onClick={saveBank} bg={bankLimitReached?"#999":"#1D9E75"} disabled={bankLimitReached&&!editingBankId}>{L(editingBankId?"Aggiorna coordinate":"Salva coordinate")}</Btn>{editingBankId&&<Btn onClick={cancelBankEdit} bg={dark?"#333":"#f0f0f0"} color={dark?"#eee":"#555"}>{L("Annulla")}</Btn>}</div>{(!bankCoords||bankCoords.length===0)&&<div style={{fontSize:13,color:"#bbb",padding:"12px 0",textAlign:"center"}}>{L("Nessuna coordinata salvata")}</div>}{(bankCoords||[]).map(function(b){return <div key={b.id} style={{background:dark?"#1e1e30":"#f9f9f9",borderRadius:10,border:"1px solid "+borderC,padding:"10px 12px",marginBottom:8}}><div style={{display:"flex",gap:8,alignItems:"flex-start"}}><div style={{flex:1,minWidth:0}}><div style={{fontSize:13,fontWeight:700,color:textC}}>{b.bank||"Banca"}</div><div style={{fontSize:12,color:subC}}>{L("Intestatario")}: {b.holder||"â"}</div><div style={{fontSize:12,color:textC,wordBreak:"break-all",fontWeight:600}}>IBAN: {b.iban||"â"}</div><div style={{fontSize:12,color:subC}}>BIC/SWIFT: {b.bic||"â"}</div>{b.note&&<div style={{fontSize:12,color:subC,marginTop:4}}>{b.note}</div>}</div><button onClick={function(){editBank(b);}} style={{background:"#EEF4FF",border:"1px solid #BFD7FF",borderRadius:8,cursor:"pointer",color:"#378ADD",fontSize:14,padding:"5px 8px",fontWeight:700}}>âï¸</button><button onClick={function(){if(!window.confirm(L("Eliminare questa coordinata bancaria?")))return;if(widget2SelectedBankId===b.id)setWidget2SelectedBankId("");setBankCoords(function(p){return p.filter(function(x){return x.id!==b.id;});});setToast("Coordinata bancaria eliminata");}} style={{background:"#FFF0F0",border:"1px solid #FFD0D0",borderRadius:8,cursor:"pointer",color:"#E24B4A",fontSize:14,padding:"5px 8px",fontWeight:700}}>ðï¸</button></div></div>;})}</div>
    </div>;
  }
  ...
  function TermsAndConditionsContent(){
    ...
    var rows=[
      {title:"Ambito dellâapp",text:"fAInance Ã¨ uno strumento personale per registrare, organizzare e analizzare entrate, uscite, budget, patrimonio, obiettivi, alert, appunti e dati collegati alla gestione finanziaria personale."},
      {title:"Agente AI",text:"Il Consulente AI aiuta a interpretare i dati inseriti nellâapp e a proporre spunti pratici di risparmio, controllo spese e organizzazione. Le risposte hanno finalitÃ  informative e organizzative."},
      {title:"Nessuna consulenza professionale",text:"Le analisi e i consigli dellâapp non costituiscono consulenza finanziaria, fiscale, legale, patrimoniale o professionale. Le decisioni restano sempre responsabilitÃ  dellâutente."},
      {title:"Dati inseriti dallâutente",text:"Lâutente Ã¨ responsabile della correttezza dei dati inseriti. Se i dati sono incompleti, errati o non aggiornati, anche statistiche, alert, budget e risposte AI possono risultare imprecisi."},
      {title:"Backup e conservazione dati",text:"Lâutente deve eseguire backup periodici prima di aggiornamenti, reinstallazioni, cambi dispositivo o modifiche importanti. Lâapp offre strumenti di esportazione e ripristino, ma non garantisce il recupero automatico di dati cancellati manualmente."},
      {title:"Uso personale",text:"fAInance Ã¨ pensata per uso personale e dimostrativo. Non deve essere usata come unico strumento per decisioni economiche rilevanti, dichiarazioni fiscali, investimenti o obblighi contabili professionali."},
      {title:"Aggiornamenti",text:"Le funzionalitÃ , i testi, i limiti dellâAgente AI e questi termini possono essere aggiornati nelle versioni successive dellâapp."}
    ];
    return <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}><span style={{fontSize:24}}>ð</span><div style={{fontSize:18,fontWeight:800,color:textC}}>{L("Termini di utilizzo")}</div></div>
        <div style={{fontSize:13,color:subC,lineHeight:1.55}}>{L("Usando fAInance accetti che lâapp sia uno strumento di supporto alla gestione personale dei tuoi dati finanziari e non un servizio di consulenza professionale.")}</div>
      </div>
      ...
      <div style={{background:dark?"#24213a":"#F0EDFF",borderRadius:14,border:"1px solid "+(dark?"#3d376a":"#D8D2FF"),padding:16}}>
        <div style={{fontSize:13,color:dark?"#BEB8FF":"#534AB7",lineHeight:1.55,fontWeight:600}}>{L("Versione termini: 1.0 Â· Ultimo aggiornamento: 25/05/2026")}</div>
      </div>
    </div>;
  }
  ...
  function PrivacyPolicyContent(){
    function L(s){return translateUiRuntimeText(s);}
    var rows=[
      {title:"Dati trattati",text:"fAInance puÃ² salvare i dati che inserisci nellâapp, come entrate, uscite, categorie, metodi di pagamento, ricorrenze, budget, patrimonio, obiettivi, alert, appunti, documenti caricati e coordinate bancarie salvate volontariamente."},
      {title:"Account e accesso",text:"Se accedi con email/password, Google o Apple, vengono usati i dati necessari allâautenticazione, come identificativo utente, email e nome profilo. Lâaccesso Ã¨ gestito tramite Firebase Authentication."},
      {title:"Salvataggio e sincronizzazione",text:"I dati dellâapp possono essere salvati localmente sul dispositivo e, per gli utenti autenticati, sincronizzati su Firestore/Firebase per consentire backup e recupero dei dati collegati allâaccount."},
      {title:"Uso dellâAgente AI",text:"Quando usi il Consulente AI, la domanda e i dati finanziari necessari allâanalisi possono essere inviati al servizio AI collegato allâapp per generare la risposta. Ã consigliabile non inserire dati non necessari o informazioni troppo sensibili nelle domande libere."},
      {title:"FinalitÃ ",text:"I dati vengono usati per fornire le funzionalitÃ  dellâapp: registrazione movimenti, statistiche, budget, alert, patrimonio, backup, sincronizzazione e analisi tramite AI."},
      {title:"ResponsabilitÃ  dellâutente",text:"Lâutente decide quali dati inserire, caricare o cancellare. Prima di salvare documenti, note o coordinate bancarie, valuta se siano davvero necessari per lâuso personale dellâapp."},
      {title:"Cancellazione dati",text:"Lâapp include funzioni per eliminare dati per sezione o cancellare informazioni salvate. Alcuni dati potrebbero restare in backup o cache tecniche fino ai normali tempi di aggiornamento dei servizi utilizzati."},
      {title:"Servizi terzi",text:"Lâapp puÃ² usare servizi esterni come Firebase, Firestore, autenticazione Google/Apple, API di cambio valuta e servizi AI. Ogni servizio puÃ² applicare proprie regole tecniche e privacy."},
      {title:"Aggiornamenti",text:"Questa informativa puÃ² essere aggiornata quando cambiano funzionalitÃ , servizi tecnici, modalitÃ  di sincronizzazione o uso dellâAgente AI."}
    ];
    return <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}><span style={{fontSize:24}}>ð</span><div style={{fontSize:18,fontWeight:800,color:textC}}>{L("Informativa Privacy")}</div></div>
        <div style={{fontSize:13,color:subC,lineHeight:1.55}}>{L("Questa informativa spiega in modo sintetico quali dati possono essere gestiti da fAInance e per quali finalitÃ  vengono usati.")}</div>
      </div>
      {rows.map(function(r){return <div key={r.title} style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:16}}>
        <div style={{fontSize:14,fontWeight:800,color:textC,marginBottom:6}}>{L(r.title)}</div>
        <div style={{fontSize:13,color:subC,lineHeight:1.55}}>{L(r.text)}</div>
      ...
      <div style={{background:dark?"#24213a":"#F0EDFF",borderRadius:14,border:"1px solid "+(dark?"#3d376a":"#D8D2FF"),padding:16}}>
        <div style={{fontSize:13,color:dark?"#BEB8FF":"#534AB7",lineHeight:1.55,fontWeight:600}}>{L("Versione privacy: 1.0 Â· Ultimo aggiornamento: 25/05/2026")}</div>
      </div>
    </div>;
  }
    ...
    function LegalDetail({type}){
      ...
      return <div>
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:12}}>
          <button onClick={function(){setLegalView("main");}} style={{border:"1px solid "+borderC,background:dark?"#252535":"#f5f5f5",color:textC,borderRadius:10,padding:"8px 12px",fontSize:13,fontWeight:700,cursor:"pointer"}}>â¹ Indietro</button>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12,marginBottom:16}}>
          ...
          <div style={{background:dark?"#1e1e30":"#f9f9f9",borderRadius:14,border:"1px solid "+borderC,padding:14}}>
            <label style={{display:"flex",alignItems:"flex-start",gap:10,cursor:"pointer"}}>
              ...
              <span style={{fontSize:13,color:textC,lineHeight:1.45}}>{translateUiRuntimeText("Dichiaro di aver letto e accettato lâInformativa Privacy")} <span style={{color:"#E24B4A"}}>*</span></span>
            </label>
            <button onClick={function(){setLegalView("privacy");}} style={{background:"transparent",border:"none",color:dark?"#BEB8FF":"#378ADD",padding:"8px 0 0 28px",fontSize:13,fontWeight:700,cursor:"pointer",textAlign:"left"}}>{translateUiRuntimeText("Leggi lâInformativa Privacy")}</button>
          </div>
        </div>
  ...
  var settingsSections=[
    {id:"profile",icon:"ð¤",label:translateUiRuntimeText("Profilo"),desc:translateUiRuntimeText("Dati personali, account, accesso")},
    {id:"general",icon:"ð",label:translateUiRuntimeText("Generale"),desc:translateUiRuntimeText("Lingua, formato data, metriche, valute e IA")},
    {id:"appearance",icon:"ð¨",label:translateUiRuntimeText("Aspetto"),desc:translateUiRuntimeText("Tema, colori, stile pulsanti e widget")},
    {id:"sections",icon:"ð§©",label:translateUiRuntimeText("Sezioni"),desc:translateUiRuntimeText("Entrate, uscite, patrimonio e storico")},
    {id:"notifications",icon:"ð",label:translateUiRuntimeText("Notifiche e Promemoria"),desc:translateUiRuntimeText("Promemoria inserimento, notifiche custom")},
    {id:"delete",icon:"ð¾",label:translateUiRuntimeText("Dati"),desc:translateUiRuntimeText("Importa, esporta, backup, elimina")},
    {id:"support",icon:"ð",label:translateUiRuntimeText("Supporto"),desc:translateUiRuntimeText("FAQ, tutorial, sito web, contatti")},
    {id:"info",icon:"â¹ï¸",label:translateUiRuntimeText("Info app"),desc:translateUiRuntimeText("Versione, piano, aggiornamenti e termini")},
  ];
  ...
  function voiceLabel(){return (TRANSLATIONS[lang]&&TRANSLATIONS[lang].voice)||({it:"Voce",en:"Voice",es:"Voz",fr:"Voix",de:"Stimme",pt:"Voz",pl:"GÅos",nl:"Stem",ro:"Voce",el:"Î¦ÏÎ½Î®"}[lang]||"Voice");}
  function sectionLabel(id){
    var dict={
      ...
      es:{home:"Inicio",spese:"Movimientos",history:"Historial",stats:"EstadÃ­sticas",appunti:"Notas",voice:"Voz",share:"Share",debtCredits:"Deudas / CrÃ©ditos",shopping:"Compra",consulenteAI:"Asesor IA",patrimonio:"Patrimonio",budget:"Presupuesto",goals:"Objetivos",alerts:"Alertas",settings:"Ajustes",more:"MÃ¡s"},
      fr:{home:"Accueil",spese:"Mouvements",history:"Historique",stats:"Statistiques",appunti:"Notes",voice:"Voix",share:"Share",debtCredits:"Dettes / CrÃ©ances",shopping:"Courses",consulenteAI:"Conseiller IA",patrimonio:"Patrimoine",budget:"Budget",goals:"Objectifs",alerts:"Alertes",settings:"ParamÃ¨tres",more:"Plus"},
      de:{home:"Startseite",spese:"Buchungen",history:"Verlauf",stats:"Statistiken",appunti:"Notizen",voice:"Stimme",share:"Share",debtCredits:"Schulden / Forderungen",shopping:"Einkauf",consulenteAI:"KI-Berater",patrimonio:"VermÃ¶gen",budget:"Budget",goals:"Ziele",alerts:"Warnungen",settings:"Einstellungen",more:"Andere"},
      pt:{home:"InÃ­cio",spese:"Movimentos",history:"HistÃ³rico",stats:"EstatÃ­sticas",appunti:"Apontamentos",voice:"Voz",share:"Share",debtCredits:"DÃ­vidas / CrÃ©ditos",shopping:"Compras",consulenteAI:"Consultor IA",patrimonio:"PatrimÃ³nio",budget:"OrÃ§amento",goals:"Objetivos",alerts:"Alertas",settings:"DefiniÃ§Ãµes",more:"Mais"},
      pl:{home:"Start",spese:"Ruchy",history:"Historia",stats:"Statystyki",appunti:"Notatki",voice:"GÅos",share:"Share",debtCredits:"DÅugi / NaleÅ¼noÅci",shopping:"Zakupy",consulenteAI:"Doradca AI",patrimonio:"MajÄtek",budget:"BudÅ¼et",goals:"Cele",alerts:"Alerty",settings:"Ustawienia",more:"WiÄcej"},
      ...
      ro:{home:"AcasÄ",spese:"MiÈcÄri",history:"Istoric",stats:"Statistici",appunti:"NotiÈe",voice:"Voce",share:"Share",debtCredits:"Datorii / CreanÈe",shopping:"CumpÄrÄturi",consulenteAI:"Consilier AI",patrimonio:"Patrimoniu",budget:"Buget",goals:"Obiective",alerts:"Alerte",settings:"SetÄri",more:"Mai mult"},
      el:{home:"ÎÏÏÎ¹ÎºÎ®",spese:"ÎÎ¹Î½Î®ÏÎµÎ¹Ï",history:"ÎÏÏÎ¿ÏÎ¹ÎºÏ",stats:"Î£ÏÎ±ÏÎ¹ÏÏÎ¹ÎºÎ¬",appunti:"Î£Î·Î¼ÎµÎ¹ÏÏÎµÎ¹Ï",voice:"Î¦ÏÎ½Î®",share:"Share",debtCredits:"Î§ÏÎ­Î· / Î Î¹ÏÏÏÏÎµÎ¹Ï",shopping:"ÎÎ³Î¿ÏÎ­Ï",consulenteAI:"Î£ÏÎ¼Î²Î¿ÏÎ»Î¿Ï AI",patrimonio:"Î ÎµÏÎ¹Î¿ÏÏÎ¯Î±",budget:"Î ÏÎ¿ÏÏÎ¿Î»Î¿Î³Î¹ÏÎ¼ÏÏ",goals:"Î£ÏÏÏÎ¿Î¹",alerts:"ÎÎ¹Î´Î¿ÏÎ¿Î¹Î®ÏÎµÎ¹Ï",settings:"Î¡ÏÎ¸Î¼Î¯ÏÎµÎ¹Ï",more:"Î ÎµÏÎ¹ÏÏÏÏÎµÏÎ±"}
    };
    return (dict[lang]&&dict[lang][id])||(dict.it[id]||id);
  }
  function allNavDefs(){return{
    home:{id:"home",icon:"ð ",label:sectionLabel("home")},spese:{id:"spese",icon:"ð¸",label:sectionLabel("spese"),badge:pendingCount},history:{id:"history",icon:"ð",label:sectionLabel("history")},stats:{id:"stats",icon:"ð",label:sectionLabel("stats")},appunti:{id:"appunti",icon:"ð",label:sectionLabel("appunti")},voice:{id:"voice",icon:"ðï¸",label:sectionLabel("voice")},share:{id:"share",icon:"ð¤",label:"Share"},debtCredits:{id:"debtCredits",icon:"ð³",label:sectionLabel("debtCredits")},shopping:{id:"shopping",icon:"ð",label:sectionLabel("shopping")},consulenteAI:{id:"consulenteAI",icon:<AIGrilloIcon size={28}/>,label:sectionLabel("consulenteAI")},patrimonio:{id:"patrimonio",icon:"ð",label:sectionLabel("patrimonio")},budget:{id:"budget",icon:"ð°",label:sectionLabel("budget")},goals:{id:"goals",icon:"ð¯",label:sectionLabel("goals")},alerts:{id:"alerts",icon:"ð",label:sectionLabel("alerts"),badge:alertTriggered},settings:{id:"settings",icon:"â",label:sectionLabel("settings")},more:{id:"more",icon:"â°",label:sectionLabel("more"),badge:alertTriggered}
  };}
  ...
  function SettingsPanel(){
    ...
    function translateWidgetSettingsText(value){
      ...
      var widgetExactAlias={
        "Icon Color":{it:"Colore icona",en:"Icon color",es:"Color del icono",fr:"Couleur de lâicÃ´ne",de:"Symbolfarbe",pt:"Cor do Ã­cone",pl:"Kolor ikony",nl:"Pictogramkleur",ro:"Culoarea pictogramei",el:"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},
        "Icon color":{it:"Colore icona",en:"Icon color",es:"Color del icono",fr:"Couleur de lâicÃ´ne",de:"Symbolfarbe",pt:"Cor do Ã­cone",pl:"Kolor ikony",nl:"Pictogramkleur",ro:"Culoarea pictogramei",el:"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},
        "Title Color":{it:"Colore titolo",en:"Title color",es:"Color del tÃ­tulo",fr:"Couleur du titre",de:"Titelfarbe",pt:"Cor do tÃ­tulo",pl:"Kolor tytuÅu",nl:"Titelkleur",ro:"Culoarea titlului",el:"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},
        "Title color":{it:"Colore titolo",en:"Title color",es:"Color del tÃ­tulo",fr:"Couleur du titre",de:"Titelfarbe",pt:"Cor do tÃ­tulo",pl:"Kolor tytuÅu",nl:"Titelkleur",ro:"Culoarea titlului",el:"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},
        "Text Color":{it:"Colore testo",en:"Text color",es:"Color del texto",fr:"Couleur du texte",de:"Textfarbe",pt:"Cor do texto",pl:"Kolor tekstu",nl:"Tekstkleur",ro:"Culoarea textului",el:"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},
        "Text color":{it:"Colore testo",en:"Text color",es:"Color del texto",fr:"Couleur du texte",de:"Textfarbe",pt:"Cor do texto",pl:"Kolor tekstu",nl:"Tekstkleur",ro:"Culoarea textului",el:"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},
        "Background Transparency":{it:"Trasparenza sfondo widget",en:"Widget background transparency",es:"Transparencia del fondo del widget",fr:"Transparence du fond du widget",de:"Widget-Hintergrundtransparenz",pt:"TransparÃªncia do fundo do widget",pl:"PrzezroczystoÅÄ tÅa widÅ¼etu",nl:"Transparantie widgetachtergrond",ro:"TransparenÈÄ fundal widget",el:"ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget"},
        "Background transparency":{it:"Trasparenza sfondo widget",en:"Widget background transparency",es:"Transparencia del fondo del widget",fr:"Transparence du fond du widget",de:"Widget-Hintergrundtransparenz",pt:"TransparÃªncia do fundo do widget",pl:"PrzezroczystoÅÄ tÅa widÅ¼etu",nl:"Transparantie widgetachtergrond",ro:"TransparenÈÄ fundal widget",el:"ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget"},
        "Save and Update widget":{it:"Salva e aggiorna widget",en:"Save and update widget",es:"Guardar y actualizar widget",fr:"Enregistrer et mettre Ã  jour le widget",de:"Widget speichern und aktualisieren",pt:"Guardar e atualizar widget",pl:"Zapisz i zaktualizuj widÅ¼et",nl:"Widget opslaan en bijwerken",ro:"SalveazÄ Èi actualizeazÄ widgetul",el:"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},
        "Save and update widget":{it:"Salva e aggiorna widget",en:"Save and update widget",es:"Guardar y actualizar widget",fr:"Enregistrer et mettre Ã  jour le widget",de:"Widget speichern und aktualisieren",pt:"Guardar e atualizar widget",pl:"Zapisz i zaktualizuj widÅ¼et",nl:"Widget opslaan en bijwerken",ro:"SalveazÄ Èi actualizeazÄ widgetul",el:"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},
        "SAVE AND UPDATE WIDGET":{it:"SALVA E AGGIORNA WIDGET",en:"SAVE AND UPDATE WIDGET",es:"GUARDAR Y ACTUALIZAR WIDGET",fr:"ENREGISTRER ET METTRE Ã JOUR LE WIDGET",de:"WIDGET SPEICHERN UND AKTUALISIEREN",pt:"GUARDAR E ATUALIZAR WIDGET",pl:"ZAPISZ I ZAKTUALIZUJ WIDÅ»ET",nl:"WIDGET OPSLAAN EN BIJWERKEN",ro:"SALVEAZÄ ÈI ACTUALIZEAZÄ WIDGETUL",el:"ÎÎ ÎÎÎÎÎÎ¥Î£Î ÎÎÎ ÎÎÎÎÎÎ¡Î©Î£Î WIDGET"},
        "Show percentage":{it:"Mostra percentuale",en:"Show percentage",es:"Mostrar porcentaje",fr:"Afficher le pourcentage",de:"Prozentsatz anzeigen",pt:"Mostrar percentagem",pl:"PokaÅ¼ procent",nl:"Percentage tonen",ro:"AfiÈeazÄ procentul",el:"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},
        "Show amounts":{it:"Mostra importi",en:"Show amounts",es:"Mostrar importes",fr:"Afficher les montants",de:"BetrÃ¤ge anzeigen",pt:"Mostrar valores",pl:"PokaÅ¼ kwoty",nl:"Bedragen tonen",ro:"AfiÈeazÄ sumele",el:"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÏÎ½"},
        "Bar color":{it:"Colore barra",en:"Bar color",es:"Color de la barra",fr:"Couleur de la barre",de:"Balkenfarbe",pt:"Cor da barra",pl:"Kolor paska",nl:"Balkkleur",ro:"Culoarea barei",el:"Î§ÏÏÎ¼Î± Î³ÏÎ±Î¼Î¼Î®Ï"},
        "Percentage color":{it:"Colore percentuale",en:"Percentage color",es:"Color del porcentaje",fr:"Couleur du pourcentage",de:"Prozentfarbe",pt:"Cor da percentagem",pl:"Kolor procentu",nl:"Percentagekleur",ro:"Culoarea procentului",el:"Î§ÏÏÎ¼Î± ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"}
      };
      var aliasRow=widgetExactAlias[raw]||widgetExactAlias[raw.trim()];
      if(aliasRow&&aliasRow[code])return aliasRow[code];
      var D={
        "Saldo":{it:"Saldo",en:"Balance",es:"Saldo",fr:"Solde",de:"Kontostand",pt:"Saldo",pl:"Saldo",nl:"Balans",ro:"Sold",el:"Î¥ÏÏÎ»Î¿Î¹ÏÎ¿"},
        "Balance":{it:"Saldo",en:"Balance",es:"Saldo",fr:"Solde",de:"Kontostand",pt:"Saldo",pl:"Saldo",nl:"Balans",ro:"Sold",el:"Î¥ÏÏÎ»Î¿Î¹ÏÎ¿"},
        "+ Spesa":{it:"+ Spesa",en:"+ Expense",es:"+ Gasto",fr:"+ DÃ©pense",de:"+ Ausgabe",pt:"+ Despesa",pl:"+ Wydatek",nl:"+ Uitgave",ro:"+ CheltuialÄ",el:"+ ÎÎ¾Î¿Î´Î¿"},
        "+ Expense":{it:"+ Spesa",en:"+ Expense",es:"+ Gasto",fr:"+ DÃ©pense",de:"+ Ausgabe",pt:"+ Despesa",pl:"+ Wydatek",nl:"+ Uitgave",ro:"+ CheltuialÄ",el:"+ ÎÎ¾Î¿Î´Î¿"},
        "Spesa":{it:"Spesa",en:"Expense",es:"Gasto",fr:"DÃ©pense",de:"Ausgabe",pt:"Despesa",pl:"Wydatek",nl:"Uitgave",ro:"CheltuialÄ",el:"ÎÎ¾Î¿Î´Î¿"},
        "Expense":{it:"Spesa",en:"Expense",es:"Gasto",fr:"DÃ©pense",de:"Ausgabe",pt:"Despesa",pl:"Wydatek",nl:"Uitgave",ro:"CheltuialÄ",el:"ÎÎ¾Î¿Î´Î¿"},
        "Salva e aggiorna widget":{it:"Salva e aggiorna widget",en:"Save and update widget",es:"Guardar y actualizar widget",fr:"Enregistrer et mettre Ã  jour le widget",de:"Widget speichern und aktualisieren",pt:"Guardar e atualizar widget",pl:"Zapisz i zaktualizuj widÅ¼et",nl:"Widget opslaan en bijwerken",ro:"SalveazÄ Èi actualizeazÄ widgetul",el:"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},
        "Save and update widget":{it:"Salva e aggiorna widget",en:"Save and update widget",es:"Guardar y actualizar widget",fr:"Enregistrer et mettre Ã  jour le widget",de:"Widget speichern und aktualisieren",pt:"Guardar e atualizar widget",pl:"Zapisz i zaktualizuj widÅ¼et",nl:"Widget opslaan en bijwerken",ro:"SalveazÄ Èi actualizeazÄ widgetul",el:"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},
        "Mostra percentuale":{it:"Mostra percentuale",en:"Show percentage",es:"Mostrar porcentaje",fr:"Afficher le pourcentage",de:"Prozentsatz anzeigen",pt:"Mostrar percentagem",pl:"PokaÅ¼ procent",nl:"Percentage tonen",ro:"AfiÈeazÄ procentul",el:"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},
        "Show percentage":{it:"Mostra percentuale",en:"Show percentage",es:"Mostrar porcentaje",fr:"Afficher le pourcentage",de:"Prozentsatz anzeigen",pt:"Mostrar percentagem",pl:"PokaÅ¼ procent",nl:"Percentage tonen",ro:"AfiÈeazÄ procentul",el:"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},
        "Mostra importi":{it:"Mostra importi",en:"Show amounts",es:"Mostrar importes",fr:"Afficher les montants",de:"BetrÃ¤ge anzeigen",pt:"Mostrar valores",pl:"PokaÅ¼ kwoty",nl:"Bedragen tonen",ro:"AfiÈeazÄ sumele",el:"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÏÎ½"},
        "Show amounts":{it:"Mostra importi",en:"Show amounts",es:"Mostrar importes",fr:"Afficher les montants",de:"BetrÃ¤ge anzeigen",pt:"Mostrar valores",pl:"PokaÅ¼ kwoty",nl:"Bedragen tonen",ro:"AfiÈeazÄ sumele",el:"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÏÎ½"},
        "Colore barra/icona":{it:"Colore barra/icona",en:"Bar/icon color",es:"Color de barra/icono",fr:"Couleur de la barre/icÃ´ne",de:"Balken-/Symbolfarbe",pt:"Cor da barra/Ã­cone",pl:"Kolor paska/ikony",nl:"Kleur van balk/pictogram",ro:"Culoarea barei/pictogramei",el:"Î§ÏÏÎ¼Î± Î¼ÏÎ¬ÏÎ±Ï/ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},
        "Bar/icon color":{it:"Colore barra/icona",en:"Bar/icon color",es:"Color de barra/icono",fr:"Couleur de la barre/icÃ´ne",de:"Balken-/Symbolfarbe",pt:"Cor da barra/Ã­cone",pl:"Kolor paska/ikony",nl:"Kleur van balk/pictogram",ro:"Culoarea barei/pictogramei",el:"Î§ÏÏÎ¼Î± Î¼ÏÎ¬ÏÎ±Ï/ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},
        "Colore testo":{it:"Colore testo",en:"Text color",es:"Color del texto",fr:"Couleur du texte",de:"Textfarbe",pt:"Cor do texto",pl:"Kolor tekstu",nl:"Tekstkleur",ro:"Culoarea textului",el:"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},
        "Text color":{it:"Colore testo",en:"Text color",es:"Color del texto",fr:"Couleur du texte",de:"Textfarbe",pt:"Cor do texto",pl:"Kolor tekstu",nl:"Tekstkleur",ro:"Culoarea textului",el:"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},
        "Colore percentuale":{it:"Colore percentuale",en:"Percentage color",es:"Color del porcentaje",fr:"Couleur du pourcentage",de:"Prozentfarbe",pt:"Cor da percentagem",pl:"Kolor procentu",nl:"Kleur van percentage",ro:"Culoarea procentului",el:"Î§ÏÏÎ¼Î± ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},
        "Percentage color":{it:"Colore percentuale",en:"Percentage color",es:"Color del porcentaje",fr:"Couleur du pourcentage",de:"Prozentfarbe",pt:"Cor da percentagem",pl:"Kolor procentu",nl:"Kleur van percentage",ro:"Culoarea procentului",el:"Î§ÏÏÎ¼Î± ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},
        "Colore icona":{it:"Colore icona",en:"Icon color",es:"Color del icono",fr:"Couleur de lâicÃ´ne",de:"Symbolfarbe",pt:"Cor do Ã­cone",pl:"Kolor ikony",nl:"Pictogramkleur",ro:"Culoarea pictogramei",el:"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},
        "Icon color":{it:"Colore icona",en:"Icon color",es:"Color del icono",fr:"Couleur de lâicÃ´ne",de:"Symbolfarbe",pt:"Cor do Ã­cone",pl:"Kolor ikony",nl:"Pictogramkleur",ro:"Culoarea pictogramei",el:"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},
        "Colore titolo":{it:"Colore titolo",en:"Title color",es:"Color del tÃ­tulo",fr:"Couleur du titre",de:"Titelfarbe",pt:"Cor do tÃ­tulo",pl:"Kolor tytuÅu",nl:"Titelkleur",ro:"Culoarea titlului",el:"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},
        "Title color":{it:"Colore titolo",en:"Title color",es:"Color del tÃ­tulo",fr:"Couleur du titre",de:"Titelfarbe",pt:"Cor do tÃ­tulo",pl:"Kolor tytuÅu",nl:"Titelkleur",ro:"Culoarea titlului",el:"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},
        "Colore + Spesa":{it:"Colore + Spesa",en:"Expense button color",es:"Color del botÃ³n de gasto",fr:"Couleur du bouton de dÃ©pense",de:"Farbe der Ausgaben-SchaltflÃ¤che",pt:"Cor do botÃ£o de despesa",pl:"Kolor przycisku wydatku",nl:"Kleur van de uitgavenknop",ro:"Culoarea butonului de cheltuialÄ",el:"Î§ÏÏÎ¼Î± ÎºÎ¿ÏÎ¼ÏÎ¹Î¿Ï ÎµÎ¾ÏÎ´Î¿Ï"},
        "Color + Expense":{it:"Colore + Spesa",en:"Expense button color",es:"Color del botÃ³n de gasto",fr:"Couleur du bouton de dÃ©pense",de:"Farbe der Ausgaben-SchaltflÃ¤che",pt:"Cor do botÃ£o de despesa",pl:"Kolor przycisku wydatku",nl:"Kleur van de uitgavenknop",ro:"Culoarea butonului de cheltuialÄ",el:"Î§ÏÏÎ¼Î± ÎºÎ¿ÏÎ¼ÏÎ¹Î¿Ï ÎµÎ¾ÏÎ´Î¿Ï"},
        "Color + Uitgave":{it:"Colore + Spesa",en:"Expense button color",es:"Color del botÃ³n de gasto",fr:"Couleur du bouton de dÃ©pense",de:"Farbe der Ausgaben-SchaltflÃ¤che",pt:"Cor do botÃ£o de despesa",pl:"Kolor przycisku wydatku",nl:"Kleur van de uitgavenknop",ro:"Culoarea butonului de cheltuialÄ",el:"Î§ÏÏÎ¼Î± ÎºÎ¿ÏÎ¼ÏÎ¹Î¿Ï ÎµÎ¾ÏÎ´Î¿Ï"},
        "Colore AttivitÃ ":{it:"Colore AttivitÃ ",en:"Activity color",es:"Color de actividad",fr:"Couleur de lâactivitÃ©",de:"AktivitÃ¤tsfarbe",pt:"Cor da atividade",pl:"Kolor aktywnoÅci",nl:"Activiteitskleur",ro:"Culoarea activitÄÈii",el:"Î§ÏÏÎ¼Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±Ï"},
        "Activity color":{it:"Colore AttivitÃ ",en:"Activity color",es:"Color de actividad",fr:"Couleur de lâactivitÃ©",de:"AktivitÃ¤tsfarbe",pt:"Cor da atividade",pl:"Kolor aktywnoÅci",nl:"Activiteitskleur",ro:"Culoarea activitÄÈii",el:"Î§ÏÏÎ¼Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±Ï"},
        "Sfondo":{it:"Sfondo",en:"Background",es:"Fondo",fr:"ArriÃ¨re-plan",de:"Hintergrund",pt:"Fundo",pl:"TÅo",nl:"Achtergrond",ro:"Fundal",el:"Î¦ÏÎ½ÏÎ¿"},
        "Background":{it:"Sfondo",en:"Background",es:"Fondo",fr:"ArriÃ¨re-plan",de:"Hintergrund",pt:"Fundo",pl:"TÅo",nl:"Achtergrond",ro:"Fundal",el:"Î¦ÏÎ½ÏÎ¿"},
        "AttivitÃ ":{it:"AttivitÃ ",en:"Activity",es:"Actividad",fr:"ActivitÃ©",de:"AktivitÃ¤t",pt:"Atividade",pl:"AktywnoÅÄ",nl:"Activiteit",ro:"Activitate",el:"ÎÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±"},
        "Activity":{it:"AttivitÃ ",en:"Activity",es:"Actividad",fr:"ActivitÃ©",de:"AktivitÃ¤t",pt:"Atividade",pl:"AktywnoÅÄ",nl:"Activiteit",ro:"Activitate",el:"ÎÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±"},
        "Ti devono":{it:"Ti devono",en:"They owe you",es:"Te deben",fr:"On te doit",de:"Dir wird geschuldet",pt:"Devem-te",pl:"Oni sÄ Ci winni",nl:"Zij zijn jou verschuldigd",ro:"ÃÈi datoreazÄ",el:"Î£Î¿Ï Î¿ÏÎµÎ¯Î»Î¿ÏÎ½"},
        "Devi":{it:"Devi",en:"You owe",es:"Debes",fr:"Tu dois",de:"Du schuldest",pt:"Deves",pl:"JesteÅ winien",nl:"Jij bent verschuldigd",ro:"Datorezi",el:"ÎÏÎµÎ¯Î»ÎµÎ¹Ï"},
        "Primo progetto disponibile":{it:"Primo progetto disponibile",en:"First available project",es:"Primer proyecto disponible",fr:"Premier projet disponible",de:"Erstes verfÃ¼gbares Projekt",pt:"Primeiro projeto disponÃ­vel",pl:"Pierwszy dostÄpny projekt",nl:"Eerste beschikbare project",ro:"Primul proiect disponibil",el:"Î ÏÏÏÎ¿ Î´Î¹Î±Î¸Î­ÏÎ¹Î¼Î¿ Î­ÏÎ³Î¿"},
        "First available project":{it:"Primo progetto disponibile",en:"First available project",es:"Primer proyecto disponible",fr:"Premier projet disponible",de:"Erstes verfÃ¼gbares Projekt",pt:"Primeiro projeto disponÃ­vel",pl:"Pierwszy dostÄpny projekt",nl:"Eerste beschikbare project",ro:"Primul proiect disponibil",el:"Î ÏÏÏÎ¿ Î´Î¹Î±Î¸Î­ÏÎ¹Î¼Î¿ Î­ÏÎ³Î¿"},
        "Progetto mostrato nel widget":{it:"Progetto mostrato nel widget",en:"Project shown in the widget",es:"Proyecto mostrado en el widget",fr:"Projet affichÃ© dans le widget",de:"Im Widget angezeigtes Projekt",pt:"Projeto mostrado no widget",pl:"Projekt pokazany w widÅ¼ecie",nl:"Project dat in de widget wordt getoond",ro:"Proiect afiÈat Ã®n widget",el:"ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"},
        "Project shown in the widget":{it:"Progetto mostrato nel widget",en:"Project shown in the widget",es:"Proyecto mostrado en el widget",fr:"Projet affichÃ© dans le widget",de:"Im Widget angezeigtes Projekt",pt:"Projeto mostrado no widget",pl:"Projekt pokazany w widÅ¼ecie",nl:"Project dat in de widget wordt getoond",ro:"Proiect afiÈat Ã®n widget",el:"ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"},
        "Questo widget serve per inserire rapidamente una nuova uscita o una nuova entrata direttamente dalla Home del telefono, senza aprire manualmente lâapp.":{it:"Questo widget serve per inserire rapidamente una nuova uscita o una nuova entrata direttamente dalla Home del telefono, senza aprire manualmente lâapp.",en:"This widget lets you quickly add a new expense or income directly from the phone Home screen, without opening the app manually.",es:"Este widget te permite aÃ±adir rÃ¡pidamente un nuevo gasto o ingreso directamente desde la pantalla de inicio del telÃ©fono, sin abrir manualmente la app.",fr:"Ce widget te permet dâajouter rapidement une nouvelle dÃ©pense ou un nouveau revenu directement depuis lâÃ©cran dâaccueil du tÃ©lÃ©phone, sans ouvrir lâapp manuellement.",de:"Mit diesem Widget kannst du schnell eine neue Ausgabe oder Einnahme direkt vom Startbildschirm des Telefons hinzufÃ¼gen, ohne die App manuell zu Ã¶ffnen.",pt:"Este widget permite adicionar rapidamente uma nova despesa ou receita diretamente a partir do ecrÃ£ inicial do telefone, sem abrir manualmente a app.",pl:"Ten widÅ¼et pozwala szybko dodaÄ nowy wydatek lub przychÃ³d bezpoÅrednio z ekranu gÅÃ³wnego telefonu, bez rÄcznego otwierania aplikacji.",nl:"Met deze widget kun je snel een nieuwe uitgave of inkomst rechtstreeks vanaf het startscherm van je telefoon toevoegen, zonder de app handmatig te openen.",ro:"Acest widget Ã®Èi permite sÄ adaugi rapid o cheltuialÄ sau un venit nou direct de pe ecranul principal al telefonului, fÄrÄ sÄ deschizi manual aplicaÈia.",el:"ÎÏÏÏ ÏÎ¿ widget ÏÎ¿Ï ÎµÏÎ¹ÏÏÎ­ÏÎµÎ¹ Î½Î± ÏÏÎ¿ÏÎ¸Î­ÏÎµÎ¹Ï Î³ÏÎ®Î³Î¿ÏÎ± Î­Î½Î± Î½Î­Î¿ Î­Î¾Î¿Î´Î¿ Î® Î­ÏÎ¿Î´Î¿ Î±ÏÎµÏÎ¸ÎµÎ¯Î±Ï Î±ÏÏ ÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î· ÏÎ¿Ï ÏÎ·Î»ÎµÏÏÎ½Î¿Ï, ÏÏÏÎ¯Ï Î½Î± Î±Î½Î¿Î¯Î³ÎµÎ¹Ï ÏÎµÎ¹ÏÎ¿ÎºÎ¯Î½Î·ÏÎ± ÏÎ·Î½ ÎµÏÎ±ÏÎ¼Î¿Î³Î®."},
        "Questo widget mostra sulla Home una nota salvata oppure una coordinata bancaria. Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori e aggiornamento.":{it:"Questo widget mostra sulla Home una nota salvata oppure una coordinata bancaria. Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori e aggiornamento.",en:"This widget shows a saved note or bank detail on the Home screen. The exact content is selected when you add the widget to the Home screen; here you only change appearance, colors and update settings.",es:"Este widget muestra en la pantalla de inicio una nota guardada o un dato bancario. El contenido exacto se elige al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas el aspecto, los colores y la actualizaciÃ³n.",fr:"Ce widget affiche sur lâÃ©cran dâaccueil une note enregistrÃ©e ou une coordonnÃ©e bancaire. Le contenu exact se choisit lorsque tu ajoutes le widget Ã  lâÃ©cran dâaccueil ; ici tu modifies seulement lâapparence, les couleurs et la mise Ã  jour.",de:"Dieses Widget zeigt auf dem Startbildschirm eine gespeicherte Notiz oder Bankverbindung. Der genaue Inhalt wird gewÃ¤hlt, wenn du das Widget zum Startbildschirm hinzufÃ¼gst; hier Ã¤nderst du nur Aussehen, Farben und Aktualisierung.",pt:"Este widget mostra no ecrÃ£ inicial uma nota guardada ou um dado bancÃ¡rio. O conteÃºdo exato Ã© escolhido quando adicionas o widget ao ecrÃ£ inicial; aqui alteras apenas o aspeto, as cores e a atualizaÃ§Ã£o.",pl:"Ten widÅ¼et pokazuje na ekranie gÅÃ³wnym zapisanÄ notatkÄ albo dane bankowe. DokÅadnÄ zawartoÅÄ wybiera siÄ podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory i aktualizacjÄ.",nl:"Deze widget toont op het startscherm een opgeslagen notitie of bankgegeven. De exacte inhoud kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren en bijwerken.",ro:"Acest widget afiÈeazÄ pe ecranul principal o notiÈÄ salvatÄ sau un detaliu bancar. ConÈinutul exact se alege cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile Èi actualizarea.",el:"ÎÏÏÏ ÏÎ¿ widget ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î· Î¼Î¹Î± Î±ÏÎ¿Î¸Î·ÎºÎµÏÎ¼Î­Î½Î· ÏÎ·Î¼ÎµÎ¯ÏÏÎ· Î® Î­Î½Î± ÏÏÎ±ÏÎµÎ¶Î¹ÎºÏ ÏÏÎ¿Î¹ÏÎµÎ¯Î¿. Î¤Î¿ Î±ÎºÏÎ¹Î²Î­Ï ÏÎµÏÎ¹ÎµÏÏÎ¼ÎµÎ½Î¿ ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÎ¹Ï ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÎ¹Ï Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},
        "Questo widget mostra sulla Home lâavanzamento di un obiettivo di risparmio: nome, percentuale, barra e importi. Lâobiettivo preciso si sceglie quando aggiungi il widget alla Home; qui modifichi aspetto e colori.":{it:"Questo widget mostra sulla Home lâavanzamento di un obiettivo di risparmio: nome, percentuale, barra e importi. Lâobiettivo preciso si sceglie quando aggiungi il widget alla Home; qui modifichi aspetto e colori.",en:"This widget shows the progress of a savings goal on the Home screen: name, percentage, bar and amounts. The exact goal is selected when you add the widget to the Home screen; here you change appearance and colors.",es:"Este widget muestra en la pantalla de inicio el avance de un objetivo de ahorro: nombre, porcentaje, barra e importes. El objetivo exacto se elige al aÃ±adir el widget a la pantalla de inicio; aquÃ­ modificas el aspecto y los colores.",fr:"Ce widget affiche sur lâÃ©cran dâaccueil la progression dâun objectif dâÃ©pargne : nom, pourcentage, barre et montants. Lâobjectif exact se choisit lorsque tu ajoutes le widget Ã  lâÃ©cran dâaccueil ; ici tu modifies lâapparence et les couleurs.",de:"Dieses Widget zeigt auf dem Startbildschirm den Fortschritt eines Sparziels: Name, Prozentwert, Balken und BetrÃ¤ge. Das genaue Ziel wird gewÃ¤hlt, wenn du das Widget zum Startbildschirm hinzufÃ¼gst; hier Ã¤nderst du Aussehen und Farben.",pt:"Este widget mostra no ecrÃ£ inicial o progresso de um objetivo de poupanÃ§a: nome, percentagem, barra e valores. O objetivo exato Ã© escolhido quando adicionas o widget ao ecrÃ£ inicial; aqui alteras o aspeto e as cores.",pl:"Ten widÅ¼et pokazuje na ekranie gÅÃ³wnym postÄp celu oszczÄdnoÅciowego: nazwÄ, procent, pasek i kwoty. DokÅadny cel wybiera siÄ podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz wyglÄd i kolory.",nl:"Deze widget toont op het startscherm de voortgang van een spaardoel: naam, percentage, balk en bedragen. Het exacte doel kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je uiterlijk en kleuren.",ro:"Acest widget afiÈeazÄ pe ecranul principal progresul unui obiectiv de economisire: nume, procent, barÄ Èi sume. Obiectivul exact se alege cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici aspectul Èi culorile.",el:"ÎÏÏÏ ÏÎ¿ widget ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î· ÏÎ·Î½ ÏÏÏÎ¿Î´Î¿ ÎµÎ½ÏÏ ÏÏÏÏÎ¿Ï Î±ÏÎ¿ÏÎ±Î¼Î¯ÎµÏÏÎ·Ï: ÏÎ½Î¿Î¼Î±, ÏÎ¿ÏÎ¿ÏÏÏ, Î¼ÏÎ¬ÏÎ± ÎºÎ±Î¹ ÏÎ¿ÏÎ¬. Î Î±ÎºÏÎ¹Î²Î®Ï ÏÏÏÏÎ¿Ï ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÎ¹Ï ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÎ¹Ï ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ· ÎºÎ±Î¹ ÏÏÏÎ¼Î±ÏÎ±."},
        "Questo widget mostra sulla Home il riepilogo di un progetto Share: saldo personale, quanto devi, quanto ti devono e ultima attivitÃ . Il progetto puÃ² essere scelto qui come default e anche dal tasto di configurazione quando aggiungi il widget.":{it:"Questo widget mostra sulla Home il riepilogo di un progetto Share: saldo personale, quanto devi, quanto ti devono e ultima attivitÃ . Il progetto puÃ² essere scelto qui come default e anche dal tasto di configurazione quando aggiungi il widget.",en:"This widget shows a Share project summary on the Home screen: personal balance, what you owe, what others owe you and the latest activity. The project can be selected here as default and also from the configuration button when you add the widget.",es:"Este widget muestra en la pantalla de inicio el resumen de un proyecto Share: saldo personal, cuÃ¡nto debes, cuÃ¡nto te deben y la Ãºltima actividad. El proyecto puede elegirse aquÃ­ como predeterminado y tambiÃ©n desde el botÃ³n de configuraciÃ³n al aÃ±adir el widget.",fr:"Ce widget affiche sur lâÃ©cran dâaccueil le rÃ©sumÃ© dâun projet Share : solde personnel, ce que tu dois, ce quâon te doit et la derniÃ¨re activitÃ©. Le projet peut Ãªtre choisi ici par dÃ©faut et aussi depuis le bouton de configuration lorsque tu ajoutes le widget.",de:"Dieses Widget zeigt auf dem Startbildschirm die Zusammenfassung eines Share-Projekts: persÃ¶nlicher Kontostand, was du schuldest, was dir geschuldet wird und die letzte AktivitÃ¤t. Das Projekt kann hier als Standard und auch Ã¼ber die Konfigurationstaste beim HinzufÃ¼gen des Widgets gewÃ¤hlt werden.",pt:"Este widget mostra no ecrÃ£ inicial o resumo de um projeto Share: saldo pessoal, quanto deves, quanto te devem e a Ãºltima atividade. O projeto pode ser escolhido aqui como padrÃ£o e tambÃ©m no botÃ£o de configuraÃ§Ã£o ao adicionares o widget.",pl:"Ten widÅ¼et pokazuje na ekranie gÅÃ³wnym podsumowanie projektu Share: saldo osobiste, ile jesteÅ winien, ile inni sÄ winni tobie i ostatniÄ aktywnoÅÄ. Projekt moÅ¼na wybraÄ tutaj jako domyÅlny, a takÅ¼e przyciskiem konfiguracji podczas dodawania widÅ¼etu.",nl:"Deze widget toont op het startscherm de samenvatting van een Share-project: persoonlijk saldo, wat jij verschuldigd bent, wat anderen jou verschuldigd zijn en de laatste activiteit. Het project kan hier als standaard worden gekozen en ook via de configuratieknop wanneer je de widget toevoegt.",ro:"Acest widget afiÈeazÄ pe ecranul principal rezumatul unui proiect Share: sold personal, cÃ¢t datorezi, cÃ¢t Èi se datoreazÄ Èi ultima activitate. Proiectul poate fi ales aici ca implicit Èi Èi din butonul de configurare cÃ¢nd adaugi widgetul.",el:"ÎÏÏÏ ÏÎ¿ widget ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î· ÏÎ· ÏÏÎ½Î¿ÏÎ· ÎµÎ½ÏÏ Î­ÏÎ³Î¿Ï Share: ÏÏÎ¿ÏÏÏÎ¹ÎºÏ ÏÏÏÎ»Î¿Î¹ÏÎ¿, ÏÏÏÎ± Î¿ÏÎµÎ¯Î»ÎµÎ¹Ï, ÏÏÏÎ± ÏÎ¿Ï Î¿ÏÎµÎ¯Î»Î¿ÏÎ½ ÎºÎ±Î¹ ÏÎ·Î½ ÏÎµÎ»ÎµÏÏÎ±Î¯Î± Î´ÏÎ±ÏÏÎ·ÏÎ¹ÏÏÎ·ÏÎ±. Î¤Î¿ Î­ÏÎ³Î¿ Î¼ÏÎ¿ÏÎµÎ¯ Î½Î± ÎµÏÎ¹Î»ÎµÎ³ÎµÎ¯ ÎµÎ´Ï ÏÏ ÏÏÎ¿ÎµÏÎ¹Î»Î¿Î³Î® ÎºÎ±Î¹ ÎµÏÎ¯ÏÎ·Ï Î±ÏÏ ÏÎ¿ ÎºÎ¿ÏÎ¼ÏÎ¯ ÏÏÎ¸Î¼Î¹ÏÎ·Ï ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÎ¹Ï ÏÎ¿ widget."}
      };
      var EXTRA_WIDGET_TRANSLATIONS_1633={"Scegli la lista, aggiungi prodotti e spunta quelli giÃ  messi nel carrello.":{"it":"Scegli la lista, aggiungi prodotti e spunta quelli giÃ  messi nel carrello.","en":"Choose a list, add products and tick the items already in your cart.","es":"Elige la lista, aÃ±ade productos y marca los que ya estÃ¡n en el carrito.","fr":"Choisissez la liste, ajoutez des produits et cochez ceux dÃ©jÃ  dans le panier.","de":"WÃ¤hle die Liste, fÃ¼ge Produkte hinzu und markiere die Artikel im Einkaufswagen.","pt":"Escolhe a lista, adiciona produtos e marca os que jÃ¡ estÃ£o no carrinho.","pl":"Wybierz listÄ, dodaj produkty i zaznacz te, ktÃ³re sÄ juÅ¼ w koszyku.","nl":"Kies de lijst, voeg producten toe en vink de artikelen aan die al in je winkelwagen liggen.","ro":"Alege lista, adaugÄ produse Èi bifeazÄ articolele deja puse Ã®n coÈ.","el":"ÎÏÎ¹Î»Î­Î¾ÏÎµ Î»Î¯ÏÏÎ±, ÏÏÎ¿ÏÎ¸Î­ÏÏÎµ ÏÏÎ¿ÏÏÎ½ÏÎ± ÎºÎ±Î¹ ÏÎ·Î¼ÎµÎ¹ÏÏÏÎµ ÏÏÎ± ÎµÎ¯Î½Î±Î¹ Î®Î´Î· ÏÏÎ¿ ÎºÎ±Î»Î¬Î¸Î¹."},"Tocca il prodotto per aggiungerlo alla lista.":{"it":"Tocca il prodotto per aggiungerlo alla lista.","en":"Tap the product to add it to the list.","es":"Toca el producto para aÃ±adirlo a la lista.","fr":"Touchez le produit pour lâajouter Ã  la liste.","de":"Tippe auf das Produkt, um es zur Liste hinzuzufÃ¼gen.","pt":"Toca no produto para o adicionar Ã  lista.","pl":"Dotknij produktu, aby dodaÄ go do listy.","nl":"Tik op het product om het aan de lijst toe te voegen.","ro":"Atinge produsul pentru a-l adÄuga Ã®n listÄ.","el":"Î Î±ÏÎ®ÏÏÎµ ÏÎ¿ ÏÏÎ¿ÏÏÎ½ Î³Î¹Î± Î½Î± ÏÎ¿ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÏÎ· Î»Î¯ÏÏÎ±."},"VisibilitÃ , collegamento a patrimonio e movimenti":{"it":"VisibilitÃ , collegamento a patrimonio e movimenti","en":"Visibility, connection to assets and transactions","es":"Visibilidad, conexiÃ³n con patrimonio y movimientos","fr":"VisibilitÃ©, lien avec patrimoine et mouvements","de":"Sichtbarkeit, VerknÃ¼pfung mit VermÃ¶gen und Bewegungen","pt":"Visibilidade, ligaÃ§Ã£o a patrimÃ³nio e movimentos","pl":"WidocznoÅÄ, poÅÄczenie z majÄtkiem i ruchami","nl":"Zichtbaarheid, koppeling met vermogen en bewegingen","ro":"Vizibilitate, legÄturÄ cu patrimoniu Èi miÈcÄri","el":"ÎÏÎ±ÏÏÏÎ·ÏÎ±, ÏÏÎ½Î´ÎµÏÎ· Î¼Îµ ÏÎµÏÎ¹Î¿ÏÏÎ¯Î± ÎºÎ±Î¹ ÎºÎ¹Î½Î®ÏÎµÎ¹Ï"},"Aree lista spesa, fidelity card e prepagate":{"it":"Aree lista spesa, fidelity card e prepagate","en":"Shopping list areas, loyalty cards and prepaid cards","es":"Ãreas de la lista de la compra, tarjetas fidelidad y prepago","fr":"Rayons de la liste de courses, cartes fidÃ©litÃ© et prÃ©payÃ©es","de":"Einkaufslistenbereiche, Kundenkarten und Prepaid-Karten","pt":"Ãreas da lista de compras, cartÃµes fidelidade e prÃ©-pagos","pl":"Obszary listy zakupÃ³w, karty lojalnoÅciowe i przedpÅacone","nl":"Boodschappenlijstgebieden, klantenkaarten en prepaidkaarten","ro":"Zone listÄ cumpÄrÄturi, carduri fidelitate Èi preplÄtite","el":"Î ÎµÏÎ¹Î¿ÏÎ­Ï Î»Î¯ÏÏÎ±Ï Î±Î³Î¿ÏÏÎ½, ÎºÎ¬ÏÏÎµÏ ÏÎµÎ»Î¬ÏÎ· ÎºÎ±Î¹ ÏÏÎ¿ÏÎ»Î·ÏÏÎ¼Î­Î½ÎµÏ"},"Carte fidelity e prepagate":{"it":"Carte fidelity e prepagate","en":"Loyalty and prepaid cards","es":"Tarjetas fidelidad y prepago","fr":"Cartes fidÃ©litÃ© et prÃ©payÃ©es","de":"Kunden- und Prepaid-Karten","pt":"CartÃµes fidelidade e prÃ©-pagos","pl":"Karty lojalnoÅciowe i przedpÅacone","nl":"Klanten- en prepaidkaarten","ro":"Carduri fidelitate Èi preplÄtite","el":"ÎÎ¬ÏÏÎµÏ ÏÎµÎ»Î¬ÏÎ· ÎºÎ±Î¹ ÏÏÎ¿ÏÎ»Î·ÏÏÎ¼Î­Î½ÎµÏ"},"Riporta nel patrimonio":{"it":"Riporta nel patrimonio","en":"Include in assets","es":"Incluir en patrimonio","fr":"Inclure dans le patrimoine","de":"In VermÃ¶gen aufnehmen","pt":"Incluir no patrimÃ³nio","pl":"UwzglÄdnij w majÄtku","nl":"Opnemen in vermogen","ro":"Include Ã®n patrimoniu","el":"Î£ÏÎ¼ÏÎµÏÎ¯Î»Î·ÏÎ· ÏÏÎ·Î½ ÏÎµÏÎ¹Î¿ÏÏÎ¯Î±"},"Consente di creare una voce Patrimonio collegata al Saldo del debito o credito.":{"it":"Consente di creare una voce Patrimonio collegata al Saldo del debito o credito.","en":"Allows creating an asset item linked to the debt or credit balance.","es":"Permite crear una partida de patrimonio vinculada al saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er un Ã©lÃ©ment de patrimoine liÃ© au solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht einen VermÃ¶genseintrag, der mit dem Saldo der Schuld oder des Guthabens verknÃ¼pft ist.","pt":"Permite criar um item de patrimÃ³nio ligado ao saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala utworzyÄ pozycjÄ majÄtku poÅÄczonÄ z saldem dÅugu lub naleÅ¼noÅci.","nl":"Maakt een vermogensitem aan dat gekoppeld is aan het saldo van de schuld of het tegoed.","ro":"Permite crearea unui element de patrimoniu legat de soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÏÏÎ¿Î¹ÏÎµÎ¯Î¿Ï ÏÎµÏÎ¹Î¿ÏÏÎ¯Î±Ï ÏÏÎ½Î´ÎµÎ´ÎµÎ¼Î­Î½Î¿Ï Î¼Îµ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Consente di creare una voce patrimonio collegata al saldo del debito o credito.":{"it":"Consente di creare una voce patrimonio collegata al saldo del debito o credito.","en":"Allows creating an asset item linked to the debt or credit balance.","es":"Permite crear una partida de patrimonio vinculada al saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er un Ã©lÃ©ment de patrimoine liÃ© au solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht einen VermÃ¶genseintrag, der mit dem Saldo der Schuld oder des Guthabens verknÃ¼pft ist.","pt":"Permite criar um item de patrimÃ³nio ligado ao saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala utworzyÄ pozycjÄ majÄtku poÅÄczonÄ z saldem dÅugu lub naleÅ¼noÅci.","nl":"Maakt een vermogensitem aan dat gekoppeld is aan het saldo van de schuld of het tegoed.","ro":"Permite crearea unui element de patrimoniu legat de soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÏÏÎ¿Î¹ÏÎµÎ¯Î¿Ï ÏÎµÏÎ¹Î¿ÏÏÎ¯Î±Ï ÏÏÎ½Î´ÎµÎ´ÎµÎ¼Î­Î½Î¿Ï Î¼Îµ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Riporta nei movimenti":{"it":"Riporta nei movimenti","en":"Include in transactions","es":"Incluir en movimientos","fr":"Inclure dans les mouvements","de":"In Bewegungen aufnehmen","pt":"Incluir nos movimentos","pl":"UwzglÄdnij w ruchach","nl":"Opnemen in bewegingen","ro":"Include Ã®n miÈcÄri","el":"Î£ÏÎ¼ÏÎµÏÎ¯Î»Î·ÏÎ· ÏÏÎ¹Ï ÎºÎ¹Î½Î®ÏÎµÎ¹Ï"},"Consente di creare entrate o uscite partendo dal Saldo del debito o credito.":{"it":"Consente di creare entrate o uscite partendo dal Saldo del debito o credito.","en":"Allows creating income or expenses from the debt or credit balance.","es":"Permite crear ingresos o gastos a partir del saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er des entrÃ©es ou sorties Ã  partir du solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht Einnahmen oder Ausgaben aus dem Saldo der Schuld oder des Guthabens.","pt":"Permite criar entradas ou saÃ­das a partir do saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala tworzyÄ przychody lub wydatki z salda dÅugu lub naleÅ¼noÅci.","nl":"Maakt inkomsten of uitgaven aan op basis van het saldo van de schuld of het tegoed.","ro":"Permite crearea de venituri sau cheltuieli pornind de la soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÎµÏÏÎ´ÏÎ½ Î® ÎµÎ¾ÏÎ´ÏÎ½ Î±ÏÏ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Consente di creare entrate o uscite partendo dal saldo del debito o credito.":{"it":"Consente di creare entrate o uscite partendo dal saldo del debito o credito.","en":"Allows creating income or expenses from the debt or credit balance.","es":"Permite crear ingresos o gastos a partir del saldo de la deuda o crÃ©dito.","fr":"Permet de crÃ©er des entrÃ©es ou sorties Ã  partir du solde de la dette ou du crÃ©dit.","de":"ErmÃ¶glicht Einnahmen oder Ausgaben aus dem Saldo der Schuld oder des Guthabens.","pt":"Permite criar entradas ou saÃ­das a partir do saldo da dÃ­vida ou crÃ©dito.","pl":"Pozwala tworzyÄ przychody lub wydatki z salda dÅugu lub naleÅ¼noÅci.","nl":"Maakt inkomsten of uitgaven aan op basis van het saldo van de schuld of het tegoed.","ro":"Permite crearea de venituri sau cheltuieli pornind de la soldul datoriei sau creditului.","el":"ÎÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· Î´Î·Î¼Î¹Î¿ÏÏÎ³Î¯Î± ÎµÏÏÎ´ÏÎ½ Î® ÎµÎ¾ÏÎ´ÏÎ½ Î±ÏÏ ÏÎ¿ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎ­Î¿ÏÏ Î® ÏÎ¯ÏÏÏÏÎ·Ï."},"Gestisci le aree dei prodotti e scegli icona e area predefinita.":{"it":"Gestisci le aree dei prodotti e scegli icona e area predefinita.","en":"Manage product areas and choose the icon and default area.","es":"Gestiona las Ã¡reas de productos y elige icono y Ã¡rea predeterminada.","fr":"GÃ©rez les rayons des produits et choisissez lâicÃ´ne et le rayon par dÃ©faut.","de":"Verwalte Produktbereiche und wÃ¤hle Symbol und Standardbereich.","pt":"Gere as Ã¡reas dos produtos e escolhe Ã­cone e Ã¡rea predefinida.","pl":"ZarzÄdzaj obszarami produktÃ³w oraz wybierz ikonÄ i obszar domyÅlny.","nl":"Beheer productgebieden en kies het pictogram en standaardgebied.","ro":"GestioneazÄ zonele produselor Èi alege pictograma Èi zona implicitÄ.","el":"ÎÎ¹Î±ÏÎµÎ¹ÏÎ¹ÏÏÎµÎ¯ÏÎµ ÏÎ¹Ï ÏÎµÏÎ¹Î¿ÏÎ­Ï ÏÏÎ¿ÏÏÎ½ÏÏÎ½ ÎºÎ±Î¹ ÎµÏÎ¹Î»Î­Î¾ÏÎµ ÎµÎ¹ÎºÎ¿Î½Î¯Î´Î¹Î¿ ÎºÎ±Î¹ ÏÏÎ¿ÎµÏÎ¹Î»ÎµÎ³Î¼Î­Î½Î· ÏÎµÏÎ¹Î¿ÏÎ®."},"Colore usato nella lista quando un prodotto Ã¨ giÃ  nel carrello.":{"it":"Colore usato nella lista quando un prodotto Ã¨ giÃ  nel carrello.","en":"Color used in the list when a product is already in the cart.","es":"Color usado en la lista cuando un producto ya estÃ¡ en el carrito.","fr":"Couleur utilisÃ©e dans la liste lorsquâun produit est dÃ©jÃ  dans le panier.","de":"Farbe in der Liste, wenn ein Produkt bereits im Wagen ist.","pt":"Cor usada na lista quando um produto jÃ¡ estÃ¡ no carrinho.","pl":"Kolor uÅ¼ywany na liÅcie, gdy produkt jest juÅ¼ w koszyku.","nl":"Kleur in de lijst wanneer een product al in de winkelwagen staat.","ro":"Culoare folositÄ Ã®n listÄ cÃ¢nd un produs este deja Ã®n coÈ.","el":"Î§ÏÏÎ¼Î± ÏÏÎ· Î»Î¯ÏÏÎ± ÏÏÎ±Î½ Î­Î½Î± ÏÏÎ¿ÏÏÎ½ ÎµÎ¯Î½Î±Î¹ Î®Î´Î· ÏÏÎ¿ ÎºÎ±Î»Î¬Î¸Î¹."},"Top summary, number of icons and section order":{"it":"Riepilogo alto, numero icone e ordine delle sezioni","en":"Top summary, number of icons and section order","es":"Resumen superior, nÃºmero de iconos y orden de secciones","fr":"RÃ©sumÃ© supÃ©rieur, nombre dâicÃ´nes et ordre des sections","de":"Obere Zusammenfassung, Anzahl der Symbole und Abschnittsreihenfolge","pt":"Resumo superior, nÃºmero de Ã­cones e ordem das secÃ§Ãµes","pl":"GÃ³rne podsumowanie, liczba ikon i kolejnoÅÄ sekcji","nl":"Bovenste samenvatting, aantal pictogrammen en volgorde van secties","ro":"Rezumat superior, numÄr de pictograme Èi ordinea secÈiunilor","el":"ÎÏÎ¬Î½Ï ÏÏÎ½Î¿ÏÎ·, Î±ÏÎ¹Î¸Î¼ÏÏ ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯ÏÎ½ ÎºÎ±Î¹ ÏÎµÎ¹ÏÎ¬ ÎµÎ½Î¿ÏÎ®ÏÏÎ½"},"Riepilogo alto, numero icone e ordine delle sezioni":{"it":"Riepilogo alto, numero icone e ordine delle sezioni","en":"Top summary, number of icons and section order","es":"Resumen superior, nÃºmero de iconos y orden de secciones","fr":"RÃ©sumÃ© supÃ©rieur, nombre dâicÃ´nes et ordre des sections","de":"Obere Zusammenfassung, Anzahl der Symbole und Abschnittsreihenfolge","pt":"Resumo superior, nÃºmero de Ã­cones e ordem das secÃ§Ãµes","pl":"GÃ³rne podsumowanie, liczba ikon i kolejnoÅÄ sekcji","nl":"Bovenste samenvatting, aantal pictogrammen en volgorde van secties","ro":"Rezumat superior, numÄr de pictograme Èi ordinea secÈiunilor","el":"ÎÏÎ¬Î½Ï ÏÏÎ½Î¿ÏÎ·, Î±ÏÎ¹Î¸Î¼ÏÏ ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯ÏÎ½ ÎºÎ±Î¹ ÏÎµÎ¹ÏÎ¬ ÎµÎ½Î¿ÏÎ®ÏÏÎ½"},"Configurazione widget Android":{"it":"Configurazione widget Android","en":"Android widget configuration","es":"ConfiguraciÃ³n de widgets Android","fr":"Configuration des widgets Android","de":"Android-Widget-Konfiguration","pt":"ConfiguraÃ§Ã£o dos widgets Android","pl":"Konfiguracja widÅ¼etÃ³w Android","nl":"Android-widgetconfiguratie","ro":"Configurare widgeturi Android","el":"Î¡ÏÎ¸Î¼Î¹ÏÎ· widget Android"},"Widget ingresso rapido":{"it":"Widget ingresso rapido","en":"Quick entry widget","es":"Widget de entrada rÃ¡pida","fr":"Widget de saisie rapide","de":"Schnelleingabe-Widget","pt":"Widget de entrada rÃ¡pida","pl":"WidÅ¼et szybkiego wpisu","nl":"Widget snelle invoer","ro":"Widget introducere rapidÄ","el":"Widget Î³ÏÎ®Î³Î¿ÏÎ·Ï ÎµÎ¹ÏÎ±Î³ÏÎ³Î®Ï"},"Incluso nel piano gratuito. Logo fAInance, pulsanti Entrata/Uscita e layout 1x4 in una sola riga":{"it":"Incluso nel piano gratuito. Logo fAInance, pulsanti Entrata/Uscita e layout 1x4 in una sola riga","en":"Included in the free plan. fAInance logo, income/expense buttons and 1x4 layout in one row","es":"Incluido en el plan gratuito. Logo fAInance, botones Entrada/Salida y diseÃ±o 1x4 en una sola fila","fr":"Inclus dans le plan gratuit. Logo fAInance, boutons EntrÃ©e/Sortie et disposition 1x4 sur une seule ligne","de":"Im Gratis-Plan enthalten. fAInance-Logo, Einnahmen/Ausgaben-SchaltflÃ¤chen und 1x4-Layout in einer Zeile","pt":"IncluÃ­do no plano gratuito. Logo fAInance, botÃµes Entrada/SaÃ­da e layout 1x4 numa sÃ³ linha","pl":"DostÄpne w planie darmowym. Logo fAInance, przyciski PrzychÃ³d/Wydatek i ukÅad 1x4 w jednym wierszu","nl":"Inbegrepen in het gratis plan. fAInance-logo, knoppen Inkomsten/Uitgaven en 1x4-indeling op Ã©Ã©n rij","ro":"Inclus Ã®n planul gratuit. Logo fAInance, butoane Venit/CheltuialÄ Èi aspect 1x4 pe un singur rÃ¢nd","el":"Î ÎµÏÎ¹Î»Î±Î¼Î²Î¬Î½ÎµÏÎ±Î¹ ÏÏÎ¿ Î´ÏÏÎµÎ¬Î½ ÏÎ»Î¬Î½Î¿. ÎÎ¿Î³ÏÏÏÏÎ¿ fAInance, ÎºÎ¿ÏÎ¼ÏÎ¹Î¬ ÎÏÎ¿Î´Î±/ÎÎ¾Î¿Î´Î± ÎºÎ±Î¹ Î´Î¹Î¬ÏÎ±Î¾Î· 1x4 ÏÎµ Î¼Î¯Î± Î³ÏÎ±Î¼Î¼Î®"},"Lista spesa":{"it":"Lista spesa","en":"Shopping list","es":"Lista de la compra","fr":"Liste de courses","de":"Einkaufsliste","pt":"Lista de compras","pl":"Lista zakupÃ³w","nl":"Boodschappenlijst","ro":"ListÄ de cumpÄrÄturi","el":"ÎÎ¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½"},"Visualizza la lista della spesa e permette di segnare gli articoli acquistati.":{"it":"Visualizza la lista della spesa e permette di segnare gli articoli acquistati.","en":"Shows the shopping list and lets you mark purchased items.","es":"Muestra la lista de la compra y permite marcar los artÃ­culos comprados.","fr":"Affiche la liste de courses et permet de marquer les articles achetÃ©s.","de":"Zeigt die Einkaufsliste und lÃ¤sst gekaufte Artikel markieren.","pt":"Mostra a lista de compras e permite marcar os artigos comprados.","pl":"Pokazuje listÄ zakupÃ³w i pozwala oznaczaÄ kupione produkty.","nl":"Toont de boodschappenlijst en laat gekochte artikelen markeren.","ro":"AfiÈeazÄ lista de cumpÄrÄturi Èi permite marcarea articolelor cumpÄrate.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÎ· Î»Î¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½ ÎºÎ±Î¹ ÎµÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· ÏÎ®Î¼Î±Î½ÏÎ· ÏÏÎ½ Î±Î³Î¿ÏÎ±ÏÎ¼Î­Î½ÏÎ½ ÎµÎ¹Î´ÏÎ½."},"Mostra la lista della spesa e permette di segnare gli articoli acquistati.":{"it":"Mostra la lista della spesa e permette di segnare gli articoli acquistati.","en":"Shows the shopping list and lets you mark purchased items.","es":"Muestra la lista de la compra y permite marcar los artÃ­culos comprados.","fr":"Affiche la liste de courses et permet de marquer les articles achetÃ©s.","de":"Zeigt die Einkaufsliste und lÃ¤sst gekaufte Artikel markieren.","pt":"Mostra a lista de compras e permite marcar os artigos comprados.","pl":"Pokazuje listÄ zakupÃ³w i pozwala oznaczaÄ kupione produkty.","nl":"Toont de boodschappenlijst en laat gekochte artikelen markeren.","ro":"AfiÈeazÄ lista de cumpÄrÄturi Èi permite marcarea articolelor cumpÄrate.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÎ· Î»Î¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½ ÎºÎ±Î¹ ÎµÏÎ¹ÏÏÎ­ÏÎµÎ¹ ÏÎ· ÏÎ®Î¼Î±Î½ÏÎ· ÏÏÎ½ Î±Î³Î¿ÏÎ±ÏÎ¼Î­Î½ÏÎ½ ÎµÎ¹Î´ÏÎ½."},"Fidelity card":{"it":"Fidelity card","en":"Loyalty card","es":"Tarjeta fidelidad","fr":"Carte fidÃ©litÃ©","de":"Kundenkarte","pt":"CartÃ£o fidelidade","pl":"Karta lojalnoÅciowa","nl":"Klantenkaart","ro":"Card fidelitate","el":"ÎÎ¬ÏÏÎ± ÏÎµÎ»Î¬ÏÎ·"},"Visualizza rapidamente una fidelity card o una prepagata.":{"it":"Visualizza rapidamente una fidelity card o una prepagata.","en":"Quickly shows a loyalty or prepaid card.","es":"Muestra rÃ¡pidamente una tarjeta fidelidad o prepago.","fr":"Affiche rapidement une carte fidÃ©litÃ© ou prÃ©payÃ©e.","de":"Zeigt schnell eine Kunden- oder Prepaid-Karte.","pt":"Mostra rapidamente um cartÃ£o fidelidade ou prÃ©-pago.","pl":"Szybko pokazuje kartÄ lojalnoÅciowÄ lub przedpÅaconÄ.","nl":"Toont snel een klantenkaart of prepaidkaart.","ro":"AfiÈeazÄ rapid un card fidelitate sau preplÄtit.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ Î³ÏÎ®Î³Î¿ÏÎ± Î¼Î¹Î± ÎºÎ¬ÏÏÎ± ÏÎµÎ»Î¬ÏÎ· Î® ÏÏÎ¿ÏÎ»Î·ÏÏÎ¼Î­Î½Î·."},"Debiti / Crediti":{"it":"Debiti / Crediti","en":"Debts / Credits","es":"Deudas / CrÃ©ditos","fr":"Dettes / CrÃ©dits","de":"Schulden / Guthaben","pt":"DÃ­vidas / CrÃ©ditos","pl":"DÅugi / NaleÅ¼noÅci","nl":"Schulden / Tegoeden","ro":"Datorii / Credite","el":"Î§ÏÎ­Î· / Î Î¹ÏÏÏÏÎµÎ¹Ï"},"Mostra il saldo aperto di debiti e crediti.":{"it":"Mostra il saldo aperto di debiti e crediti.","en":"Shows the open balance of debts and credits.","es":"Muestra el saldo abierto de deudas y crÃ©ditos.","fr":"Affiche le solde ouvert des dettes et crÃ©dits.","de":"Zeigt den offenen Saldo von Schulden und Guthaben.","pt":"Mostra o saldo em aberto de dÃ­vidas e crÃ©ditos.","pl":"Pokazuje otwarte saldo dÅugÃ³w i naleÅ¼noÅci.","nl":"Toont het open saldo van schulden en tegoeden.","ro":"AfiÈeazÄ soldul deschis al datoriilor Èi creditelor.","el":"ÎÎ¼ÏÎ±Î½Î¯Î¶ÎµÎ¹ ÏÎ¿ Î±Î½Î¿Î¹ÎºÏÏ ÏÏÏÎ»Î¿Î¹ÏÎ¿ ÏÏÎµÏÎ½ ÎºÎ±Î¹ ÏÎ¹ÏÏÏÏÎµÏÎ½."},"Icon color":{"it":"Colore icona","en":"Icon color","es":"Color del icono","fr":"Couleur de lâicÃ´ne","de":"Symbolfarbe","pt":"Cor do Ã­cone","pl":"Kolor ikony","nl":"Pictogramkleur","ro":"Culoare pictogramÄ","el":"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},"Title color":{"it":"Colore titolo","en":"Title color","es":"Color del tÃ­tulo","fr":"Couleur du titre","de":"Titelfarbe","pt":"Cor do tÃ­tulo","pl":"Kolor tytuÅu","nl":"Titelkleur","ro":"Culoare titlu","el":"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},"Text color":{"it":"Colore testo","en":"Text color","es":"Color del texto","fr":"Couleur du texte","de":"Textfarbe","pt":"Cor do texto","pl":"Kolor tekstu","nl":"Tekstkleur","ro":"Culoare text","el":"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Project shown in the widget":{"it":"Progetto mostrato nel widget","en":"Project shown in the widget","es":"Proyecto mostrado en el widget","fr":"Projet affichÃ© dans le widget","de":"Im Widget angezeigtes Projekt","pt":"Projeto mostrado no widget","pl":"Projekt pokazany w widÅ¼ecie","nl":"Project getoond in de widget","ro":"Proiect afiÈat Ã®n widget","el":"ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"},"Save and update widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},"Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.":{"it":"Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.","en":"You choose the exact content when adding the widget to the Home screen; here you only edit appearance, colors, transparency and updates.","es":"El contenido exacto se elige al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas aspecto, colores, transparencia y actualizaciÃ³n.","fr":"Le contenu exact se choisit lors de lâajout du widget Ã  lâÃ©cran dâaccueil ; ici vous modifiez seulement lâaspect, les couleurs, la transparence et lâactualisation.","de":"Den genauen Inhalt wÃ¤hlst du beim HinzufÃ¼gen des Widgets zum Startbildschirm; hier Ã¤nderst du nur Aussehen, Farben, Transparenz und Aktualisierung.","pt":"O conteÃºdo exato Ã© escolhido ao adicionar o widget ao ecrÃ£ inicial; aqui alteras apenas aspeto, cores, transparÃªncia e atualizaÃ§Ã£o.","pl":"DokÅadnÄ treÅÄ wybierasz podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory, przezroczystoÅÄ i odÅwieÅ¼anie.","nl":"De exacte inhoud kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren, transparantie en updates.","ro":"ConÈinutul exact se alege cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile, transparenÈa Èi actualizarea.","el":"Î¤Î¿ Î±ÎºÏÎ¹Î²Î­Ï ÏÎµÏÎ¹ÎµÏÏÎ¼ÎµÎ½Î¿ ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÏÎµ Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ±, Î´Î¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},"La carta precisa si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.":{"it":"La carta precisa si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.","en":"You choose the exact card when adding the widget to the Home screen; here you only edit appearance, colors, transparency and updates.","es":"La tarjeta exacta se elige al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas aspecto, colores, transparencia y actualizaciÃ³n.","fr":"La carte exacte se choisit lors de lâajout du widget Ã  lâÃ©cran dâaccueil ; ici vous modifiez seulement lâaspect, les couleurs, la transparence et lâactualisation.","de":"Die genaue Karte wÃ¤hlst du beim HinzufÃ¼gen des Widgets zum Startbildschirm; hier Ã¤nderst du nur Aussehen, Farben, Transparenz und Aktualisierung.","pt":"O cartÃ£o exato Ã© escolhido ao adicionar o widget ao ecrÃ£ inicial; aqui alteras apenas aspeto, cores, transparÃªncia e atualizaÃ§Ã£o.","pl":"DokÅadnÄ kartÄ wybierasz podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory, przezroczystoÅÄ i odÅwieÅ¼anie.","nl":"De exacte kaart kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren, transparantie en updates.","ro":"Cardul exact se alege cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile, transparenÈa Èi actualizarea.","el":"Î Î±ÎºÏÎ¹Î²Î®Ï ÎºÎ¬ÏÏÎ± ÎµÏÎ¹Î»Î­Î³ÎµÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÏÎµ Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ±, Î´Î¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},"I debiti e crediti precisi si scelgono quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.":{"it":"I debiti e crediti precisi si scelgono quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori, trasparenza e aggiornamento.","en":"You choose the exact debts and credits when adding the widget to the Home screen; here you only edit appearance, colors, transparency and updates.","es":"Las deudas y crÃ©ditos exactos se eligen al aÃ±adir el widget a la pantalla de inicio; aquÃ­ solo modificas aspecto, colores, transparencia y actualizaciÃ³n.","fr":"Les dettes et crÃ©dits exacts se choisissent lors de lâajout du widget Ã  lâÃ©cran dâaccueil ; ici vous modifiez seulement lâaspect, les couleurs, la transparence et lâactualisation.","de":"Die genauen Schulden und Guthaben wÃ¤hlst du beim HinzufÃ¼gen des Widgets zum Startbildschirm; hier Ã¤nderst du nur Aussehen, Farben, Transparenz und Aktualisierung.","pt":"As dÃ­vidas e crÃ©ditos exatos sÃ£o escolhidos ao adicionar o widget ao ecrÃ£ inicial; aqui alteras apenas aspeto, cores, transparÃªncia e atualizaÃ§Ã£o.","pl":"DokÅadne dÅugi i naleÅ¼noÅci wybierasz podczas dodawania widÅ¼etu do ekranu gÅÃ³wnego; tutaj zmieniasz tylko wyglÄd, kolory, przezroczystoÅÄ i odÅwieÅ¼anie.","nl":"De exacte schulden en tegoeden kies je wanneer je de widget aan het startscherm toevoegt; hier wijzig je alleen uiterlijk, kleuren, transparantie en updates.","ro":"Datoriile Èi creditele exacte se aleg cÃ¢nd adaugi widgetul pe ecranul principal; aici modifici doar aspectul, culorile, transparenÈa Èi actualizarea.","el":"Î¤Î± Î±ÎºÏÎ¹Î²Î® ÏÏÎ­Î· ÎºÎ±Î¹ ÏÎ¹ÏÏÏÏÎµÎ¹Ï ÎµÏÎ¹Î»Î­Î³Î¿Î½ÏÎ±Î¹ ÏÏÎ±Î½ ÏÏÎ¿ÏÎ¸Î­ÏÎµÏÎµ ÏÎ¿ widget ÏÏÎ·Î½ Î±ÏÏÎ¹ÎºÎ® Î¿Î¸ÏÎ½Î·Â· ÎµÎ´Ï Î±Î»Î»Î¬Î¶ÎµÏÎµ Î¼ÏÎ½Î¿ ÎµÎ¼ÏÎ¬Î½Î¹ÏÎ·, ÏÏÏÎ¼Î±ÏÎ±, Î´Î¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ·."},"Grandezza testo":{"it":"Grandezza testo","en":"Text size","es":"TamaÃ±o del texto","fr":"Taille du texte","de":"TextgrÃ¶Ãe","pt":"Tamanho do texto","pl":"Rozmiar tekstu","nl":"Tekstgrootte","ro":"Dimensiune text","el":"ÎÎ­Î³ÎµÎ¸Î¿Ï ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Dimensione del contenuto mostrato nel widget.":{"it":"Dimensione del contenuto mostrato nel widget.","en":"Size of the content shown in the widget.","es":"TamaÃ±o del contenido mostrado en el widget.","fr":"Taille du contenu affichÃ© dans le widget.","de":"GrÃ¶Ãe des im Widget angezeigten Inhalts.","pt":"Tamanho do conteÃºdo mostrado no widget.","pl":"Rozmiar treÅci pokazywanej w widÅ¼ecie.","nl":"Grootte van de inhoud die in de widget wordt getoond.","ro":"Dimensiunea conÈinutului afiÈat Ã®n widget.","el":"ÎÎ­Î³ÎµÎ¸Î¿Ï ÏÎ¿Ï ÏÎµÏÎ¹ÎµÏÎ¿Î¼Î­Î½Î¿Ï ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget."},"Trasparenza sfondo widget":{"it":"Trasparenza sfondo widget","en":"Widget background transparency","es":"Transparencia del fondo del widget","fr":"Transparence du fond du widget","de":"Widget-Hintergrundtransparenz","pt":"TransparÃªncia do fundo do widget","pl":"PrzezroczystoÅÄ tÅa widÅ¼etu","nl":"Transparantie van widgetachtergrond","ro":"TransparenÈÄ fundal widget","el":"ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget"},"100% = completamente trasparente. 0% = sfondo pieno.":{"it":"100% = completamente trasparente. 0% = sfondo pieno.","en":"100% = fully transparent. 0% = solid background.","es":"100% = totalmente transparente. 0% = fondo sÃ³lido.","fr":"100 % = totalement transparent. 0 % = fond plein.","de":"100 % = vollstÃ¤ndig transparent. 0 % = voller Hintergrund.","pt":"100% = totalmente transparente. 0% = fundo sÃ³lido.","pl":"100% = caÅkowicie przezroczyste. 0% = peÅne tÅo.","nl":"100% = volledig transparant. 0% = volle achtergrond.","ro":"100% = complet transparent. 0% = fundal plin.","el":"100% = ÏÎ»Î®ÏÏÏ Î´Î¹Î±ÏÎ±Î½Î­Ï. 0% = ÏÎ»Î®ÏÎµÏ ÏÏÎ½ÏÎ¿."},"Aggiornamento automatico":{"it":"Aggiornamento automatico","en":"Automatic update","es":"ActualizaciÃ³n automÃ¡tica","fr":"Mise Ã  jour automatique","de":"Automatische Aktualisierung","pt":"AtualizaÃ§Ã£o automÃ¡tica","pl":"Automatyczna aktualizacja","nl":"Automatische update","ro":"Actualizare automatÄ","el":"ÎÏÏÏÎ¼Î±ÏÎ· ÎµÎ½Î·Î¼Î­ÏÏÏÎ·"},"Aggiorna i widget giÃ  installati quando cambi contenuti o impostazioni.":{"it":"Aggiorna i widget giÃ  installati quando cambi contenuti o impostazioni.","en":"Updates already installed widgets when you change content or settings.","es":"Actualiza los widgets ya instalados cuando cambias contenidos o ajustes.","fr":"Met Ã  jour les widgets dÃ©jÃ  installÃ©s lorsque vous changez du contenu ou des paramÃ¨tres.","de":"Aktualisiert bereits installierte Widgets, wenn du Inhalte oder Einstellungen Ã¤nderst.","pt":"Atualiza os widgets jÃ¡ instalados quando alteras conteÃºdos ou definiÃ§Ãµes.","pl":"Aktualizuje juÅ¼ zainstalowane widÅ¼ety po zmianie treÅci lub ustawieÅ.","nl":"Werkt al geÃ¯nstalleerde widgets bij wanneer je inhoud of instellingen wijzigt.","ro":"ActualizeazÄ widgeturile deja instalate cÃ¢nd schimbi conÈinutul sau setÄrile.","el":"ÎÎ½Î·Î¼ÎµÏÏÎ½ÎµÎ¹ ÏÎ± Î®Î´Î· ÎµÎ³ÎºÎ±ÏÎµÏÏÎ·Î¼Î­Î½Î± widget ÏÏÎ±Î½ Î±Î»Î»Î¬Î¶ÎµÏÎµ ÏÎµÏÎ¹ÎµÏÏÎ¼ÎµÎ½Î¿ Î® ÏÏÎ¸Î¼Î¯ÏÎµÎ¹Ï."},"Colore icona":{"it":"Colore icona","en":"Icon color","es":"Color del icono","fr":"Couleur de lâicÃ´ne","de":"Symbolfarbe","pt":"Cor do Ã­cone","pl":"Kolor ikony","nl":"Pictogramkleur","ro":"Culoare pictogramÄ","el":"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},"Colore titolo":{"it":"Colore titolo","en":"Title color","es":"Color del tÃ­tulo","fr":"Couleur du titre","de":"Titelfarbe","pt":"Cor do tÃ­tulo","pl":"Kolor tytuÅu","nl":"Titelkleur","ro":"Culoare titlu","el":"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},"Colore testo":{"it":"Colore testo","en":"Text color","es":"Color del texto","fr":"Couleur du texte","de":"Textfarbe","pt":"Cor do texto","pl":"Kolor tekstu","nl":"Tekstkleur","ro":"Culoare text","el":"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Progetto mostrato nel widget":{"it":"Progetto mostrato nel widget","en":"Project shown in the widget","es":"Proyecto mostrado en el widget","fr":"Projet affichÃ© dans le widget","de":"Im Widget angezeigtes Projekt","pt":"Projeto mostrado no widget","pl":"Projekt pokazany w widÅ¼ecie","nl":"Project getoond in de widget","ro":"Proiect afiÈat Ã®n widget","el":"ÎÏÎ³Î¿ ÏÎ¿Ï ÎµÎ¼ÏÎ±Î½Î¯Î¶ÎµÏÎ±Î¹ ÏÏÎ¿ widget"},"Salva e aggiorna widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"}};Object.keys(EXTRA_WIDGET_TRANSLATIONS_1633).forEach(function(x){D[x]=EXTRA_WIDGET_TRANSLATIONS_1633[x];});var WIDGET_ALIAS_TRANSLATIONS_1634={"Icon Color":{"it":"Colore icona","en":"Icon color","es":"Color del icono","fr":"Couleur de lâicÃ´ne","de":"Symbolfarbe","pt":"Cor do Ã­cone","pl":"Kolor ikony","nl":"Pictogramkleur","ro":"Culoare pictogramÄ","el":"Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï"},"Title Color":{"it":"Colore titolo","en":"Title color","es":"Color del tÃ­tulo","fr":"Couleur du titre","de":"Titelfarbe","pt":"Cor do tÃ­tulo","pl":"Kolor tytuÅu","nl":"Titelkleur","ro":"Culoare titlu","el":"Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï"},"Text Color":{"it":"Colore testo","en":"Text color","es":"Color del texto","fr":"Couleur du texte","de":"Textfarbe","pt":"Cor do texto","pl":"Kolor tekstu","nl":"Tekstkleur","ro":"Culoare text","el":"Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï"},"Background Transparency":{"it":"Trasparenza sfondo widget","en":"Widget background transparency","es":"Transparencia del fondo del widget","fr":"Transparence du fond du widget","de":"Widget-Hintergrundtransparenz","pt":"TransparÃªncia do fundo do widget","pl":"PrzezroczystoÅÄ tÅa widÅ¼etu","nl":"Transparantie widgetachtergrond","ro":"TransparenÈÄ fundal widget","el":"ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget"},"Save and Update widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},"Save and update widget":{"it":"Salva e aggiorna widget","en":"Save and update widget","es":"Guardar y actualizar widget","fr":"Enregistrer et mettre Ã  jour le widget","de":"Widget speichern und aktualisieren","pt":"Guardar e atualizar widget","pl":"Zapisz i zaktualizuj widÅ¼et","nl":"Widget opslaan en bijwerken","ro":"SalveazÄ Èi actualizeazÄ widgetul","el":"ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget"},"Show percentage":{"it":"Mostra percentuale","en":"Show percentage","es":"Mostrar porcentaje","fr":"Afficher le pourcentage","de":"Prozent anzeigen","pt":"Mostrar percentagem","pl":"PokaÅ¼ procent","nl":"Percentage tonen","ro":"AfiÈeazÄ procentul","el":"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"},"Show amounts":{"it":"Mostra importi","en":"Show amounts","es":"Mostrar importes","fr":"Afficher les montants","de":"BetrÃ¤ge anzeigen","pt":"Mostrar valores","pl":"PokaÅ¼ kwoty","nl":"Bedragen tonen","ro":"AfiÈeazÄ sumele","el":"ÎÎ¼ÏÎ¬Î½Î¹ÏÎ· ÏÎ¿ÏÏÎ½"},"Bar color":{"it":"Colore barra","en":"Bar color","es":"Color de la barra","fr":"Couleur de la barre","de":"Balkenfarbe","pt":"Cor da barra","pl":"Kolor paska","nl":"Balkkleur","ro":"Culoarea barei","el":"Î§ÏÏÎ¼Î± Î³ÏÎ±Î¼Î¼Î®Ï"},"Percentage color":{"it":"Colore percentuale","en":"Percentage color","es":"Color del porcentaje","fr":"Couleur du pourcentage","de":"Prozentfarbe","pt":"Cor da percentagem","pl":"Kolor procentu","nl":"Percentagekleur","ro":"Culoarea procentului","el":"Î§ÏÏÎ¼Î± ÏÎ¿ÏÎ¿ÏÏÎ¿Ï"}};Object.keys(WIDGET_ALIAS_TRANSLATIONS_1634).forEach(function(x){D[x]=WIDGET_ALIAS_TRANSLATIONS_1634[x];});
    var EXTRA_FINAL_1637={"Spunta i prodotti giÃ  messi nel carrello.":{en:"Tick the products already in your cart.",es:"Marca los productos ya puestos en el carrito.",fr:"Cochez les produits dÃ©jÃ  mis dans le panier.",de:"Markiere die Produkte, die bereits im Einkaufswagen sind.",pt:"Marca os produtos jÃ¡ colocados no carrinho.",pl:"Zaznacz produkty juÅ¼ wÅoÅ¼one do koszyka.",nl:"Vink de producten aan die al in je winkelwagen liggen.",ro:"BifeazÄ produsele deja puse Ã®n coÈ.",el:"Î£Î·Î¼ÎµÎ¹ÏÏÏÎµ ÏÎ± ÏÏÎ¿ÏÏÎ½ÏÎ± ÏÎ¿Ï ÎµÎ¯Î½Î±Î¹ Î®Î´Î· ÏÏÎ¿ ÎºÎ±Î»Î¬Î¸Î¹."},"Se vuoi creare unâaltra lista, vai nelle impostazioni":{en:"To create another list, go to settings",es:"Si quieres crear otra lista, ve a los ajustes",fr:"Pour crÃ©er une autre liste, allez dans les paramÃ¨tres",de:"Wenn du eine weitere Liste erstellen mÃ¶chtest, gehe zu den Einstellungen",pt:"Se quiseres criar outra lista, vai Ã s definiÃ§Ãµes",pl:"Aby utworzyÄ innÄ listÄ, przejdÅº do ustawieÅ",nl:"Ga naar instellingen om een andere lijst te maken",ro:"Pentru a crea o altÄ listÄ, mergi la setÄri",el:"ÎÎ¹Î± Î½Î± Î´Î·Î¼Î¹Î¿ÏÏÎ³Î®ÏÎµÏÎµ Î¬Î»Î»Î· Î»Î¯ÏÏÎ±, Î¼ÎµÏÎ±Î²ÎµÎ¯ÏÎµ ÏÏÎ¹Ï ÏÏÎ¸Î¼Î¯ÏÎµÎ¹Ï"},"Liste della spesa":{en:"Shopping lists",es:"Listas de la compra",fr:"Listes de courses",de:"Einkaufslisten",pt:"Listas de compras",pl:"Listy zakupÃ³w",nl:"Boodschappenlijsten",ro:"Liste de cumpÄrÄturi",el:"ÎÎ¯ÏÏÎµÏ Î±Î³Î¿ÏÏÎ½"},"Crea, modifica o elimina le liste disponibili nella sezione Spesa.":{en:"Create, edit or delete the lists available in the Shopping section.",es:"Crea, modifica o elimina las listas disponibles en la secciÃ³n Compra.",fr:"CrÃ©ez, modifiez ou supprimez les listes disponibles dans la section Courses.",de:"Erstelle, bearbeite oder lÃ¶sche die Listen im Bereich Einkaufen.",pt:"Cria, edita ou elimina as listas disponÃ­veis na secÃ§Ã£o Compras.",pl:"TwÃ³rz, edytuj lub usuwaj listy dostÄpne w sekcji Zakupy.",nl:"Maak, bewerk of verwijder de lijsten in de sectie Boodschappen.",ro:"CreeazÄ, modificÄ sau Èterge listele disponibile Ã®n secÈiunea CumpÄrÄturi.",el:"ÎÎ·Î¼Î¹Î¿ÏÏÎ³Î®ÏÏÎµ, ÎµÏÎµÎ¾ÎµÏÎ³Î±ÏÏÎµÎ¯ÏÎµ Î® Î´Î¹Î±Î³ÏÎ¬ÏÏÎµ ÏÎ¹Ï Î»Î¯ÏÏÎµÏ ÏÏÎ·Î½ ÎµÎ½ÏÏÎ·ÏÎ± ÎÎ³Î¿ÏÎ­Ï."},"Lista della spesa creata":{en:"Shopping list created",es:"Lista de la compra creada",fr:"Liste de courses crÃ©Ã©e",de:"Einkaufsliste erstellt",pt:"Lista de compras criada",pl:"Lista zakupÃ³w utworzona",nl:"Boodschappenlijst aangemaakt",ro:"Lista de cumpÄrÄturi a fost creatÄ",el:"Î Î»Î¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½ Î´Î·Î¼Î¹Î¿ÏÏÎ³Î®Î¸Î·ÎºÎµ"},"Lista della spesa aggiornata":{en:"Shopping list updated",es:"Lista de la compra actualizada",fr:"Liste de courses mise Ã  jour",de:"Einkaufsliste aktualisiert",pt:"Lista de compras atualizada",pl:"Lista zakupÃ³w zaktualizowana",nl:"Boodschappenlijst bijgewerkt",ro:"Lista de cumpÄrÄturi a fost actualizatÄ",el:"Î Î»Î¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½ ÎµÎ½Î·Î¼ÎµÏÏÎ¸Î·ÎºÎµ"},"Confermi la cancellazione?":{en:"Confirm deletion?",es:"Â¿Confirmas la eliminaciÃ³n?",fr:"Confirmer la suppression ?",de:"LÃ¶schung bestÃ¤tigen?",pt:"Confirmas a eliminaÃ§Ã£o?",pl:"Potwierdzasz usuniÄcie?",nl:"Verwijderen bevestigen?",ro:"Confirmi Ètergerea?",el:"ÎÏÎ¹Î²ÎµÎ²Î±Î¹ÏÎ½ÎµÏÎµ ÏÎ· Î´Î¹Î±Î³ÏÎ±ÏÎ®;"},"Cancellazione completata":{en:"Deletion completed",es:"EliminaciÃ³n completada",fr:"Suppression terminÃ©e",de:"LÃ¶schung abgeschlossen",pt:"EliminaÃ§Ã£o concluÃ­da",pl:"Usuwanie zakoÅczone",nl:"Verwijderen voltooid",ro:"Ètergere finalizatÄ",el:"Î Î´Î¹Î±Î³ÏÎ±ÏÎ® Î¿Î»Î¿ÎºÎ»Î·ÏÏÎ¸Î·ÎºÎµ"},"Transazione modificata":{en:"Transaction updated",es:"TransacciÃ³n modificada",fr:"Transaction modifiÃ©e",de:"Transaktion geÃ¤ndert",pt:"TransaÃ§Ã£o modificada",pl:"Transakcja zmieniona",nl:"Transactie gewijzigd",ro:"TranzacÈie modificatÄ",el:"Î ÏÏÎ½Î±Î»Î»Î±Î³Î® ÏÏÎ¿ÏÎ¿ÏÎ¿Î¹Î®Î¸Î·ÎºÎµ"},"La lista principale non puÃ² essere eliminata se Ã¨ lâunica lista.":{en:"The main list cannot be deleted if it is the only list.",es:"La lista principal no se puede eliminar si es la Ãºnica lista.",fr:"La liste principale ne peut pas Ãªtre supprimÃ©e si câest la seule liste.",de:"Die Hauptliste kann nicht gelÃ¶scht werden, wenn sie die einzige Liste ist.",pt:"A lista principal nÃ£o pode ser eliminada se for a Ãºnica lista.",pl:"GÅÃ³wnej listy nie moÅ¼na usunÄÄ, jeÅli jest jedynÄ listÄ.",nl:"De hoofdlijst kan niet worden verwijderd als dit de enige lijst is.",ro:"Lista principalÄ nu poate fi ÈtearsÄ dacÄ este singura listÄ.",el:"Î ÎºÏÏÎ¹Î± Î»Î¯ÏÏÎ± Î´ÎµÎ½ Î¼ÏÎ¿ÏÎµÎ¯ Î½Î± Î´Î¹Î±Î³ÏÎ±ÏÎµÎ¯ Î±Î½ ÎµÎ¯Î½Î±Î¹ Î· Î¼ÏÎ½Î· Î»Î¯ÏÏÎ±."},"Lista selezionata":{en:"Selected list",es:"Lista seleccionada",fr:"Liste sÃ©lectionnÃ©e",de:"AusgewÃ¤hlte Liste",pt:"Lista selecionada",pl:"Wybrana lista",nl:"Geselecteerde lijst",ro:"ListÄ selectatÄ",el:"ÎÏÎ¹Î»ÎµÎ³Î¼Î­Î½Î· Î»Î¯ÏÏÎ±"}};Object.keys(EXTRA_FINAL_1637).forEach(function(k){D[k]=Object.assign({it:k},EXTRA_FINAL_1637[k]);});
var row=D[raw]||D[raw.trim()];
    ...
    function WidgetQuickAddSettingsPanel(){
      ...
      function stripWidgetPrefix(v){return String(v||"").replace(/^\s*[+\-â]\s*/,"").trim();}
      ...
      return <div style={{display:"flex",flexDirection:"column",gap:14}}>
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:14,padding:16}}><div style={{fontSize:15,fontWeight:900,color:textC,marginBottom:4}}>{L("â¡ Aggiunta Rapida")}</div><SettingHint>{L("Questo widget serve per inserire rapidamente una nuova uscita o una nuova entrata direttamente dalla Home del telefono, senza aprire manualmente lâapp.")}</SettingHint><div style={{background:cardAlpha,border:"1px solid rgba(255,255,255,.18)",borderRadius:14,padding:10,display:"flex",alignItems:"center",gap:10,boxShadow:"inset 0 1px 0 rgba(255,255,255,.08)"}}><FAInanceLogo size={36}/><div style={{height:32,width:1,background:"rgba(255,255,255,.18)"}}/>{draft.voiceEnabled&&<div style={{width:34,height:34,borderRadius:17,background:"rgba(255,255,255,.18)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,color:previewText}}>ðï¸</div>}<div style={{flex:1,background:draft.expenseColor,color:"#fff",borderRadius:radiusFor(draft.buttonStyle),padding:"10px 8px",display:"flex",alignItems:"center",justifyContent:"center",gap:8,fontSize:13,fontWeight:900}}><span>â</span><span>{L(draft.expenseLabel||"Uscita")}</span></div><div style={{flex:1,background:draft.incomeColor,color:"#fff",borderRadius:radiusFor(draft.buttonStyle),padding:"10px 8px",display:"flex",alignItems:"center",justifyContent:"center",gap:8,fontSize:13,fontWeight:900}}><span>+</span><span>{L(draft.incomeLabel||"Entrata")}</span></div><div style={{width:30,height:30,borderRadius:15,border:"1px solid rgba(255,255,255,.25)",display:"flex",alignItems:"center",justifyContent:"center",color:previewText}}>â</div></div>{draft.showHeader&&<div style={{background:cardAlpha,border:"1px solid rgba(255,255,255,.18)",borderRadius:14,padding:14,marginTop:12}}><div style={{display:"flex",alignItems:"center",gap:10,marginBottom:12}}><FAInanceLogo size={42}/><div style={{flex:1,minWidth:0}}><div style={{fontSize:16,fontWeight:900,color:previewText}}>{draft.title||"fAInance"}</div><div style={{fontSize:12,color:previewSub}}>{draft.subtitle||"Aggiunta rapida movimenti"}</div></div><div style={{color:previewText}}>â</div></div><div style={{display:"flex",gap:10}}>{draft.voiceEnabled&&<div style={{width:44,background:"rgba(255,255,255,.18)",color:previewText,border:"1px solid rgba(255,255,255,.25)",borderRadius:radiusFor(draft.buttonStyle),padding:"10px 10px",textAlign:"center",fontWeight:900}}>ðï¸</div>}<div style={{flex:1,background:draft.expenseColor,color:"#fff",borderRadius:radiusFor(draft.buttonStyle),padding:"10px 10px",textAlign:"center",fontWeight:900}}>â {L(draft.expenseLabel||"Uscita")}</div><div style={{flex:1,background:draft.incomeColor,color:"#fff",borderRadius:radiusFor(draft.buttonStyle),padding:"10px 10px",textAlign:"center",fontWeight:900}}>+ {L(draft.incomeLabel||"Entrata")}</div></div></div>}</div>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,background:cardBg,border:"1px solid "+borderC,borderRadius:12,padding:"12px 14px"}}><div><div style={{fontSize:13,fontWeight:800,color:textC}}>{L("Mostra microfono nel widget")}</div><div style={{fontSize:12,color:subC}}>{L("Aggiunge il pulsante ðï¸ sulla sinistra del widget di aggiunta rapida.")}</div></div><Toggle label="" checked={!!draft.voiceEnabled} onChange={function(){dset("voiceEnabled",!draft.voiceEnabled);}}/></div>
    ...
    function WidgetNoteSettingsPanel(){
      ...
      return <div style={{display:"flex",flexDirection:"column",gap:14}}>
        <WidgetIntroCard icon="ð" title={L("Nota / Coordinata")}>{L("Questo widget mostra sulla Home una nota salvata oppure una coordinata bancaria. Il contenuto preciso si sceglie quando aggiungi il widget alla Home; qui modifichi solo aspetto, colori e aggiornamento.")}</WidgetIntroCard>
    ...
    function WidgetGoalSettingsPanel(){
      ...
      return <div style={{display:"flex",flexDirection:"column",gap:14}}>
        <WidgetIntroCard icon="ð¯" title={L("Obiettivo")}>{L("Questo widget mostra sulla Home lâavanzamento di un obiettivo di risparmio: nome, percentuale, barra e importi. Lâobiettivo preciso si sceglie quando aggiungi il widget alla Home; qui modifichi aspetto e colori.")}</WidgetIntroCard>
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:14,padding:14}}><div style={{background:dark?"#111827":"#F8FAFC",border:"1px solid "+borderC,borderRadius:14,padding:12,display:"flex",alignItems:"center",gap:12}}><div style={{width:48,height:48,borderRadius:24,background:gColor,display:"flex",alignItems:"center",justifyContent:"center",fontSize:24,color:"#fff"}}>{selectedGoal?(selectedGoal.icon||"ð¯"):"ð¯"}</div><div style={{flex:1,minWidth:0}}><div style={{display:"flex",justifyContent:"space-between",gap:10}}><div style={{fontSize:16,fontWeight:900,color:widget3TextColor,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{selectedGoal?(selectedGoal.name||"Obiettivo"):"Anteprima obiettivo"}</div>{widget3ShowPercent&&<div style={{fontSize:16,fontWeight:900,color:widget3PercentColor}}>{pct}%</div>}</div><div style={{height:8,borderRadius:8,background:dark?"#273244":"#E5E7EB",overflow:"hidden",marginTop:8}}><div style={{width:pct+"%",height:"100%",background:gColor,borderRadius:8}}/></div>{widget3ShowAmounts&&<div style={{fontSize:12,color:widget3TextColor,marginTop:5,opacity:0.82}}><span style={{color:widget3PercentColor,fontWeight:800}}>{fmt(saved)}</span> / {fmt(target)}</div>}</div><div style={{fontSize:18,color:subC}}>â</div></div></div>
        ...
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:14,padding:14}}><div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,marginBottom:8}}><div><div style={{fontSize:13,fontWeight:900,color:textC}}>{L("Trasparenza sfondo widget")}</div><div style={{fontSize:12,color:subC}}>{L("100% = completamente trasparente. 0% = sfondo pieno.")}</div></div><div style={{fontSize:16,fontWeight:900,color:"#7F77DD"}}>{draftBgAlpha}%</div></div><input type="range" min="0" max="100" step="1" value={draftBgAlpha} onChange={function(e){setDraftBgAlpha(Number(e.target.value));}} style={{width:"100%"}}/><input type="number" min="0" max="100" value={draftBgAlpha} onChange={function(e){setDraftBgAlpha(Math.max(0,Math.min(100,Number(e.target.value)||0)));}} style={{...sinp,width:90,marginTop:8}}/></div>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,background:cardBg,border:"1px solid "+borderC,borderRadius:14,padding:14}}><div><div style={{fontSize:13,fontWeight:800,color:textC}}>{L("Aggiornamento automatico")}</div><div style={{fontSize:12,color:subC}}>{L("Aggiorna il widget quando cambia lâobiettivo.")}</div></div><Toggle label="" checked={!!widget3AutoUpdate} onChange={function(){setWidget3AutoUpdate(!widget3AutoUpdate);}}/></div>
        <Btn onClick={save} bg="#7F77DD" style={{width:"100%",padding:12,fontWeight:800}}>{L("Salva e aggiorna widget")}</Btn>
      </div>;
    }
    ...
    function WidgetShareSettingsPanel(){
      ...
      function projectBalance(project){
        if(!project)return{net:0,owed:0,owe:0,last:"Nessuna attivitÃ  recente"};
        var participants=(project.participants||[]);
        var member=participants.find(function(p){return p.uid===userId;})||participants.find(function(p){return p.id==="me";})||participants[0]||null;
        var currentId=member?member.id:"me";
        ...
        return{net:net,owed:Math.max(0,net),owe:Math.max(0,-net),last:last?(last.kind==="settlement"?"Ultimo saldo: "+fmt(Number(last.amount||0)):(last.desc||"Ultima spesa")+" Â· "+fmt(Number(last.amount||0))):"Nessuna attivitÃ  recente"};
      }
      ...
      return <div style={{display:"flex",flexDirection:"column",gap:14}}>
        <WidgetIntroCard icon="ð¤" title="Share">{L("Questo widget mostra sulla Home il riepilogo di un progetto Share: saldo personale, quanto devi, quanto ti devono e ultima attivitÃ . Il progetto puÃ² essere scelto qui come default e anche dal tasto di configurazione quando aggiungi il widget.")}</WidgetIntroCard>
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:14,padding:14}}>
          ...
          <div style={{fontSize:12,color:subC,marginBottom:8}}>{L("Scegli il progetto predefinito. Ogni singolo widget potrÃ  comunque essere configurato con un progetto diverso.")}</div>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr 1fr",gap:10}}>
          ...
          <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:14,padding:14}}><div style={{fontSize:13,fontWeight:800,color:textC,marginBottom:8}}>{L("Colore AttivitÃ ")}</div><input type="color" value={widgetShareActivityColor} onChange={function(e){setWidgetShareActivityColor(e.target.value);saveWidgetSettingsToNative(false,{...widgetSettingsPayload(),shareWidget:{...widgetSettingsPayload().shareWidget,activityColor:e.target.value}});}} style={{width:54,height:42,border:"none",borderRadius:10,background:"transparent"}}/></div>
    ...
    function GroupSettingsPanel({title,desc,items,setItems,defaultValue,setDefaultValue,withIcon}){
      ...
      var [form,setForm]=useState({name:"",icon:"ð",color:COLORS[0]});
      function add(){if(blockSetting("base"))return;if(!form.name.trim())return;setItems([...(items||[]),{id:"area_"+Date.now(),name:form.name.trim(),icon:withIcon?form.icon:undefined,color:form.color}]);setForm({name:"",icon:"ð",color:COLORS[0]});}
...
var ordered=(cleanCatOrder.length?cleanCatOrder.map(function(id){return cats.find(function(c){return String(c.id)===String(id);});}).filter(Boolean).concat(cats.filter(function(c){return cleanCatOrder.indexOf(String(c.id))<0&&cleanCatOrder.indexOf(c.id)<0;})):cats);return <div><PageHeader title={L("Uscite / Categorie")}/><div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}><SettingHint>{L("Gestisci categorie uscite: lista, riordino, default e accorpamento.")}</SettingHint><Segmented items={[{id:"list",label:"Lista categorie"},{id:"order",label:"Riordina",disabled:!baseSettingsAllowed,lockedMessage:settingLockedMessage("base")},{id:"default",label:"Default"},{id:"merge",label:"Accorpa",disabled:!baseSettingsAllowed,lockedMessage:settingLockedMessage("base")}]} value={view} onChange={setView}/>{view==="list"&&<><SettingsList items={cats} setItems={guardedSetter(setCats,"base")} label="Aggiungi categoria uscita" showGroup showIcon groupList={expenseGroups||DEFAULT_EXPENSE_GROUPS}/>{baseLockHint("Modifica, archiviazione, eliminazione e aggiunta categorie disponibili dal piano Base")}</>} {view==="order"&&<SortableRows items={ordered} onMove={function(i,dir){if(blockSetting("base"))return;var j=i+dir;if(j<0||j>=ordered.length)return;var arr=ordered.slice();var tmp=arr[i];arr[i]=arr[j];arr[j]=tmp;setCatOrder(arr.map(function(c){return c.id;}));setCats(arr.concat(cats.filter(function(c){return arr.findIndex(function(x){return String(x.id)===String(c.id);})<0;})));}} renderItem={function(c){return <div style={{display:"flex",alignItems:"center",gap:10,minWidth:0}}><span style={{fontSize:18}}>{c.icon}</span><span style={{fontSize:13,color:textC,fontWeight:600,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{L(c.name)}</span></div>;}}/>}{view==="default"&&<div><select value={defaultExpenseCat||""} onChange={function(e){setDefaultExpenseCat(e.target.value);}} style={{...sinp,width:"100%"}}><option value="">{L("Nessuna categoria default")}</option>{cats.map(function(c){return <option key={c.id} value={c.id}>{c.icon} {L(c.name)}</option>;})}</select></div>}{view==="merge"&&<div><div style={{marginBottom:12}}><label style={{fontSize:12,color:subC,display:"block",marginBottom:4}}>{L("Da (elimina)")}</label><select value={mergeFrom} onChange={function(e){setMergeFrom(e.target.value);}} style={sinp}><option value="">-</option>{cats.map(function(c){return <option key={c.id} value={c.id}>{c.icon} {L(c.name)}</option>;})}</select></div><div style={{marginBottom:16}}><label style={{fontSize:12,color:subC,display:"block",marginBottom:4}}>{L("In (mantieni)")}</label><select value={mergeTo} onChange={function(e){setMergeTo(e.target.value);}} style={sinp}><option value="">-</option>{cats.filter(function(c){return String(c.id)!==mergeFrom;}).map(function(c){return <option key={c.id} value={c.id}>{c.icon} {L(c.name)}</option>;})}</select></div><Btn onClick={function(){if(blockSetting("base"))return;if(!mergeFrom||!mergeTo)return;setExpenses(expenses.map(function(e){return e.catId===Number(mergeFrom)?{...e,catId:Number(mergeTo)}:e;}));setCats(cats.filter(function(c){return c.id!==Number(mergeFrom);}));setMergeFrom("");setMergeTo("");}} style={{width:"100%",padding:13,fontSize:14,fontWeight:600}}>{L("Accorpa")}</Btn></div>}</div></div>;}
    ...
    function IncomeCategoriesSettings(){
      ...
      var ordered=orderedRaw.map(function(it){return {...it,group:it.group||incomeDefaultGroup(it.id),color:it.color||"#5DCAA5",icon:it.icon||"ð°"};});
      function setIncomeItems(nextItems){
        ...
        orderedRaw.forEach(function(oldItem){
          ...
          if(used){
            if(setToast)setToast({text:L("Non puoi eliminare questa voce perchÃ© esistono giÃ  elementi associati. Archiviala invece di eliminarla."),type:"warning",color:"#EF9F27",icon:"â ï¸"});
        ...
        (nextItems||[]).forEach(function(it){
          ...
          var clean={name:it.name,icon:it.icon||"ð°",color:it.color||"#5DCAA5",group:it.group||(groups[0]?groups[0].id:"lavoro"),archived:!!it.archived,deleted:false};
    ...
    if(settingsPage==="general")return <div><PageHeader title="Generale"/>
      <div style={{display:"flex",flexDirection:"column",gap:14}}>
        <div style={{display:"flex",flexDirection:"column",gap:0,borderRadius:14,overflow:"hidden",border:"1px solid "+borderC}}>
          {[{label:"ð Lingua",el:<div><select value={pendingLang} onChange={function(e){setPendingLang(e.target.value);}} style={{...sinp,width:"100%",marginBottom:8}}>{LANGUAGES.map(function(l){return <option key={l.code} value={l.code}>{l.label}</option>;})}</select><Btn onClick={function(){var nextLang=pendingLang;setLang(nextLang);try{localStorage.setItem("pref_lang_v2",JSON.stringify(nextLang));}catch(e){};setToast({text:translateFainanceText("Lingua aggiornata",nextLang),type:"success",translated:true});}} bg="#7F77DD" style={{width:"100%",padding:10}}>{L("Salva lingua")}</Btn><div style={{fontSize:11,color:subC,marginTop:6}}>{L("La lingua viene applicata salvando e ricaricando lâapp.")}</div></div>},{label:"ð Formato data",el:<Segmented items={DATE_FORMATS.map(function(f){return{id:f.id,label:f.label};})} value={dateFmt} onChange={setDateFmt}/>},{label:"ð Primo giorno settimana",el:<Segmented items={[{id:"mon",label:"LunedÃ¬"},{id:"sun",label:"Domenica"}]} value={firstDayOfWeek} onChange={setFirstDayOfWeek}/>}].map(function(item,i,arr){return <div key={item.label} style={{background:cardBg,padding:"16px 20px",borderBottom:i<arr.length-1?"1px solid "+borderC:"none"}}><div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:8}}>{L(item.label)}</div>{item.el}</div>;})}
        </div>

        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:4}}>ð± {L("Valute")}</div>
          ...
          {secondaryCurrency&&<div style={{display:"flex",flexDirection:"column",gap:10,background:dark?"#252535":"#f9f9f9",borderRadius:12,padding:"14px 16px",border:"1px solid "+borderC,marginTop:12,opacity:settingAllowed("base")?1:.62}}>
            ...
            {[{label:"ð  Home",always:true},{label:"ð Storico",v:showSecInHistory,fn:function(){if(blockSetting("base"))return;setShowSecInHistory(!showSecInHistory);}},{label:"ð Statistiche",v:showSecInStats,fn:function(){if(blockSetting("base"))return;setShowSecInStats(!showSecInStats);}},{label:"ð° Budget",v:showSecInBudget,fn:function(){if(blockSetting("base"))return;setShowSecInBudget(!showSecInBudget);}},{label:"ð Patrimonio",v:showSecInPatrimonio,fn:function(){if(blockSetting("base"))return;setShowSecInPatrimonio(!showSecInPatrimonio);}}].map(function(item,i){return <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{fontSize:13,color:item.always?subC:textC}}>{L(item.label)}</span>{item.always?<span style={{fontSize:11,background:dark?"#333":"#f0f0f0",color:"#aaa",borderRadius:8,padding:"2px 8px"}}>{L("sempre")}</span>:<Toggle label="" checked={item.v} onChange={item.fn}/>}</div>;})}
          </div>}
        </div>

        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:4}}>ð {L("Metriche")}</div>
          <SettingHint>{translateUiRuntimeText("Saldo home e visualizzazione valori.")}</SettingHint>
          <div style={{marginTop:12,marginBottom:14}}>
            <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:6}}>ð  {L("Saldo Home")}</div>
        ...
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          ...
          <SettingHint>{translateUiRuntimeText("Scegli quali dati lâagente AI puÃ² leggere quando risponde nella chat.")}</SettingHint>
          <div style={{display:"flex",flexDirection:"column",gap:10,marginTop:12}}>
            {[
              {id:"summary",icon:"ð",title:"Analisi limitata",desc:"Solo riassunto delle spese: totali mensili/annuali, saldo, categorie principali, budget e ricorrenti."},
              {id:"areas",icon:"ð",title:"Analisi media",desc:"Riassunto + spese raggruppate per area, utile per capire quali blocchi di spesa pesano di piÃ¹."},
              {id:"full",icon:"ð",title:"Analisi completa",desc:"Tutte le transazioni essenziali: data, importo, categoria/metodo o tipo entrata e descrizione."}
              ...
              {active&&<span style={{fontSize:16,color:"#7F77DD",fontWeight:800}}>â</span>}
            </button>;})}
          </div>
          ...
          <div style={{fontSize:11,color:subC,marginTop:10,lineHeight:1.45}}>{L("Questa impostazione viene applicata solo alle richieste inviate allâagente AI esterno. I consigli locali dellâapp continuano a usare i dati giÃ  presenti sul dispositivo.")}</div>
        </div>
      </div>
    </div>;

    if(settingsPage==="sections")return <div><PageHeader title="Sezioni"/><SettingsCards items={[
      {id:"sections_income",icon:"ð°",label:"Entrate",desc:"Aree e categorie delle entrate"},
      {id:"sections_expense",icon:"ð¸",label:"Uscite",desc:"Aree, categorie e metodi di pagamento"},
      {id:"history_settings",icon:"ð",label:t.history||"Storico",desc:"Ordinamento e movimenti futuri"},
      {id:"patrimonio_settings",icon:"ð",label:"Patrimonio",desc:"ModalitÃ , aree e voci patrimonio"},
      {id:"debt_credits_settings",icon:"ð³",label:"Debiti / Crediti",desc:"VisibilitÃ , collegamento a patrimonio e movimenti"},
      {id:"shopping_settings",icon:"ð",label:"Spesa",desc:"Aree lista spesa, fidelity card e prepagate"}
    ]}/></div>;
    ...
    if(settingsPage==="debt_credits_settings")return <div><PageHeader title="Debiti / Crediti"/>
      <div style={{display:"flex",flexDirection:"column",gap:12}}>
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:18}}>
          <div style={{fontSize:14,fontWeight:900,color:textC,marginBottom:4}}>ð³ {L("Debiti / Crediti")}</div>
    ...
    var [newListSettIcon,setNewListSettIcon]=useState("ð§º");
    var [showNewListSettForm,setShowNewListSettForm]=useState(false);
    var SHOP_CREATE_ICONS=["ð","ð","ðª","ð¬","ð¦","ð¥","ð","ð§","ð¨","ðª","ðª","ð©","ðª","ð§²","ð¡","ð","ðª","ð¿","ð","ðª ","ð½","ð§´","ð§¹","ð§º","ð§»","ð«","ð«","ð","ð¥©","ð","ð¥¦","ð","ð§","ð¥","ð·","ð«","â","ð§","ð¥¤","ð","ð","ð£","ð¥","ð","ð°","ð","ð§","ð«","ð§¸","ð®","ð±","ð»","ð¥","ð·","ðµ","ð","ð","â","ð","ð¨","ð¼","ðª´","ð¿","ð¸","ðª","ð","ðª","ð","ðª£","ð§¯","ð","ðª","ð","ð»","ð","ð²","â½","ð","ð","ð§³","ð","ð ","ð","ð","ð§¥","ð©","ð","ð","ðª¥","ð","ðªz","ð","â½","ð¾","ð","ð¸","ð­","ð","ð","ð","â","ðº","ð"];
    function createSettingsShoppingList(){setShowNewListSettForm(true);}
    function confirmCreateSettingsList(){var title=String(newListSettTitle||"").trim();if(!title){setToast({text:L("Inserisci il titolo della lista."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}var icon=newListSettIcon||"ð§º";var id="list_"+Date.now();setShoppingLists(function(list){return (list||[]).concat([{id:id,title:title,icon:icon,createdAt:new Date().toISOString()}]);});setToast({text:L("Lista della spesa creata"),type:"success",icon:"ðï¸"});setNewListSettTitle("");setNewListSettIcon("ð§º");setShowNewListSettForm(false);}
    function editSettingsShoppingList(list){var title=window.prompt(L("Titolo lista"),list.title||"");if(title===null)return;var icon=window.prompt(L("Icona lista"),list.icon||"ð§º");if(icon===null)return;setShoppingLists(function(items){return (items||[]).map(function(x){return String(x.id)===String(list.id)?{...x,title:String(title||"").trim()||list.title,icon:icon||"ð§º",updatedAt:new Date().toISOString()}:x;});});setToast({text:L("Lista della spesa aggiornata"),type:"success",icon:"â"});}
    function deleteSettingsShoppingList(id){var list=(shoppingLists||[]).find(function(x){return String(x.id)===String(id);});if(!list)return;if(String(id)==="main"&&((shoppingLists||[]).length<=1)){setToast({text:L("La lista principale non puÃ² essere eliminata se Ã¨ lâunica lista."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}if(!window.confirm(L("Confermi la cancellazione?")))return;setShoppingLists(function(items){return (items||[]).filter(function(x){return String(x.id)!==String(id);});});setShoppingItems(function(items){return (items||[]).filter(function(x){return String(x.listId||"main")!==String(id)||x.archived;});});if(String(activeShoppingListId)===String(id))setActiveShoppingListId("main");setToast({text:L("Cancellazione completata"),type:"success",icon:"ðï¸"});}
    function shoppingAreaSettingsItems(){return (shoppingAreas||DEFAULT_SHOPPING_AREAS).map(function(a,idx){return{id:String(a),name:String(a),icon:(shoppingAreaIcons&&shoppingAreaIcons[a])||"ð",color:COLORS[idx%COLORS.length]};});}
    function setShoppingAreaSettingsItems(nextItems){var oldIcons=shoppingAreaIcons||{};var nextAreas=[];var nextIcons={};(nextItems||[]).forEach(function(it,idx){var name=String((it&&it.name)||("Area "+(idx+1))).trim()||("Area "+(idx+1));nextAreas.push(name);nextIcons[name]=(it&&it.icon)||oldIcons[it&&it.id]||oldIcons[name]||"ð";});setShoppingAreas(nextAreas);setShoppingAreaIcons(nextIcons);if(shoppingDefaultArea&&nextAreas.indexOf(shoppingDefaultArea)<0)setShoppingDefaultArea(nextAreas[0]||"");}
    ...
    if(settingsPage==="sections_income")return <div><PageHeader title="Entrate"/><SettingsCards items={[
      {id:"sections_income_areas",icon:"ð",label:"Aree",desc:"Lista, riordino e default delle aree entrate"},
      {id:"sections_income_categories",icon:"ð·",label:"Categorie",desc:"Lista, riordino e default delle categorie entrate"}
    ]}/></div>;

    if(settingsPage==="sections_expense")return <div><PageHeader title="Uscite"/><SettingsCards items={[
      {id:"sections_expense_areas",icon:"ð",label:"Aree",desc:"Lista, riordino e default delle aree uscite"},
      {id:"sections_expense_categories",icon:"ð·",label:"Categorie",desc:"Lista, riordino, default e accorpa categorie"},
      {id:"sections_expense_methods",icon:"ð³",label:"Metodi di pagamento",desc:"Lista, riordino e default dei metodi"}
    ]}/></div>;
    ...
    if(settingsPage==="values")return <div><PageHeader title="Categorie & Metodi"/>
      <div style={{display:"flex",gap:8,marginBottom:16,flexWrap:"wrap"}}>
        {[{id:"cats",icon:"ð¸",label:"Uscite"},{id:"income_types",icon:"ð°",label:"Entrate"},{id:"methods",icon:"ð³",label:"Metodi di pagamento"},{id:"areas",icon:"ð",label:"Aree"},{id:"patrimonio",icon:"ð",label:"Patrimonio"},{id:"merge",icon:"â",label:"Accorpa"},{id:"order",icon:"â",label:"Ordine"},{id:"defaultcat",icon:"â­",label:"Default"}].map(function(st){return <Btn key={st.id} onClick={function(){setSettingsValuesTab(st.id);}} bg={settingsValuesTab===st.id?(dark?"#444":"#333"):(dark?"#333":"#f0f0f0")} color={settingsValuesTab===st.id?"#fff":(dark?"#eee":"#555")} style={{fontSize:12,padding:"8px 11px",whiteSpace:"nowrap",minWidth:settingsValuesTab===st.id?92:78,flex:"0 0 auto",textAlign:"center"}}>{st.icon} {L(st.label)}</Btn>;})}
</div>
      ...
      {settingsValuesTab==="income_types"&&<div style={{display:"flex",flexDirection:"column",gap:8}}>
        <div style={{background:dark?"#1e2a1e":"#f0faf5",borderRadius:10,border:"1px solid "+(dark?"#2a5a2a":"#a8e6c8"),padding:"10px 14px",marginBottom:4}}>
          <div style={{fontSize:12,color:dark?"#7ec":"#1D9E75",fontWeight:600,marginBottom:2}}>ð° Tipi di entrata</div>
        ...
        <div style={{fontSize:12,color:subC,marginTop:4}}>{translateUiRuntimeText("Le categorie personalizzate si aggiungono da Sezioni â Entrate â Categorie.")}</div>
      </div>}
      {settingsValuesTab==="methods"&&<div><SettingsList items={methods} setItems={guardedSetter(setMethods,"base")} label="Aggiungi metodo di pagamento" showIcon showGroup groupList={methodGroups} isMethod/>{baseLockHint("Modifica, archiviazione, ripristino, riordino e aggiunta metodi disponibili dal piano Base")}<div style={{fontSize:12,color:subC,marginTop:8}}>ð = Archivia  ð = Ripristina</div></div>}
      ...
      {settingsValuesTab==="patrimonio"&&<div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        />
        <div style={{fontSize:12,color:subC,marginTop:4}}>ð = {L("Archivia")}  ð = {L("Ripristina")} Â· {L("Le aree si gestiscono in Aree â Patrimonio")}</div>
      </div>}
      ...
      {settingsValuesTab==="defaultcat"&&<div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
        <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:4}}>â­ {L("Categoria default")}</div>
        ...
        <div style={{display:"flex",alignItems:"flex-start",gap:8,marginTop:10,background:dark?"#252535":"#f0f4ff",borderRadius:10,padding:"10px 12px",border:"1px solid "+(dark?"#3a3a5a":"#c7d7f8")}}>
          <span style={{fontSize:16,flexShrink:0}}>â¹ï¸</span>
    ...
    function NotificationsSettingsPage(){
      ...
      function saveNotif(){
        ...
        if(!newNotif.title.trim()){setToast({text:"â ï¸ Inserisci il titolo della notifica.",type:"warning"});return;}
        if(editNotifId){
      ...
      return <div><PageHeader title="Notifiche & Promemoria"/>
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          ...
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
            <div style={{fontSize:14,fontWeight:600,color:textC,marginBottom:4}}>â° Promemoria inserimento spese</div>
            ...
            {np.remindActive&&<div style={{marginTop:16,display:"flex",flexDirection:"column",gap:12}}>
              ...
              <div style={{background:"#FFF8E1",border:"1px solid #FFD54F",borderRadius:8,padding:"10px 12px"}}><span style={{fontSize:12,color:"#856404"}}>{"â¹ï¸ "+L('I promemoria richiedono i permessi di notifica del browser. Clicca "Attiva" per abilitarli.')}</span></div>
            </div>}
          </div>

          {/* Notifiche di sistema */}
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
            <div style={{fontSize:14,fontWeight:600,color:textC,marginBottom:14}}>ð Notifiche di sistema</div>
            <div style={{display:"flex",flexDirection:"column",gap:12}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",background:dark?"#252535":"#f9f9f9",borderRadius:10,border:"1px solid "+(dark?"#333":"#f0f0f0")}}>
                <div><div style={{fontSize:13,fontWeight:600,color:textC}}>{"ð¼ "+L("Stipendio")}</div><div style={{fontSize:12,color:subC}}>{L("Notifica il giorno del mese configurato")}</div></div>
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",background:dark?"#252535":"#f9f9f9",borderRadius:10,border:"1px solid "+(dark?"#333":"#f0f0f0")}}>
                <div><div style={{fontSize:13,fontWeight:600,color:textC}}>ð {L("Spese ricorrenti")} <span style={{fontSize:10,background:dark?"#333":"#FFF3CD",color:dark?"#ffd58a":"#856404",borderRadius:20,padding:"1px 7px",fontWeight:900}}>Base</span></div><div style={{fontSize:12,color:subC}}>{L("Avviso quando ci sono ricorrenti da confermare")}</div></div>
                ...
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8}}>
                  <div style={{flex:1,minWidth:0}}>
                    ...
                    <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
                      ...
                      <span style={{fontSize:11,color:subC}}>ð {n.hour||"09:00"}</span>
                      {n.freq==="monthly"&&<span style={{fontSize:11,color:subC}}>ð {L("giorno")} {n.dayOfMonth}</span>}
                      {n.freq==="weekly"&&<span style={{fontSize:11,color:subC}}>ð {DOW[n.dayOfWeek||0]}</span>}
                      {(n.freq==="once"||n.freq==="yearly")&&n.date&&<span style={{fontSize:11,color:subC}}>ð {fmtDate(n.date,"dmy")}</span>}
                    </div>
                  </div>
                  <div style={{display:"flex",gap:6,alignItems:"center",flexShrink:0}}>
                    <Toggle label="" checked={n.active!==false} onChange={function(){if(blockSetting("base"))return;toggleNotif(n.id);}}/>
                    <button title={L("Modifica")} onClick={function(){if(blockSetting("base"))return;startEditNotif(n);}} style={{background:"#EEF4FF",border:"1px solid #BFD7FF",cursor:notifBaseAllowed?"pointer":"not-allowed",color:"#378ADD",fontSize:14,padding:"5px 8px",borderRadius:8,fontWeight:700,opacity:notifBaseAllowed?1:.45}}>âï¸</button>
                    <button title={L("Elimina")} onClick={function(){if(blockSetting("base"))return;delNotif(n.id);}} style={{background:"#FFF0F0",border:"1px solid #FFD0D0",cursor:notifBaseAllowed?"pointer":"not-allowed",color:"#E24B4A",fontSize:14,padding:"5px 8px",borderRadius:8,fontWeight:700,opacity:notifBaseAllowed?1:.45}}>ðï¸</button>
                  </div>
                </div>
              </div>;})}
            </div>
    ...
    if(settingsPage==="patrimonio_settings")return <div><PageHeader title="Patrimonio"/><SettingsCards items={[{id:"patrimonio_areas_settings",icon:"ð",label:"Aree",desc:settingAllowed("base")?"Lista, crea, modifica e riordina aree patrimonio":"Lista disponibile. Crea, modifica e riordina dal piano Base"},{id:"patrimonio_entries_settings",icon:"ð",label:"Voci",desc:settingAllowed("base")?"Lista, crea, modifica e riordina voci patrimonio":"Lista disponibile. Crea, modifica e riordina dal piano Base"},{id:"patrimonio_mode_settings",icon:"âï¸",label:"ModalitÃ ",desc:"Come vengono aggiornati i valori del patrimonio"}]}/></div>;
    ...
    if(settingsPage==="patrimonio_mode_settings")return <div><PageHeader title="Patrimonio / ModalitÃ "/><PatrimonioSettingsPanel forcedSection="mode"/></div>;

    if(settingsPage==="appearance")return <div><PageHeader title="Aspetto"/><SettingsCards items={[
      {id:"appearance_app",icon:"ð¨",label:"App",desc:"Tema, sfondo, stile e colori dei pulsanti dellâapp"},
      {id:"appearance_nav",icon:"ð±",label:"Barra inferiore",desc:"Riepilogo alto, numero icone e ordine delle sezioni"},
      {id:"appearance_widget",icon:"ð§©",label:"Widget",desc:"Configurazione separata del widget Android"}
    ]}/></div>;

    if(settingsPage==="appearance_nav")return <div><PageHeader title="Aspetto / Barra inferiore e menu"/>
      <div style={{display:"flex",flexDirection:"column",gap:14}}>
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:4}}>ð Mostra riepilogo in alto</div>
        ...
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:14,fontWeight:700,color:textC,marginBottom:4}}>{"ð± "+L("Barra inferiore e menu")}</div>
          ...
          <div style={{fontSize:12,color:subC,marginTop:8,marginBottom:12}}>{(function(){var n=parseInt(String(mobileNavIconCount||5),10)||5;var sec=Math.max(0,n-1);var map={it:"Con "+n+" icone: "+sec+" sezioni + Altro.",en:"With "+n+" icons: "+sec+" sections + More.",es:"Con "+n+" iconos: "+sec+" secciones + MÃ¡s.",fr:"Avec "+n+" icÃ´nes : "+sec+" sections + Plus.",de:"Mit "+n+" Symbolen: "+sec+" Bereiche + Mehr.",pt:"Com "+n+" Ã­cones: "+sec+" secÃ§Ãµes + Mais.",pl:"Przy "+n+" ikonach: "+sec+" sekcje + WiÄcej.",nl:"Met "+n+" pictogrammen: "+sec+" secties + Meer.",ro:"Cu "+n+" pictograme: "+sec+" secÈiuni + Mai mult.",el:"ÎÎµ "+n+" ÎµÎ¹ÎºÎ¿Î½Î¯Î´Î¹Î±: "+sec+" ÎµÎ½ÏÏÎ·ÏÎµÏ + Î ÎµÏÎ¹ÏÏÏÏÎµÏÎ±."};return map[lang]||map.en;})()}</div>
          <div style={{display:"flex",flexDirection:"column",gap:6}}>{normalizeOrder(mobileAllNavOrder,mobileAllNavDefaultOrder).map(function(id,idx,arr){var item=allNavDefs()[id];if(!item)return null;var bottomMap={};getBottomNavIds().forEach(function(x){bottomMap[x]=true;});var zone=bottomMap[id]?"Barra inferiore":"Menu Altro";return <div key={id} style={{display:"flex",alignItems:"center",gap:10,background:dark?"#252535":"#f9f9f9",border:"1px solid "+borderC,borderRadius:10,padding:"8px 10px"}}><span style={{fontSize:18,width:28,textAlign:"center"}}>{item.icon}</span><span style={{flex:1,fontSize:13,fontWeight:800,color:textC} }>{L(item.label)}<span style={{display:"block",fontSize:10,fontWeight:700,color:bottomMap[id]?"#1D9E75":subC,marginTop:2}}>{L(zone)}</span></span><button onClick={function(){moveOrder(mobileAllNavOrder,setMobileAllNavOrder,mobileAllNavDefaultOrder,id,-1);}} disabled={idx===0} style={{border:"1px solid "+borderC,borderRadius:8,background:dark?"#1e1e30":"#fff",color:textC,padding:"4px 8px",opacity:idx===0?0.35:1,cursor:idx===0?"not-allowed":"pointer"}}>â²</button><button onClick={function(){moveOrder(mobileAllNavOrder,setMobileAllNavOrder,mobileAllNavDefaultOrder,id,1);}} disabled={idx===arr.length-1} style={{border:"1px solid "+borderC,borderRadius:8,background:dark?"#1e1e30":"#fff",color:textC,padding:"4px 8px",opacity:idx===arr.length-1?0.35:1,cursor:idx===arr.length-1?"not-allowed":"pointer"}}>â¼</button></div>;})}</div>
        </div>
      </div>
    </div>;
    ...
    if(settingsPage==="appearance_app")return <div><PageHeader title="Aspetto / App"/>
      <div style={{display:"flex",flexDirection:"column",gap:0,borderRadius:14,overflow:"hidden",border:"1px solid "+borderC}}>
        <div style={{background:cardBg,padding:"16px 20px",borderBottom:"1px solid "+borderC}}>
          <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:10}}>{"ð "+L("Dark Mode")}</div>
        ...
        <div onClick={function(){if(!baseSettingsAllowed)blockSetting("base");}} style={{background:baseSettingsAllowed?cardBg:(dark?"#342b16":"#FFF8E1"),padding:"16px 20px",borderBottom:"1px solid "+(baseSettingsAllowed?borderC:(dark?"#6a5520":"#FFD54F"))}}>
          <div style={{fontSize:13,fontWeight:600,color:baseSettingsAllowed?textC:(dark?"#ffd58a":"#856404"),marginBottom:12}}>{"ð¨ "+L("Sfondo")}</div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:10}}>{BG_THEMES.map(function(th){return <button key={th.id} disabled={!baseSettingsAllowed} onClick={function(){if(blockSetting("base"))return;setBgTheme(th.id);}} style={{padding:"10px 6px",border:"2px solid "+(baseSettingsAllowed?(bgTheme===th.id?"#7F77DD":borderC):"#FFD54F"),borderRadius:12,background:baseSettingsAllowed?th.bg:"#FFF8E1",cursor:baseSettingsAllowed?"pointer":"not-allowed",fontSize:11,color:baseSettingsAllowed?(th.dark?"#eee":"#333"):"#856404",fontWeight:bgTheme===th.id?600:400,display:"flex",flexDirection:"column",alignItems:"center",gap:4,opacity:1,filter:baseSettingsAllowed?"none":"none"}}><div style={{width:22,height:22,borderRadius:6,background:th.bg,border:"1px solid #ccc"}}/>{bgTheme===th.id&&<span style={{fontSize:9,color:"#7F77DD"}}>â</span>}<span>{L(th.label)}</span></button>;}) }</div>{baseLockHint("Scelta sfondo disponibile dal piano Base")}
        </div>
        <div style={{background:cardBg,padding:"16px 20px",borderBottom:"1px solid "+borderC}}>
          <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:12}}>{"ð² "+L("Stile pulsanti")}</div>
        ...
        <div style={{background:cardBg,padding:"16px 20px",borderBottom:"1px solid "+borderC}}>
          <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:12}}>{"ð´ "+L("Colore uscite")}</div>
        ...
        <div style={{background:cardBg,padding:"16px 20px"}}>
          <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:12}}>{"ð¢ "+L("Colore entrate")}</div>
        ...
        <div onClick={function(){if(!baseSettingsAllowed)blockSetting("base");}} style={{background:baseSettingsAllowed?cardBg:(dark?"#342b16":"#FFF8E1"),padding:"16px 20px",borderTop:"1px solid "+(baseSettingsAllowed?borderC:(dark?"#6a5520":"#FFD54F"))}}>
          <div style={{fontSize:13,fontWeight:600,color:baseSettingsAllowed?textC:(dark?"#ffd58a":"#856404"),marginBottom:12}}>{"â "+L("Colore bottoni di conferma")}</div>
    ...
    if(settingsPage==="appearance_widget_note"){
      if(!isWidgetAllowed("note"))return <div><PageHeader title="Nota / Coordinata"/><LockedFeatureCard icon="ð" title="Widget Nota / Coordinata" message={widgetLockedMessage("note")}/></div>;
      return <div><PageHeader title="Nota / Coordinata"/><WidgetNoteSettingsPanel/></div>;
    }
    if(settingsPage==="appearance_widget_goal"){
      if(!isWidgetAllowed("goal"))return <div><PageHeader title="Obiettivo"/><LockedFeatureCard icon="ð¯" title="Widget Obiettivo" message={widgetLockedMessage("goal")}/></div>;
      return <div><PageHeader title="Obiettivo"/><WidgetGoalSettingsPanel/></div>;
    }
    if(settingsPage==="appearance_widget_shopping_list"){
      if(!isWidgetAllowed("shoppingList"))return <div><PageHeader title="Lista spesa"/><LockedFeatureCard icon="ð§º" title="Widget Lista spesa" message={widgetLockedMessage("shoppingList")}/></div>;
      return <div><PageHeader title="Lista spesa"/><WidgetShoppingListSettingsPanel/></div>;
    }
    if(settingsPage==="appearance_widget_fidelity"){
      if(!isWidgetAllowed("fidelity"))return <div><PageHeader title="Fidelity card"/><LockedFeatureCard icon="ð³" title="Widget Fidelity card" message={widgetLockedMessage("fidelity")}/></div>;
      return <div><PageHeader title="Fidelity card"/><WidgetFidelitySettingsPanel/></div>;
    }
    if(settingsPage==="appearance_widget_debt_credits"){
      if(!isWidgetAllowed("debtCredits"))return <div><PageHeader title="Debiti / Crediti"/><LockedFeatureCard icon="ð" title="Widget Debiti / Crediti" message={widgetLockedMessage("debtCredits")}/></div>;
      return <div><PageHeader title="Debiti / Crediti"/><WidgetDebtCreditsSettingsPanel/></div>;
    }
    if(settingsPage==="appearance_widget_share"){
      if(!isWidgetAllowed("share"))return <div><PageHeader title="Share"/><LockedFeatureCard icon="ð¤" title="Widget Share" message={widgetLockedMessage("share")}/></div>;
    ...
    if(settingsPage==="history_settings")return <div><PageHeader title="Storico"/>
      <div style={{display:"flex",flexDirection:"column",gap:12}}>
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:15,fontWeight:700,color:textC,marginBottom:4}}>ð {L("Ordinamento storico")}</div>
          ...
          <div style={{fontSize:15,fontWeight:700,color:textC,marginBottom:4}}>â {L("Direzione ordinamento")}</div>
          <SettingHint>{L("Decidi se mostrare prima i movimenti piÃ¹ recenti o quelli piÃ¹ vecchi.")}</SettingHint>
          <Segmented items={[{id:"desc",label:"PiÃ¹ recenti"},{id:"asc",label:"PiÃ¹ vecchi"}]} value={historySortDirection} onChange={setHistorySortDirection}/>
          <div style={{fontSize:12,color:subC}}>{L("Default: prima i movimenti piÃ¹ recenti, ordinati per data dellâoperazione.")}</div>
        </div>
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:14,fontWeight:600,color:textC,marginBottom:4}}>ð {L("Movimenti futuri")}</div>
        ...
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:14,fontWeight:600,color:textC,marginBottom:4}}>ð¤ {L("Share nello storico")} {!baseSettingsAllowed&&<span style={{fontSize:11,color:subC}}> ð Base</span>}</div>
          <SettingHint>Attiva questa opzione per mostrare nello storico anche la tua quota delle spese inserite nella sezione Share. La categoria Share comparirÃ  nei filtri solo quando questa opzione Ã¨ attiva.</SettingHint>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(2, minmax(0, 1fr))",gap:10,alignItems:"center"}}>
            ...
            <div style={{gridColumn:"1 / -1",fontSize:12,color:subC}}>{expenses.length} {L("uscite")} Â· {incomes.length} {L("entrate")} Â· {(debtCredits||[]).length} {L("debiti/crediti")} Â· {((shoppingItems||[]).length+(shoppingCards||[]).length)} {L("elementi spesa")}</div>
          </div>
        </div>
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
          <div style={{fontSize:15,fontWeight:600,color:textC,marginBottom:4}}>ð¾ {L("Backup JSON completo")}</div>
          <div style={{fontSize:13,color:subC,marginBottom:14}}>{L("Esporta tutto il contenuto dellâapp in un file JSON")}</div>
          <div style={{display:"flex",gap:10,flexWrap:"wrap"}}>
            <Btn onClick={function(){var data=buildBackupPayload();androidDownload("fainance_backup_"+todayStr()+".json",new Blob([JSON.stringify(data,null,2)],{type:"application/json"}),function(){setToast("Backup pronto");});}} bg="#7F77DD" style={{padding:"10px 18px",fontSize:14,fontWeight:500}}>â¬ï¸ {L("Scarica backup")}</Btn>
      ...
      return <div><PageHeader title="Supporto"/>
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,overflow:"hidden"}}>
            {[
              {icon:"ð",label:"FAQ sul sito web",desc:"Apri le FAQ ufficiali su fainanceapp.it",action:function(){openExternal("https://fainanceapp.it/it/faq-ita/");},badge:"Apri"},
              {icon:"ð",label:"Sito web ufficiale",desc:"fainanceapp.it",action:function(){openExternal("https://fainanceapp.it/");},badge:"Apri"},
              {icon:"âï¸",label:"Contattaci",desc:"Apri il form di contatto interno",action:function(){setShowContactForm(function(v){return !v;});},badge:"Form"}
        ...
        <div style={{display:"flex",flexDirection:"column",gap:12}}>
          ...
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:16}}>
            <button onClick={function(){setSettingsPage("terms_conditions");}} style={{width:"100%",display:"flex",alignItems:"center",gap:12,background:"none",border:"none",cursor:"pointer",padding:0,textAlign:"left",marginBottom:14}}>
              ...
              <div style={{flex:1}}><div style={{fontSize:14,fontWeight:700,color:textC}}>Termini di utilizzo</div><div style={{fontSize:12,color:subC}}>Consulta ambito dellâapp, limiti dellâAgente AI e responsabilitÃ  utente.</div></div>
              <span style={{fontSize:18,color:subC}}>âº</span>
            </button>
            ...
            <button onClick={function(){setSettingsPage("privacy_policy");}} style={{width:"100%",display:"flex",alignItems:"center",gap:12,background:"none",border:"none",cursor:"pointer",padding:0,textAlign:"left"}}>
              <span style={{fontSize:24}}>ð</span>
              <div style={{flex:1}}><div style={{fontSize:14,fontWeight:700,color:textC}}>Informativa Privacy</div><div style={{fontSize:12,color:subC}}>Consulta dati salvati, sincronizzazione, Firebase e uso dellâAgente AI.</div></div>
              <span style={{fontSize:18,color:subC}}>âº</span>
            </button>
          </div>
          ...
          {/* Aggiornamenti OTA */}
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
            <div style={{fontSize:14,fontWeight:600,color:textC,marginBottom:4}}>{"ð "+translateUiRuntimeText("Aggiornamenti")}</div>
            ...
            {updateStatus==="playstore"&&<div style={{background:dark?"#1a2a1e":"#edfaf3",borderRadius:10,padding:"12px 16px",marginBottom:12,border:"1px solid #1D9E75",display:"flex",alignItems:"center",gap:10}}>
              ...
              <span style={{fontSize:13,color:"#1D9E75",fontWeight:500}}>{L("Si aprirÃ  la pagina dello store di fAInance per verificare eventuali aggiornamenti.")}</span>
            </div>}
          ...
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:20}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12,marginBottom:14}}>
              <div><div style={{fontSize:14,fontWeight:800,color:textC,marginBottom:3}}>ð {L("Piano")}</div><div style={{fontSize:12,color:subC}}>{L("Scorri lateralmente per confrontare tutti i dettagli dei piani.")}</div></div>
            ...
            <div style={{display:"flex",gap:12,overflowX:"auto",paddingBottom:8,scrollSnapType:"x mandatory"}}>
              {PLAN_IDS.map(function(pid){
                ...
                return <div key={pid} style={{minWidth:isMobile?280:320,scrollSnapAlign:"start",background:active?(dark?"#1a2a1e":"#edfaf3"):(dark?"#252535":"#fff"),border:"2px solid "+(active?"#1D9E75":borderC),borderRadius:18,padding:"16px 16px",boxShadow:active?(dark?"none":"0 8px 24px rgba(29,158,117,0.18)"):"none"}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8,marginBottom:8}}><div><div style={{fontSize:18,fontWeight:900,color:active?"#1D9E75":textC}}>{planLabel(pid,lang)}</div><div style={{fontSize:12,color:subC,marginTop:3}}>{price.monthly===0?"0 â¬":price.monthly+" â¬/"+L("mese")} Â· {price.yearly===0?"0 â¬":price.yearly+" â¬/"+L("anno")}</div><div style={{fontSize:12,color:pid==="free"?subC:"#7F77DD",fontWeight:800,marginTop:5}}>{pid==="free"?L("Gratis sempre disponibile"):L("Pagamento")+": "+(planBillingPeriod==="yearly"?(price.yearly+" â¬/"+L("anno")):price.monthly+" â¬/"+L("mese"))}</div></div>{active&&<span style={{fontSize:11,fontWeight:900,color:"#1D9E75",background:"#1D9E7522",borderRadius:12,padding:"3px 8px"}}>{L("ATTIVO")}</span>}</div>
          ...
          <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:16}}>
            <button onClick={function(){window.open("https://play.google.com","_blank");}} style={{width:"100%",display:"flex",alignItems:"center",gap:12,background:"none",border:"none",cursor:"pointer",padding:0}}>
              ...
              <span style={{marginLeft:"auto",fontSize:16,color:subC}}>âº</span>
            </button>
          </div>
          ...
          <div style={{fontSize:11,color:subC,textAlign:"center",padding:"8px 0"}}>Â© 2026 fAInance Â· Tutti i diritti riservati</div>
        </div>
      </div>;
    }
  ...
  function DebtCreditsPanel(){
    ...
    async function pickContact(){
      try{
        ...
        if(contacts&&contacts.pickContact){
          ...
          if(name){setHolder(name);setToast({text:L("Contatto importato dalla rubrica"),type:"success",icon:"ð"});return;}
        }
        if(contacts&&contacts.getContacts){
          ...
          if(arr.length){
            ...
            if(chosen){setHolder(chosen);setToast({text:L("Contatto importato dalla rubrica"),type:"success",icon:"ð"});return;}
          }
        }
        setToast({text:L("Rubrica non disponibile. Inserisci il titolare manualmente."),type:"warning",color:"#FFF8E1",icon:"ð",textColor:"#856404"});
      }catch(e){setToast({text:L("Impossibile leggere la rubrica. Inserisci il titolare manualmente."),type:"warning",color:"#FFF8E1",icon:"ð",textColor:"#856404"});}
    }
    function saveItem(){
      if(!debtBaseAllowed){setToast({text:L("Debiti / Crediti disponibili dal piano Base."),type:"error",color:"#E24B4A",icon:"ð«"});return;}
      var a=parseMoney(amount);if(!holder.trim()||!a){setToast({text:L("Inserisci titolare e importo."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}
      if(editingId){
        ...
        setSelectedId(editingId);setToast({text:L("Debito / Credito aggiornato"),type:"success",icon:"â"});resetForm();return;
      }
      ...
      setDebtCredits(function(list){return [item].concat(list||[]);});setSelectedId(item.id);setToast({text:L("Debito / Credito salvato"),type:"success",icon:"â"});resetForm();
    }
    function deleteItem(id){if(!window.confirm(L("Eliminare questo Debito / Credito?")))return;setDebtCredits(function(list){return (list||[]).filter(function(x){return String(x.id)!==String(id);});});if(String(selectedId)===String(id))setSelectedId(null);if(String(editingId)===String(id))resetForm();setToast({text:L("Debito / Credito eliminato"),type:"success",icon:"ðï¸"});}
    ...
    function closeItem(item){var b=balance(item);if(b<=0)return;if(!window.confirm(L(item.kind==="debt"?"Chiudere questo Debito?":"Chiudere questo Credito?")))return;var tx={id:"tx_"+Date.now(),action:"reduction",amount:b,date:todayStr(),startDate:item.startDate||todayStr(),estimatedEndDate:item.estimatedEndDate||"",note:L(item.kind==="debt"?"Debito chiuso":"Credito chiuso"),createdAt:new Date().toISOString(),closing:true};setDebtCredits(function(list){return (list||[]).map(function(x){return String(x.id)===String(item.id)?{...x,transactions:[tx].concat(x.transactions||[]),closedAt:new Date().toISOString(),updatedAt:new Date().toISOString()}:x;});});setShowTxForm(false);setToast({text:L(item.kind==="debt"?"Debito chiuso":"Credito chiuso"),type:"success",icon:"â"});}
    function reportPatrimonio(item){var val=balance(item)*(item.kind==="debt"?-1:1);var id="dc_"+item.id;setPatrimonioEntries(function(list){var exists=(list||[]).some(function(e){return e.id===id;});if(exists)return list;return (list||[]).concat([{id:id,name:(item.kind==="debt"?L("Debito"):L("Credito"))+" - "+item.holder,icon:item.kind==="debt"?"ð":"ð",color:item.kind==="debt"?"#E24B4A":"#1D9E75",group:"altro"}]);});setPatrimonioValues(function(v){var next={...(v||{})};if(!next[curMonthKey])next[curMonthKey]={};next[curMonthKey][id]=val;return next;});setToast({text:L("Debito / Credito riportato nel patrimonio"),type:"success",icon:"ð"});}
    function reportMovement(item){var a=balance(item);if(!a)return;var desc=(item.kind==="debt"?L("Debito"):L("Credito"))+" - "+item.holder;if(item.kind==="debt"){addExpenses([{id:Date.now(),amount:a,catId:(cats&&cats[0]&&cats[0].id)||1,methodId:(methods&&methods[0]&&methods[0].id)||1,desc:desc,date:todayStr()}],"manual");}else{addIncomes([{id:Date.now(),amount:a,typeId:(incomeTypes&&incomeTypes[0]&&incomeTypes[0].id)||"stipendio",desc:desc,date:todayStr()}],"manual");}setToast({text:L("Debito / Credito riportato nei movimenti"),type:"success",icon:"ð¸"});}
    var sel=selected();
    if(sel){return <div style={{display:"flex",flexDirection:"column",gap:14}}><button onClick={function(){setSelectedId(null);setShowTxForm(false);setEditingTxId("");}} style={{alignSelf:"flex-start",background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"9px 12px",fontWeight:900,cursor:"pointer"}}>â¹ {L("Indietro")}</button><div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:16,padding:14}}><div style={{display:"flex",flexDirection:"column",gap:12}}><div style={{background:balance(sel)<=0?(dark?"#202024":"#f2f2f2"):(dark?"#252535":"#F8FAFC"),border:"1px solid "+borderC,borderRadius:14,padding:14}}><div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"flex-start"}}><div><div style={{fontSize:18,fontWeight:900,color:textC}}>{sel.kind==="debt"?"ð":"ð"} {sel.holder}</div><div style={{fontSize:12,color:subC,marginTop:4}}>{L(sel.kind==="debt"?"Debito":"Credito")} Â· {L("Saldo attuale")}: <b style={{color:balance(sel)<=0?incomeColor:textC}}>{fmt(balance(sel))}</b> {balance(sel)<=0&&<b style={{color:incomeColor}}> Â· {L("Estinto")}</b>}</div><div style={{fontSize:12,color:subC,marginTop:4}}>{L("Data inizio")}: {sel.startDate||"-"} Â· {L("Fine stimata")}: {sel.estimatedEndDate||"-"}</div>{sel.note&&<div style={{fontSize:12,color:subC,marginTop:4}}>{sel.note}</div>}</div><button onClick={function(){editItem(sel);}} style={{border:"none",background:dark?"#2b2b3a":"#eef1ff",color:confirmButtonColor,borderRadius:8,padding:"6px 8px",cursor:"pointer"}}>âï¸</button></div></div><div style={{display:"flex",gap:8,flexWrap:"wrap"}}>{balance(sel)>0&&<button onClick={function(){setEditingTxId("");setTxType("reduction");setTxAmount("");setTxDate(todayStr());setTxStart(sel.startDate||todayStr());setTxEnd(sel.estimatedEndDate||"");setTxNote("");setShowTxForm(function(v){return !v;});}} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"9px 12px",fontWeight:900,cursor:"pointer"}}>ï¼ {L("Aggiungi transazione")}</button>}{balance(sel)>0&&<button onClick={function(){closeItem(sel);}} style={{background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"9px 12px",fontWeight:900,cursor:"pointer"}}>â {L(sel.kind==="debt"?"Chiudi Debito":"Chiudi Credito")}</button>}{showDebtCreditsInPatrimonio&&<button onClick={function(){reportPatrimonio(sel);}} style={{border:"1px solid "+borderC,background:dark?"#252535":"#fff",color:textC,borderRadius:10,padding:"8px 10px",fontWeight:800,cursor:"pointer"}}>ð {L("Riporta nel patrimonio")}</button>}{showDebtCreditsInExpenses&&<button onClick={function(){reportMovement(sel);}} style={{border:"1px solid "+borderC,background:dark?"#252535":"#fff",color:textC,borderRadius:10,padding:"8px 10px",fontWeight:800,cursor:"pointer"}}>ð¸ {L("Riporta nei movimenti")}</button>}</div>{balance(sel)>0&&showTxForm&&<div style={{background:dark?"#1f2333":"#FAFBFF",border:"1px solid "+borderC,borderRadius:14,padding:14,display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 120px 140px",gap:8}}>{field("Tipo transazione",<select value={txType} onChange={function(e){setTxType(e.target.value);}} style={sinp}><option value="reduction">{L(sel.kind==="debt"?"Riduzione del Debito":"Riduzione del Credito")}</option><option value="increase">{L(sel.kind==="debt"?"Aumento del debito":"Aumento del Credito")}</option></select>)}{field("Importo",<input value={txAmount} onChange={function(e){setTxAmount(e.target.value);}} inputMode="decimal" placeholder={L("Importo")} style={sinp}/>)}{field("Data transazione",<input type="date" value={txDate} onChange={function(e){setTxDate(e.target.value);}} style={sinp}/>)}{field("Data inizio",<input type="date" value={txStart} onChange={function(e){setTxStart(e.target.value);}} style={sinp}/>)}{field("Data stimata fine",<input type="date" value={txEnd} onChange={function(e){setTxEnd(e.target.value);}} style={sinp}/>)}{field("Commento",<input value={txNote} onChange={function(e){setTxNote(e.target.value);}} placeholder={L("Commento")} style={sinp}/>)}<button onClick={saveTx} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px 14px",fontWeight:900,cursor:"pointer"}}>ï¼ {L(editingTxId?"Salva modifica":"Aggiungi transazione")}</button>{editingTxId&&<button onClick={function(){setEditingTxId("");setShowTxForm(false);}} style={{background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"10px 14px",fontWeight:900,cursor:"pointer"}}>{L("Annulla")}</button>}</div>}<div>{(sel.transactions||[]).map(function(tx){return <div key={tx.id} style={{display:"flex",alignItems:"center",gap:8,border:"1px solid "+borderC,borderRadius:10,padding:"8px 10px",marginBottom:6,background:dark?"#252535":"#fff"}}><div style={{flex:1,minWidth:0}}><div style={{fontSize:13,fontWeight:900,color:tx.action==="increase"?expenseColor:incomeColor}}>{tx.action==="increase"?"ï¼":"â"} {fmt(tx.amount)} Â· {tx.date||""}</div><div style={{fontSize:11,color:subC}}>{L("Inizio")}: {tx.startDate||"-"} Â· {L("Fine stimata")}: {tx.estimatedEndDate||"-"}{tx.note?" Â· "+tx.note:""}</div></div><button onClick={function(){editTx(tx);}} style={{border:"none",background:dark?"#2b2b3a":"#eef1ff",color:confirmButtonColor,borderRadius:8,padding:"5px 7px",cursor:"pointer"}}>âï¸</button><button onClick={function(){deleteTx(sel.id,tx.id);}} style={{border:"none",background:"#FFF0F0",color:"#E24B4A",borderRadius:8,padding:"5px 7px",cursor:"pointer"}}>ðï¸</button></div>;})}{!(sel.transactions||[]).length&&<div style={{fontSize:13,color:subC}}>{L("Nessuna transazione inserita")}</div>}</div></div></div></div>;}
    return <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <div style={{background:debtBaseAllowed?cardBg:(dark?"#342b16":"#FFF8E1"),border:"1px solid "+(debtBaseAllowed?borderC:"#FFD54F"),borderRadius:16,padding:16}}>
        <div style={{fontSize:18,fontWeight:900,color:textC,marginBottom:4}}>ð³ {L("Debiti / Crediti")}</div>
        ...
        {!debtBaseAllowed&&<div style={{fontSize:12,color:dark?"#ffd58a":"#856404",marginBottom:12,fontWeight:700}}>ð« {L("Disponibile dal piano Base.")}</div>}
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"repeat(3, minmax(0, 1fr))",gap:10,marginTop:12}}>
          ...
          <button onClick={function(){resetForm();setShowDebtForm(true);}} disabled={!debtBaseAllowed} style={{background:debtBaseAllowed?confirmButtonColor:"#ccc",color:"#fff",border:"none",borderRadius:btnRadius,padding:"12px 14px",fontWeight:900,cursor:debtBaseAllowed?"pointer":"not-allowed"}}>ï¼ {L("Aggiungi Debito o Credito")}</button>
        </div>
        {(showDebtForm||editingId)&&<div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"150px 1fr 130px 150px",gap:10}}>
          ...
          {field("Titolare",<div style={{display:"flex",gap:6}}><input value={holder} onChange={function(e){setHolder(e.target.value);}} placeholder={L("Nome titolare")} style={sinp}/><button onClick={pickContact} title={L("Cerca nella rubrica")} style={{border:"1px solid "+borderC,borderRadius:10,background:dark?"#252535":"#fff",color:textC,padding:"0 12px",cursor:"pointer"}}>ð</button></div>)}
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr",gap:12}}>
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:16,padding:14}}>
          ...
          {(debtCredits||[]).map(function(item){var b=balance(item);var active=String(selectedId)===String(item.id);var extinct=b<=0;return <div key={item.id} onClick={function(){openItem(item);}} style={{border:"1px solid "+(active?confirmButtonColor:borderC),borderRadius:12,padding:10,marginBottom:8,background:extinct?(dark?"#202024":"#f2f2f2"):(active?(dark?"#252535":"#f7f5ff"):(dark?"#1e1e30":"#fff")),opacity:extinct?.62:1,cursor:"pointer"}}><div style={{display:"flex",justifyContent:"space-between",gap:8,alignItems:"flex-start"}}><div style={{minWidth:0}}><div style={{fontSize:14,fontWeight:900,color:textC,wordBreak:"break-word"}}>{item.kind==="debt"?"ð":"ð"} {item.holder}</div><div style={{fontSize:12,color:subC}}>{L(item.kind==="debt"?"Debito":"Credito")} Â· {L("Saldo")}: {fmt(b)} {extinct&&<span style={{marginLeft:6,fontWeight:900,color:incomeColor}}>Â· {L("Estinto")}</span>}</div></div><div style={{display:"flex",gap:6,flexShrink:0}}><button onClick={function(e){e.stopPropagation();editItem(item);}} style={{border:"none",background:dark?"#2b2b3a":"#eef1ff",color:confirmButtonColor,borderRadius:8,padding:"6px 8px",cursor:"pointer"}}>âï¸</button><button onClick={function(e){e.stopPropagation();deleteItem(item.id);}} style={{border:"none",background:"#FFF0F0",color:"#E24B4A",borderRadius:8,padding:"6px 8px",cursor:"pointer"}}>ðï¸</button></div></div></div>;})}
        </div>
        <div style={{display:"none"}}>
          {!sel&&<div style={{fontSize:13,color:subC}}>{L("Seleziona un Debito / Credito per inserire transazioni.")}</div>}
          {sel&&<div style={{display:"flex",flexDirection:"column",gap:12}}><div style={{background:balance(sel)<=0?(dark?"#202024":"#f2f2f2"):(dark?"#252535":"#F8FAFC"),border:"1px solid "+borderC,borderRadius:14,padding:14}}><div style={{display:"flex",justifyContent:"space-between",gap:10,alignItems:"flex-start"}}><div><div style={{fontSize:16,fontWeight:900,color:textC}}>{sel.kind==="debt"?"ð":"ð"} {sel.holder}</div><div style={{fontSize:12,color:subC,marginTop:4}}>{L(sel.kind==="debt"?"Debito":"Credito")} Â· {L("Saldo attuale")}: <b style={{color:balance(sel)<=0?incomeColor:textC}}>{fmt(balance(sel))}</b> {balance(sel)<=0&&<b style={{color:incomeColor}}> Â· {L("Estinto")}</b>}</div><div style={{fontSize:12,color:subC,marginTop:4}}>{L("Data inizio")}: {sel.startDate||"-"} Â· {L("Fine stimata")}: {sel.estimatedEndDate||"-"}</div>{sel.note&&<div style={{fontSize:12,color:subC,marginTop:4}}>{sel.note}</div>}</div><div style={{display:"flex",gap:6,flexShrink:0}}><button onClick={function(){editItem(sel);}} style={{border:"none",background:dark?"#2b2b3a":"#eef1ff",color:confirmButtonColor,borderRadius:8,padding:"6px 8px",cursor:"pointer"}}>âï¸</button><button onClick={function(){setSelectedId(null);setShowTxForm(false);}} style={{border:"none",background:dark?"#333":"#f0f0f0",color:textC,borderRadius:8,padding:"6px 8px",cursor:"pointer"}}>Ã</button></div></div></div>
            ...
            {balance(sel)>0&&showTxForm&&<div style={{background:dark?"#1f2333":"#FAFBFF",border:"1px solid "+borderC,borderRadius:14,padding:14,display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 120px 140px",gap:8}}>
              ...
              <button onClick={saveTx} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px 14px",fontWeight:900,cursor:"pointer"}}>ï¼ {L("Aggiungi transazione")}</button>
            </div>}
            <div>{(sel.transactions||[]).map(function(tx){return <div key={tx.id} style={{display:"flex",alignItems:"center",gap:8,border:"1px solid "+borderC,borderRadius:10,padding:"8px 10px",marginBottom:6,background:dark?"#252535":"#fff"}}><div style={{flex:1,minWidth:0}}><div style={{fontSize:13,fontWeight:900,color:tx.action==="increase"?expenseColor:incomeColor}}>{tx.action==="increase"?"ï¼":"â"} {fmt(tx.amount)} Â· {tx.date||""}</div><div style={{fontSize:11,color:subC}}>{L("Inizio")}: {tx.startDate||"-"} Â· {L("Fine stimata")}: {tx.estimatedEndDate||"-"}{tx.note?" Â· "+tx.note:""}</div></div><button onClick={function(){deleteTx(sel.id,tx.id);}} style={{border:"none",background:"#FFF0F0",color:"#E24B4A",borderRadius:8,padding:"5px 7px",cursor:"pointer"}}>ðï¸</button></div>;})}{!(sel.transactions||[]).length&&<div style={{fontSize:13,color:subC}}>{L("Nessuna transazione inserita")}</div>}</div>
          </div>}
        </div>
      </div>
    </div>;
  ...
  function ShoppingPanel(){
    ...
    var [newListIcon,setNewListIcon]=useState("ð§º");
    ...
    var [itemUnit,setItemUnit]=useState("unitÃ ");
    ...
    var [productUnit,setProductUnit]=useState("unitÃ ");
    ...
    var lists=(shoppingLists&&shoppingLists.length)?shoppingLists:[{id:"main",title:"Lista principale",icon:"ð§º",createdAt:new Date().toISOString()}];
    ...
    var unitOptions=["unitÃ ","grammi","millilitri","altro"];
    function areaIcon(a){return (shoppingAreaIcons&&shoppingAreaIcons[a])||"ð";}
    ...
    function addShoppingList(){var title=String(newListTitle||"").trim();if(!title){setToast({text:L("Inserisci il titolo della lista."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}var id="list_"+Date.now();setShoppingLists(function(list){return (list||[]).concat([{id:id,title:title,icon:newListIcon||"ð§º",createdAt:new Date().toISOString()}]);});setActiveShoppingListId(id);setNewListTitle("");setNewListIcon("ð§º");setShowNewListForm(false);}
    ...
    function saveCard(){var clean=String(cardCode||"").replace(/\D/g,"");if(!cardName.trim()||!clean){setToast({text:L("Inserisci nome carta e codice numerico."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}if(editingCardId){setShoppingCards(function(list){return (list||[]).map(function(c){return String(c.id)===String(editingCardId)?{...c,name:cardName.trim(),code:clean,codeType:cardCodeType,color:cardColor,updatedAt:new Date().toISOString()}:c;});});setEditingCardId("");setPendingScannedCard(null);setCardName("");setCardCode("");setCardCodeType("barcode");setCardColor("#0F9F76");setShowCardManualForm(false);setShowCardCreateChoice(false);setToast({text:L("Carta aggiornata"),type:"success",icon:"â"});return;}var lim=(PLAN_LIMITS[currentPlan]&&PLAN_LIMITS[currentPlan].shoppingCards)||2;if(lim!==Infinity&&(shoppingCards||[]).length>=lim){setToast({text:L("Hai raggiunto il limite di carte del tuo piano."),type:"error",color:"#E24B4A",icon:"ð«"});return;}var c={id:"card_"+Date.now(),name:cardName.trim(),code:clean,codeType:cardCodeType,color:cardColor,createdAt:new Date().toISOString(),fromScan:!!pendingScannedCard};setShoppingCards(function(list){return [c].concat(list||[]);});setPendingScannedCard(null);setCardName("");setCardCode("");setCardCodeType("barcode");setCardColor("#0F9F76");setShowCardManualForm(false);setShowCardCreateChoice(false);setToast({text:L("Carta salvata"),type:"success",icon:"â"});}
    ...
    function deleteCard(id){if(!window.confirm(L("Eliminare questa carta?")))return;setShoppingCards(function(list){return (list||[]).filter(function(c){return String(c.id)!==String(id);});});if(String(editingCardId)===String(id)){setEditingCardId("");setCardName("");setCardCode("");setShowCardManualForm(false);setShowCardCreateChoice(false);}setToast({text:L("Carta eliminata"),type:"success",icon:"ðï¸"});}
    ...
    function manualCardPrompt(message){setShowCardCreateChoice(true);setShowCardManualForm(true);setToast({text:L(message||"Non sono riuscito a leggere automaticamente il codice. Si apre lâinserimento manuale."),type:"warning",color:"#FFF8E1",icon:"â¨ï¸",textColor:"#856404"});}
    ...
    function scanCardFromImage(useCamera){try{var input=document.createElement("input");input.type="file";input.accept="image/*";if(useCamera)input.setAttribute("capture","environment");input.onchange=async function(){try{var file=input.files&&input.files[0];if(!file){manualCardPrompt();return;}if("BarcodeDetector" in window){var Detector=(window as any).BarcodeDetector;var detector=new Detector({formats:["qr_code","ean_13","ean_8","code_128","code_39","upc_a","upc_e","itf"]});var bmp=await createImageBitmap(file);var codes=await detector.detect(bmp);var raw=codes&&codes[0]&&codes[0].rawValue?String(codes[0].rawValue).replace(/\D/g,""):"";if(raw){saveScannedCard(raw,codes&&codes[0]&&String(codes[0].format||"").toLowerCase().indexOf("qr")>=0?"qr":"barcode");return;}}manualCardPrompt("Non sono riuscito a leggere automaticamente il codice. Si apre lâinserimento manuale.");}catch(e){manualCardPrompt("Non sono riuscito a leggere automaticamente il codice. Si apre lâinserimento manuale.");}};input.click();}catch(e){manualCardPrompt("Scanner non disponibile. Inserisci il codice manualmente.");}}
    function uploadCardPhoto(){scanCardFromImage(false);}
    function makeItem(name,area,archived,extra){return {id:(archived?"prod_":"shop_")+Date.now()+"_"+Math.floor(Math.random()*9999),name:name,area:area||"Altro",note:(extra&&extra.note)||"",qty:(extra&&extra.qty)||"1",unit:(extra&&extra.unit)||"unitÃ ",bought:false,archived:!!archived,listId:archived?"":activeListId,order:Date.now(),createdAt:new Date().toISOString(),catalogOnly:!!archived,usageCount:(extra&&extra.usageCount)||0};}
    function saveItem(){if(!itemName.trim()){setToast({text:L("Inserisci il nome del prodotto."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}var lim=(PLAN_LIMITS[currentPlan]&&PLAN_LIMITS[currentPlan].shoppingListItems)||25;if(lim!==Infinity&&activeItems().length>=lim){setToast({text:L("Hai raggiunto il limite della lista spesa del tuo piano."),type:"error",color:"#E24B4A",icon:"ð«"});return;}var area=itemArea||"Altro";var name=itemName.trim();var extra={note:itemNote,qty:itemQty,unit:itemUnit,usageCount:1};var it=makeItem(name,area,false,extra);setShoppingItems(function(list){var next=[it].concat(list||[]);if(!catalogHas(name,area,next)){next.push(makeItem(name,area,true,extra));}else{next=next.map(function(x){return x.archived&&normName(x.name)===normName(name)&&String(x.area||"Altro")===String(area||"Altro")?{...x,usageCount:(x.usageCount||0)+1,lastUsedAt:new Date().toISOString()}:x;});}return next;});setItemName("");setItemNote("");setItemQty("1");setItemUnit("unitÃ ");setShowItemForm(false);}
    function saveProductOnly(){if(!productName.trim()){setToast({text:L("Inserisci il nome del prodotto."),type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}var name=productName.trim();var area=productArea||"Altro";var extra={note:productNote,qty:productQty,unit:productUnit};if(editingProductId){setShoppingItems(function(list){return (list||[]).map(function(x){return String(x.id)===String(editingProductId)?{...x,name:name,area:area,note:productNote,qty:productQty,unit:productUnit,updatedAt:new Date().toISOString()}:x;});});cancelEditProduct();setTabShop("products");return;}setShoppingItems(function(list){if(catalogHas(name,area,list)){setToast({text:L("Prodotto giÃ  presente in Prodotti"),type:"warning",color:"#FFF8E1",icon:"ð¦",textColor:"#856404"});return list||[];}return [makeItem(name,area,true,extra)].concat(list||[]);});setProductName("");setProductNote("");setProductQty("1");setProductUnit("unitÃ ");setShowProductForm(false);setTabShop("products");}
    function addProductToList(x){if(listHasProduct(x))return;var lim=(PLAN_LIMITS[currentPlan]&&PLAN_LIMITS[currentPlan].shoppingListItems)||25;if(lim!==Infinity&&activeItems().length>=lim){setToast({text:L("Hai raggiunto il limite della lista spesa del tuo piano."),type:"error",color:"#E24B4A",icon:"ð«"});return;}setShoppingItems(function(list){return [{...x,id:"shop_"+Date.now()+"_"+Math.floor(Math.random()*9999),archived:false,bought:false,listId:activeListId,order:Date.now(),restoredAt:new Date().toISOString()}].concat((list||[]).map(function(p){return p.archived&&String(p.id)===String(x.id)?{...p,usageCount:(p.usageCount||0)+1,lastUsedAt:new Date().toISOString()}:p;}));});setTabShop("products");}
    function editProduct(x){setEditingProductId(x.id);setProductName(x.name||"");setProductArea(x.area||shoppingDefaultArea||"Alimenti");setProductNote(x.note||"");setProductQty(x.qty||"1");setProductUnit(x.unit||"unitÃ ");setShowProductForm(false);setTabShop("products");}
    function deleteProduct(id){if(!window.confirm(L("Eliminare questo prodotto?")))return;setShoppingItems(function(list){return (list||[]).filter(function(x){return String(x.id)!==String(id);});});if(String(editingProductId)===String(id))cancelEditProduct();setToast({text:L("Prodotto eliminato"),type:"success",icon:"ðï¸"});}
    function cancelEditProduct(){setEditingProductId("");setProductName("");setProductArea(shoppingDefaultArea||"Alimenti");setProductNote("");setProductQty("1");setProductUnit("unitÃ ");setShowProductForm(false);}
    ...
    function productForm(prefix){
      ...
      return <div style={{...formBox,borderRadius:22,padding:16,background:dark?"#202033":"linear-gradient(135deg,#fff7e8,#ffffff)",boxShadow:dark?"none":"0 12px 28px rgba(239,159,39,.14)"}} onClick={function(e){e.stopPropagation();}}>
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":"1.4fr 150px 95px 135px",gap:8,alignItems:"end"}}>
          ...
          <label style={{fontSize:11,fontWeight:900,color:subC}}>{L("QuantitÃ ")}<input value={qVal} onChange={function(e){var v=e.target.value.replace(/[^0-9.,]/g,"");isList?setItemQty(v):setProductQty(v);}} placeholder="1" inputMode="decimal" style={{...sinp,marginTop:5}}/></label>
          <label style={{fontSize:11,fontWeight:900,color:subC}}>{L("UnitÃ ")}<select value={uVal} onChange={function(e){isList?setItemUnit(e.target.value):setProductUnit(e.target.value);}} style={{...sinp,marginTop:5}}>{unitOptions.map(function(u){return <option key={u} value={u}>{L(u)}</option>;})}</select></label>
        </div>
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 150px",gap:8,marginTop:8,alignItems:"end"}}>
          ...
          <button type="button" onClick={function(e){e.stopPropagation();(isList?saveItem:saveProductOnly)();}} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"11px 12px",fontWeight:950,cursor:"pointer"}}>{isList?"ï¼ ":(editingProductId?"ð¾ ":"ï¼ ")}{L(isList?"Aggiungi alla lista":(editingProductId?"Salva modifica":"Crea"))}</button>
        </div>
        {!isList&&editingProductId&&<button type="button" onClick={function(e){e.stopPropagation();cancelEditProduct();}} style={{marginTop:8,background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"9px 12px",fontWeight:900,cursor:"pointer"}}>Ã {L("Annulla modifica")}</button>}
      </div>;
    }
      ...
      {tabShop==="list"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
        <div style={softPanel}>
          <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1.25fr .95fr",gap:12,alignItems:"stretch",marginBottom:12}}>
            <div style={{background:dark?"#252535":"linear-gradient(135deg,#FFF7E8,#FFFFFF)",border:"1px solid "+(dark?borderC:"#F4D79B"),borderRadius:18,padding:14}}><div style={{fontSize:20,fontWeight:950,color:textC,display:"flex",alignItems:"center",gap:8}}>ð§º {L("Lista della spesa")}</div><div style={{fontSize:12,color:subC,marginTop:4,lineHeight:1.35}}>{L("Spunta i prodotti giÃ  messi nel carrello.")}<br/>{L("Se vuoi creare unâaltra lista, vai nelle impostazioni")} <button type="button" onClick={function(){setTab("settings");setSettingsPage("shopping_settings");}} style={{border:"none",background:"transparent",padding:0,color:confirmButtonColor,fontWeight:900,cursor:"pointer",textDecoration:"underline"}}>{L("Spesa")}</button></div></div>
            <div style={{background:dark?"#252535":"#fff",border:"1px solid "+borderC,borderRadius:18,padding:12,display:"flex",flexDirection:"column",gap:10,justifyContent:"center"}}><select value={activeListId} onChange={function(e){setActiveShoppingListId(e.target.value);}} style={{...sinp,minWidth:170,fontWeight:900}}>{lists.map(function(l){return <option key={l.id} value={l.id}>{l.icon||"ð§º"} {l.title}</option>;})}</select><button type="button" onClick={function(){setShowItemForm(!showItemForm);}} style={{background:dark?"#1d1d2b":"#F8FAFC",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"10px 10px",fontWeight:950,cursor:"pointer"}}>ï¼ {L("Crea Prodotto")}</button></div>
          </div>
                    {showItemForm&&productForm("item")}
        </div>
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:16,padding:14}}>
          {Object.keys(listGroups).map(function(area){return <div key={area} style={{marginBottom:12}}><div style={{fontSize:13,fontWeight:950,color:textC,marginBottom:7}}>{area==L("Acquistati")?"â":areaIcon(area)} {L(area)}</div>{listGroups[area].map(function(x,idx){var bought=!!x.bought;return <div key={x.id} style={{display:"flex",alignItems:"center",gap:8,border:"1px solid "+borderC,borderRadius:12,padding:"9px 10px",marginBottom:7,background:bought?shoppingBoughtColor:(dark?"#252535":"#fff")}}><input type="checkbox" checked={bought} onChange={function(){toggleItem(x.id);}} style={{width:18,height:18,accentColor:incomeColor}}/><div style={{flex:1,minWidth:0}}><div style={{fontSize:14,fontWeight:900,color:bought?subC:textC,textDecoration:bought?"line-through":"none",wordBreak:"break-word"}}>{x.name} {qtyLabel(x)&&<span style={{fontSize:11,color:subC}}>Ã {qtyLabel(x)}</span>}</div>{x.note&&<div style={{fontSize:11,color:subC,wordBreak:"break-word"}}>{x.note}</div>}</div>{!bought&&<button type="button" disabled={idx===0} onClick={function(){moveItem(x.id,-1);}} style={{border:"1px solid "+borderC,background:dark?"#1d1d2b":"#fff",borderRadius:8,padding:"4px 7px",opacity:idx===0?0.35:1,cursor:idx===0?"not-allowed":"pointer"}}>â²</button>}{!bought&&<button type="button" disabled={idx===listGroups[area].length-1} onClick={function(){moveItem(x.id,1);}} style={{border:"1px solid "+borderC,background:dark?"#1d1d2b":"#fff",borderRadius:8,padding:"4px 7px",opacity:idx===listGroups[area].length-1?0.35:1,cursor:idx===listGroups[area].length-1?"not-allowed":"pointer"}}>â¼</button>}<button type="button" onClick={function(){deleteItem(x.id);}} style={{border:"none",background:"#FFF0F0",color:"#E24B4A",borderRadius:8,padding:"6px 8px",cursor:"pointer"}}>ðï¸</button></div>;})}</div>;})}
          {active.some(function(x){return x.bought;})&&<div style={{marginTop:12,display:"flex",justifyContent:"center"}}><button type="button" onClick={removeBoughtItems} style={{background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"10px 14px",fontWeight:950,cursor:"pointer",boxShadow:dark?"none":"0 6px 16px rgba(15,23,42,.07)"}}>ð§¹ {L("Rimuovi prodotti acquistati")}</button></div>}
      ...
      {tabShop==="products"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
        <div style={softPanel}>
          <div style={{background:dark?"#252535":"linear-gradient(135deg,#FFFFFF,#FFF8E8)",border:"1px solid "+(dark?borderC:"#F1D39C"),borderRadius:20,padding:16,boxShadow:dark?"none":"0 10px 24px rgba(15,23,42,.06)",marginBottom:showProductForm&&!editingProductId?12:0}}>
            <div style={{fontSize:21,fontWeight:950,color:textC,lineHeight:1.1,display:"flex",alignItems:"center",gap:8}}>ð¦ {L("Prodotti")}</div>
            <div style={{fontSize:12,color:subC,marginTop:6,lineHeight:1.35}}>{L("Tocca il prodotto per aggiungerlo alla lista.")}</div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,alignItems:"center",marginTop:14}}><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();setEditingProductId("");if(showProductForm&&!editingProductId){setShowProductForm(false);return;}setProductName("");setProductArea(shoppingDefaultArea||"Alimenti");setProductNote("");setProductQty("1");setProductUnit("unitÃ ");setShowProductForm(true);setShowProductSortMenu(false);setTabShop("products");}} style={{background:dark?"#1d1d2b":"#F8FAFC",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"10px 10px",fontWeight:950,cursor:"pointer",whiteSpace:"nowrap"}}>ï¼ {L("Crea Prodotto")}</button><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();setShowProductSortMenu(function(v){return !v;});setShowProductForm(false);setTabShop("products");}} style={{background:showProductSortMenu?confirmButtonColor:(dark?"#1d1d2b":"#F8FAFC"),color:showProductSortMenu?"#fff":textC,border:"1px solid "+(showProductSortMenu?confirmButtonColor:borderC),borderRadius:btnRadius,padding:"10px 10px",fontWeight:950,cursor:"pointer",whiteSpace:"nowrap"}}>â {L("Ordina")}</button></div>{showProductSortMenu&&<div style={{display:"grid",gridTemplateColumns:isMobile?"1fr 1fr":"repeat(4,1fr)",gap:8,background:dark?"#1d1d2b":"#fff",border:"1px solid "+borderC,borderRadius:16,padding:8,marginTop:10}}>{[{id:"alpha",label:"Alfabetico"},{id:"area",label:"Per Area"},{id:"usage",label:"Per utilizzo"},{id:"custom",label:"Personalizzato"}].map(function(m){return <button type="button" key={m.id} onClick={function(e){e.preventDefault();e.stopPropagation();setShoppingProductSort(m.id);setShowProductSortMenu(false);setTabShop("products");}} style={{border:"1px solid "+(shoppingProductSort===m.id?confirmButtonColor:borderC),background:shoppingProductSort===m.id?confirmButtonColor:(dark?"#252535":"#F8FAFC"),color:shoppingProductSort===m.id?"#fff":textC,borderRadius:999,padding:"9px 8px",fontSize:12,fontWeight:950,cursor:"pointer",textAlign:"center"}}>{L(m.label)}</button>;})}</div>}
          </div>
        ...
        <div style={{background:cardBg,border:"1px solid "+borderC,borderRadius:18,padding:14}}>
          ...
          {groupedProducts().map(function(group){return <div key={group.area} style={{marginBottom:16}}><div style={{fontSize:13,fontWeight:950,color:textC,margin:"0 0 8px"}}>{areaIcon(group.area)} {L(group.area)}</div><div style={{display:"flex",flexDirection:"column",gap:9}}>{group.items.map(function(x,idx){var inList=listHasProduct(x);var editing=String(editingProductId)===String(x.id);return <div key={x.id} style={{border:"1px solid "+(editing?confirmButtonColor:(inList?incomeColor:borderC)),background:inList?(dark?"#183425":"linear-gradient(135deg,#E7F8EE,#F6FFF9)"):(dark?"#252535":"linear-gradient(135deg,#ffffff,#fbfbff)"),borderRadius:18,padding:12,boxShadow:dark?"none":"0 8px 22px rgba(15,23,42,.06)"}}><div style={{display:"grid",gridTemplateColumns:isMobile?"minmax(0,1fr) 38px 38px 38px 38px":"minmax(0,1fr) 140px 38px 38px 38px 38px",alignItems:"center",gap:7}}><button type="button" disabled={inList} onClick={function(e){e.preventDefault();e.stopPropagation();addProductToList(x);setTabShop("products");}} style={{border:"none",background:"transparent",textAlign:"left",cursor:inList?"default":"pointer",padding:"2px 0",minWidth:0}}><div style={{display:"flex",alignItems:"center",gap:7,flexWrap:"wrap"}}><span style={{fontSize:15,fontWeight:950,color:inList?incomeColor:textC,wordBreak:"break-word"}}>{x.name}</span>{inList&&<span style={{fontSize:11,fontWeight:950,color:incomeColor,background:dark?"#123121":"#D9F4E5",border:"1px solid "+incomeColor,borderRadius:999,padding:"2px 7px"}}>â {L("In lista")}</span>}</div><div style={{fontSize:11,color:inList?incomeColor:subC,marginTop:3}}>{qtyLabel(x)?qtyLabel(x)+" Â· ":""}{x.note||""}</div></button><div style={{fontSize:11,color:inList?incomeColor:subC,fontWeight:900,background:dark?"#1d1d2b":"#F7F7F7",border:"1px solid "+borderC,borderRadius:999,padding:"6px 9px",textAlign:"center",display:isMobile?"none":"block",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{L(x.area||"Altro")}{x.usageCount?" Â· "+x.usageCount:""}</div><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();editProduct(x);setTabShop("products");}} style={{width:38,height:38,border:"none",background:dark?"#2b2b3a":"#EEF1FF",color:confirmButtonColor,borderRadius:12,padding:0,cursor:"pointer",fontSize:16,display:"flex",alignItems:"center",justifyContent:"center"}}>âï¸</button><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();deleteProduct(x.id);setTabShop("products");}} style={{width:38,height:38,border:"none",background:"#FFF0F0",color:"#E24B4A",borderRadius:12,padding:0,cursor:"pointer",fontSize:16,display:"flex",alignItems:"center",justifyContent:"center"}}>ðï¸</button><button type="button" disabled={shoppingProductSort!=="custom"||idx===0} onClick={function(e){e.preventDefault();e.stopPropagation();moveProduct(x.id,-1);setTabShop("products");}} style={{width:38,height:38,border:"1px solid "+borderC,background:dark?"#1d1d2b":"#fff",borderRadius:12,padding:0,opacity:(shoppingProductSort!=="custom"||idx===0)?0.35:1,cursor:shoppingProductSort!=="custom"||idx===0?"not-allowed":"pointer",fontSize:15,fontWeight:950,display:"flex",alignItems:"center",justifyContent:"center",lineHeight:1}}>â²</button><button type="button" disabled={shoppingProductSort!=="custom"||idx===group.items.length-1} onClick={function(e){e.preventDefault();e.stopPropagation();moveProduct(x.id,1);setTabShop("products");}} style={{width:38,height:38,border:"1px solid "+borderC,background:dark?"#1d1d2b":"#fff",borderRadius:12,padding:0,opacity:(shoppingProductSort!=="custom"||idx===group.items.length-1)?0.35:1,cursor:shoppingProductSort!=="custom"||idx===group.items.length-1?"not-allowed":"pointer",fontSize:15,fontWeight:950,display:"flex",alignItems:"center",justifyContent:"center",lineHeight:1}}>â¼</button></div>{editing&&<div style={{marginTop:10}}>{productForm("product")}</div>}</div>;})}</div></div>;})}
        </div>
      </div>}

      {tabShop==="cards"&&<div style={{display:"flex",flexDirection:"column",gap:12}}>
        <div style={softPanel}>
          <div style={productTitleStyle}>ð³ {L("Fidelity card e prepagate")}</div>
          ...
          <button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();if(showCardCreateChoice&&!editingCardId){setShowCardCreateChoice(false);setShowCardManualForm(false);return;}setPendingScannedCard(null);setEditingCardId("");setCardName("");setCardCode("");setCardCodeType("barcode");setCardColor("#0F9F76");setShowCardCreateChoice(true);setShowCardManualForm(false);setTabShop("cards");}} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px 12px",fontWeight:950,cursor:"pointer",marginBottom:showCardCreateChoice?12:0}}>ï¼ {L("Nuova Carta")}</button>
          {showCardCreateChoice&&<div style={{...formBox,marginBottom:12}}><div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"repeat(3,1fr)",gap:8}}><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();scanPhysicalCard();}} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"12px",fontWeight:950,cursor:"pointer"}}>ð· {L("Scansiona carta")}</button><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();uploadCardPhoto();}} style={{background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"12px",fontWeight:950,cursor:"pointer"}}>ð¼ï¸ {L("Carica foto")}</button><button type="button" onClick={function(e){e.preventDefault();e.stopPropagation();setShowCardManualForm(true);}} style={{background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"12px",fontWeight:950,cursor:"pointer"}}>â¨ï¸ {L("Compila manualmente")}</button></div>{showCardManualForm&&<div style={{marginTop:12,background:dark?"#202033":"#fff",border:"1px solid "+borderC,borderRadius:18,padding:12}}>{pendingScannedCard&&<div style={{marginBottom:10,padding:"10px 12px",borderRadius:14,background:dark?"#26263a":"#F0FDF4",border:"1px solid "+(dark?"#3A3A52":"#BBF7D0")}}><div style={{fontSize:15,fontWeight:950,color:textC}}>â {L("Conferma dati carta")}</div><div style={{fontSize:12,color:subC,marginTop:3}}>{L("Il codice Ã¨ stato letto. Controlla i dati prima di salvare la carta.")}</div></div>}<div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1.2fr 1fr 130px 54px 120px",gap:8,alignItems:"end"}}><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Nome carta")}<input value={cardName} onChange={function(e){setCardName(e.target.value);}} placeholder={L("Nome carta")} style={{...sinp,marginTop:5}}/></label><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Codice numerico")}<input value={cardCode} onChange={function(e){setCardCode(e.target.value.replace(/\D/g,""));}} placeholder={L("Codice numerico")} inputMode="numeric" style={{...sinp,marginTop:5}}/></label><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Tipo codice")}<select value={cardCodeType} onChange={function(e){setCardCodeType(e.target.value);}} style={{...sinp,marginTop:5}}><option value="barcode">{L("Codice a barre")}</option><option value="qr">{L("QR")}</option></select></label><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Colore")}<div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap",marginTop:6}}>{["#0F9F76","#378ADD","#7F77DD","#EF9F27","#E24B4A","#111827"].map(function(c){return <button key={c} type="button" onClick={function(){setCardColor(c);}} style={{width:26,height:26,borderRadius:999,border:cardColor===c?"3px solid #111827":"1px solid #E5E7EB",background:c,cursor:"pointer"}}/>;})}<input type="color" value={cardColor} onChange={function(e){setCardColor(e.target.value);}} style={{width:34,height:30,border:"none",background:"transparent"}}/></div></label><button type="button" onClick={saveCard} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"11px",fontWeight:950,cursor:"pointer"}}>{editingCardId?"ð¾ ":"ï¼ "}{L(editingCardId?"Salva modifica":"Aggiungi")}</button></div>{editingCardId&&<button type="button" onClick={function(){setEditingCardId("");setCardName("");setCardCode("");setCardCodeType("barcode");setCardColor("#0F9F76");setShowCardManualForm(false);setShowCardCreateChoice(false);}} style={{marginTop:8,background:dark?"#252535":"#fff",color:textC,border:"1px solid "+borderC,borderRadius:btnRadius,padding:"9px 12px",fontWeight:900,cursor:"pointer"}}>Ã {L("Annulla modifica")}</button>}</div>}</div>}
          {false&&pendingScannedCard&&<div style={{...formBox,marginBottom:12,border:"2px solid "+confirmButtonColor,background:dark?"#202033":"linear-gradient(135deg,#fff7df,#ffffff)"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10,marginBottom:10}}><div><div style={{fontSize:16,fontWeight:950,color:textC}}>â {L("Conferma dati carta")}</div><div style={{fontSize:12,color:subC,marginTop:3}}>{L("Il codice Ã¨ stato letto. Controlla i dati prima di salvare la carta.")}</div></div><button type="button" onClick={function(){setPendingScannedCard(null);setCardName("");setCardCode("");setCardCodeType("barcode");setCardColor("#0F9F76");}} style={{border:"1px solid "+borderC,background:dark?"#252535":"#fff",color:textC,borderRadius:12,padding:"7px 10px",fontWeight:950,cursor:"pointer"}}>Ã</button></div><div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1.2fr 1fr 130px 54px 120px",gap:8,alignItems:"end"}}><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Nome carta")}<input value={cardName} onChange={function(e){setCardName(e.target.value);}} placeholder={L("Nome carta")} style={{...sinp,marginTop:5}}/></label><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Codice numerico")}<input value={cardCode} onChange={function(e){setCardCode(e.target.value.replace(/\D/g,""));}} placeholder={L("Codice numerico")} inputMode="numeric" style={{...sinp,marginTop:5}}/></label><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Tipo codice")}<select value={cardCodeType} onChange={function(e){setCardCodeType(e.target.value);}} style={{...sinp,marginTop:5}}><option value="barcode">{L("Codice a barre")}</option><option value="qr">{L("QR")}</option></select></label><label style={{fontSize:11,fontWeight:900,color:subC}}>{L("Colore")}<div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap",marginTop:6}}>{["#0F9F76","#378ADD","#7F77DD","#EF9F27","#E24B4A","#111827"].map(function(c){return <button key={c} type="button" onClick={function(){setCardColor(c);}} style={{width:26,height:26,borderRadius:999,border:cardColor===c?"3px solid #111827":"1px solid #E5E7EB",background:c,cursor:"pointer"}}/>;})}<input type="color" value={cardColor} onChange={function(e){setCardColor(e.target.value);}} style={{width:34,height:30,border:"none",background:"transparent"}}/></div></label><button type="button" onClick={saveCard} style={{background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"11px",fontWeight:950,cursor:"pointer"}}>ð¾ {L("Salva carta")}</button></div></div>}
        </div>
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:14}}>{(shoppingCards||[]).map(function(c){var mainColor=c.color||((c.type||"")==="prepaid"?"#7F77DD":"#0F9F76");return <div key={c.id} style={{background:"linear-gradient(135deg,"+mainColor+",#101828 82%)",border:"1px solid rgba(255,255,255,.18)",borderRadius:26,padding:18,boxShadow:"0 18px 38px rgba(0,0,0,.24)",color:"#fff",position:"relative",overflow:"hidden",minHeight:250}}><div style={{position:"absolute",right:-45,top:-45,width:160,height:160,borderRadius:999,background:"rgba(255,255,255,.13)"}}/><div style={{display:"flex",justifyContent:"space-between",gap:8,marginBottom:16,position:"relative"}}><div><div style={{fontSize:20,fontWeight:950,letterSpacing:.2}}>{c.name}</div><div style={{fontSize:12,opacity:.82,marginTop:6,letterSpacing:1.2}}>{c.code}</div></div><div style={{display:"flex",gap:6}}><button type="button" onClick={function(){editCard(c);}} style={{border:"none",background:"rgba(255,255,255,.22)",color:"#fff",borderRadius:10,padding:"7px 9px",height:36,cursor:"pointer"}}>âï¸</button><button type="button" onClick={function(){deleteCard(c.id);}} style={{border:"none",background:"rgba(255,255,255,.22)",color:"#fff",borderRadius:10,padding:"7px 9px",height:36,cursor:"pointer"}}>ðï¸</button></div></div>{cardCodePreview(c)}{String(editingCardId)===String(c.id)&&<div style={{marginTop:12,background:"rgba(255,255,255,.96)",color:"#111827",borderRadius:18,padding:12,position:"relative",zIndex:2}}><div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr 110px 54px",gap:8,alignItems:"end"}}><label style={{fontSize:11,fontWeight:900,color:"#6B7280"}}>{L("Nome carta")}<input value={cardName} onChange={function(e){setCardName(e.target.value);}} placeholder={L("Nome carta")} style={{...sinp,marginTop:5,background:"#fff",color:"#111827"}}/></label><label style={{fontSize:11,fontWeight:900,color:"#6B7280"}}>{L("Codice numerico")}<input value={cardCode} onChange={function(e){setCardCode(e.target.value.replace(/\D/g,""));}} placeholder={L("Codice numerico")} inputMode="numeric" style={{...sinp,marginTop:5,background:"#fff",color:"#111827"}}/></label><label style={{fontSize:11,fontWeight:900,color:"#6B7280"}}>{L("Tipo codice")}<select value={cardCodeType} onChange={function(e){setCardCodeType(e.target.value);}} style={{...sinp,marginTop:5,background:"#fff",color:"#111827"}}><option value="barcode">{L("Codice a barre")}</option><option value="qr">{L("QR")}</option></select></label><label style={{fontSize:11,fontWeight:900,color:"#6B7280"}}>{L("Colore")}<div style={{display:"flex",alignItems:"center",gap:6,flexWrap:"wrap",marginTop:6}}>{["#0F9F76","#378ADD","#7F77DD","#EF9F27","#E24B4A","#111827"].map(function(c){return <button key={c} type="button" onClick={function(){setCardColor(c);}} style={{width:26,height:26,borderRadius:999,border:cardColor===c?"3px solid #111827":"1px solid #E5E7EB",background:c,cursor:"pointer"}}/>;})}<input type="color" value={cardColor} onChange={function(e){setCardColor(e.target.value);}} style={{width:34,height:30,border:"none",background:"transparent"}}/></div></label></div><div style={{display:"flex",gap:8,marginTop:10}}><button type="button" onClick={saveCard} style={{flex:1,background:confirmButtonColor,color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px 12px",fontWeight:950,cursor:"pointer"}}>ð¾ {L("Salva modifica")}</button><button type="button" onClick={function(){setEditingCardId("");setCardName("");setCardCode("");setCardCodeType("barcode");setCardColor("#0F9F76");}} style={{background:"#fff",color:"#111827",border:"1px solid #E5E7EB",borderRadius:btnRadius,padding:"10px 12px",fontWeight:950,cursor:"pointer"}}>Ã {L("Annulla")}</button></div></div>}</div>;})}{!(shoppingCards||[]).length&&<div style={{fontSize:13,color:subC,background:cardBg,border:"1px solid "+borderC,borderRadius:16,padding:16}}>{L("Nessuna carta inserita")}</div>}</div>
      </div>}
    </div>;
  }

  // ââ Pannelli estratti in file separati âââââââââââââââââââââââââââââââââââââââ
  // HomePanel, SpesePanel, HistoryPanel â sezioni.tsx
  // StatsPanel                          â statistiche.tsx
  // ConsulenteAIPanel, FloatingAIButton  â sezioni.tsx
  // PatrimonioPanel                      â sezioni.tsx
  // SharePanel                           â sezioni.tsx
  // MorePanel + panelContent             â sezioni.tsx
  ...
  // ââ COPY MONTH WIDGET (proper component to avoid hooks-in-IIFE) ââââââââââââââ
  function CopyMonthWidget({pHistory,pEntries,selMonthKey,setDraft,setToast,dark,textC,subC,borderC,sinp,btnRadius,onCopyMonth}){
    ...
    return <div style={{background:dark?"#252535":"#f9f9f9",borderRadius:12,border:"1px solid "+borderC,padding:"12px 16px"}}>
      {!showCopy
        ?<button onClick={function(){setShowCopy(true);}} style={{background:"none",border:"none",cursor:"pointer",color:"#7F77DD",fontSize:13,fontWeight:500,padding:0}}>ð {translateUiRuntimeText("Copia valori da un altro mese...")}</button>
  ...
  // ââ PATRIMONIO PANEL ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  function PatrimonioPanel(){
    ...
    function lockedPatrimonioEntry(){setToast({text:"Aggiungi voce patrimonio disponibile dal piano Base.",type:"warning",color:"#EF9F27",icon:"â ï¸"});}
    ...
    // ââ INSERIMENTO: mese selezionato âââââââââââââââââââââââââââââââââââââââââ
    ...
    var [newEntryIcon,setNewEntryIcon]=useState("ð¦");
    ...
    function saveNote(){setPatrimonioNotes(function(n){return{...n,[noteEntryId]:noteDraft};});setNoteEntryId(null);setToast({text:"Nota inserita",type:"success",color:"#1D9E75",icon:"â"});}
    ...
    function copyPatrimonioSnapshot(copyFromKey,rewardAlreadyGranted){
      ...
      if(!rewardAlreadyGranted&&pg.state==="blocked"){setToast({text:pg.text,type:"error",color:"#E24B4A",icon:"ð«"});return;}
      ...
      if(!hasValues){setToast({text:"Nessun valore disponibile per il mese selezionato",type:"error",color:"#E24B4A",icon:"ð«"});return;}
      var nd={};
      var copiedSnap={};
    ...
    function saveMonthSnap(){
      ...
      // Se Ã¨ il mese corrente aggiorna anche pValues (valori "live")
      if(isCurrentMonth){
        var newVals={};
    ...
    function addEntry(areaId){if(!newEntryName.trim())return;var nid="entry_"+Date.now();setPatrimonioEntries(function(p){return [...p,{id:nid,name:newEntryName.trim(),icon:newEntryIcon,areaId:areaId}];});setDraft(function(d){return{...d,[nid]:""}});setNewEntryName("");setNewEntryIcon("ð¦");setAddingEntry(null);}
    ...
    // ââ STORICO ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
    ...
    return <div style={{display:"flex",flexDirection:"column",gap:16}}>
        ...
        return <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={function(e){if(e.target===e.currentTarget){saveNote();}}}>
          <div style={{background:dark?"#1e1e30":"#fff",borderRadius:16,padding:20,width:"100%",maxWidth:440,boxShadow:"0 8px 40px rgba(0,0,0,0.2)"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
              ...
              <button onClick={function(){saveNote();}} style={{background:"none",border:"none",fontSize:20,cursor:"pointer",color:"#aaa"}}>Ã</button>
            </div>
            ...
            <div style={{display:"flex",gap:8,marginTop:12}}>
              <Btn onClick={saveNote} bg="#7F77DD" style={{flex:1,padding:"10px",fontWeight:600}}>{"ð¾ "+L("Salva nota")}</Btn>
              <Btn onClick={function(){setNoteEntryId(null);}} bg={dark?"#333":"#f0f0f0"} color={dark?"#eee":"#666"} style={{padding:"10px 14px"}}>{L("Annulla")}</Btn>
            </div>
            {pNotes[noteEntryId]&&<button onClick={function(){if(!window.confirm(L("Eliminare questa nota?")))return;setPatrimonioNotes(function(n){var q={...n};delete q[noteEntryId];return q;});setNoteEntryId(null);setToast(L("Nota eliminata"));}} style={{marginTop:8,background:"none",border:"none",cursor:"pointer",color:"#aaa",fontSize:12,width:"100%"}}>{"ð "+L("Elimina nota")}</button>}
          </div>
        </div>;
      })()}

      {/* ââ Header totale ââ */}
      <div style={{background:"linear-gradient(135deg,#378ADD22,#9F77DD22)",borderRadius:14,border:"1px solid "+(dark?"#444":"#ddd"),padding:20,textAlign:"center"}}>
        <div style={{fontSize:11,color:subC,marginBottom:2}}>{L("Patrimonio")} â {monthFullName(now.getMonth())} {curYear}</div>
        ...
        {livePrevTotal!==null&&<div style={{fontSize:13,fontWeight:500,color:(liveTotal-livePrevTotal)>=0?"#1D9E75":"#E24B4A",marginTop:4}}>
          {(liveTotal-livePrevTotal)>=0?"â²":"â¼"} {fmt(Math.abs(liveTotal-livePrevTotal))} vs mese scorso
        </div>}
        <div style={{fontSize:11,color:subC,marginTop:6}}>ModalitÃ : {patrimonioMode==="manuale"?"Manuale":"Semi-automatica â ï¸"}</div>
      </div>

      {/* ââ Tab ââ */}
      <div style={{display:"flex",gap:0,background:dark?"#252535":"#f5f5f5",borderRadius:12,padding:3}}>
        <button onClick={function(){setPatTab("inserimento");}} style={{flex:1,padding:"9px",border:"none",borderRadius:10,background:patTab==="inserimento"?(dark?"#444":"#fff"):"transparent",color:patTab==="inserimento"?textC:subC,fontSize:14,cursor:"pointer",fontWeight:patTab==="inserimento"?500:400}}>âï¸ Inserimento</button>
        <button onClick={function(){setPatTab("storico");}} style={{flex:1,padding:"9px",border:"none",borderRadius:10,background:patTab==="storico"?(dark?"#444":"#fff"):"transparent",color:patTab==="storico"?textC:subC,fontSize:14,cursor:"pointer",fontWeight:patTab==="storico"?500:400}}>
          ð Storico {histMonths.length>0&&<span style={{fontSize:11,background:"#7F77DD",color:"#fff",borderRadius:10,padding:"1px 6px",marginLeft:4}}>{histMonths.length}</span>}
        </button>
      </div>

      {/* ââââââââââââââââââââââ TAB INSERIMENTO ââââââââââââââââââââââ */}
      {patTab==="inserimento"&&<>
        ...
        <div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:"12px 16px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <button onClick={function(){goMonth(-1);}} style={{background:"none",border:"none",cursor:"pointer",fontSize:20,color:subC,padding:"4px 8px",borderRadius:8}}>â¹</button>
          <div style={{textAlign:"center"}}>
            ...
            <div style={{fontSize:11,color:subC,marginTop:2}}>
              {existingSnap?"â Dati giÃ  salvati":(isCurrentMonth?"Mese corrente â non ancora salvato":"â ï¸ Nessun dato per questo mese")}
            </div>
          </div>
          <button onClick={function(){goMonth(1);}} disabled={selMonthKey>=curMonthKey} style={{background:"none",border:"none",cursor:selMonthKey>=curMonthKey?"not-allowed":"pointer",fontSize:20,color:selMonthKey>=curMonthKey?"#ccc":subC,padding:"4px 8px",borderRadius:8}}>âº</button>
        </div>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"minmax(0,1fr) auto",gap:12,alignItems:"center",padding:"14px 16px",background:dark?"#252535":"#f9f9f9",borderRadius:14,border:"1px solid "+borderC}}>
          ...
          <button onClick={saveMonthSnap} style={{background:"#7F77DD",color:"#fff",border:"none",borderRadius:btnRadius,padding:"12px 18px",fontSize:14,cursor:"pointer",fontWeight:900,width:isMobile?"100%":"auto",minWidth:isMobile?0:118,boxShadow:dark?"none":"0 6px 18px rgba(127,119,221,0.28)"}}>
            {existingSnap?("ð "+L("Aggiorna")):("ð¾ "+L("Salva"))}
          </button>
        </div>
                ...
                return <div key={entry.id}>
                  ...
                  {editingId===entry.id
                    ?<div style={{display:"flex",gap:6,alignItems:"center"}}>
                      ...
                      <button onClick={function(){setEditingId(null);}} style={{background:"#7F77DD",color:"#fff",border:"none",borderRadius:6,padding:"4px 10px",cursor:"pointer",fontSize:12,fontWeight:500}}>â</button>
                    </div>
                    :<div style={{display:"flex",alignItems:"center",gap:isMobile?4:6,flexShrink:0,minWidth:0}}>
                      ...
                      <span onClick={function(){setEditingId(entry.id);}} style={{fontSize:isMobile?12:14,fontWeight:500,color:numVal>0?"#1D9E75":numVal<0?"#E24B4A":subC,minWidth:isMobile?62:80,maxWidth:isMobile?72:110,textAlign:"right",cursor:"pointer",borderBottom:"1px dashed "+(dark?"#555":"#ddd"),padding:"1px 0",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{rawVal===""?"â":fmt(numVal)}</span>
                      <button title={L("Modifica")} onClick={function(){setEditingId(entry.id);}} style={{background:"#EEF4FF",border:"1px solid #BFD7FF",cursor:"pointer",color:"#378ADD",fontSize:isMobile?12:14,padding:isMobile?"4px 6px":"5px 8px",borderRadius:8,fontWeight:700,flexShrink:0}}>âï¸</button>
                      <button onClick={function(){openNote(entry.id);}} title="Nota" style={{background:pNotes[entry.id]?"#EEEDFE":"none",border:pNotes[entry.id]?"1px solid #AFA9EC":"none",borderRadius:6,cursor:"pointer",color:pNotes[entry.id]?"#534AB7":"#ccc",fontSize:isMobile?12:13,padding:isMobile?"1px 3px":"1px 5px",flexShrink:0}}>ð</button>
                      <button title={L("Elimina")} onClick={function(){if(!window.confirm(L("Eliminare questa voce dal Patrimonio?")))return;delEntry(entry.id);}} style={{background:"#FFF0F0",border:"1px solid #FFD0D0",cursor:"pointer",color:"#E24B4A",fontSize:isMobile?12:14,padding:isMobile?"4px 6px":"5px 8px",borderRadius:8,fontWeight:700,flexShrink:0}}>ðï¸</button>
                    </div>
                  }
                  </div>
                  {pNotes[entry.id]&&<div onClick={function(){openNote(entry.id);}} style={{padding:"6px 12px",background:dark?"#1e1e30":"#f5f4ff",border:"1px solid "+(dark?"#3a3a5a":"#c8c0f8"),borderTop:"none",borderRadius:"0 0 10px 10px",fontSize:11,color:dark?"#aac":"#534AB7",cursor:"pointer",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>ð {pNotes[entry.id]}</div>}
                </div>;
              })}
            </div>
            {addingEntry===area.id
              ...
              :<button onClick={function(){if(!patrimonioEntryAllowed){lockedPatrimonioEntry();return;}setAddingEntry(area.id);}} style={{marginTop:10,background:patrimonioEntryAllowed?"none":"#FFF8E1",border:"1.5px dashed "+(patrimonioEntryAllowed?(dark?"#444":"#ddd"):(dark?"#6a5520":"#FFD54F")),borderRadius:8,padding:"7px 14px",cursor:patrimonioEntryAllowed?"pointer":"not-allowed",color:patrimonioEntryAllowed?subC:"#856404",fontSize:13,width:"100%"}}>+ {L("Aggiungi voce")}{patrimonioEntryAllowed?"":" ð"}</button>
            }
          </div>;
        })}
        {patrimonioMode==="semi"&&<div style={{background:"#FFF8E1",border:"1px solid #FFD54F",borderRadius:12,padding:"12px 16px"}}><span style={{fontSize:13,color:"#856404"}}>â ï¸ ModalitÃ  semi-automatica in beta.</span></div>}
      </>}

      {/* ââââââââââââââââââââââ TAB STORICO ââââââââââââââââââââââ */}
      {patTab==="storico"&&<>
        {histMonths.length===0&&<div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:40,textAlign:"center",color:subC,fontSize:14}}>
          Nessuno storico disponibile. Nella scheda Inserimento seleziona un mese, inserisci i valori e clicca "ð¾ Salva".
        </div>}
        ...
        {histMonths.length>0&&<>
          ...
          {filteredHist.length>1&&<div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:16}}>
            <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:10}}>Andamento patrimonio â {histViewYear}</div>
            {(function(){
            ...
            <div style={{overflowX:"auto"}}>
              <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
                <thead><tr style={{background:dark?"#252535":"#f5f5f5"}}>
                  ...
                  <th style={{padding:"7px 10px",textAlign:"right",fontWeight:600,color:subC}}>Î</th>
                ...
                <tbody>
                  {filteredHist.map(function(m){
                    ...
                    return <tr key={m.mk} style={{borderBottom:"1px solid "+(dark?"#333":"#f0f0f0")}}>
                      ...
                      <td style={{padding:"8px 10px",textAlign:"right",fontWeight:500,color:m.delta===null?subC:m.delta>=0?"#1D9E75":"#E24B4A"}}>{m.delta===null?"â":(m.delta>=0?"+":"")+fmt(m.delta)}</td>
                      ...
                      <td style={{padding:"8px 10px",textAlign:"center"}}>
                        <button onClick={function(){if(window.confirm(L("Eliminare snapshot ")+m.mk+"?")){delMonthSnap(m.mk);}}} style={{background:"none",border:"none",cursor:"pointer",color:"#ccc",fontSize:13}}>Ã</button>
                      </td>
                    </tr>;
                  })}
                </tbody>
          ...
          {filteredHist.length>0&&<div style={{background:cardBg,borderRadius:14,border:"1px solid "+borderC,padding:16}}>
            <div style={{fontSize:13,fontWeight:600,color:textC,marginBottom:12}}>Variazioni per voce â {monthShortName(parseInt(filteredHist[0].mk.split("-")[1])-1)} vs mese precedente</div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:6}}>
              {pEntries.map(function(entry){
                ...
                return <div key={entry.id} style={{display:"flex",alignItems:"center",gap:8,padding:"6px 10px",background:dark?"#252535":"#f9f9f9",borderRadius:8}}>
                  ...
                  {d2!==null&&<span style={{fontSize:11,fontWeight:500,color:d2===0?subC:d2>0?"#1D9E75":"#E24B4A",minWidth:60,textAlign:"right"}}>{d2===0?"â":(d2>0?"+":"")+fmt(d2)}</span>}
                </div>;
              }).filter(Boolean)}
            </div>}
          </div>}
  ...
  function createShareProject(name,description){
    if(!canAddPlanItem("shareProjects",(shareProjects||[]).length,1)){setToast({text:upgradeMessage("shareProjects",(shareProjects||[]).length),type:"error",color:"#E24B4A",icon:"ð«"});return null;}
  ...
  function createProjectFromDraft(){if(shareProjectLimitReached){setToast({text:L("Hai raggiunto il limite massimo del tuo piano. Non puoi aggiungere altri elementi in questa sezione."),type:"error",color:"#E24B4A",icon:"ð«"});return;}var v=(newProjectName||"").trim();var d=(newProjectDesc||"").trim();if(!v){setToast("Inserisci il nome del progetto Share");return;}var p=createShareProject(v,d);if(p){setShowNewProjectForm(false);setNewProjectName("");setNewProjectDesc("");setToast("Progetto Share creato");}}
  function requestDeleteProject(pid){if(!pid)return;if(!window.confirm(L("Eliminare il progetto Share?")))return;deleteShareProject(pid);}
    function saveNewShareProject(){if(shareProjectLimitReached){setToast({text:L("Hai raggiunto il limite massimo del tuo piano. Non puoi aggiungere altri elementi in questa sezione."),type:"error",color:"#E24B4A",icon:"ð«"});return;}var name=(newProjectName||"").trim();if(!name){setToast("Inserisci il nome del progetto Share");return;}var created=createShareProject(name,(newProjectDesc||"").trim());if(created){setNewProjectName("");setNewProjectDesc("");setShowNewProjectForm(false);setToast("Progetto Share creato");}}
    async function addParticipant(){
      if(!selected||participantBusy)return;
      var name=newPersonName.trim();var email=normalizeEmail(newPersonEmail);
      if(personMode==="fake"){
        if(!name){setToast({text:"Inserisci il nome della persona esterna",type:"warning",color:"#FFF8E1",icon:"â ï¸",textColor:"#856404"});return;}
      ...
      if(!email){setToast({text:"Inserisci l'email dell'utente",type:"warning",color:"#EF9F27",icon:"â ï¸"});return;}
      ...
      try{
        ...
        setToast(foundUser?"Invito Share inviato correttamente.":"Invito creato: email inviata. Quando l'utente si registra con questa email, troverÃ  l'invito.");
    ...
    function shareValidation(){
      ...
      if(splitMode==="percent"){
        ...
        if(Math.abs(pctDiff)>0.009){var moneyDiff=shareRound(amount*(pctDiff/100));return{ok:false,blocking:true,message:pctDiff>0?(lang==="es"?"Falta todavÃ­a el "+pctDiff.toFixed(2).replace(".",",")+"% ("+fmt(Math.abs(moneyDiff))+") para llegar al 100%.":lang==="en"?"Still missing "+pctDiff.toFixed(2).replace(".",",")+"% ("+fmt(Math.abs(moneyDiff))+") to reach 100%.":"Manca ancora il "+pctDiff.toFixed(2).replace(".",",")+"% ("+fmt(Math.abs(moneyDiff))+") per arrivare al 100%."):(lang==="es"?"Has superado el 100% en "+Math.abs(pctDiff).toFixed(2).replace(".",",")+"% ("+fmt(Math.abs(moneyDiff))+").":lang==="en"?"You exceeded 100% by "+Math.abs(pctDiff).toFixed(2).replace(".",",")+"% ("+fmt(Math.abs(moneyDiff))+").":"Hai superato il 100% di "+Math.abs(pctDiff).toFixed(2).replace(".",",")+"% ("+fmt(Math.abs(moneyDiff))+").")};}
      }
      if(splitMode==="amount"){
        var sum=ids.reduce(function(a,id){return a+shareRound(parseFloat(splitDraft[id])||0);},0);var diff=shareRound(amount-sum);
        if(Math.abs(diff)>0.009)return{ok:false,blocking:true,message:diff>0?(lang==="es"?"Faltan todavÃ­a "+fmt(Math.abs(diff))+" para llegar al total.":lang==="en"?"Still missing "+fmt(Math.abs(diff))+" to reach the total.":"Mancano ancora "+fmt(Math.abs(diff))+" per arrivare al totale."):(lang==="es"?"Has superado el total en "+fmt(Math.abs(diff))+".":lang==="en"?"You exceeded the total by "+fmt(Math.abs(diff))+".":"Hai superato il totale di "+fmt(Math.abs(diff))+".")};
      }
    ...
    function saveShareReceiptFromScan(item){
      ...
      if(lim!==Infinity&&count>=lim){setToast({text:L("Hai raggiunto il limite scontrini Share del tuo piano."),type:"error",color:"#E24B4A",icon:"ð«"});return false;}
      ...
      setToast({text:L(currentPlan==="premium"?"Scontrino Share salvato nel progetto per 6 mesi":"Scontrino Share letto. Nel piano attuale l'immagine non viene conservata nel progetto."),type:"success",icon:"ð§¾"});
      return false;
    }

    function addSharedActivity(){
      if(!selected)return;var shareTodayCount=(selected.activities||[]).filter(function(a){return a.kind!=="settlement"&&a.createdAt&&String(a.createdAt).slice(0,10)===todayUsageKey();}).length;if(!shareEditingActivityId&&!canAddPlanItem("shareDailyExpenses",shareTodayCount,1)){setToast({text:upgradeMessage("shareDailyExpenses",shareTodayCount),type:"error",color:"#E24B4A",icon:"ð«"});return;}if(!shareAmount||parseFloat(shareAmount)<=0){setToast({text:"Inserisci l'importo della spesa",type:"error",color:"#FDECEC",icon:"ð«",textColor:"#E24B4A"});return;}
      ...
      if(!shareEditingActivityId){
        ...
        if(slim.total!==Infinity&&shareTodayCount>=Number(slim.included||0)){
          if(shareTodayCount>=Number(slim.total||0)){setToast({text:upgradeMessage("shareDailyExpenses",shareTodayCount),type:"error",color:"#E24B4A",icon:"ð«"});return;}
    ...
    var tabs=[{id:"attivita",label:L("AttivitÃ ")},{id:"partecipanti",label:L("Partecipanti")},{id:"riassunto",label:L("Riassunto")},{id:"saldi",label:L("Saldi")}];
    return <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      {shareProjectLimitReached&&<div style={{background:dark?"#342b16":"#FFF8E1",border:"1px solid "+(dark?"#6a5520":"#FFD54F"),borderRadius:16,padding:14,color:dark?"#FFE5A6":"#856404",fontSize:13,fontWeight:800,lineHeight:1.4}}>â ï¸ {L("Hai raggiunto il limite massimo del tuo piano. Non puoi aggiungere altri elementi in questa sezione.")}</div>}
...
(function(){
  ...
  var D={
    'Barra inferiore':{en:'Bottom bar',es:'Barra inferior',fr:'Barre infÃ©rieure',de:'Untere Leiste',pt:'Barra inferior',pl:'Dolny pasek',nl:'Onderste balk',ro:'BarÄ inferioarÄ',el:'ÎÎ¬ÏÏ Î¼ÏÎ¬ÏÎ±'},
    'Debiti / Crediti':{en:'Debts / Credits',es:'Deudas / CrÃ©ditos',fr:'Dettes / CrÃ©dits',de:'Schulden / Guthaben',pt:'DÃ­vidas / CrÃ©ditos',pl:'DÅugi / NaleÅ¼noÅci',nl:'Schulden / Tegoeden',ro:'Datorii / CreanÈe',el:'Î§ÏÎ­Î· / Î Î¹ÏÏÏÏÎµÎ¹Ï'},
    'Debiti':{en:'Debts',es:'Deudas',fr:'Dettes',de:'Schulden',pt:'DÃ­vidas',pl:'DÅugi',nl:'Schulden',ro:'Datorii',el:'Î§ÏÎ­Î·'},
    'Crediti':{en:'Credits',es:'CrÃ©ditos',fr:'CrÃ©dits',de:'Guthaben',pt:'CrÃ©ditos',pl:'NaleÅ¼noÅci',nl:'Tegoeden',ro:'CreanÈe',el:'Î Î¹ÏÏÏÏÎµÎ¹Ï'},
    'Saldo':{en:'Balance',es:'Saldo',fr:'Solde',de:'Saldo',pt:'Saldo',pl:'Saldo',nl:'Saldo',ro:'Sold',el:'Î¥ÏÏÎ»Î¿Î¹ÏÎ¿'},
    'Lista spesa':{en:'Shopping list',es:'Lista de la compra',fr:'Liste de courses',de:'Einkaufsliste',pt:'Lista de compras',pl:'Lista zakupÃ³w',nl:'Boodschappenlijst',ro:'ListÄ de cumpÄrÄturi',el:'ÎÎ¯ÏÏÎ± Î±Î³Î¿ÏÏÎ½'},
    'Fidelity card':{en:'Fidelity card',es:'Tarjeta de fidelidad',fr:'Carte de fidÃ©litÃ©',de:'Kundenkarte',pt:'CartÃ£o de fidelidade',pl:'Karta lojalnoÅciowa',nl:'Klantenkaart',ro:'Card de fidelitate',el:'ÎÎ¬ÏÏÎ± ÏÎ¹ÏÏÏÏÎ·ÏÎ±Ï'},
    'Grandezza testo':{en:'Text size',es:'TamaÃ±o del texto',fr:'Taille du texte',de:'TextgrÃ¶Ãe',pt:'Tamanho do texto',pl:'Rozmiar tekstu',nl:'Tekstgrootte',ro:'Dimensiune text',el:'ÎÎ­Î³ÎµÎ¸Î¿Ï ÎºÎµÎ¹Î¼Î­Î½Î¿Ï'},
    'Colore icona':{en:'Icon color',es:'Color del icono',fr:'Couleur de lâicÃ´ne',de:'Symbolfarbe',pt:'Cor do Ã­cone',pl:'Kolor ikony',nl:'Pictogramkleur',ro:'Culoare pictogramÄ',el:'Î§ÏÏÎ¼Î± ÎµÎ¹ÎºÎ¿Î½Î¹Î´Î¯Î¿Ï'},
    'Colore titolo':{en:'Title color',es:'Color del tÃ­tulo',fr:'Couleur du titre',de:'Titelfarbe',pt:'Cor do tÃ­tulo',pl:'Kolor tytuÅu',nl:'Titelkleur',ro:'Culoare titlu',el:'Î§ÏÏÎ¼Î± ÏÎ¯ÏÎ»Î¿Ï'},
    'Colore testo':{en:'Text color',es:'Color del texto',fr:'Couleur du texte',de:'Textfarbe',pt:'Cor do texto',pl:'Kolor tekstu',nl:'Tekstkleur',ro:'Culoare text',el:'Î§ÏÏÎ¼Î± ÎºÎµÎ¹Î¼Î­Î½Î¿Ï'},
    'Trasparenza sfondo widget':{en:'Widget background transparency',es:'Transparencia del fondo del widget',fr:'Transparence du fond du widget',de:'Widget-Hintergrundtransparenz',pt:'TransparÃªncia do fundo do widget',pl:'PrzezroczystoÅÄ tÅa widÅ¼etu',nl:'Transparantie widgetachtergrond',ro:'TransparenÈa fundalului widgetului',el:'ÎÎ¹Î±ÏÎ¬Î½ÎµÎ¹Î± ÏÏÎ½ÏÎ¿Ï widget'},
    'Aggiornamento automatico':{en:'Automatic update',es:'ActualizaciÃ³n automÃ¡tica',fr:'Mise Ã  jour automatique',de:'Automatische Aktualisierung',pt:'AtualizaÃ§Ã£o automÃ¡tica',pl:'Automatyczna aktualizacja',nl:'Automatisch bijwerken',ro:'Actualizare automatÄ',el:'ÎÏÏÏÎ¼Î±ÏÎ· ÎµÎ½Î·Î¼Î­ÏÏÏÎ·'},
    'Salva e aggiorna widget':{en:'Save and update widget',es:'Guardar y actualizar widget',fr:'Enregistrer et mettre Ã  jour le widget',de:'Widget speichern und aktualisieren',pt:'Guardar e atualizar widget',pl:'Zapisz i zaktualizuj widÅ¼et',nl:'Widget opslaan en bijwerken',ro:'SalveazÄ Èi actualizeazÄ widgetul',el:'ÎÏÎ¿Î¸Î®ÎºÎµÏÏÎ· ÎºÎ±Î¹ ÎµÎ½Î·Î¼Î­ÏÏÏÎ· widget'},
    'Tocca un articolo quando Ã¨ nel carrello':{en:'Tap an item when it is in the cart',es:'Toca un artÃ­culo cuando estÃ© en el carrito',fr:'Touchez un article quand il est dans le panier',de:'Tippe auf einen Artikel, wenn er im Wagen liegt',pt:'Toca num artigo quando estiver no carrinho',pl:'Dotknij produktu, gdy jest w koszyku',nl:'Tik op een artikel wanneer het in de winkelwagen ligt',ro:'Atinge un articol cÃ¢nd este Ã®n coÈ',el:'Î Î¬ÏÎ·ÏÎµ Î­Î½Î± ÏÏÎ¿ÏÏÎ½ ÏÏÎ±Î½ ÎµÎ¯Î½Î±Î¹ ÏÏÎ¿ ÎºÎ±Î»Î¬Î¸Î¹'},
    'Rimuovi prodotti acquistati':{en:'Remove purchased products',es:'Eliminar productos comprados',fr:'Supprimer les produits achetÃ©s',de:'Gekaufte Produkte entfernen',pt:'Remover produtos comprados',pl:'UsuÅ kupione produkty',nl:'Gekochte producten verwijderen',ro:'EliminÄ produsele cumpÄrate',el:'ÎÏÎ±Î¯ÏÎµÏÎ· Î±Î³Î¿ÏÎ±ÏÎ¼Î­Î½ÏÎ½ ÏÏÎ¿ÏÏÎ½ÏÏÎ½'}
  };
