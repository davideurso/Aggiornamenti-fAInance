...
import {
  detectAssistantTurnLanguage, assistantAnswerNeedsTranslation, assistantHearingReply, assistantRuntimeText, assistantLanguageName,
  createAssistantConversationLanguageState, resolveAssistantLanguageTurn, assistantLanguageControlReply, assistantSpeechLocale,
  buildAssistantRequestPayload, buildAssistantTranslationPayload,
  buildFinanceAdviceRequestPayload, buildFinanceAdviceTranslationPayload,
  buildRealtimeSessionRequest, buildRealtimeManualResponseSessionUpdate,
  buildRealtimeResponseCreate, getFainanceHelpAnswer, compactAssistantAnswer
} from './assistantLogic';
...
export function HomePanel(){
  ...
  var HOME_WORKLET_I18N:any={"en":{"Ultimo mese":"Last month","Ultimi 3 mesi":"Last 3 months","Ultimi 6 mesi":"Last 6 months","Ultimi 12 mesi":"Last 12 months","Tasti rapidi Entrate / Uscite":"Quick actions Income / Expenses","Riassunto":"Summary","Distribuzione Uscite":"Expense distribution","Entrate vs Uscite":"Income vs Expenses","Saldo Mensile":"Monthly balance","Ultime Uscite":"Recent expenses","Ultime Entrate":"Recent income","Share - Ultime transazioni":"Share - Recent transactions","Share - Saldo":"Share - Balance","Risparmio Pianificato":"Planned savings","Fidelity Card":"Loyalty card","Obiettivo":"Goal","Uscite per Area":"Expenses by area","Uscite per Categoria":"Expenses by category","Entrate per Tipo":"Income by type","Budget - Riepilogo":"Budget - Summary","Budget - Categorie":"Budget - Categories","Risparmio - Andamento":"Savings - Trend","Note":"Notes","Coordinata bancaria":"Bank details","Carta di Credito":"Credit card","Lista della spesa":"Shopping list","Voce":"Voice","Scontrino":"Receipt","Impostazioni":"Settings","Share":"Share","Consigli AI":"AI tips","Chat AI":"AI chat","Statistiche":"Statistics","Patrimonio":"Assets","Budget":"Budget","Spesa":"Shopping","Obiettivi":"Goals","Alert":"Alerts","Appunti":"Notes","Pulsanti rapidi per inserire entrate e uscite":"Quick buttons to add income and expenses","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Monthly expenses, monthly income, monthly balance and balance over the last 12 months","Grafico per aree di uscita con intervallo temporale":"Expense-area chart with a selectable time range","Confronto mensile tra entrate e uscite":"Monthly comparison between income and expenses","Andamento del saldo negli ultimi 6 o 12 mesi":"Balance trend over the last 6 or 12 months","Lista delle ultime uscite con numero configurabile":"List of recent expenses with a configurable item count","Lista delle ultime entrate con numero configurabile":"List of recent income with a configurable item count","Ultime transazioni di un progetto Share scelto":"Recent transactions from a selected Share project","Saldo personale di un progetto Share scelto":"Personal balance for a selected Share project","Risparmio pianificato dal Budget e confronto con il reale":"Planned savings from the Budget compared with actual savings","Mostra una carta fidelity o prepagata scelta":"Shows a selected loyalty or prepaid card","Avanzamento di un obiettivo scelto":"Progress of a selected goal","Uscite raggruppate per area":"Expenses grouped by area","Uscite raggruppate per categoria":"Expenses grouped by category","Entrate raggruppate per tipo":"Income grouped by type","Riepilogo budget, spesa reale e risparmio":"Summary of budget, actual spending and savings","Categorie di budget con consumo del mese":"Budget categories with monthly usage","Andamento sintetico del risparmio":"Summary of the savings trend","Mostra una nota scelta dagli Appunti":"Shows a note selected from Notes","Mostra una coordinata bancaria scelta":"Shows selected bank details","Mostra una carta di credito salvata":"Shows a saved credit card","Mostra gli elementi della lista della spesa scelta":"Shows the items in the selected shopping list","Bottone rapido per aprire Voce":"Quick button to open Voice","Bottone rapido per aprire Scontrino":"Quick button to open Receipt","Bottone rapido per aprire Impostazioni":"Quick button to open Settings","Bottone rapido per aprire Share":"Quick button to open Share","Bottone rapido per aprire i consigli AI":"Quick button to open AI tips","Bottone rapido per aprire la chat AI":"Quick button to open AI chat","Bottone rapido per aprire Statistiche":"Quick button to open Statistics","Bottone rapido per aprire Patrimonio":"Quick button to open Assets","Bottone rapido per aprire Budget":"Quick button to open Budget","Bottone rapido per aprire Spesa":"Quick button to open Shopping","Bottone rapido per aprire Obiettivi":"Quick button to open Goals","Bottone rapido per aprire Alert":"Quick button to open Alerts","Bottone rapido per aprire Appunti":"Quick button to open Notes"},"es":{"Ultimo mese":"Último mes","Ultimi 3 mesi":"Últimos 3 meses","Ultimi 6 mesi":"Últimos 6 meses","Ultimi 12 mesi":"Últimos 12 meses","Tasti rapidi Entrate / Uscite":"Acciones rápidas Ingresos / Gastos","Riassunto":"Resumen","Distribuzione Uscite":"Distribución de gastos","Entrate vs Uscite":"Ingresos vs Gastos","Saldo Mensile":"Saldo mensual","Ultime Uscite":"Últimos gastos","Ultime Entrate":"Últimos ingresos","Share - Ultime transazioni":"Share - Últimas transacciones","Share - Saldo":"Share - Saldo","Risparmio Pianificato":"Ahorro planificado","Fidelity Card":"Tarjeta de fidelización","Obiettivo":"Objetivo","Uscite per Area":"Gastos por área","Uscite per Categoria":"Gastos por categoría","Entrate per Tipo":"Ingresos por tipo","Budget - Riepilogo":"Presupuesto - Resumen","Budget - Categorie":"Presupuesto - Categorías","Risparmio - Andamento":"Ahorro - Evolución","Note":"Notas","Coordinata bancaria":"Datos bancarios","Carta di Credito":"Tarjeta de crédito","Lista della spesa":"Lista de la compra","Voce":"Voz","Scontrino":"Recibo","Impostazioni":"Ajustes","Share":"Share","Consigli AI":"Consejos de IA","Chat AI":"Chat de IA","Statistiche":"Estadísticas","Patrimonio":"Patrimonio","Budget":"Presupuesto","Spesa":"Compras","Obiettivi":"Objetivos","Alert":"Alertas","Appunti":"Notas","Pulsanti rapidi per inserire entrate e uscite":"Botones rápidos para añadir ingresos y gastos","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Gastos del mes, ingresos del mes, saldo del mes y saldo de los últimos 12 meses","Grafico per aree di uscita con intervallo temporale":"Gráfico de gastos por área con intervalo temporal seleccionable","Confronto mensile tra entrate e uscite":"Comparación mensual entre ingresos y gastos","Andamento del saldo negli ultimi 6 o 12 mesi":"Evolución del saldo durante los últimos 6 o 12 meses","Lista delle ultime uscite con numero configurabile":"Lista de los últimos gastos con cantidad configurable","Lista delle ultime entrate con numero configurabile":"Lista de los últimos ingresos con cantidad configurable","Ultime transazioni di un progetto Share scelto":"Últimas transacciones de un proyecto Share seleccionado","Saldo personale di un progetto Share scelto":"Saldo personal de un proyecto Share seleccionado","Risparmio pianificato dal Budget e confronto con il reale":"Ahorro planificado en el Presupuesto comparado con el ahorro real","Mostra una carta fidelity o prepagata scelta":"Muestra una tarjeta de fidelización o prepago seleccionada","Avanzamento di un obiettivo scelto":"Progreso de un objetivo seleccionado","Uscite raggruppate per area":"Gastos agrupados por área","Uscite raggruppate per categoria":"Gastos agrupados por categoría","Entrate raggruppate per tipo":"Ingresos agrupados por tipo","Riepilogo budget, spesa reale e risparmio":"Resumen de presupuesto, gasto real y ahorro","Categorie di budget con consumo del mese":"Categorías de presupuesto con consumo del mes","Andamento sintetico del risparmio":"Resumen de la evolución del ahorro","Mostra una nota scelta dagli Appunti":"Muestra una nota seleccionada en Notas","Mostra una coordinata bancaria scelta":"Muestra los datos bancarios seleccionados","Mostra una carta di credito salvata":"Muestra una tarjeta de crédito guardada","Mostra gli elementi della lista della spesa scelta":"Muestra los elementos de la lista de la compra seleccionada","Bottone rapido per aprire Voce":"Botón rápido para abrir Voz","Bottone rapido per aprire Scontrino":"Botón rápido para abrir Recibo","Bottone rapido per aprire Impostazioni":"Botón rápido para abrir Ajustes","Bottone rapido per aprire Share":"Botón rápido para abrir Share","Bottone rapido per aprire i consigli AI":"Botón rápido para abrir los consejos de IA","Bottone rapido per aprire la chat AI":"Botón rápido para abrir el chat de IA","Bottone rapido per aprire Statistiche":"Botón rápido para abrir Estadísticas","Bottone rapido per aprire Patrimonio":"Botón rápido para abrir Patrimonio","Bottone rapido per aprire Budget":"Botón rápido para abrir Presupuesto","Bottone rapido per aprire Spesa":"Botón rápido para abrir Compras","Bottone rapido per aprire Obiettivi":"Botón rápido para abrir Objetivos","Bottone rapido per aprire Alert":"Botón rápido para abrir Alertas","Bottone rapido per aprire Appunti":"Botón rápido para abrir Notas"},"fr":{"Ultimo mese":"Dernier mois","Ultimi 3 mesi":"3 derniers mois","Ultimi 6 mesi":"6 derniers mois","Ultimi 12 mesi":"12 derniers mois","Tasti rapidi Entrate / Uscite":"Actions rapides Revenus / Dépenses","Riassunto":"Résumé","Distribuzione Uscite":"Répartition des dépenses","Entrate vs Uscite":"Revenus vs Dépenses","Saldo Mensile":"Solde mensuel","Ultime Uscite":"Dernières dépenses","Ultime Entrate":"Derniers revenus","Share - Ultime transazioni":"Share - Dernières transactions","Share - Saldo":"Share - Solde","Risparmio Pianificato":"Épargne planifiée","Fidelity Card":"Carte de fidélité","Obiettivo":"Objectif","Uscite per Area":"Dépenses par zone","Uscite per Categoria":"Dépenses par catégorie","Entrate per Tipo":"Revenus par type","Budget - Riepilogo":"Budget - Résumé","Budget - Categorie":"Budget - Catégories","Risparmio - Andamento":"Épargne - Évolution","Note":"Notes","Coordinata bancaria":"Coordonnées bancaires","Carta di Credito":"Carte de crédit","Lista della spesa":"Liste de courses","Voce":"Voix","Scontrino":"Ticket de caisse","Impostazioni":"Paramètres","Share":"Share","Consigli AI":"Conseils IA","Chat AI":"Chat IA","Statistiche":"Statistiques","Patrimonio":"Patrimoine","Budget":"Budget","Spesa":"Courses","Obiettivi":"Objectifs","Alert":"Alertes","Appunti":"Notes","Pulsanti rapidi per inserire entrate e uscite":"Boutons rapides pour ajouter des revenus et des dépenses","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Dépenses du mois, revenus du mois, solde du mois et solde des 12 derniers mois","Grafico per aree di uscita con intervallo temporale":"Graphique des dépenses par zone avec période sélectionnable","Confronto mensile tra entrate e uscite":"Comparaison mensuelle entre revenus et dépenses","Andamento del saldo negli ultimi 6 o 12 mesi":"Évolution du solde sur les 6 ou 12 derniers mois","Lista delle ultime uscite con numero configurabile":"Liste des dernières dépenses avec nombre d’éléments configurable","Lista delle ultime entrate con numero configurabile":"Liste des derniers revenus avec nombre d’éléments configurable","Ultime transazioni di un progetto Share scelto":"Dernières transactions d’un projet Share sélectionné","Saldo personale di un progetto Share scelto":"Solde personnel d’un projet Share sélectionné","Risparmio pianificato dal Budget e confronto con il reale":"Épargne planifiée dans le Budget comparée à l’épargne réelle","Mostra una carta fidelity o prepagata scelta":"Affiche une carte de fidélité ou prépayée sélectionnée","Avanzamento di un obiettivo scelto":"Progression d’un objectif sélectionné","Uscite raggruppate per area":"Dépenses regroupées par zone","Uscite raggruppate per categoria":"Dépenses regroupées par catégorie","Entrate raggruppate per tipo":"Revenus regroupés par type","Riepilogo budget, spesa reale e risparmio":"Résumé du budget, des dépenses réelles et de l’épargne","Categorie di budget con consumo del mese":"Catégories de budget avec consommation du mois","Andamento sintetico del risparmio":"Synthèse de l’évolution de l’épargne","Mostra una nota scelta dagli Appunti":"Affiche une note sélectionnée dans Notes","Mostra una coordinata bancaria scelta":"Affiche les coordonnées bancaires sélectionnées","Mostra una carta di credito salvata":"Affiche une carte de crédit enregistrée","Mostra gli elementi della lista della spesa scelta":"Affiche les éléments de la liste de courses sélectionnée","Bottone rapido per aprire Voce":"Bouton rapide pour ouvrir Voix","Bottone rapido per aprire Scontrino":"Bouton rapide pour ouvrir Ticket de caisse","Bottone rapido per aprire Impostazioni":"Bouton rapide pour ouvrir Paramètres","Bottone rapido per aprire Share":"Bouton rapide pour ouvrir Share","Bottone rapido per aprire i consigli AI":"Bouton rapide pour ouvrir les conseils IA","Bottone rapido per aprire la chat AI":"Bouton rapide pour ouvrir le chat IA","Bottone rapido per aprire Statistiche":"Bouton rapide pour ouvrir Statistiques","Bottone rapido per aprire Patrimonio":"Bouton rapide pour ouvrir Patrimoine","Bottone rapido per aprire Budget":"Bouton rapide pour ouvrir Budget","Bottone rapido per aprire Spesa":"Bouton rapide pour ouvrir Courses","Bottone rapido per aprire Obiettivi":"Bouton rapide pour ouvrir Objectifs","Bottone rapido per aprire Alert":"Bouton rapide pour ouvrir Alertes","Bottone rapido per aprire Appunti":"Bouton rapide pour ouvrir Notes"},"de":{"Ultimo mese":"Letzter Monat","Ultimi 3 mesi":"Letzte 3 Monate","Ultimi 6 mesi":"Letzte 6 Monate","Ultimi 12 mesi":"Letzte 12 Monate","Tasti rapidi Entrate / Uscite":"Schnellaktionen Einnahmen / Ausgaben","Riassunto":"Übersicht","Distribuzione Uscite":"Ausgabenverteilung","Entrate vs Uscite":"Einnahmen vs Ausgaben","Saldo Mensile":"Monatlicher Saldo","Ultime Uscite":"Letzte Ausgaben","Ultime Entrate":"Letzte Einnahmen","Share - Ultime transazioni":"Share - Letzte Transaktionen","Share - Saldo":"Share - Saldo","Risparmio Pianificato":"Geplantes Sparen","Fidelity Card":"Kundenkarte","Obiettivo":"Ziel","Uscite per Area":"Ausgaben nach Bereich","Uscite per Categoria":"Ausgaben nach Kategorie","Entrate per Tipo":"Einnahmen nach Typ","Budget - Riepilogo":"Budget - Übersicht","Budget - Categorie":"Budget - Kategorien","Risparmio - Andamento":"Sparen - Entwicklung","Note":"Notizen","Coordinata bancaria":"Bankverbindung","Carta di Credito":"Kreditkarte","Lista della spesa":"Einkaufsliste","Voce":"Spracheingabe","Scontrino":"Beleg","Impostazioni":"Einstellungen","Share":"Share","Consigli AI":"KI-Tipps","Chat AI":"KI-Chat","Statistiche":"Statistiken","Patrimonio":"Vermögen","Budget":"Budget","Spesa":"Einkauf","Obiettivi":"Ziele","Alert":"Warnungen","Appunti":"Notizen","Pulsanti rapidi per inserire entrate e uscite":"Schnellschaltflächen zum Hinzufügen von Einnahmen und Ausgaben","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Monatliche Ausgaben, monatliche Einnahmen, Monatssaldo und Saldo der letzten 12 Monate","Grafico per aree di uscita con intervallo temporale":"Ausgabendiagramm nach Bereichen mit auswählbarem Zeitraum","Confronto mensile tra entrate e uscite":"Monatlicher Vergleich von Einnahmen und Ausgaben","Andamento del saldo negli ultimi 6 o 12 mesi":"Saldoentwicklung der letzten 6 oder 12 Monate","Lista delle ultime uscite con numero configurabile":"Liste der letzten Ausgaben mit einstellbarer Anzahl","Lista delle ultime entrate con numero configurabile":"Liste der letzten Einnahmen mit einstellbarer Anzahl","Ultime transazioni di un progetto Share scelto":"Letzte Transaktionen eines ausgewählten Share-Projekts","Saldo personale di un progetto Share scelto":"Persönlicher Saldo eines ausgewählten Share-Projekts","Risparmio pianificato dal Budget e confronto con il reale":"Geplantes Sparen aus dem Budget im Vergleich zum tatsächlichen Sparen","Mostra una carta fidelity o prepagata scelta":"Zeigt eine ausgewählte Kunden- oder Prepaidkarte","Avanzamento di un obiettivo scelto":"Fortschritt eines ausgewählten Ziels","Uscite raggruppate per area":"Ausgaben nach Bereich gruppiert","Uscite raggruppate per categoria":"Ausgaben nach Kategorie gruppiert","Entrate raggruppate per tipo":"Einnahmen nach Typ gruppiert","Riepilogo budget, spesa reale e risparmio":"Übersicht über Budget, tatsächliche Ausgaben und Ersparnis","Categorie di budget con consumo del mese":"Budgetkategorien mit Verbrauch im aktuellen Monat","Andamento sintetico del risparmio":"Zusammenfassung der Sparentwicklung","Mostra una nota scelta dagli Appunti":"Zeigt eine aus den Notizen ausgewählte Notiz","Mostra una coordinata bancaria scelta":"Zeigt die ausgewählte Bankverbindung","Mostra una carta di credito salvata":"Zeigt eine gespeicherte Kreditkarte","Mostra gli elementi della lista della spesa scelta":"Zeigt die Einträge der ausgewählten Einkaufsliste","Bottone rapido per aprire Voce":"Schnellschaltfläche zum Öffnen der Spracheingabe","Bottone rapido per aprire Scontrino":"Schnellschaltfläche zum Öffnen von Beleg","Bottone rapido per aprire Impostazioni":"Schnellschaltfläche zum Öffnen der Einstellungen","Bottone rapido per aprire Share":"Schnellschaltfläche zum Öffnen von Share","Bottone rapido per aprire i consigli AI":"Schnellschaltfläche zum Öffnen der KI-Tipps","Bottone rapido per aprire la chat AI":"Schnellschaltfläche zum Öffnen des KI-Chats","Bottone rapido per aprire Statistiche":"Schnellschaltfläche zum Öffnen der Statistiken","Bottone rapido per aprire Patrimonio":"Schnellschaltfläche zum Öffnen von Vermögen","Bottone rapido per aprire Budget":"Schnellschaltfläche zum Öffnen des Budgets","Bottone rapido per aprire Spesa":"Schnellschaltfläche zum Öffnen von Einkauf","Bottone rapido per aprire Obiettivi":"Schnellschaltfläche zum Öffnen der Ziele","Bottone rapido per aprire Alert":"Schnellschaltfläche zum Öffnen der Warnungen","Bottone rapido per aprire Appunti":"Schnellschaltfläche zum Öffnen der Notizen"},"pt":{"Ultimo mese":"Último mês","Ultimi 3 mesi":"Últimos 3 meses","Ultimi 6 mesi":"Últimos 6 meses","Ultimi 12 mesi":"Últimos 12 meses","Tasti rapidi Entrate / Uscite":"Ações rápidas Receitas / Despesas","Riassunto":"Resumo","Distribuzione Uscite":"Distribuição de despesas","Entrate vs Uscite":"Receitas vs Despesas","Saldo Mensile":"Saldo mensal","Ultime Uscite":"Últimas despesas","Ultime Entrate":"Últimas receitas","Share - Ultime transazioni":"Share - Últimas transações","Share - Saldo":"Share - Saldo","Risparmio Pianificato":"Poupança planeada","Fidelity Card":"Cartão de fidelização","Obiettivo":"Objetivo","Uscite per Area":"Despesas por área","Uscite per Categoria":"Despesas por categoria","Entrate per Tipo":"Receitas por tipo","Budget - Riepilogo":"Orçamento - Resumo","Budget - Categorie":"Orçamento - Categorias","Risparmio - Andamento":"Poupança - Evolução","Note":"Notas","Coordinata bancaria":"Dados bancários","Carta di Credito":"Cartão de crédito","Lista della spesa":"Lista de compras","Voce":"Voz","Scontrino":"Recibo","Impostazioni":"Definições","Share":"Share","Consigli AI":"Dicas de IA","Chat AI":"Chat de IA","Statistiche":"Estatísticas","Patrimonio":"Património","Budget":"Orçamento","Spesa":"Compras","Obiettivi":"Objetivos","Alert":"Alertas","Appunti":"Notas","Pulsanti rapidi per inserire entrate e uscite":"Botões rápidos para adicionar receitas e despesas","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Despesas do mês, receitas do mês, saldo do mês e saldo dos últimos 12 meses","Grafico per aree di uscita con intervallo temporale":"Gráfico de despesas por área com intervalo de tempo selecionável","Confronto mensile tra entrate e uscite":"Comparação mensal entre receitas e despesas","Andamento del saldo negli ultimi 6 o 12 mesi":"Evolução do saldo nos últimos 6 ou 12 meses","Lista delle ultime uscite con numero configurabile":"Lista das últimas despesas com quantidade configurável","Lista delle ultime entrate con numero configurabile":"Lista das últimas receitas com quantidade configurável","Ultime transazioni di un progetto Share scelto":"Últimas transações de um projeto Share selecionado","Saldo personale di un progetto Share scelto":"Saldo pessoal de um projeto Share selecionado","Risparmio pianificato dal Budget e confronto con il reale":"Poupança planeada no Orçamento comparada com a poupança real","Mostra una carta fidelity o prepagata scelta":"Mostra um cartão de fidelização ou pré-pago selecionado","Avanzamento di un obiettivo scelto":"Progresso de um objetivo selecionado","Uscite raggruppate per area":"Despesas agrupadas por área","Uscite raggruppate per categoria":"Despesas agrupadas por categoria","Entrate raggruppate per tipo":"Receitas agrupadas por tipo","Riepilogo budget, spesa reale e risparmio":"Resumo do orçamento, despesa real e poupança","Categorie di budget con consumo del mese":"Categorias de orçamento com utilização do mês","Andamento sintetico del risparmio":"Resumo da evolução da poupança","Mostra una nota scelta dagli Appunti":"Mostra uma nota selecionada nas Notas","Mostra una coordinata bancaria scelta":"Mostra os dados bancários selecionados","Mostra una carta di credito salvata":"Mostra um cartão de crédito guardado","Mostra gli elementi della lista della spesa scelta":"Mostra os itens da lista de compras selecionada","Bottone rapido per aprire Voce":"Botão rápido para abrir Voz","Bottone rapido per aprire Scontrino":"Botão rápido para abrir Recibo","Bottone rapido per aprire Impostazioni":"Botão rápido para abrir Definições","Bottone rapido per aprire Share":"Botão rápido para abrir Share","Bottone rapido per aprire i consigli AI":"Botão rápido para abrir as dicas de IA","Bottone rapido per aprire la chat AI":"Botão rápido para abrir o chat de IA","Bottone rapido per aprire Statistiche":"Botão rápido para abrir Estatísticas","Bottone rapido per aprire Patrimonio":"Botão rápido para abrir Património","Bottone rapido per aprire Budget":"Botão rápido para abrir Orçamento","Bottone rapido per aprire Spesa":"Botão rápido para abrir Compras","Bottone rapido per aprire Obiettivi":"Botão rápido para abrir Objetivos","Bottone rapido per aprire Alert":"Botão rápido para abrir Alertas","Bottone rapido per aprire Appunti":"Botão rápido para abrir Notas"},"pl":{"Ultimo mese":"Ostatni miesiąc","Ultimi 3 mesi":"Ostatnie 3 miesiące","Ultimi 6 mesi":"Ostatnie 6 miesięcy","Ultimi 12 mesi":"Ostatnie 12 miesięcy","Tasti rapidi Entrate / Uscite":"Szybkie akcje Przychody / Wydatki","Riassunto":"Podsumowanie","Distribuzione Uscite":"Rozkład wydatków","Entrate vs Uscite":"Przychody vs Wydatki","Saldo Mensile":"Saldo miesięczne","Ultime Uscite":"Ostatnie wydatki","Ultime Entrate":"Ostatnie przychody","Share - Ultime transazioni":"Share - Ostatnie transakcje","Share - Saldo":"Share - Saldo","Risparmio Pianificato":"Planowane oszczędności","Fidelity Card":"Karta lojalnościowa","Obiettivo":"Cel","Uscite per Area":"Wydatki według obszaru","Uscite per Categoria":"Wydatki według kategorii","Entrate per Tipo":"Przychody według typu","Budget - Riepilogo":"Budżet - Podsumowanie","Budget - Categorie":"Budżet - Kategorie","Risparmio - Andamento":"Oszczędności - Trend","Note":"Notatki","Coordinata bancaria":"Dane bankowe","Carta di Credito":"Karta kredytowa","Lista della spesa":"Lista zakupów","Voce":"Głos","Scontrino":"Paragon","Impostazioni":"Ustawienia","Share":"Share","Consigli AI":"Porady AI","Chat AI":"Czat AI","Statistiche":"Statystyki","Patrimonio":"Majątek","Budget":"Budżet","Spesa":"Zakupy","Obiettivi":"Cele","Alert":"Alerty","Appunti":"Notatki","Pulsanti rapidi per inserire entrate e uscite":"Szybkie przyciski do dodawania przychodów i wydatków","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Miesięczne wydatki, miesięczne przychody, saldo miesiąca i saldo z ostatnich 12 miesięcy","Grafico per aree di uscita con intervallo temporale":"Wykres wydatków według obszaru z wybieranym zakresem czasu","Confronto mensile tra entrate e uscite":"Miesięczne porównanie przychodów i wydatków","Andamento del saldo negli ultimi 6 o 12 mesi":"Trend salda z ostatnich 6 lub 12 miesięcy","Lista delle ultime uscite con numero configurabile":"Lista ostatnich wydatków z konfigurowalną liczbą pozycji","Lista delle ultime entrate con numero configurabile":"Lista ostatnich przychodów z konfigurowalną liczbą pozycji","Ultime transazioni di un progetto Share scelto":"Ostatnie transakcje z wybranego projektu Share","Saldo personale di un progetto Share scelto":"Osobiste saldo wybranego projektu Share","Risparmio pianificato dal Budget e confronto con il reale":"Planowane oszczędności z Budżetu w porównaniu z rzeczywistymi","Mostra una carta fidelity o prepagata scelta":"Pokazuje wybraną kartę lojalnościową lub przedpłaconą","Avanzamento di un obiettivo scelto":"Postęp wybranego celu","Uscite raggruppate per area":"Wydatki pogrupowane według obszaru","Uscite raggruppate per categoria":"Wydatki pogrupowane według kategorii","Entrate raggruppate per tipo":"Przychody pogrupowane według typu","Riepilogo budget, spesa reale e risparmio":"Podsumowanie budżetu, rzeczywistych wydatków i oszczędności","Categorie di budget con consumo del mese":"Kategorie budżetu z wykorzystaniem w danym miesiącu","Andamento sintetico del risparmio":"Podsumowanie trendu oszczędności","Mostra una nota scelta dagli Appunti":"Pokazuje notatkę wybraną z Notatek","Mostra una coordinata bancaria scelta":"Pokazuje wybrane dane bankowe","Mostra una carta di credito salvata":"Pokazuje zapisaną kartę kredytową","Mostra gli elementi della lista della spesa scelta":"Pokazuje pozycje z wybranej listy zakupów","Bottone rapido per aprire Voce":"Szybki przycisk otwierający Głos","Bottone rapido per aprire Scontrino":"Szybki przycisk otwierający Paragon","Bottone rapido per aprire Impostazioni":"Szybki przycisk otwierający Ustawienia","Bottone rapido per aprire Share":"Szybki przycisk otwierający Share","Bottone rapido per aprire i consigli AI":"Szybki przycisk otwierający porady AI","Bottone rapido per aprire la chat AI":"Szybki przycisk otwierający czat AI","Bottone rapido per aprire Statistiche":"Szybki przycisk otwierający Statystyki","Bottone rapido per aprire Patrimonio":"Szybki przycisk otwierający Majątek","Bottone rapido per aprire Budget":"Szybki przycisk otwierający Budżet","Bottone rapido per aprire Spesa":"Szybki przycisk otwierający Zakupy","Bottone rapido per aprire Obiettivi":"Szybki przycisk otwierający Cele","Bottone rapido per aprire Alert":"Szybki przycisk otwierający Alerty","Bottone rapido per aprire Appunti":"Szybki przycisk otwierający Notatki"},"nl":{"Ultimo mese":"Laatste maand","Ultimi 3 mesi":"Laatste 3 maanden","Ultimi 6 mesi":"Laatste 6 maanden","Ultimi 12 mesi":"Laatste 12 maanden","Tasti rapidi Entrate / Uscite":"Snelle acties Inkomsten / Uitgaven","Riassunto":"Samenvatting","Distribuzione Uscite":"Uitgavenverdeling","Entrate vs Uscite":"Inkomsten vs Uitgaven","Saldo Mensile":"Maandelijks saldo","Ultime Uscite":"Recente uitgaven","Ultime Entrate":"Recente inkomsten","Share - Ultime transazioni":"Share - Recente transacties","Share - Saldo":"Share - Saldo","Risparmio Pianificato":"Geplande besparing","Fidelity Card":"Klantenkaart","Obiettivo":"Doel","Uscite per Area":"Uitgaven per gebied","Uscite per Categoria":"Uitgaven per categorie","Entrate per Tipo":"Inkomsten per type","Budget - Riepilogo":"Budget - Samenvatting","Budget - Categorie":"Budget - Categorieën","Risparmio - Andamento":"Besparing - Verloop","Note":"Notities","Coordinata bancaria":"Bankgegevens","Carta di Credito":"Creditcard","Lista della spesa":"Boodschappenlijst","Voce":"Spraak","Scontrino":"Bon","Impostazioni":"Instellingen","Share":"Share","Consigli AI":"AI-advies","Chat AI":"AI-chat","Statistiche":"Statistieken","Patrimonio":"Vermogen","Budget":"Budget","Spesa":"Boodschappen","Obiettivi":"Doelen","Alert":"Waarschuwingen","Appunti":"Notities","Pulsanti rapidi per inserire entrate e uscite":"Snelknoppen om inkomsten en uitgaven toe te voegen","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Maandelijkse uitgaven, maandelijkse inkomsten, maandsaldo en saldo van de laatste 12 maanden","Grafico per aree di uscita con intervallo temporale":"Uitgavengrafiek per gebied met instelbare periode","Confronto mensile tra entrate e uscite":"Maandelijkse vergelijking van inkomsten en uitgaven","Andamento del saldo negli ultimi 6 o 12 mesi":"Saldoverloop over de laatste 6 of 12 maanden","Lista delle ultime uscite con numero configurabile":"Lijst met recente uitgaven en instelbaar aantal items","Lista delle ultime entrate con numero configurabile":"Lijst met recente inkomsten en instelbaar aantal items","Ultime transazioni di un progetto Share scelto":"Recente transacties van een geselecteerd Share-project","Saldo personale di un progetto Share scelto":"Persoonlijk saldo van een geselecteerd Share-project","Risparmio pianificato dal Budget e confronto con il reale":"Geplande besparing uit het Budget vergeleken met de werkelijke besparing","Mostra una carta fidelity o prepagata scelta":"Toont een geselecteerde klantenkaart of prepaidkaart","Avanzamento di un obiettivo scelto":"Voortgang van een geselecteerd doel","Uscite raggruppate per area":"Uitgaven gegroepeerd per gebied","Uscite raggruppate per categoria":"Uitgaven gegroepeerd per categorie","Entrate raggruppate per tipo":"Inkomsten gegroepeerd per type","Riepilogo budget, spesa reale e risparmio":"Samenvatting van budget, werkelijke uitgaven en besparing","Categorie di budget con consumo del mese":"Budgetcategorieën met verbruik van de maand","Andamento sintetico del risparmio":"Samenvatting van het spaarverloop","Mostra una nota scelta dagli Appunti":"Toont een notitie die bij Notities is geselecteerd","Mostra una coordinata bancaria scelta":"Toont de geselecteerde bankgegevens","Mostra una carta di credito salvata":"Toont een opgeslagen creditcard","Mostra gli elementi della lista della spesa scelta":"Toont de items van de geselecteerde boodschappenlijst","Bottone rapido per aprire Voce":"Snelknop om Spraak te openen","Bottone rapido per aprire Scontrino":"Snelknop om Bon te openen","Bottone rapido per aprire Impostazioni":"Snelknop om Instellingen te openen","Bottone rapido per aprire Share":"Snelknop om Share te openen","Bottone rapido per aprire i consigli AI":"Snelknop om AI-advies te openen","Bottone rapido per aprire la chat AI":"Snelknop om AI-chat te openen","Bottone rapido per aprire Statistiche":"Snelknop om Statistieken te openen","Bottone rapido per aprire Patrimonio":"Snelknop om Vermogen te openen","Bottone rapido per aprire Budget":"Snelknop om Budget te openen","Bottone rapido per aprire Spesa":"Snelknop om Boodschappen te openen","Bottone rapido per aprire Obiettivi":"Snelknop om Doelen te openen","Bottone rapido per aprire Alert":"Snelknop om Waarschuwingen te openen","Bottone rapido per aprire Appunti":"Snelknop om Notities te openen"},"ro":{"Ultimo mese":"Ultima lună","Ultimi 3 mesi":"Ultimele 3 luni","Ultimi 6 mesi":"Ultimele 6 luni","Ultimi 12 mesi":"Ultimele 12 luni","Tasti rapidi Entrate / Uscite":"Acțiuni rapide Venituri / Cheltuieli","Riassunto":"Rezumat","Distribuzione Uscite":"Distribuția cheltuielilor","Entrate vs Uscite":"Venituri vs Cheltuieli","Saldo Mensile":"Sold lunar","Ultime Uscite":"Ultimele cheltuieli","Ultime Entrate":"Ultimele venituri","Share - Ultime transazioni":"Share - Ultimele tranzacții","Share - Saldo":"Share - Sold","Risparmio Pianificato":"Economii planificate","Fidelity Card":"Card de fidelitate","Obiettivo":"Obiectiv","Uscite per Area":"Cheltuieli pe zonă","Uscite per Categoria":"Cheltuieli pe categorie","Entrate per Tipo":"Venituri pe tip","Budget - Riepilogo":"Buget - Rezumat","Budget - Categorie":"Buget - Categorii","Risparmio - Andamento":"Economii - Evoluție","Note":"Notițe","Coordinata bancaria":"Date bancare","Carta di Credito":"Card de credit","Lista della spesa":"Listă de cumpărături","Voce":"Voce","Scontrino":"Bon","Impostazioni":"Setări","Share":"Share","Consigli AI":"Sfaturi AI","Chat AI":"Chat AI","Statistiche":"Statistici","Patrimonio":"Patrimoniu","Budget":"Buget","Spesa":"Cumpărături","Obiettivi":"Obiective","Alert":"Alerte","Appunti":"Notițe","Pulsanti rapidi per inserire entrate e uscite":"Butoane rapide pentru adăugarea veniturilor și cheltuielilor","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Cheltuieli lunare, venituri lunare, sold lunar și soldul ultimelor 12 luni","Grafico per aree di uscita con intervallo temporale":"Grafic al cheltuielilor pe zone cu interval de timp selectabil","Confronto mensile tra entrate e uscite":"Comparație lunară între venituri și cheltuieli","Andamento del saldo negli ultimi 6 o 12 mesi":"Evoluția soldului în ultimele 6 sau 12 luni","Lista delle ultime uscite con numero configurabile":"Lista ultimelor cheltuieli cu număr configurabil de elemente","Lista delle ultime entrate con numero configurabile":"Lista ultimelor venituri cu număr configurabil de elemente","Ultime transazioni di un progetto Share scelto":"Ultimele tranzacții dintr-un proiect Share selectat","Saldo personale di un progetto Share scelto":"Soldul personal al unui proiect Share selectat","Risparmio pianificato dal Budget e confronto con il reale":"Economiile planificate în Buget comparate cu cele reale","Mostra una carta fidelity o prepagata scelta":"Afișează un card de fidelitate sau preplătit selectat","Avanzamento di un obiettivo scelto":"Progresul unui obiectiv selectat","Uscite raggruppate per area":"Cheltuieli grupate pe zonă","Uscite raggruppate per categoria":"Cheltuieli grupate pe categorie","Entrate raggruppate per tipo":"Venituri grupate pe tip","Riepilogo budget, spesa reale e risparmio":"Rezumatul bugetului, cheltuielilor reale și economiilor","Categorie di budget con consumo del mese":"Categorii de buget cu consumul lunii","Andamento sintetico del risparmio":"Rezumatul evoluției economiilor","Mostra una nota scelta dagli Appunti":"Afișează o notiță selectată din Notițe","Mostra una coordinata bancaria scelta":"Afișează datele bancare selectate","Mostra una carta di credito salvata":"Afișează un card de credit salvat","Mostra gli elementi della lista della spesa scelta":"Afișează elementele din lista de cumpărături selectată","Bottone rapido per aprire Voce":"Buton rapid pentru a deschide Voce","Bottone rapido per aprire Scontrino":"Buton rapid pentru a deschide Bon","Bottone rapido per aprire Impostazioni":"Buton rapid pentru a deschide Setări","Bottone rapido per aprire Share":"Buton rapid pentru a deschide Share","Bottone rapido per aprire i consigli AI":"Buton rapid pentru a deschide sfaturile AI","Bottone rapido per aprire la chat AI":"Buton rapid pentru a deschide chatul AI","Bottone rapido per aprire Statistiche":"Buton rapid pentru a deschide Statistici","Bottone rapido per aprire Patrimonio":"Buton rapid pentru a deschide Patrimoniu","Bottone rapido per aprire Budget":"Buton rapid pentru a deschide Buget","Bottone rapido per aprire Spesa":"Buton rapid pentru a deschide Cumpărături","Bottone rapido per aprire Obiettivi":"Buton rapid pentru a deschide Obiective","Bottone rapido per aprire Alert":"Buton rapid pentru a deschide Alerte","Bottone rapido per aprire Appunti":"Buton rapid pentru a deschide Notițe"},"el":{"Ultimo mese":"Τελευταίος μήνας","Ultimi 3 mesi":"Τελευταίοι 3 μήνες","Ultimi 6 mesi":"Τελευταίοι 6 μήνες","Ultimi 12 mesi":"Τελευταίοι 12 μήνες","Tasti rapidi Entrate / Uscite":"Γρήγορες ενέργειες Έσοδα / Έξοδα","Riassunto":"Σύνοψη","Distribuzione Uscite":"Κατανομή εξόδων","Entrate vs Uscite":"Έσοδα vs Έξοδα","Saldo Mensile":"Μηνιαίο υπόλοιπο","Ultime Uscite":"Τελευταία έξοδα","Ultime Entrate":"Τελευταία έσοδα","Share - Ultime transazioni":"Share - Τελευταίες συναλλαγές","Share - Saldo":"Share - Υπόλοιπο","Risparmio Pianificato":"Προγραμματισμένη αποταμίευση","Fidelity Card":"Κάρτα επιβράβευσης","Obiettivo":"Στόχος","Uscite per Area":"Έξοδα ανά περιοχή","Uscite per Categoria":"Έξοδα ανά κατηγορία","Entrate per Tipo":"Έσοδα ανά τύπο","Budget - Riepilogo":"Προϋπολογισμός - Σύνοψη","Budget - Categorie":"Προϋπολογισμός - Κατηγορίες","Risparmio - Andamento":"Αποταμίευση - Εξέλιξη","Note":"Σημειώσεις","Coordinata bancaria":"Τραπεζικά στοιχεία","Carta di Credito":"Πιστωτική κάρτα","Lista della spesa":"Λίστα αγορών","Voce":"Φωνή","Scontrino":"Απόδειξη","Impostazioni":"Ρυθμίσεις","Share":"Share","Consigli AI":"Συμβουλές AI","Chat AI":"Συνομιλία AI","Statistiche":"Στατιστικά","Patrimonio":"Περιουσία","Budget":"Προϋπολογισμός","Spesa":"Αγορές","Obiettivi":"Στόχοι","Alert":"Ειδοποιήσεις","Appunti":"Σημειώσεις","Pulsanti rapidi per inserire entrate e uscite":"Γρήγορα κουμπιά για προσθήκη εσόδων και εξόδων","Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi":"Μηνιαία έξοδα, μηνιαία έσοδα, μηνιαίο υπόλοιπο και υπόλοιπο τελευταίων 12 μηνών","Grafico per aree di uscita con intervallo temporale":"Γράφημα εξόδων ανά περιοχή με επιλέξιμο χρονικό διάστημα","Confronto mensile tra entrate e uscite":"Μηνιαία σύγκριση εσόδων και εξόδων","Andamento del saldo negli ultimi 6 o 12 mesi":"Εξέλιξη υπολοίπου τους τελευταίους 6 ή 12 μήνες","Lista delle ultime uscite con numero configurabile":"Λίστα τελευταίων εξόδων με ρυθμιζόμενο αριθμό στοιχείων","Lista delle ultime entrate con numero configurabile":"Λίστα τελευταίων εσόδων με ρυθμιζόμενο αριθμό στοιχείων","Ultime transazioni di un progetto Share scelto":"Τελευταίες συναλλαγές επιλεγμένου έργου Share","Saldo personale di un progetto Share scelto":"Προσωπικό υπόλοιπο επιλεγμένου έργου Share","Risparmio pianificato dal Budget e confronto con il reale":"Προγραμματισμένη αποταμίευση από τον Προϋπολογισμό σε σύγκριση με την πραγματική","Mostra una carta fidelity o prepagata scelta":"Εμφανίζει επιλεγμένη κάρτα επιβράβευσης ή προπληρωμένη κάρτα","Avanzamento di un obiettivo scelto":"Πρόοδος επιλεγμένου στόχου","Uscite raggruppate per area":"Έξοδα ομαδοποιημένα ανά περιοχή","Uscite raggruppate per categoria":"Έξοδα ομαδοποιημένα ανά κατηγορία","Entrate raggruppate per tipo":"Έσοδα ομαδοποιημένα ανά τύπο","Riepilogo budget, spesa reale e risparmio":"Σύνοψη προϋπολογισμού, πραγματικών εξόδων και αποταμίευσης","Categorie di budget con consumo del mese":"Κατηγορίες προϋπολογισμού με κατανάλωση του μήνα","Andamento sintetico del risparmio":"Σύνοψη της εξέλιξης αποταμίευσης","Mostra una nota scelta dagli Appunti":"Εμφανίζει μια σημείωση επιλεγμένη από τις Σημειώσεις","Mostra una coordinata bancaria scelta":"Εμφανίζει τα επιλεγμένα τραπεζικά στοιχεία","Mostra una carta di credito salvata":"Εμφανίζει μια αποθηκευμένη πιστωτική κάρτα","Mostra gli elementi della lista della spesa scelta":"Εμφανίζει τα στοιχεία της επιλεγμένης λίστας αγορών","Bottone rapido per aprire Voce":"Γρήγορο κουμπί για άνοιγμα της Φωνής","Bottone rapido per aprire Scontrino":"Γρήγορο κουμπί για άνοιγμα της Απόδειξης","Bottone rapido per aprire Impostazioni":"Γρήγορο κουμπί για άνοιγμα των Ρυθμίσεων","Bottone rapido per aprire Share":"Γρήγορο κουμπί για άνοιγμα του Share","Bottone rapido per aprire i consigli AI":"Γρήγορο κουμπί για άνοιγμα των συμβουλών AI","Bottone rapido per aprire la chat AI":"Γρήγορο κουμπί για άνοιγμα της συνομιλίας AI","Bottone rapido per aprire Statistiche":"Γρήγορο κουμπί για άνοιγμα των Στατιστικών","Bottone rapido per aprire Patrimonio":"Γρήγορο κουμπί για άνοιγμα της Περιουσίας","Bottone rapido per aprire Budget":"Γρήγορο κουμπί για άνοιγμα του Προϋπολογισμού","Bottone rapido per aprire Spesa":"Γρήγορο κουμπί για άνοιγμα των Αγορών","Bottone rapido per aprire Obiettivi":"Γρήγορο κουμπί για άνοιγμα των Στόχων","Bottone rapido per aprire Alert":"Γρήγορο κουμπί για άνοιγμα των Ειδοποιήσεων","Bottone rapido per aprire Appunti":"Γρήγορο κουμπί για άνοιγμα των Σημειώσεων"}};
  function H(value:any){var key=String(value==null?"":value);if(!key||lang==="it")return key;var table=HOME_WORKLET_I18N[lang]||HOME_WORKLET_I18N.en||{};return table[key]!==undefined?table[key]:L(key);}
  var HOME_LIBRARY=[
    {type:"assistant_voice_widget",icon:"🦗",label:assistantVoiceUiText(lang||"it").title,desc:assistantVoiceUiText(lang||"it").sub},
    {type:"quick_actions",icon:"⚡",label:H("Tasti rapidi Entrate / Uscite"),desc:H("Pulsanti rapidi per inserire entrate e uscite")},
    {type:"summary",icon:"📌",label:H("Riassunto"),desc:H("Uscite mese, entrate mese, saldo mese e saldo ultimi 12 mesi")},
    {type:"distribution_expenses",icon:"🥧",label:H("Distribuzione Uscite"),desc:H("Grafico per aree di uscita con intervallo temporale")},
    {type:"income_vs_expense",icon:"📊",label:H("Entrate vs Uscite"),desc:H("Confronto mensile tra entrate e uscite")},
    {type:"monthly_balance",icon:"📈",label:H("Saldo Mensile"),desc:H("Andamento del saldo negli ultimi 6 o 12 mesi")},
    {type:"latest_expenses",icon:"🧾",label:H("Ultime Uscite"),desc:H("Lista delle ultime uscite con numero configurabile")},
    {type:"latest_incomes",icon:"💰",label:H("Ultime Entrate"),desc:H("Lista delle ultime entrate con numero configurabile")},
    {type:"share_recent",icon:"🤝",label:H("Share - Ultime transazioni"),desc:H("Ultime transazioni di un progetto Share scelto")},
    {type:"share_balance",icon:"⚖️",label:H("Share - Saldo"),desc:H("Saldo personale di un progetto Share scelto")},
    {type:"planned_saving",icon:"🌱",label:H("Risparmio Pianificato"),desc:H("Risparmio pianificato dal Budget e confronto con il reale")},
    {type:"fidelity_card",icon:"💳",label:H("Fidelity Card"),desc:H("Mostra una carta fidelity o prepagata scelta")},
    {type:"goal",icon:"🎯",label:H("Obiettivo"),desc:H("Avanzamento di un obiettivo scelto")},
    {type:"expenses_by_area",icon:"🗂️",label:H("Uscite per Area"),desc:H("Uscite raggruppate per area")},
    {type:"expenses_by_category",icon:"🏷️",label:H("Uscite per Categoria"),desc:H("Uscite raggruppate per categoria")},
    {type:"incomes_by_type",icon:"💵",label:H("Entrate per Tipo"),desc:H("Entrate raggruppate per tipo")},
    {type:"budget_overview",icon:"📋",label:H("Budget - Riepilogo"),desc:H("Riepilogo budget, spesa reale e risparmio")},
    {type:"budget_by_category",icon:"🧮",label:H("Budget - Categorie"),desc:H("Categorie di budget con consumo del mese")},
    {type:"savings_progress",icon:"📈",label:H("Risparmio - Andamento"),desc:H("Andamento sintetico del risparmio")},
    {type:"monthly_average_income_expense",icon:"📊",label:H("Entrate e Uscite medie mensili"),desc:H("Confronta entrate e uscite medie mensili")},
    {type:"monthly_average_balance",icon:"📈",label:H("Saldo medio mensile"),desc:H("Mostra il saldo medio mensile")},
    {type:"monthly_average_area",icon:"🗂️",label:H("Spesa media mensile per area"),desc:H("Mostra la spesa media mensile per area")},
    {type:"monthly_average_category",icon:"🏷️",label:H("Spesa media mensile per categoria"),desc:H("Mostra la spesa media mensile per categoria")},
    {type:"monthly_average_income_type",icon:"💵",label:H("Entrata media mensile per tipo"),desc:H("Mostra l'entrata media mensile per tipo")},
    {type:"monthly_budget_area",icon:"📋",label:H("Spesa media mensile rispetto al budget per area"),desc:H("Confronta la spesa media mensile con il budget per area")},
    {type:"monthly_budget_category",icon:"🧮",label:H("Spesa media mensile rispetto al budget per categoria"),desc:H("Confronta la spesa media mensile con il budget per categoria")},
    {type:"monthly_budget_delta",icon:"↕️",label:H("Scostamento medio mensile dal budget"),desc:H("Mostra lo scostamento medio mensile dal budget")},
    {type:"note_widget",icon:"📝",label:H("Note"),desc:H("Mostra una nota scelta dagli Appunti")},
    {type:"bank_coord_widget",icon:"🏦",label:H("Coordinata bancaria"),desc:H("Mostra una coordinata bancaria scelta")},
    {type:"credit_card_widget",icon:"💳",label:H("Carta di Credito"),desc:H("Mostra una carta di credito salvata")},
    {type:"shopping_list_widget",icon:"🧺",label:H("Lista della spesa"),desc:H("Mostra gli elementi della lista della spesa scelta")},
    {type:"button_voice",icon:"🎙️",label:H("Voce"),desc:H("Bottone rapido per aprire Voce")},
    {type:"button_receipt",icon:"📷",label:H("Scontrino"),desc:H("Bottone rapido per aprire Scontrino")},
    {type:"button_settings",icon:"⚙",label:H("Impostazioni"),desc:H("Bottone rapido per aprire Impostazioni")},
    {type:"button_share",icon:"🤝",label:H("Share"),desc:H("Bottone rapido per aprire Share")},
    {type:"button_ai_advice",icon:"🦗",label:H("Consigli AI"),desc:H("Bottone rapido per aprire i consigli AI")},
    {type:"button_ai_chat",icon:"💬",label:H("Chat AI"),desc:H("Bottone rapido per aprire la chat AI")},
    {type:"button_stats",icon:"📊",label:H("Statistiche"),desc:H("Bottone rapido per aprire Statistiche")},
    {type:"button_patrimonio",icon:"💎",label:H("Patrimonio"),desc:H("Bottone rapido per aprire Patrimonio")},
    {type:"button_budget",icon:"💰",label:H("Budget"),desc:H("Bottone rapido per aprire Budget")},
    {type:"button_shopping",icon:"🛒",label:H("Spesa"),desc:H("Bottone rapido per aprire Spesa")},
    {type:"button_goals",icon:"🎯",label:H("Obiettivi"),desc:H("Bottone rapido per aprire Obiettivi")},
    {type:"button_alerts",icon:"🔔",label:H("Alert"),desc:H("Bottone rapido per aprire Alert")},
    {type:"button_appunti",icon:"🗂",label:H("Appunti"),desc:H("Bottone rapido per aprire Appunti")}
  ];
  ...
  var RANGE_LABELS:any={1:H("Ultimo mese"),3:H("Ultimi 3 mesi"),6:H("Ultimi 6 mesi"),12:H("Ultimi 12 mesi")};
  ...
  function usableHistoricalCategoryName(value,id){var name=String(value||"").trim(),sid=String(id||"");if(!name)return false;if(sid&&(name===sid||name.toLowerCase()===("categoria "+sid).toLowerCase()||name.toLowerCase()===("category "+sid).toLowerCase()))return false;if(/^(categoria|category|catégorie|kategorie|categoría|categorie|kategoria|κατηγορία)\s+[0-9_-]{5,}$/i.test(name)||/^[0-9_-]{5,}$/.test(name))return false;return true;}
  function unresolvedHistoricalCategory(){return{id:"__history_unresolved__",name:L("Movimenti storici"),icon:"🗂️",color:"#B4B2A9",group:"__history_unresolved__",archived:true,historical:true,unresolved:true};}
  function normalizeHistoricalCategoryName(value){try{return String(value||"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").trim().toLowerCase().replace(/\s+/g," ");}catch(e){return String(value||"").trim().toLowerCase().replace(/\s+/g," ");}}
  function homeExpenseCategory(id,e?:any){var sid=String(id==null?"":id);var name=String((e&&(e.catName||e.categoryName||e.categoryLabel))||"").trim();var found=(cats||[]).find(function(c){return c&&!c.deleted&&String(c.id)===sid;});var fromCurrent=!!found;if(!found&&name){var nn=normalizeHistoricalCategoryName(name);found=(cats||[]).find(function(c){return c&&!c.deleted&&normalizeHistoricalCategoryName(c.name)===nn;});fromCurrent=!!found;}if(!found)found=(historicalExpenseCats||[]).find(function(c){return c&&!c.deleted&&String(c.id)===sid;});if(!found&&name){var nh=normalizeHistoricalCategoryName(name);found=(historicalExpenseCats||[]).find(function(c){return c&&!c.deleted&&normalizeHistoricalCategoryName(c.name)===nh;});}if(found&&usableHistoricalCategoryName(found.name,found.id))return {...found,archived:fromCurrent&&found.archived===true};if(usableHistoricalCategoryName(name,sid))return {id:sid||("history_"+normalizeHistoricalCategoryName(name)),name:name,icon:String((e&&(e.catIcon||e.categoryIcon))||"🏷️"),color:String((e&&(e.catColor||e.categoryColor))||"#B4B2A9"),group:String((e&&(e.catGroup||e.categoryGroup||e.groupId))||""),archived:false,historical:true};return unresolvedHistoricalCategory();}
  function groupForExpense(e){var cat=homeExpenseCategory(e&&e.catId,e);var groups=allGroups();if(cat&&cat.unresolved)return{id:"__history_unresolved__",name:L("Movimenti storici"),icon:"🗂️",color:"#B4B2A9",historical:true};var g=(groups||[]).find(function(x){return cat&&String(x.id)===String(cat.group);});if(g)return g;return{id:"__history_archived__",name:L("Categorie archiviate"),icon:"🗂️",color:"#B4B2A9",historical:true};}
  ...
  function openHomeButton(type){var d=homeButtonDef(type);if(d.tab==="voice"){if(openVoiceModal)openVoiceModal();else{if(setVoiceText)setVoiceText("");if(setVoiceParsed)setVoiceParsed(null);if(setVoiceError)setVoiceError("");if(setVoiceListening)setVoiceListening(false);if(setVoiceModal)setVoiceModal(true);}homeScrollTop();return;}if(d.tab==="receipt"){var aiReceiptAllowed=currentPlan==="base"||currentPlan==="premium";if(aiReceiptAllowed&&openVoiceModal){openVoiceModal(false,true,"receipt");homeScrollTop();return;}setTab("spese");setSpeseSubTab("add");setAddType("expense");setAddSubTab("receipt");homeScrollTop();return;}setTab(d.tab);if(d.tab==="settings"&&setSettingsPage)setSettingsPage(null);if(d.tab==="consulenteAI"&&setAiTab){setAiTab(d.aiTab||"consigli");if(d.aiTab==="chat"){try{localStorage.setItem("fainance_open_ai_chat_input_once","1");}catch(_e){}[120,320,700].forEach(function(ms){setTimeout(function(){try{window.dispatchEvent(new Event("fainance-focus-ai-chat-input"));}catch(_e){}},ms);});return;}if(d.aiTab==="consigli"&&setAiAdviceFilter)setAiAdviceFilter("all");}homeScrollTop();}
  ...
  function homeTitleText(w){var custom=w&&w.params?String(w.params.customTitle||"").trim():"";return cleanHomeWorkletTitle(custom||((lib(w.type).label)||w.type));}
  ...
  function homePlanRank(p){return p==="premium"?2:p==="base"?1:0;}
  function homeWorkletRequiredPlan(type){return type==="monthly_budget_delta"?"premium":(["monthly_average_income_expense","monthly_average_balance","monthly_average_area","monthly_average_category","monthly_average_income_type","monthly_budget_area","monthly_budget_category"].indexOf(String(type||""))>=0?"base":"free");}
  function homeWorkletAllowed(type){return homePlanRank(String(currentPlan||"free"))>=homePlanRank(homeWorkletRequiredPlan(type));}
  function monthlyAverageRows(range){var keys=lastMonthKeys(range),div=Math.max(1,keys.length),exp=totalInKeys(expenses,keys),inc=totalInKeys(incomes,keys);return{keys:keys,div:div,exp:exp/div,inc:inc/div,balance:(inc-exp)/div};}
  function monthlyValueList(items,compact,limit){var rows=(items||[]).slice(0,limit||12);return <div>{rows.map(function(x,i){var max=Math.max.apply(null,rows.map(function(r){return Math.abs(safeNum(r.value));}).concat([1]));return <div key={String(x.id||i)} style={{marginBottom:compact?7:10}}><div style={{display:"flex",justifyContent:"space-between",gap:8,fontSize:compact?10:12,color:textC}}><span style={{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{x.label}</span><b style={{whiteSpace:"nowrap"}}>{fmt(x.value)}</b></div><div style={{height:compact?5:7,borderRadius:999,background:dark?"#333":"#EEF1F5",overflow:"hidden",marginTop:4}}><div style={{height:"100%",width:Math.max(2,Math.min(100,Math.abs(safeNum(x.value))/max*100))+"%",background:x.color||expenseColor,borderRadius:999}}/></div></div>;})}</div>;}
  function monthlyBudgetList(items,compact,limit){return <div>{(items||[]).slice(0,limit||10).map(function(x,i){var pct=x.budget>0?Math.min(100,Math.abs(x.average)/x.budget*100):0;return <div key={String(x.id||i)} style={{marginBottom:compact?7:10}}><div style={{display:"flex",justifyContent:"space-between",gap:8,fontSize:compact?10:12,color:textC}}><span style={{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{x.label}</span><b style={{whiteSpace:"nowrap"}}>{fmt(x.average)} / {fmt(x.budget)}</b></div><div style={{height:compact?5:7,borderRadius:999,background:dark?"#333":"#EEF1F5",overflow:"hidden",marginTop:4}}><div style={{height:"100%",width:pct+"%",background:pct>=100?expenseColor:(x.color||"#7F77DD"),borderRadius:999}}/></div></div>;})}</div>;}
  function homeMonthlyAreaData(keys,div){return sumBy(expenses,keys,function(e){return groupForExpense(e).id;},function(e){var g=groupForExpense(e);return (g.icon?g.icon+" ":"")+(g.name||L("Categoria"));},function(e){return groupForExpense(e).color||expenseColor;}).map(function(x){return{...x,value:x.value/div};});}
  function homeMonthlyCategoryData(keys,div){return sumBy(expenses,keys,function(e){return e.catId||"_category";},function(e){var c=homeExpenseCategory(e.catId,e);return (c.icon?c.icon+" ":"")+c.name+(c.archived?(" · "+L("Archiviata")):"");},function(e){return homeExpenseCategory(e.catId,e).color||expenseColor;}).map(function(x){return{...x,value:x.value/div};});}
  function homeMonthlyIncomeTypeData(keys,div){return sumBy(incomes,keys,function(e){return e.type||"other";},function(e){var it=getIT?getIT(e.type):null;return (it&&it.icon?it.icon+" ":"")+(it&&it.name?it.name:L("Altro"));},function(e){var it=getIT?getIT(e.type):null;return(it&&it.color)||incomeColor;}).map(function(x){return{...x,value:x.value/div};});}
  function homeMonthlyBudgetData(keys,div,byArea){var bp=budgetNumbers(keys.length),rows:any={};(bp.items||[]).forEach(function(it){var c=homeExpenseCategory(it.catId);if(!c)return;var g=groupForExpense({catId:c.id,catName:c.name,catIcon:c.icon,catColor:c.color,catGroup:c.group});var id=byArea?g.id:String(c.id),label=byArea?((g.icon?g.icon+" ":"")+g.name):((c.icon?c.icon+" ":"")+c.name+(c.archived?(" · "+L("Archiviata")):"")),color=byArea?g.color:c.color;if(!rows[id])rows[id]={id:id,label:label,average:0,budget:0,color:color};rows[id].budget+=safeNum(it.amount);rows[id].average+=(expenses||[]).reduce(function(a,e){return String(e.catId)===String(c.id)?a+keys.reduce(function(sum,k){return sum+safeNum(rateMonth(e,k));},0):a;},0)/div;});return Object.keys(rows).map(function(k){return rows[k];}).sort(function(a,b){return b.average-a.average;});}
  function renderWorklet(w){var range=Number((w.params&&w.params.range)||12);var keys=lastMonthKeys(range);var compact=String(w.size||"")==="0.5x";var doubleSize=String(w.size||"")==="2x";if(!homeWorkletAllowed(w.type))return <div style={{height:"100%",minHeight:compact?92:128,borderRadius:12,background:dark?"rgba(255,255,255,.04)":"#F5F6F8",display:"flex",alignItems:"center",justifyContent:"center",padding:12,textAlign:"center",fontSize:11,color:subC}}>{L("Statistica non disponibile nel piano attuale.")}</div>;if(w.type==="assistant_voice_widget"){var av=assistantVoiceUiText(lang||"it");var avSize=String(w.size||"1x1"),avTall=avSize==="1x2"||avSize==="2x2",avWide=avSize==="2x1"||avSize==="2x2";return <button type="button" onClick={function(){if(openVoiceModal)openVoiceModal();else if(setVoiceModal)setVoiceModal(true);}} style={{width:"100%",height:"100%",minHeight:avTall?172:78,border:"none",borderRadius:14,background:"linear-gradient(135deg,rgba(127,119,221,.18),rgba(55,138,221,.13))",color:textC,display:"flex",alignItems:"center",justifyContent:"center",gap:avWide?16:8,flexDirection:avWide?"row":"column",padding:avTall?16:10,cursor:"pointer",textAlign:avWide?"left":"center",overflow:"hidden"}}><AIGrilloIcon size={avTall?(avWide?84:76):(avWide?58:46)}/><div style={{minWidth:0,maxWidth:avWide?280:"100%"}}>{homeShowTitle(w)&&<div style={{fontSize:avTall?17:14,fontWeight:950,color:textC,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{homeTitleText(w)}</div>}<div style={{fontSize:avTall?12:10,color:subC,lineHeight:1.35,marginTop:homeShowTitle(w)?4:0,display:"-webkit-box",WebkitLineClamp:avTall?3:1,WebkitBoxOrient:"vertical",overflow:"hidden"}}>{av.sub}</div><div style={{display:"inline-flex",alignItems:"center",gap:5,marginTop:avTall?10:5,padding:avTall?"7px 10px":"4px 8px",borderRadius:999,background:"#7F77DD",color:"#fff",fontSize:avTall?12:10,fontWeight:900}}>🎙️ {av.speak}</div></div></button>;}if(isHomeNavButton(w.type)){var bd=homeButtonDef(w.type);var showLabel=homeShowTitle(w);var lbl=homeTitleText(w);return <button type="button" onClick={function(){openHomeButton(w.type);}} style={{width:"100%",height:doubleSize?"100%":undefined,minHeight:doubleSize?88:56,border:"none",borderRadius:14,background:secondaryC,color:"#fff",display:"flex",alignItems:"center",justifyContent:"center",gap:compact?4:8,flexDirection:compact?"column":"row",fontSize:compact?10:13,fontWeight:950,cursor:"pointer",boxShadow:dark?"none":"0 8px 18px rgba(0,0,0,.12)",padding:compact?"8px 4px":"10px 10px",textAlign:"center",lineHeight:1.12,overflow:"hidden"}}>{homeButtonIcon(w.type,compact?22:28)}{showLabel&&<span style={{overflow:"hidden",textOverflow:"ellipsis",display:"-webkit-box",WebkitLineClamp:compact?2:1,WebkitBoxOrient:"vertical"}}>{lbl}</span>}</button>;}if(w.type==="quick_actions")return <div style={{display:"flex",gap:compact?8:10,flexDirection:compact?"column":"row",flexWrap:"wrap",height:doubleSize?"100%":undefined,alignItems:doubleSize?"stretch":undefined}}><Btn onClick={function(){setTab("spese");setSpeseSubTab("add");setAddType("expense");setAddSubTab("single");}} bg={expenseColor} style={{flex:1,minWidth:compact?0:130,padding:compact?"10px 8px":"12px 16px",minHeight:doubleSize?72:undefined,fontWeight:900,fontSize:compact?12:undefined}}>− {L(t.expense||"Uscita")}</Btn><Btn onClick={function(){setTab("spese");setSpeseSubTab("add");setAddType("income");setAddSubTab("single");}} bg={incomeColor} style={{flex:1,minWidth:compact?0:130,padding:compact?"10px 8px":"12px 16px",minHeight:doubleSize?72:undefined,fontWeight:900,fontSize:compact?12:undefined}}>+ {L(t.income||"Entrata")}</Btn></div>;
    ...
    if(w.type==="expenses_by_category"){var data2=sumBy(expenses,keys,function(e){return e.catId||"_category";},function(e){var c=homeExpenseCategory(e.catId,e);return (c.icon?c.icon+" ":"")+c.name+(c.archived?(" · "+L("Archiviata")):"");},function(e){return homeExpenseCategory(e.catId,e).color||expenseColor;});return legendChart(data2,compact,doubleSize);}
    ...
    if(w.type==="monthly_average_income_expense"){var monthlyAvgIncomeExpense=monthlyAverageRows(range);return <div style={{overflow:"hidden",width:"100%"}}><BarChart data={[{label:L("Media mensile"),exp:monthlyAvgIncomeExpense.exp,inc:monthlyAvgIncomeExpense.inc}]} width={compact?150:(isMobile?420:640)} height={compact?132:(doubleSize?250:160)}/></div>;}
    if(w.type==="monthly_average_balance"){var monthlyAvgBalance=monthlyAverageRows(range);return monthlyValueList([{id:"balance",label:L("Saldo medio mensile"),value:monthlyAvgBalance.balance,color:BALANCE_COLOR}],compact,1);}
    if(w.type==="monthly_average_area"){var monthlyAvgArea=monthlyAverageRows(range);return monthlyValueList(homeMonthlyAreaData(monthlyAvgArea.keys,monthlyAvgArea.div),compact,8);}
    if(w.type==="monthly_average_category"){var monthlyAvgCategory=monthlyAverageRows(range);return monthlyValueList(homeMonthlyCategoryData(monthlyAvgCategory.keys,monthlyAvgCategory.div),compact,10);}
    if(w.type==="monthly_average_income_type"){var monthlyAvgIncomeType=monthlyAverageRows(range);return monthlyValueList(homeMonthlyIncomeTypeData(monthlyAvgIncomeType.keys,monthlyAvgIncomeType.div),compact,8);}
    if(w.type==="monthly_budget_area"){var monthlyBudgetAreaAvg=monthlyAverageRows(range);return monthlyBudgetList(homeMonthlyBudgetData(monthlyBudgetAreaAvg.keys,monthlyBudgetAreaAvg.div,true),compact,8);}
    if(w.type==="monthly_budget_category"){var monthlyBudgetCategoryAvg=monthlyAverageRows(range);return monthlyBudgetList(homeMonthlyBudgetData(monthlyBudgetCategoryAvg.keys,monthlyBudgetCategoryAvg.div,false),compact,10);}
    if(w.type==="monthly_budget_delta"){var monthlyBudgetDeltaAvg=monthlyAverageRows(range);var monthlyBudgetDeltaRows=homeMonthlyBudgetData(monthlyBudgetDeltaAvg.keys,monthlyBudgetDeltaAvg.div,false).map(function(x){var value=x.budget-x.average;return{id:x.id,label:x.label,value:value,color:value>=0?incomeColor:expenseColor};}).sort(function(a,b){return Math.abs(b.value)-Math.abs(a.value);});return monthlyValueList(monthlyBudgetDeltaRows,compact,10);}
  ...
  function availableItems(){var m=insertedTypes();return HOME_LIBRARY.filter(function(x){return x.type!=="assistant_voice_widget"&&!m[x.type]&&homeWorkletAllowed(x.type);});}
  ...
  function rangeBadge(w){var txt="";if(["distribution_expenses","income_vs_expense","expenses_by_area","expenses_by_category","incomes_by_type","planned_saving","budget_overview","budget_by_category","savings_progress","monthly_average_income_expense","monthly_average_balance","monthly_average_area","monthly_average_category","monthly_average_income_type","monthly_budget_area","monthly_budget_category","monthly_budget_delta"].indexOf(w.type)>=0)txt=rangeTitle(w);else if(w.type==="monthly_balance")txt=((w.params&&w.params.range)==6?H("Ultimi 6 mesi"):H("Ultimi 12 mesi"));return cleanHomeWorkletTitle(txt);}
  function isGraphWorklet(type){return ["distribution_expenses","expenses_by_area","expenses_by_category","incomes_by_type","income_vs_expense","monthly_balance","savings_progress","monthly_average_income_expense","monthly_average_balance","monthly_average_area","monthly_average_category","monthly_average_income_type","monthly_budget_area","monthly_budget_category","monthly_budget_delta"].indexOf(String(type||""))>=0;}
...
export function HistoryPanel(){
  var _c:any=useApp();
  var {lang,cats,historicalExpenseCats,methods,expenseGroups,incomeTypes,customIncomeTypes,incomeTypeOverrides,expenses,setExpenses,incomes,setIncomes,fmt,dark,dateFmt,curMonthKey,btnRadius,expenseColor,incomeColor,isMobile}:any=_c;
  ...
  var {showShareInHistory,setShowShareInHistory,confirmButtonColor,secondaryButtonColor,setNativeBannerSuppressed,getCat,getMethod,getIT,resolveExpenseCategoryForMovement,secRate,showSecInHistory,fmtSec,historySearchDraftRef,deleteConfirmId,setDeleteConfirmId}:any=_c;
  ...
  function usableHistoricalCategoryName(value,id){
    var name=String(value||"").trim(),sid=String(id||"");
    if(!name)return false;
    if(sid&&(name===sid||name.toLowerCase()===("categoria "+sid).toLowerCase()||name.toLowerCase()===("category "+sid).toLowerCase()))return false;
    if(/^(categoria|category|catégorie|kategorie|categoría|categorie|kategoria|κατηγορία)\s+[0-9_-]{5,}$/i.test(name)||/^[0-9_-]{5,}$/.test(name))return false;
    return true;
  }
  function unresolvedHistoricalCategory(){return{id:"__history_unresolved__",name:L("Movimenti storici"),icon:"🗂️",color:"#B4B2A9",group:"__history_unresolved__",archived:true,historical:true,unresolved:true};}
  var t=TRANSLATIONS[lang]||TRANSLATIONS.it;
  ...
  useEffect(function(){
    var hasIncomingFilters=!!((filterCats&&filterCats.length)||(filterCat&&filterCat!=="all")||(filterGroup&&filterGroup!=="all")||(filterMonths&&filterMonths.length)||filterMonth||filterDateFrom||filterDateTo||filterAmtMin||filterAmtMax);
    if(hasIncomingFilters)return;
    try{var raw=localStorage.getItem(historySavedFilterKey());if(raw){applyHistoryFilterPayload(JSON.parse(raw));}else{setHistoryDefaultFilters();}}catch(e){setHistoryDefaultFilters();}
  },[]);
  ...
  function expenseCategoryFromHistoryMovement(e){
    try{if(resolveExpenseCategoryForMovement){var resolved=resolveExpenseCategoryForMovement(e);if(resolved)return resolved;}}catch(_e){}
    var rawId=String(e&&e.catId!==undefined&&e.catId!==null?e.catId:"");
    var movementName=String((e&&(e.catName||e.categoryName||e.categoryLabel))||"").trim();
    var exact=(cats||[]).find(function(c){return c&&!c.deleted&&String(c.id)===rawId;});if(exact)return exact;
    if(movementName){var normalized=String(movementName).trim().toLowerCase();var byName=(cats||[]).find(function(c){return c&&!c.deleted&&String(c.name||"").trim().toLowerCase()===normalized;});if(byName)return byName;}
    var historical=(historicalExpenseCats||[]).find(function(c){return c&&!c.deleted&&String(c.id)===rawId;});if(historical)return historical;
    if(movementName&&usableHistoricalCategoryName(movementName,rawId))return{id:rawId||("history_"+movementName.toLowerCase().replace(/\s+/g,"_")),name:movementName,icon:String((e&&(e.catIcon||e.categoryIcon))||"🏷️"),color:String((e&&(e.catColor||e.categoryColor))||"#B4B2A9"),group:String((e&&(e.catGroup||e.categoryGroup||e.groupId))||""),archived:false,historical:true};
    return unresolvedHistoricalCategory();
  }
  var allHistoricalExpenseCats=useMemo(function(){
    var map:any={},order:string[]=[],hasUnresolved=false;
    (Array.isArray(expenses)?expenses:[]).forEach(function(e){
      var c=expenseCategoryFromHistoryMovement(e);
      if(!c||c.unresolved){hasUnresolved=true;return;}
      var id=String(c.id!==undefined&&c.id!==null?c.id:(e&&e.catId)||"");
      if(!id||!usableHistoricalCategoryName(c.name,id)){hasUnresolved=true;return;}
      if(!map[id])order.push(id);
      var current=(cats||[]).find(function(x){return x&&!x.deleted&&String(x.id)===id;});
      map[id]={...(map[id]||{}),...c,...(current||{}),id:id,archived:current?!!current.archived:!!c.archived,historical:!current||!!current.archived,deleted:false};
    });
    var out=order.map(function(id){return map[id];});
    if(hasUnresolved)out.push(unresolvedHistoricalCategory());
    return out;
  },[historicalExpenseCats,cats,expenses,resolveExpenseCategoryForMovement]);
  function getHistoricalCat(id){var exact=(allHistoricalExpenseCats||[]).find(function(c){return String(c.id)===String(id);});if(exact)return exact;return null;}
  useEffect(function(){var valid:any={share:true};(allHistoricalExpenseCats||[]).forEach(function(c){if(!c||!c.id)return;valid[String(c.id)]=true;valid["expense:"+String(c.id)]=true;});getAllIncomeTypes(customIncomeTypes,incomeTypeOverrides).forEach(function(c){if(c&&c.id)valid["income:"+String(c.id)]=true;});setFilterCats(function(prev){var source=(prev||[]).map(String),next=source.filter(function(id){return !!valid[id];});return next.length===source.length?prev:next;});if(filterCat&&filterCat!=="all"&&!valid[String(filterCat)]&&!valid["expense:"+String(filterCat)])setFilterCat("all");},[allHistoricalExpenseCats,customIncomeTypes,incomeTypeOverrides]);
  function categorySortLabel(item){if(item&&item._historyKind==="income"){var it=getIT?getIT(item.type):null;return String((it&&it.name)||item.type||"");}var c=getHistoricalCat(item&&item.catId)||expenseCategoryFromHistoryMovement(item);return String((c&&c.name)||"");}
  ...
  },[filteredExpenses,filteredIncomes,historyTab,expenseFilterActive,historySortDate,historySortDirection,historySortSecondary,historySortSecondaryDirection,cats,historicalExpenseCats]);
  ...
  function incomeTypeItems(){return getAllIncomeTypes(customIncomeTypes,incomeTypeOverrides).filter(function(x){return x&&x.id&&!x.deleted;});}
  function activeExpenseFilterCats(){return (cats||[]).filter(function(c){return c&&c.id&&!c.deleted&&!c.archived;});}
  function historicalExpenseFilterCats(){var referenced=new Set((expenses||[]).map(function(e){return String(e&&e.catId||"");}).filter(Boolean));var unresolvedUsed=(expenses||[]).some(function(e){return expenseCategoryFromHistoryMovement(e)&&expenseCategoryFromHistoryMovement(e).unresolved;});return (allHistoricalExpenseCats||[]).filter(function(c){return c&&c.id&&(c.unresolved?unresolvedUsed:referenced.has(String(c.id)));});}
  function expenseCategoryFilterItems(){return historicalExpenseFilterCats();}
  function activeFilterMethods(){return (methods||[]).filter(function(m){return m&&m.id&&!m.deleted&&!m.archived;});}
  function categoryButtons(items,kind){return <div style={{display:"flex",gap:7,flexWrap:"wrap"}}>{(items||[]).filter(function(c){return c&&c.id;}).map(function(c){var id=String(c.id);var active=isCatActive(kind,id);var col=c.color||confirmC;var archived=!!c.archived||!!c.deleted;return <button type="button" key={kind+id} onClick={function(){togglePrefixedCat(kind,id);}} style={{padding:"8px 11px",borderRadius:999,border:"1px solid "+(active?col:(dark?"#46465d":"#D7DEEA")),background:active?col:(dark?"#242438":"#FFFFFF"),color:active?"#fff":textC,fontSize:12,fontWeight:900,cursor:"pointer",boxShadow:active?("0 5px 14px "+col+"30"):(dark?"none":"0 2px 8px rgba(15,23,42,.05)"),opacity:archived?.72:1}}>{active?"✓ ":""}{c.icon||"🏷️"} {L(c.name)}{archived?(" · "+L("Archiviata")):""}</button>;})}</div>;}
...
export function ConsulenteAIPanel(){
  ...
  var {setShowShareInHistory,confirmButtonColor,setConfirmButtonColor,secondaryButtonColor,firestoreReady,userKey,userId,currentUser,pendingCount}:any=_c;
  var {alertTriggered,getCat,getMethod,getIT,curMonthExp,curMonthInc,last12Balance,aiTab}:any=_c;
  var {setAiTab,aiLoading,setAiLoading,aiAdviceFilter,setAiAdviceFilter,voiceModal,setVoiceModal,openVoiceModal,voiceListening}:any=_c;
  var {setVoiceListening,voiceText,setVoiceText,voiceError,setVoiceError,voiceConfirm,setVoiceConfirm,voiceSaving}:any=_c;
  var {setVoiceSaving,voiceParsed,setVoiceParsed,defaultExpenseCat,setDefaultExpenseCat,defaultExpenseMethod,setDefaultExpenseMethod,defaultExpenseArea}:any=_c;
  var {setDefaultExpenseArea,defaultIncomeType,setDefaultIncomeType,defaultIncomeArea,setDefaultIncomeArea,defaultMethodArea,setDefaultMethodArea,incomeTypeOrder}:any=_c;
  var {setIncomeTypeOrder,deleteConfirmId,setDeleteConfirmId,mergeFrom,setMergeFrom,mergeTo,setMergeTo,homeBalanceView}:any=_c;
...
var {normalizeEmail,loadShareCollaboration,acceptShareInvite,declineShareInvite,createShareInvite,createShareProject,updateShareProject,deleteShareProject,canAddPlanItem}:any=_c;
  ...
  var aiConversationLanguageRef=useRef(createAssistantConversationLanguageState(lang||"it"));
  ...
  function buildAIRequest(q){
    ...
    var req:any=buildFinanceAdviceRequestPayload({question:q,forcedLanguage:forced||undefined,fallbackLanguage:lang||"it",languageState:aiConversationLanguageRef.current,interfaceLanguage:lang||"it",context:buildAIContext(),chatHistory:(aiChat||[]).filter(function(m){return m&&(m.role==="user"||m.role==="assistant");}).slice(-12).map(function(m){return{role:m.role,text:m.rawText||m.text};}),scopeInstruction:AI_AGENT_SCOPE_INSTRUCTION,financialInstruction:"Respect dataAccessLevel: summary uses only summaries, areas may also use area aggregates, and full may use the supplied transactions. Use trend, budgetRisks, dataQuality and activeAdvice to give 2 to 4 concrete actions. Use estimated amounts only when they derive from the supplied data. Never invent missing personal data. Present scenarios, risks and assumptions rather than absolute certainty."});
    if(req&&req.languageState)aiConversationLanguageRef.current=req.languageState;
    return req;
  }
  async function callFinanceAgent(q,preparedRequest?:any){
    var req=preparedRequest||buildAIRequest(q);var token="";try{if(fbAuth.currentUser)token=await fbAuth.currentUser.getIdToken();}catch(e){}var aiHeaders:any={"Content-Type":"application/json"};if(token)aiHeaders.Authorization="Bearer "+token;var aiCtrl=new AbortController();var aiTimeout=setTimeout(function(){aiCtrl.abort();},15000);var res=await fetch(AI_AGENT_ENDPOINT,{method:"POST",headers:aiHeaders,signal:aiCtrl.signal,body:JSON.stringify(req)}).finally(function(){clearTimeout(aiTimeout);});var data=null;try{data=await res.json();}catch(e){}if(!res.ok){throw new Error((data&&data.error)||("Errore agente AI: "+res.status));}
  ...
  async function sendChat(){
    ...
    var languageControlReply=assistantLanguageControlReply(preparedRequest&&preparedRequest.languageResolution);
    if(languageControlReply){
      setAiChat(function(p){return [...p,{id:Date.now(),role:"user",text:q},{id:Date.now()+1,role:"assistant",text:languageControlReply}].slice(-50);});
      if(chatInputRef.current)chatInputRef.current.value="";
      return;
    }
    var localHelpAnswer=getFainanceHelpAnswer(q,preparedRequest&&preparedRequest.language||lang||"it");
    if(localHelpAnswer){
      setAiChat(function(p){return [...p,{id:Date.now(),role:"user",text:q},{id:Date.now()+1,role:"assistant",text:localHelpAnswer}].slice(-50);});
      if(chatInputRef.current)chatInputRef.current.value="";
      return;
    }
    function runAllowed(){
      ...
      if(!isAIQuestionInScope(q)){
        setAiChat(function(p){return [...p,{id:Date.now()+1,role:"assistant",text:localizedOutOfScope(preparedRequest.language||detectAssistantTurnLanguage(q,lang||"it"))}].slice(-50);});
        return;
      }
      function callExternalAI(){
        setAiLoading(true);
        callFinanceAgent(q,preparedRequest).then(function(ans){
  ...
  return <div style={{display:"flex",flexDirection:"column",gap:16}}>
    <div style={{position:"relative",overflow:"hidden",background:dark?"#252535":"linear-gradient(135deg,#ffffff,#f4f1ff)",border:"1px solid "+borderC2,borderRadius:18,padding:isMobile?18:22,minHeight:isMobile?132:150,boxShadow:dark?"none":"0 8px 28px rgba(127,119,221,0.12)"}}>
      <div style={{position:"relative",zIndex:2,maxWidth:620}}>
        ...
        <div style={{display:"flex",gap:9,flexWrap:"wrap"}}><button onClick={function(){openAIChat("");}} style={{background:"linear-gradient(135deg,var(--fainance-primary,#378ADD),var(--fainance-secondary,#5FAFE5))",color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px 14px",fontSize:13,fontWeight:700,cursor:"pointer",display:"inline-flex",alignItems:"center",gap:8,boxShadow:"0 4px 14px rgba(127,119,221,0.22)"}}>💬 {L("Chat")}</button><button onClick={function(){if(openVoiceModal)openVoiceModal(true,true);else setVoiceModal(true);}} style={{background:"linear-gradient(135deg,#1D9E75,#378ADD)",color:"#fff",border:"none",borderRadius:btnRadius,padding:"10px 14px",fontSize:13,fontWeight:800,cursor:"pointer",display:"inline-flex",alignItems:"center",gap:8,boxShadow:"0 4px 14px rgba(29,158,117,0.22)"}}>🎙️ {L("Parla con l’assistente")}</button></div>
      </div>
    </div>
    ...
    {aiConsentPrompt&&<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.58)",zIndex:950,display:"flex",alignItems:"center",justifyContent:"center",padding:"10vh 16px 2vh",boxSizing:"border-box",overflowY:"auto"}}>
      <div style={{width:"100%",maxWidth:560,background:cardBg2,border:"1px solid "+borderC2,borderRadius:22,boxShadow:"0 18px 60px rgba(0,0,0,.34)",padding:18}}>
        ...
        <div style={{display:"flex",gap:10,marginTop:16,flexDirection:isMobile?"column":"row"}}>
          <button onClick={acceptAIExternalConsent} style={{flex:1,border:"none",borderRadius:btnRadius,padding:"12px 14px",background:"linear-gradient(135deg,var(--fainance-primary,#378ADD),var(--fainance-secondary,#5FAFE5))",color:"#fff",fontSize:14,fontWeight:900,cursor:"pointer"}}>{L("Accetto e continuo")}</button>
...
function VoiceAssistantModal({onQuick}){
  ...
  var assistantLanguageStateRef=useRef(createAssistantConversationLanguageState(lang||"it"));
  ...
  function handleRealtimeEvent(raw:any){var event:any=raw;try{if(typeof raw==="string")event=JSON.parse(raw);}catch(e){return;}if(!event||!event.type)return;var type=String(event.type);
    ...
    if(type==="conversation.item.input_audio_transcription.completed"){var ut=String(event.transcript||realtimeUserDraftRef.current||"").trim();realtimeUserDraftRef.current="";setRealtimeUserDraft("");clearVoiceNotice();if(ut){var probs=Array.isArray(event.logprobs)?event.logprobs:[];var avgLogProb=probs.length?probs.reduce(function(sum,p){var lp=Number(p&&p.logprob);return sum+(Number.isFinite(lp)?lp:-4);},0)/probs.length:null;var confidence=avgLogProb===null?null:Math.exp(Math.max(-12,Math.min(0,avgLogProb)));var turnResolution:any=resolveVoiceAssistantTurn(ut);var turnLanguage=turnResolution.language;lastVoiceUserRequestRef.current=ut;appendVoiceMessage(ut,confidence);var languageControlReply=assistantLanguageControlReply(turnResolution);var localHelpAnswer=getFainanceHelpAnswer(ut,turnLanguage);var check=normalized(ut);var hearingCheck=/^(mi senti|mi stai sentendo|riesci a sentirmi|mi ascolti|ci sei|can you hear me|do you hear me|tu m'entends|vous m'entendez|me escuchas|puedes oirme|kannst du mich horen|consegues ouvir-me|slyszysz mnie|hoor je mij|ma auzi|με ακους)[?.! ]*$/.test(check);if(languageControlReply)sendRealtimeEvent(buildRealtimeResponseCreate(turnResolution,"This is a language control command. Reply exactly and only with this text: "+languageControlReply));else if(localHelpAnswer)sendRealtimeEvent(buildRealtimeResponseCreate(turnResolution,"This is verified fAInance help. Reply exactly and only with the following text, without adding anything:\n"+localHelpAnswer));else{if(consumePlanFeature)consumePlanFeature("aiReply",1);if(hearingCheck)sendRealtimeEvent(buildRealtimeResponseCreate(turnResolution,"Reply exactly and only: "+assistantHearingReply(turnLanguage)));else if(activeAttachmentRef.current){sendRealtimeEvent({type:"response.cancel"});sendRealtimeEvent({type:"output_audio_buffer.clear"});callAssistant(ut,turnResolution);}else sendRealtimeEvent(buildRealtimeResponseCreate(turnResolution));}}return;}
  ...
  async function connectRealtime(){
    ...
    try{
      ...
      phase="session";
      var sessionPromise=(async function(){var token="";if(fbAuth.currentUser)token=await fbAuth.currentUser.getIdToken();var headers:any={"Content-Type":"application/json"};if(token)headers.Authorization="Bearer "+token;var realtimeSessionPayload=buildRealtimeSessionRequest({interfaceLanguage:lang||"it",languageState:assistantLanguageStateRef.current,aiDataAccess:aiDataAccess||"summary",financeContext:contextForRealtime,chatHistory:(aiChat||[]).slice(-8).map(function(m){return{role:m.role,text:m.rawText||m.text};})});var response=await fetch(AI_REALTIME_ENDPOINT,{method:"POST",headers:headers,signal:controller.signal,body:JSON.stringify(realtimeSessionPayload)});var payload:any={};try{payload=await response.json();}catch(e){}if(!response.ok||!payload.value){statusCode=response.status;serverMessage=String((payload&&payload.error)||"");var err:any=new Error(serverMessage||("Errore sessione "+response.status));err.httpStatus=response.status;err.serverMessage=serverMessage;throw err;}return payload;})();
  ...
  function sendRealtimeText(q:string,providedResolution?:any){var clean=String(q||"");var turnResolution:any=providedResolution||resolveVoiceAssistantTurn(clean);lastVoiceUserRequestRef.current=clean;if(!sendRealtimeEvent({type:"conversation.item.create",item:{type:"message",role:"user",content:[{type:"input_text",text:clean}]}}))return false;var languageControlReply=assistantLanguageControlReply(turnResolution);if(languageControlReply)sendRealtimeEvent(buildRealtimeResponseCreate(turnResolution,"This is a language control command. Reply exactly and only with this text: "+languageControlReply));else sendRealtimeEvent(buildRealtimeResponseCreate(turnResolution));setBusy(true);return true;}
  ...
  async function speakFallback(clean,resume,cycle){
    try{
      ...
      if(nativePlatform()){
        ...
        var speechLang=lastAssistantUserLanguageRef.current||String(lang||"it");await tts.speak({text:clean,lang:assistantSpeechLocale(speechLang),rate:1.02,pitch:1,volume:assistantVolumeRef.current,category:"ambient",queueStrategy:0});
      ...
      window.speechSynthesis.cancel();var u=new SpeechSynthesisUtterance(clean);var speechLang=lastAssistantUserLanguageRef.current||String(lang||"it");u.lang=assistantSpeechLocale(speechLang);u.rate=1.02;u.pitch=1;u.volume=assistantVolumeRef.current;
  ...
  async function speak(text,resume){
    ...
    try{
      ...
      var res=await fetch(AI_VOICE_ENDPOINT,{method:"POST",headers:headers,signal:ctrl.signal,body:JSON.stringify({text:clean,language:lastAssistantUserLanguageRef.current||String(lang||"it")})}).finally(function(){clearTimeout(timer);});
  ...
  useEffect(function(){if(receiptAutoOpenAttemptedRef.current||!aiExternalConsent)return;var requested="";try{requested=String(localStorage.getItem("fainance_voice_assistant_receipt_once")||"");}catch(e){}if(!requested)return;receiptAutoOpenAttemptedRef.current=true;try{localStorage.removeItem("fainance_voice_assistant_receipt_once");}catch(e){}var timer=setTimeout(function(){if(!mountedRef.current)return;if(requested==="gallery")chooseFinancePhoto();else takeFinancePhoto();},140);return function(){clearTimeout(timer);};},[aiExternalConsent]);
  ...
  return <div style={{position:"fixed",inset:0,zIndex:1000,background:"rgba(0,0,0,.62)",display:"flex",alignItems:isMobile?"stretch":"center",justifyContent:"center",padding:isMobile?"calc(env(safe-area-inset-top, 0px) + 12px) 0 max(env(safe-area-inset-bottom, 0px), 8px)":18,boxSizing:"border-box"}} onClick={close}>
    <div onClick={function(e){e.stopPropagation();}} style={{width:"100%",maxWidth:760,height:isMobile?"auto":"min(820px,94vh)",flex:isMobile?1:undefined,minHeight:0,background:dark?"#171724":"#F8F9FF",border:isMobile?"none":"1px solid "+borderC,borderRadius:isMobile?0:24,boxShadow:"0 22px 70px rgba(0,0,0,.38)",display:"flex",flexDirection:"column",overflow:"hidden",position:"relative"}}>
      <div style={{padding:isMobile?"10px 10px":"10px 14px",background:dark?"#202033":"linear-gradient(135deg,#F0EDFF,#EAF5FF)",borderBottom:"1px solid "+borderC,display:"flex",alignItems:"center",gap:isMobile?8:10,minHeight:isMobile?60:68,boxSizing:"border-box"}}><AIGrilloIcon size={isMobile?34:40}/><div style={{flex:1,minWidth:0}}><div style={{fontSize:isMobile?15:17,fontWeight:950,color:textC,lineHeight:1.12}}>{V.title}</div>{!isMobile&&<div style={{fontSize:11,color:subC,marginTop:2,lineHeight:1.25}}>{V.sub}</div>}</div><button onClick={onQuick} style={{border:"1px solid "+borderC,background:dark?"#2A2A3E":"#fff",color:textC,borderRadius:9,padding:isMobile?"7px 8px":"8px 10px",fontSize:isMobile?10:11,fontWeight:850,cursor:"pointer",whiteSpace:"nowrap"}}>⚡ {isMobile?"Rapido":V.quick}</button><button onClick={close} style={{width:isMobile?34:38,height:isMobile?34:38,borderRadius:11,border:"1px solid #FFB8B8",background:dark?"#3A1F25":"#FFF0F0",color:"#E24B4A",fontSize:22,fontWeight:950,cursor:"pointer"}}>×</button></div>
      {!aiExternalConsent?<div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",padding:24}}><div style={{maxWidth:560,background:cardBg,border:"1px solid "+borderC,borderRadius:18,padding:20}}><div style={{fontSize:17,fontWeight:950,color:textC,marginBottom:8}}>{V.consentTitle}</div><div style={{fontSize:13,color:subC,lineHeight:1.55,marginBottom:16}}>{V.consentText}</div><button onClick={function(){setAiExternalConsent(true,new Date().toISOString());setVoiceError("");}} style={{width:"100%",border:"none",borderRadius:btnRadius,padding:"12px 14px",background:"linear-gradient(135deg,var(--fainance-primary,#378ADD),var(--fainance-secondary,#5FAFE5))",color:"#fff",fontWeight:900,cursor:"pointer"}}>{V.accept}</button></div></div>:<>
      <div style={{margin:"12px 14px 8px",padding:"13px 14px",display:"flex",alignItems:"center",gap:12,border:"2px solid "+statusAccent,borderRadius:15,background:realtimeStatus==="connecting"?(dark?"#17263A":"#EDF6FF"):(realtimeStatus==="connected"?(dark?"#153229":"#ECFFF7"):(dark?"#28233B":"#F3F0FF")),boxShadow:"0 7px 20px "+statusAccent+"26"}}><span style={{width:13,height:13,borderRadius:"50%",background:statusAccent,boxShadow:"0 0 0 6px "+statusAccent+"22",flexShrink:0,animation:realtimeStatus==="connecting"?"pulse 1.2s infinite":"none"}}/><div style={{flex:1,minWidth:0}}><div style={{fontSize:15,fontWeight:950,color:textC,lineHeight:1.25}}>{statusTitle}</div><div style={{fontSize:12,color:subC,lineHeight:1.4,marginTop:3,fontWeight:realtimeStatus==="connecting"?750:500}}>{statusSub}</div></div>{realtimeStatus!=="connected"&&realtimeStatus!=="connecting"&&<button onClick={connectRealtime} style={{border:"none",background:"linear-gradient(135deg,var(--fainance-primary,#378ADD),var(--fainance-secondary,#5FAFE5))",color:"#fff",borderRadius:10,padding:"9px 12px",fontSize:12,fontWeight:900,cursor:"pointer"}}><span style={{display:"inline-flex",verticalAlign:"middle",marginRight:5}}><FinanceMicIcon size={17}/></span>Avvia</button>}</div>
      ...
      <div style={{padding:"10px 14px 12px",background:dark?"#202033":"#fff",display:"grid",gridTemplateColumns:"auto auto minmax(0,1fr) auto",gap:9,alignItems:"end",borderTop:"1px solid "+borderC}}><button onClick={realtimeStatus==="connected"?toggleRealtimeMicrophone:connectRealtime} disabled={realtimeStatus==="connecting"} title={realtimeStatus==="connected"?(realtimeMicEnabled?"Disattiva microfono":"Attiva microfono"):"Avvia conversazione"} style={{width:48,height:48,borderRadius:"50%",border:"none",background:realtimeStatus==="connected"?(realtimeMicEnabled?(voiceListening?"#EF9F27":"#1D9E75"):"#777"):(realtimeStatus==="connecting"?"#A8A8A8":"linear-gradient(135deg,var(--fainance-primary,#378ADD),var(--fainance-secondary,#5FAFE5))"),color:"#fff",fontSize:20,fontWeight:900,cursor:realtimeStatus==="connecting"?"wait":"pointer",boxShadow:"0 5px 16px rgba(127,119,221,.3)"}}><FinanceMicIcon size={25} muted={realtimeStatus==="connected"&&!realtimeMicEnabled} active={realtimeStatus==="connected"&&realtimeMicEnabled&&voiceListening}/></button><button onClick={function(){setAttachmentMenuOpen(function(v){return !v;});}} disabled={documentLoading||busy} title="Aggiungi allegato" style={{width:48,height:48,borderRadius:"50%",border:"1px solid "+borderC,background:dark?"#2A2A3E":"#F5F6FB",color:textC,fontSize:27,fontWeight:500,lineHeight:1,cursor:documentLoading||busy?"wait":"pointer"}}>+</button><textarea value={input} onChange={function(e){setInput(e.target.value);}} onKeyDown={function(e){if(e.key==="Enter"&&!e.shiftKey){e.preventDefault();sendMessage();}}} placeholder={realtimeStatus==="connected"?"Parla liberamente oppure scrivi qui…":V.placeholder} style={{...sinp,minHeight:48,maxHeight:110,resize:"none"}}/><button onClick={function(){sendMessage();}} disabled={!input.trim()||busy||aiLoading||realtimeStatus==="connecting"} style={{height:48,border:"none",borderRadius:12,padding:"0 15px",background:input.trim()&&!busy?"#7F77DD":"#A8A8A8",color:"#fff",fontWeight:900,cursor:input.trim()&&!busy?"pointer":"not-allowed"}}>{V.send}</button></div>
      </>}
    </div>
  </div>;
}
